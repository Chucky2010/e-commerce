/*
               File: WorkWithPlus.NativeMobile.WWPTileType
        Description: WWPTileType
             Author: GeneXus Android Generator version 17_0_11-163677
       Generated on: December 11, 2024 1:24:32.99
...
public final  class gxdomainwwptiletype
{
   private static java.util.TreeMap domain = new java.util.TreeMap();
   static
   {
      domain.put(new Byte((byte)0), "Information");
      domain.put(new Byte((byte)1), "Image");
      domain.put(new Byte((byte)2), "Web Component");
   }
