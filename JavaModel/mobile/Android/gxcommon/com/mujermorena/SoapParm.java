/*
       ...
       Generated on: December 11, 2024 1:24:33.46
...
public final  class SoapParm
{
      ...
      if ( oReader.getNodeType() == 1 )
      {
         ...
         while ( ! ( ( GXutil.strcmp(oReader.getName(), sSection) == 0 ) && ( oReader.getNodeType() == 2 ) ) )
         {
            ...
            else if ( GXutil.strcmp(oReader.getName(), "Authentication") == 0 )
            {
               ...
               oLocation.setAuthenticationMethod( (byte)(GXutil.lval( GXutil.ltrimstr( DecimalUtil.doubleToDec(0), 9, 0))) );
               oReader.read();
            ...
            {
               oLocation.setProxyAuthenticationMethod( (byte)(GXutil.lval( GXutil.ltrimstr( DecimalUtil.doubleToDec(0), 9, 0))) );
               oReader.read();
      ...
      if ( oLocation != null )
      {
         ...
         if ( GXutil.strcmp(sLocation, "") != 0 )
         {
            ...
            else
            {
               ...
               oLocation.setWSDLURL( oGroupLocation.getWSDLURL() );
                                                ...
                                                com.genexus.internet.HttpClient oClient )
   {
      ...
      if ( context.globals.nSOAPErr == 0 )
      {
         ...
         if ( GXutil.strcmp(oLocation.getWSDLURL(), "") != 0 )
         {
            oClient.setWSDLURL( oLocation.getWSDLURL() );
         }
