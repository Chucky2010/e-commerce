/*
       ...
       Generated on: December 11, 2024 1:24:33.39
...
public  class GxObjectCollection<T> extends GXSimpleCollection<T>
{
   public GxObjectCollection( Class<T> elementsType ,
                              String elementsName ,
   ...
   public GxObjectCollection<T> Clone( )
   {
      GxObjectCollection<T> objCol = new GxObjectCollection<T>();
      objCol.setStruct(getStruct());
      return (GxObjectCollection<T>)(objCol) ;
   }
