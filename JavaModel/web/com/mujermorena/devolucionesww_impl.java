...
public final  class devolucionesww_impl extends GXDataArea
{
   public devolucionesww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devolucionesww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devolucionesww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV39Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_MotivoDevolucionDescripcion, AV36IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.devolucionesww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV39Pgmname, ""))));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION", getSecureSignedToken( "", AV33IsAuthorized_MotivoDevolucionDescripcion));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV39Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV39Pgmname, ""))));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION", AV33IsAuthorized_MotivoDevolucionDescripcion);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION", getSecureSignedToken( "", AV33IsAuthorized_MotivoDevolucionDescripcion));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   {
      return formatLink("com.mujermorena.devolucionesww", new String[] {}, new String[] {})  ;
   }

   public String getPgmname( )
   {
      return "DevolucionesWW" ;
   }
   ...
   public void wb660( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Devoluciones", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_DevolucionesWW.htm");
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_662( true) ;
      }
      else
      {
         wb_table1_22_662( false) ;
      }
      return  ;
   }

   public void wb_table1_22_662e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVOLUCIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A272DevolucionesID), "ZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DEVOLUCIONESID", GXutil.ltrim( localUtil.ntoc( A272DevolucionesID, (byte)(10), (byte)(0), ".", "")));
   }
   ...
   public void rf662( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV40Devolucioneswwds_1_filterfulltext ,
         ...
         lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
         lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
         lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
         lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
         lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
         ...
         lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
         /* Using cursor H00663 */
         pr_default.execute(0, new Object[] {lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A279DevolucionesObservacion = H00663_A279DevolucionesObservacion[0] ;
            A280MotivoDevolucionDescripcion = H00663_A280MotivoDevolucionDescripcion[0] ;
            A273MotivoDevolucionID = H00663_A273MotivoDevolucionID[0] ;
            A9TipoPagoId = H00663_A9TipoPagoId[0] ;
            A4ClienteId = H00663_A4ClienteId[0] ;
            A91VentasFecha = H00663_A91VentasFecha[0] ;
            A19VentasId = H00663_A19VentasId[0] ;
            A275DevolucionesFecha = H00663_A275DevolucionesFecha[0] ;
            A272DevolucionesID = H00663_A272DevolucionesID[0] ;
            A276DevolucionesTotal = H00663_A276DevolucionesTotal[0] ;
            n276DevolucionesTotal = H00663_n276DevolucionesTotal[0] ;
            A280MotivoDevolucionDescripcion = H00663_A280MotivoDevolucionDescripcion[0] ;
            A9TipoPagoId = H00663_A9TipoPagoId[0] ;
            A4ClienteId = H00663_A4ClienteId[0] ;
            A91VentasFecha = H00663_A91VentasFecha[0] ;
   ...
   public void send_integrity_lvl_hashes662( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV39Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV39Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DISPLAY", AV28IsAuthorized_Display);
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVOLUCIONESID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A272DevolucionesID), "ZZZZZZZZZ9")));
   }
   ...
   {
      AV40Devolucioneswwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV40Devolucioneswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Devolucioneswwds_1_filterfulltext), "%", "") ;
      /* Using cursor H00665 */
      pr_default.execute(1, new Object[] {lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext, lV40Devolucioneswwds_1_filterfulltext});
      GRID_nRecordCount = H00665_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e17662( )
   {
      ...
      devolucionesww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV33IsAuthorized_MotivoDevolucionDescripcion = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV33IsAuthorized_MotivoDevolucionDescripcion", AV33IsAuthorized_MotivoDevolucionDescripcion);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION", getSecureSignedToken( "", AV33IsAuthorized_MotivoDevolucionDescripcion));
   ...
   public void e18662( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV39Pgmname, GXv_char7) ;
      devolucionesww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e11662( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("DevolucionesWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV39Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("DevolucionesWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "DevolucionesWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         devolucionesww_impl.this.GXt_char6 = GXv_char7[0] ;
         ...
         else
         {
            ...
            S172 ();
            if (returnInSub) return;
            new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV39Pgmname+"GridState", AV20ManageFiltersXml) ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "DevolucionesWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S132( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV18Session.getValue(AV39Pgmname+"GridState"), "") == 0 )
      {
         AV11GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV39Pgmname+"GridState"), null, null);
      }
      else
      {
         AV11GridState.fromxml(AV18Session.getValue(AV39Pgmname+"GridState"), null, null);
      }
      AV13OrderedBy = AV11GridState.getgxTv_SdtWWPGridState_Orderedby() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13OrderedBy", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13OrderedBy), 4, 0));
      AV14OrderedDsc = AV11GridState.getgxTv_SdtWWPGridState_Ordereddsc() ;
   ...
   public void S182( )
   {
      ...
      returnInSub = false ;
      AV41GXV1 = 1 ;
      while ( AV41GXV1 <= AV11GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV12GridStateFilterValue = (com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV41GXV1));
   ...
   public void S162( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV39Pgmname+"GridState", AV11GridState.toxml(false, true, "WWPGridState", "Mujer_Morena")) ;
   }
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Devoluciones" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.devolucioneswwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      devolucionesww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      devolucionesww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.devolucioneswwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_662( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_662( true) ;
      }
      else
      {
         wb_table2_27_662( false) ;
      }
      return  ;
   }

   public void wb_table2_27_662e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_662e( true) ;
      }
      else
      {
         wb_table1_22_662e( false) ;
      }
   }

   public void wb_table2_27_662( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211123355", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("devolucionesww.js", "?20241211123355", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtDevolucionesID_Internalname = "DEVOLUCIONESID_"+sGXsfl_40_idx ;
      edtDevolucionesFecha_Internalname = "DEVOLUCIONESFECHA_"+sGXsfl_40_idx ;
      ...
      edtMotivoDevolucionID_Internalname = "MOTIVODEVOLUCIONID_"+sGXsfl_40_idx ;
      edtMotivoDevolucionDescripcion_Internalname = "MOTIVODEVOLUCIONDESCRIPCION_"+sGXsfl_40_idx ;
      edtDevolucionesObservacion_Internalname = "DEVOLUCIONESOBSERVACION_"+sGXsfl_40_idx ;
      edtDevolucionesTotal_Internalname = "DEVOLUCIONESTOTAL_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtDevolucionesID_Internalname = "DEVOLUCIONESID_"+sGXsfl_40_fel_idx ;
      edtDevolucionesFecha_Internalname = "DEVOLUCIONESFECHA_"+sGXsfl_40_fel_idx ;
      ...
      edtMotivoDevolucionID_Internalname = "MOTIVODEVOLUCIONID_"+sGXsfl_40_fel_idx ;
      edtMotivoDevolucionDescripcion_Internalname = "MOTIVODEVOLUCIONDESCRIPCION_"+sGXsfl_40_fel_idx ;
      edtDevolucionesObservacion_Internalname = "DEVOLUCIONESOBSERVACION_"+sGXsfl_40_fel_idx ;
      edtDevolucionesTotal_Internalname = "DEVOLUCIONESTOTAL_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtMotivoDevolucionID_Internalname,GXutil.ltrim( localUtil.ntoc( A273MotivoDevolucionID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A273MotivoDevolucionID), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtMotivoDevolucionID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDentificador","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A276DevolucionesTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A276DevolucionesTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Pago Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         httpContext.writeValue( httpContext.getMessage( "Devolucion Descripcion", "")) ;
         httpContext.writeTextNL( "</th>") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:DevolucionesID|4:DevolucionesFecha|5:VentasId|6:VentasFecha|7:ClienteId|8:TipoPagoId|9:MotivoDevolucionID|10:MotivoDevolucionDescripcion|11:DevolucionesObservacion" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e12662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e13662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e15662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e19662',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A272DevolucionesID',fld:'DEVOLUCIONESID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'A273MotivoDevolucionID',fld:'MOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9'}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e11662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e16662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A272DevolucionesID',fld:'DEVOLUCIONESID',pic:'ZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e14662',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV40Devolucioneswwds_1_filterfulltext = "" ;
      AV40Devolucioneswwds_1_filterfulltext = "" ;
      H00663_A279DevolucionesObservacion = new String[] {""} ;
      H00663_A280MotivoDevolucionDescripcion = new String[] {""} ;
      H00663_A273MotivoDevolucionID = new long[1] ;
      H00663_A9TipoPagoId = new long[1] ;
      H00663_A4ClienteId = new long[1] ;
      H00663_A91VentasFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H00663_A19VentasId = new long[1] ;
      H00663_A275DevolucionesFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H00663_A272DevolucionesID = new long[1] ;
      H00663_A276DevolucionesTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00663_n276DevolucionesTotal = new boolean[] {false} ;
      H00665_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devolucionesww__default(),
         new Object[] {
             new Object[] {
            H00663_A279DevolucionesObservacion, H00663_A280MotivoDevolucionDescripcion, H00663_A273MotivoDevolucionID, H00663_A9TipoPagoId, H00663_A4ClienteId, H00663_A91VentasFecha, H00663_A19VentasId, H00663_A275DevolucionesFecha, H00663_A272DevolucionesID, H00663_A276DevolucionesTotal,
            H00663_n276DevolucionesTotal
            }
            , new Object[] {
            H00665_AGRID_nRecordCount
            }
         }
      );
      AV39Pgmname = "DevolucionesWW" ;
   ...
   private String lV40Devolucioneswwds_1_filterfulltext ;
   private String AV40Devolucioneswwds_1_filterfulltext ;
   ...
   private String[] H00663_A279DevolucionesObservacion ;
   private String[] H00663_A280MotivoDevolucionDescripcion ;
   private long[] H00663_A273MotivoDevolucionID ;
   private long[] H00663_A9TipoPagoId ;
   private long[] H00663_A4ClienteId ;
   private java.util.Date[] H00663_A91VentasFecha ;
   private long[] H00663_A19VentasId ;
   private java.util.Date[] H00663_A275DevolucionesFecha ;
   private long[] H00663_A272DevolucionesID ;
   private java.math.BigDecimal[] H00663_A276DevolucionesTotal ;
   private boolean[] H00663_n276DevolucionesTotal ;
   private long[] H00665_AGRID_nRecordCount ;
...
final  class devolucionesww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00663( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Devolucioneswwds_1_filterfulltext ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[DevolucionesObservacion], T2.[MotivoDevolucionDescripcion], T1.[MotivoDevolucionID], T3.[TipoPagoId], T3.[ClienteId], T3.[VentasFecha], T1.[VentasId], T1.[DevolucionesFecha]," ;
      sSelectString += " T1.[DevolucionesID], COALESCE( T4.[DevolucionesTotal], 0) AS DevolucionesTotal" ;
      sFromString = " FROM ((([Devoluciones] T1 INNER JOIN [MotivoDevolucion] T2 ON T2.[MotivoDevolucionID] = T1.[MotivoDevolucionID]) INNER JOIN [Ventas] T3 ON T3.[VentasId] = T1.[VentasId])" ;
      sFromString += " LEFT JOIN (SELECT SUM(T6.[ArticuloPrecioVenta] * CAST(T5.[DevolucionesDetalleCant] AS decimal( 27, 10))) AS DevolucionesTotal, T5.[DevolucionesID] FROM ([DevolucionesDetalle]" ;
      sFromString += " T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) GROUP BY T5.[DevolucionesID] ) T4 ON T4.[DevolucionesID] = T1.[DevolucionesID])" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV40Devolucioneswwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesFecha]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesFecha] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T3.[VentasFecha]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[VentasFecha] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T3.[ClienteId]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[ClienteId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T3.[TipoPagoId]" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[TipoPagoId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 7 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[MotivoDevolucionID]" ;
      }
      else if ( ( AV13OrderedBy == 7 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[MotivoDevolucionID] DESC" ;
      }
      else if ( ( AV13OrderedBy == 8 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[MotivoDevolucionDescripcion]" ;
      }
      else if ( ( AV13OrderedBy == 8 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[MotivoDevolucionDescripcion] DESC" ;
      }
      else if ( ( AV13OrderedBy == 9 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesObservacion]" ;
      }
      else if ( ( AV13OrderedBy == 9 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesObservacion] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID]" ;
   ...
   protected Object[] conditional_H00665( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Devolucioneswwds_1_filterfulltext ,
                                          long A272DevolucionesID ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ((([Devoluciones] T1 INNER JOIN [MotivoDevolucion] T3 ON T3.[MotivoDevolucionID] = T1.[MotivoDevolucionID]) INNER JOIN [Ventas] T2 ON T2.[VentasId]" ;
      scmdbuf += " = T1.[VentasId]) LEFT JOIN (SELECT SUM(T6.[ArticuloPrecioVenta] * CAST(T5.[DevolucionesDetalleCant] AS decimal( 27, 10))) AS DevolucionesTotal, T5.[DevolucionesID]" ;
      scmdbuf += " FROM ([DevolucionesDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) GROUP BY T5.[DevolucionesID] ) T4 ON T4.[DevolucionesID] = T1.[DevolucionesID])" ;
      if ( ! (GXutil.strcmp("", AV40Devolucioneswwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(10), CAST(T1.[DevolucionesID] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[VentasId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T2.[ClienteId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T2.[TipoPagoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[MotivoDevolucionID] AS decimal(10,0))) like '%' + ?) or ( T3.[MotivoDevolucionDescripcion] like '%' + ?) or ( T1.[DevolucionesObservacion] like '%' + ?) or ( CONVERT( char(17), CAST(T4.[DevolucionesTotal] AS decimal(17,2))) like '%' + ?))");
      }
      else
      {
         GXv_int14[0] = (byte)(1) ;
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00663", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00665", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
