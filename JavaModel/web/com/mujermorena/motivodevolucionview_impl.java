...
public final  class motivodevolucionview_impl extends GXDataArea
{
   public motivodevolucionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public motivodevolucionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( motivodevolucionview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10MotivoDevolucionID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10MotivoDevolucionID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10MotivoDevolucionID), 10, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMOTIVODEVOLUCIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10MotivoDevolucionID), "ZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.motivodevolucionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10MotivoDevolucionID,10,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"MotivoDevolucionID","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"MotivoDevolucionView");
      forbiddenHiddens.add("MotivoDevolucionDescripcion", GXutil.rtrim( localUtil.format( A280MotivoDevolucionDescripcion, "")));
      ...
      GXutil.writeLogInfo("motivodevolucionview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vMOTIVODEVOLUCIONID", GXutil.ltrim( localUtil.ntoc( AV10MotivoDevolucionID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMOTIVODEVOLUCIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10MotivoDevolucionID), "ZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.motivodevolucionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10MotivoDevolucionID,10,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"MotivoDevolucionID","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "MotivoDevolucionView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Motivo Devolucion View", "") ;
   }
   ...
   public void wb6B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Motivo Devolucion :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_MotivoDevolucionView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtMotivoDevolucionDescripcion_Internalname, httpContext.getMessage( "Motivo Devolucion Descripcion", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtMotivoDevolucionDescripcion_Internalname, A280MotivoDevolucionDescripcion, GXutil.rtrim( localUtil.format( A280MotivoDevolucionDescripcion, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMotivoDevolucionDescripcion_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtMotivoDevolucionDescripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "", "HLP_MotivoDevolucionView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Motivo Devolucion", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_MotivoDevolucionView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_MotivoDevolucionView.htm");
         /* Div Control */
   ...
   public void start6B2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Motivo Devolucion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf6B2( )
   {
      ...
      {
         /* Using cursor H006B2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10MotivoDevolucionID)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A273MotivoDevolucionID = H006B2_A273MotivoDevolucionID[0] ;
            A280MotivoDevolucionDescripcion = H006B2_A280MotivoDevolucionDescripcion[0] ;
   ...
   public void strup6B0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10MotivoDevolucionID = localUtil.ctol( httpContext.cgiGet( "vMOTIVODEVOLUCIONID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("motivodevolucionview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e116B2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.motivodevolucionww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H006B3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10MotivoDevolucionID)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A273MotivoDevolucionID = H006B3_A273MotivoDevolucionID[0] ;
         A280MotivoDevolucionDescripcion = H006B3_A280MotivoDevolucionDescripcion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A280MotivoDevolucionDescripcion", A280MotivoDevolucionDescripcion);
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A280MotivoDevolucionDescripcion );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "MotivoDevolucionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.motivodevoluciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "MotivoDevolucionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10MotivoDevolucionID)});
   ...
   {
      AV10MotivoDevolucionID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10MotivoDevolucionID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10MotivoDevolucionID), 10, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMOTIVODEVOLUCIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10MotivoDevolucionID), "ZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224988", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("motivodevolucionview.js", "?202412111224988", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Motivo Devolucion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10MotivoDevolucionID',fld:'vMOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A280MotivoDevolucionDescripcion',fld:'MOTIVODEVOLUCIONDESCRIPCION',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H006B2_A273MotivoDevolucionID = new long[1] ;
      H006B2_A280MotivoDevolucionDescripcion = new String[] {""} ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H006B3_A273MotivoDevolucionID = new long[1] ;
      H006B3_A280MotivoDevolucionDescripcion = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.motivodevolucionview__default(),
         new Object[] {
             new Object[] {
            H006B2_A273MotivoDevolucionID, H006B2_A280MotivoDevolucionDescripcion
            }
            , new Object[] {
            H006B3_A273MotivoDevolucionID, H006B3_A280MotivoDevolucionDescripcion
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10MotivoDevolucionID ;
   private long AV10MotivoDevolucionID ;
   ...
   private long[] H006B2_A273MotivoDevolucionID ;
   private String[] H006B2_A280MotivoDevolucionDescripcion ;
   private long[] H006B3_A273MotivoDevolucionID ;
   private String[] H006B3_A280MotivoDevolucionDescripcion ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class motivodevolucionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H006B2", "SELECT [MotivoDevolucionID], [MotivoDevolucionDescripcion] FROM [MotivoDevolucion] WHERE [MotivoDevolucionID] = ? ORDER BY [MotivoDevolucionID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H006B3", "SELECT [MotivoDevolucionID], [MotivoDevolucionDescripcion] FROM [MotivoDevolucion] WHERE [MotivoDevolucionID] = ? ORDER BY [MotivoDevolucionID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
