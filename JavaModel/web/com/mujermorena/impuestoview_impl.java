...
public final  class impuestoview_impl extends GXDataArea
{
   public impuestoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public impuestoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( impuestoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10ImpuestoId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ImpuestoId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPUESTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ImpuestoId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.impuestoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ImpuestoId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ImpuestoId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vIMPUESTOID", GXutil.ltrim( localUtil.ntoc( AV10ImpuestoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPUESTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ImpuestoId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.impuestoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ImpuestoId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ImpuestoId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Impuesto View", "") ;
   }
   ...
   public void wb4J0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Impuesto :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_ImpuestoView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Impuesto", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_ImpuestoView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ImpuestoView.htm");
         /* Div Control */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblArticulo_title_Internalname, httpContext.getMessage( "Articulo", ""), "", "", lblArticulo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ImpuestoView.htm");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "W0039"+"", GXutil.rtrim( WebComp_Articulowc_Component));
            httpContext.writeText( "<div") ;
            com.mujermorena.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start4J2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Impuesto View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldArticulowc = httpContext.cgiGet( "W0039") ;
                        ...
                        if ( GXutil.len( WebComp_Articulowc_Component) != 0 )
                        {
                           WebComp_Articulowc.componentprocess("W0039", "", sEvt);
                        }
                        WebComp_Articulowc_Component = OldArticulowc ;
                     }
                  }
   ...
   public void send_integrity_lvl_hashes4J2( )
   {
   }
   ...
   public void strup4J0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10ImpuestoId = localUtil.ctol( httpContext.cgiGet( "vIMPUESTOID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e114J2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.impuestoww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H004J2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10ImpuestoId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A18ImpuestoId = H004J2_A18ImpuestoId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ImpuestoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.impuestogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ImpuestoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10ImpuestoId)});
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "Articulo") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Articulowc_Component), GXutil.lower( "ImpuestoArticuloWC")) != 0 )
         {
            WebComp_Articulowc = WebUtils.getWebComponent(getClass(), "com.mujermorena.impuestoarticulowc_impl", remoteHandle, context);
            WebComp_Articulowc_Component = "ImpuestoArticuloWC" ;
         }
         if ( GXutil.len( WebComp_Articulowc_Component) != 0 )
         {
            WebComp_Articulowc.setjustcreated();
            WebComp_Articulowc.componentprepare(new Object[] {"W0039","",Long.valueOf(AV10ImpuestoId)});
   ...
   {
      AV10ImpuestoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ImpuestoId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPUESTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ImpuestoId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122157", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("impuestoview.js", "?20241211122157", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Impuesto View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10ImpuestoId',fld:'vIMPUESTOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H004J2_A18ImpuestoId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.impuestoview__default(),
         new Object[] {
             new Object[] {
            H004J2_A18ImpuestoId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10ImpuestoId ;
   private long AV10ImpuestoId ;
   ...
   private long[] H004J2_A18ImpuestoId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class impuestoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004J2", "SELECT [ImpuestoId] FROM [Impuesto] WHERE [ImpuestoId] = ? ORDER BY [ImpuestoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
