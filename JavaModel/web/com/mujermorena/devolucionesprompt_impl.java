...
public final  class devolucionesprompt_impl extends GXDataArea
{
   public devolucionesprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devolucionesprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devolucionesprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutDevolucionesID") ;
         ...
         {
            AV8InOutDevolucionesID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutDevolucionesID), 10, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.devolucionesprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutDevolucionesID,10,0))}, new String[] {"InOutDevolucionesID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTDEVOLUCIONESID", GXutil.ltrim( localUtil.ntoc( AV8InOutDevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.devolucionesprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutDevolucionesID,10,0))}, new String[] {"InOutDevolucionesID"})  ;
   }

   public String getPgmname( )
   {
      return "DevolucionesPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Devoluciones", "") ;
   }
   ...
   public void wb6C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_6C2( true) ;
      }
      else
      {
         wb_table1_14_6C2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_6C2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start6C2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Devoluciones", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV21Pgmname = "DevolucionesPrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf6C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A279DevolucionesObservacion = H006C3_A279DevolucionesObservacion[0] ;
            A280MotivoDevolucionDescripcion = H006C3_A280MotivoDevolucionDescripcion[0] ;
            A273MotivoDevolucionID = H006C3_A273MotivoDevolucionID[0] ;
            A9TipoPagoId = H006C3_A9TipoPagoId[0] ;
            A4ClienteId = H006C3_A4ClienteId[0] ;
            A91VentasFecha = H006C3_A91VentasFecha[0] ;
            A19VentasId = H006C3_A19VentasId[0] ;
            A275DevolucionesFecha = H006C3_A275DevolucionesFecha[0] ;
            A272DevolucionesID = H006C3_A272DevolucionesID[0] ;
            A276DevolucionesTotal = H006C3_A276DevolucionesTotal[0] ;
            n276DevolucionesTotal = H006C3_n276DevolucionesTotal[0] ;
            A280MotivoDevolucionDescripcion = H006C3_A280MotivoDevolucionDescripcion[0] ;
            A9TipoPagoId = H006C3_A9TipoPagoId[0] ;
            A4ClienteId = H006C3_A4ClienteId[0] ;
            A91VentasFecha = H006C3_A91VentasFecha[0] ;
   ...
   public void send_integrity_lvl_hashes6C2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVOLUCIONESID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A272DevolucionesID), "ZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      GRID_nRecordCount = H006C5_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e156C2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Devoluciones", "") );
   ...
   public void e166C2( )
   {
      ...
      devolucionesprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e186C2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutDevolucionesID = A272DevolucionesID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutDevolucionesID), 10, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutDevolucionesID)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutDevolucionesID"});
   ...
   public void wb_table1_14_6C2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_DevolucionesPrompt.htm");
   ...
   {
      AV8InOutDevolucionesID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutDevolucionesID), 10, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211123235", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("devolucionesprompt.js", "?20241211123235", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtDevolucionesID_Internalname = "DEVOLUCIONESID_"+sGXsfl_26_idx ;
      edtDevolucionesFecha_Internalname = "DEVOLUCIONESFECHA_"+sGXsfl_26_idx ;
      ...
      edtMotivoDevolucionID_Internalname = "MOTIVODEVOLUCIONID_"+sGXsfl_26_idx ;
      edtMotivoDevolucionDescripcion_Internalname = "MOTIVODEVOLUCIONDESCRIPCION_"+sGXsfl_26_idx ;
      edtDevolucionesObservacion_Internalname = "DEVOLUCIONESOBSERVACION_"+sGXsfl_26_idx ;
      edtDevolucionesTotal_Internalname = "DEVOLUCIONESTOTAL_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtDevolucionesID_Internalname = "DEVOLUCIONESID_"+sGXsfl_26_fel_idx ;
      edtDevolucionesFecha_Internalname = "DEVOLUCIONESFECHA_"+sGXsfl_26_fel_idx ;
      ...
      edtMotivoDevolucionID_Internalname = "MOTIVODEVOLUCIONID_"+sGXsfl_26_fel_idx ;
      edtMotivoDevolucionDescripcion_Internalname = "MOTIVODEVOLUCIONDESCRIPCION_"+sGXsfl_26_fel_idx ;
      edtDevolucionesObservacion_Internalname = "DEVOLUCIONESOBSERVACION_"+sGXsfl_26_fel_idx ;
      edtDevolucionesTotal_Internalname = "DEVOLUCIONESTOTAL_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:DevolucionesID|2:DevolucionesFecha|3:VentasId|4:VentasFecha|5:ClienteId|6:TipoPagoId|7:MotivoDevolucionID|8:MotivoDevolucionDescripcion|9:DevolucionesObservacion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e176C2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e186C2',iparms:[{av:'A272DevolucionesID',fld:'DEVOLUCIONESID',pic:'ZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutDevolucionesID',fld:'vINOUTDEVOLUCIONESID',pic:'ZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H006C3_A279DevolucionesObservacion = new String[] {""} ;
      H006C3_A280MotivoDevolucionDescripcion = new String[] {""} ;
      H006C3_A273MotivoDevolucionID = new long[1] ;
      H006C3_A9TipoPagoId = new long[1] ;
      H006C3_A4ClienteId = new long[1] ;
      H006C3_A91VentasFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006C3_A19VentasId = new long[1] ;
      H006C3_A275DevolucionesFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006C3_A272DevolucionesID = new long[1] ;
      H006C3_A276DevolucionesTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006C3_n276DevolucionesTotal = new boolean[] {false} ;
      H006C5_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devolucionesprompt__default(),
         new Object[] {
             new Object[] {
            H006C3_A279DevolucionesObservacion, H006C3_A280MotivoDevolucionDescripcion, H006C3_A273MotivoDevolucionID, H006C3_A9TipoPagoId, H006C3_A4ClienteId, H006C3_A91VentasFecha, H006C3_A19VentasId, H006C3_A275DevolucionesFecha, H006C3_A272DevolucionesID, H006C3_A276DevolucionesTotal,
            H006C3_n276DevolucionesTotal
            }
            , new Object[] {
            H006C5_AGRID_nRecordCount
            }
         }
      );
      AV21Pgmname = "DevolucionesPrompt" ;
   ...
   private long wcpOAV8InOutDevolucionesID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutDevolucionesID ;
   ...
   private String[] H006C3_A279DevolucionesObservacion ;
   private String[] H006C3_A280MotivoDevolucionDescripcion ;
   private long[] H006C3_A273MotivoDevolucionID ;
   private long[] H006C3_A9TipoPagoId ;
   private long[] H006C3_A4ClienteId ;
   private java.util.Date[] H006C3_A91VentasFecha ;
   private long[] H006C3_A19VentasId ;
   private java.util.Date[] H006C3_A275DevolucionesFecha ;
   private long[] H006C3_A272DevolucionesID ;
   private java.math.BigDecimal[] H006C3_A276DevolucionesTotal ;
   private boolean[] H006C3_n276DevolucionesTotal ;
   private long[] H006C5_AGRID_nRecordCount ;
...
final  class devolucionesprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   protected Object[] conditional_H006C5( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A272DevolucionesID ,
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006C3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006C5", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
