...
public final  class cajaprompt_impl extends GXDataArea
{
   public cajaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public cajaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( cajaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutCajaId") ;
         ...
         {
            AV8InOutCajaId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCajaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCajaId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.cajaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCajaId,11,0))}, new String[] {"InOutCajaId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCAJAID", GXutil.ltrim( localUtil.ntoc( AV8InOutCajaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.cajaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCajaId,11,0))}, new String[] {"InOutCajaId"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Selecciona Caja", "") ;
   }
   ...
   public void wb170( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_172( true) ;
      }
      else
      {
         wb_table1_14_172( false) ;
      }
      return  ;
   }

   public void wb_table1_14_172e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start172( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Caja", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf172( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A255CajaAsiganacion = H00172_A255CajaAsiganacion[0] ;
            A253CajaEstado = H00172_A253CajaEstado[0] ;
            A111CajaNombreUsuario = H00172_A111CajaNombreUsuario[0] ;
            A110CajaNumero = H00172_A110CajaNumero[0] ;
            A25CajaId = H00172_A25CajaId[0] ;
            e17172 ();
   ...
   public void send_integrity_lvl_hashes172( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CAJAID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A25CajaId), "ZZZZZZZZZZ9")));
   }
   ...
   public void e15172( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Caja", "") );
   ...
   public void e16172( )
   {
      ...
      cajaprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e18172( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutCajaId = A25CajaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCajaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCajaId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutCajaId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutCajaId"});
   ...
   public void wb_table1_14_172( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_CajaPrompt.htm");
   ...
   {
      AV8InOutCajaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCajaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCajaId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211113863", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("cajaprompt.js", "?20241211113863", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtCajaNombreUsuario_Internalname = "CAJANOMBREUSUARIO_"+sGXsfl_26_idx ;
      edtCajaEstado_Internalname = "CAJAESTADO_"+sGXsfl_26_idx ;
      edtCajaAsiganacion_Internalname = "CAJAASIGANACION_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtCajaNombreUsuario_Internalname = "CAJANOMBREUSUARIO_"+sGXsfl_26_fel_idx ;
      edtCajaEstado_Internalname = "CAJAESTADO_"+sGXsfl_26_fel_idx ;
      edtCajaAsiganacion_Internalname = "CAJAASIGANACION_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:CajaId|2:CajaNumero|3:CajaNombreUsuario|4:CajaEstado|5:CajaAsiganacion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17172',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18172',iparms:[{av:'A25CajaId',fld:'CAJAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCajaId',fld:'vINOUTCAJAID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14172',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00172_A255CajaAsiganacion = new String[] {""} ;
      H00172_A253CajaEstado = new String[] {""} ;
      H00172_A111CajaNombreUsuario = new String[] {""} ;
      H00172_A110CajaNumero = new long[1] ;
      H00172_A25CajaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.cajaprompt__default(),
         new Object[] {
             new Object[] {
            H00172_A255CajaAsiganacion, H00172_A253CajaEstado, H00172_A111CajaNombreUsuario, H00172_A110CajaNumero, H00172_A25CajaId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutCajaId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutCajaId ;
   ...
   private String[] H00172_A255CajaAsiganacion ;
   private String[] H00172_A253CajaEstado ;
   private String[] H00172_A111CajaNombreUsuario ;
   private long[] H00172_A110CajaNumero ;
   private long[] H00172_A25CajaId ;
...
final  class cajaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00172(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H00173(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
