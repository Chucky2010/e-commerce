...
public final  class localidadprompt_impl extends GXDataArea
{
   public localidadprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public localidadprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( localidadprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutLocalidadId") ;
         ...
         {
            AV8InOutLocalidadId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutLocalidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutLocalidadId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutLocalidadNombre = httpContext.GetPar( "InOutLocalidadNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutLocalidadNombre", AV9InOutLocalidadNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.localidadprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutLocalidadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutLocalidadNombre))}, new String[] {"InOutLocalidadId","InOutLocalidadNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTLOCALIDADID", GXutil.ltrim( localUtil.ntoc( AV8InOutLocalidadId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTLOCALIDADNOMBRE", GXutil.rtrim( AV9InOutLocalidadNombre));
   ...
   {
      return formatLink("com.mujermorena.localidadprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutLocalidadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutLocalidadNombre))}, new String[] {"InOutLocalidadId","InOutLocalidadNombre"})  ;
   }

   public String getPgmname( )
   {
      return "LocalidadPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Localidad", "") ;
   }
   ...
   public void wb0G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_0G2( true) ;
      }
      else
      {
         wb_table1_14_0G2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_0G2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0G2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Localidad", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_LOCALIDADNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A64LocalidadNombre, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "LOCALIDADNOMBRE", GXutil.rtrim( A64LocalidadNombre));
   }
   ...
   public void rf0G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H000G2 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A6DepartamentoId = H000G2_A6DepartamentoId[0] ;
            A5PaisId = H000G2_A5PaisId[0] ;
            A60PaisNombre = H000G2_A60PaisNombre[0] ;
            A61DepartamentoNombre = H000G2_A61DepartamentoNombre[0] ;
            A62CiudadNombre = H000G2_A62CiudadNombre[0] ;
            A7CiudadId = H000G2_A7CiudadId[0] ;
            A64LocalidadNombre = H000G2_A64LocalidadNombre[0] ;
            A3LocalidadId = H000G2_A3LocalidadId[0] ;
            A6DepartamentoId = H000G2_A6DepartamentoId[0] ;
            A62CiudadNombre = H000G2_A62CiudadNombre[0] ;
            A5PaisId = H000G2_A5PaisId[0] ;
            A61DepartamentoNombre = H000G2_A61DepartamentoNombre[0] ;
   ...
   public void send_integrity_lvl_hashes0G2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_LOCALIDADID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A3LocalidadId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_LOCALIDADNOMBRE"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A64LocalidadNombre, ""))));
   }
   ...
   public void e150G2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Localidad", "") );
   ...
   public void e160G2( )
   {
      ...
      localidadprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e180G2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutLocalidadId = A3LocalidadId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutLocalidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutLocalidadId), 11, 0));
      AV9InOutLocalidadNombre = A64LocalidadNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutLocalidadNombre", AV9InOutLocalidadNombre);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutLocalidadId),AV9InOutLocalidadNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutLocalidadId","AV9InOutLocalidadNombre"});
   ...
   public void wb_table1_14_0G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_LocalidadPrompt.htm");
   ...
   {
      AV8InOutLocalidadId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutLocalidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutLocalidadId), 11, 0));
      AV9InOutLocalidadNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutLocalidadNombre", AV9InOutLocalidadNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111113740", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("localidadprompt.js", "?202412111113740", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtCiudadId_Internalname = "CIUDADID_"+sGXsfl_26_idx ;
      ...
      edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtCiudadId_Internalname = "CIUDADID_"+sGXsfl_26_fel_idx ;
      ...
      edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ciudad Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Pais Nombre", "")) ;
         httpContext.writeTextNL( "</th>") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:LocalidadId|2:LocalidadNombre|3:CiudadId|4:CiudadNombre|5:DepartamentoNombre|6:PaisNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e170G2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e180G2',iparms:[{av:'A3LocalidadId',fld:'LOCALIDADID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A64LocalidadNombre',fld:'LOCALIDADNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutLocalidadId',fld:'vINOUTLOCALIDADID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutLocalidadNombre',fld:'vINOUTLOCALIDADNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e140G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   {
      wcpOAV9InOutLocalidadNombre = "" ;
      Gridpaginationbar_Selectedpage = "" ;
      Ddo_grid_Activeeventkey = "" ;
      Ddo_grid_Selectedvalue_get = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV9InOutLocalidadNombre = "" ;
      AV13FilterFullText = "" ;
      AV22Pgmname = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H000G2_A6DepartamentoId = new long[1] ;
      H000G2_A5PaisId = new long[1] ;
      H000G2_A60PaisNombre = new String[] {""} ;
      H000G2_A61DepartamentoNombre = new String[] {""} ;
      H000G2_A62CiudadNombre = new String[] {""} ;
      H000G2_A7CiudadId = new long[1] ;
      H000G2_A64LocalidadNombre = new String[] {""} ;
      H000G2_A3LocalidadId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.localidadprompt__default(),
         new Object[] {
             new Object[] {
            H000G2_A6DepartamentoId, H000G2_A5PaisId, H000G2_A60PaisNombre, H000G2_A61DepartamentoNombre, H000G2_A62CiudadNombre, H000G2_A7CiudadId, H000G2_A64LocalidadNombre, H000G2_A3LocalidadId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutLocalidadId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutLocalidadId ;
   ...
   private String wcpOAV9InOutLocalidadNombre ;
   private String Gridpaginationbar_Selectedpage ;
   private String Ddo_grid_Activeeventkey ;
   private String Ddo_grid_Selectedvalue_get ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV9InOutLocalidadNombre ;
   ...
   private long[] H000G2_A6DepartamentoId ;
   private long[] H000G2_A5PaisId ;
   private String[] H000G2_A60PaisNombre ;
   private String[] H000G2_A61DepartamentoNombre ;
   private String[] H000G2_A62CiudadNombre ;
   private long[] H000G2_A7CiudadId ;
   private String[] H000G2_A64LocalidadNombre ;
   private long[] H000G2_A3LocalidadId ;
...
final  class localidadprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000G2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
            case 1 :
                  return conditional_H000G3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000G2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000G3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
