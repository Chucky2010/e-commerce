...
public final  class gamwwconnections_impl extends GXDataArea
{
   public gamwwconnections_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gamwwconnections_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gamwwconnections_impl.class ));
   }
   ...
   public void gxnrgrid_newrow_invoke( )
   {
      ...
      edtavBtnkeys_Title = httpContext.GetNextPar( ) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavBtnkeys_Internalname, "Title", edtavBtnkeys_Title, !bGXsfl_39_Refreshing);
      httpContext.setAjaxCallMode();
      if ( ! httpContext.IsValidAjaxCall( true) )
      {
         GxWebError = (byte)(1) ;
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV70IsAuthorized_BtnKeys = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_BtnKeys")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV51ManageFiltersExecutionStep, AV74Pgmname, AV11FilName, AV65IsAuthorized_Display, AV66IsAuthorized_Update, AV67IsAuthorized_Delete, AV70IsAuthorized_BtnKeys, AV17IsAuthorized_Name, AV68IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.gamwwconnections", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_BTNKEYS", getSecureSignedToken( "", AV70IsAuthorized_BtnKeys));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV67IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_BTNKEYS", AV70IsAuthorized_BtnKeys);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_BTNKEYS", getSecureSignedToken( "", AV70IsAuthorized_BtnKeys));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vBTNKEYS_Title", GXutil.rtrim( edtavBtnkeys_Title));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDPAGINATIONBAR_Selectedpage", GXutil.rtrim( Gridpaginationbar_Selectedpage));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDPAGINATIONBAR_Rowsperpageselectedvalue", GXutil.ltrim( localUtil.ntoc( Gridpaginationbar_Rowsperpageselectedvalue, (byte)(9), (byte)(0), ".", "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DDO_MANAGEFILTERS_Activeeventkey", GXutil.rtrim( Ddo_managefilters_Activeeventkey));
   ...
   {
      return formatLink("com.mujermorena.gamwwconnections", new String[] {}, new String[] {})  ;
   }
   ...
   {
      return httpContext.getMessage( "WWP_GAM_Connections", "") ;
   }
   ...
   public void wb1K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, lblTextblocktitle_Caption, "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_GAMWWConnections.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_GAMWWConnections.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         wb_table1_20_1K2( true) ;
      }
      else
      {
         wb_table1_20_1K2( false) ;
      }
      return  ;
   }

   public void wb_table1_20_1K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start1K2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "WWP_GAM_Connections", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV69BtnKeys = httpContext.cgiGet( edtavBtnkeys_Internalname) ;
                           httpContext.ajax_rsp_assign_attri("", false, edtavBtnkeys_Internalname, AV69BtnKeys);
                           ...
                           AV22UserName = httpContext.cgiGet( edtavUsername_Internalname) ;
                           httpContext.ajax_rsp_assign_attri("", false, edtavUsername_Internalname, AV22UserName);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV70IsAuthorized_BtnKeys ,
   ...
   public void initialize_formulas( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavBtnkeys_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavBtnkeys_Enabled), 5, 0), !bGXsfl_39_Refreshing);
      edtavName_Enabled = 0 ;
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavUsername_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavUsername_Enabled), 5, 0), !bGXsfl_39_Refreshing);
   }
   ...
   public void e151K2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "gamconnectionentry_Execute", GXv_boolean2) ;
      gamwwconnections_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      edtavBtnkeys_Title = httpContext.getMessage( "WWP_GAM_Keys", "") ;
      httpContext.ajax_rsp_assign_prop("", false, edtavBtnkeys_Internalname, "Title", edtavBtnkeys_Title, !bGXsfl_39_Refreshing);
   }
   ...
   public void e161K2( )
   {
      ...
      gamwwconnections_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e171K2( )
   {
      ...
      AV12Filter.setgxTv_SdtGAMRepositoryConnectionFilter_Connectionname( "%"+AV11FilName );
      GXv_objcol_SdtGAMError6[0] = AV10Errors ;
      AV60GAMConnections = new genexus.security.api.genexussecurity.SdtGAMRepository(remoteHandle, context).getconnections(AV12Filter, GXv_objcol_SdtGAMError6) ;
      AV10Errors = GXv_objcol_SdtGAMError6[0] ;
      if ( AV60GAMConnections.size() == 0 )
      {
         AV13GridPageCount = 0 ;
      ...
      {
         AV13GridPageCount = (long)((AV60GAMConnections.size()/ (double) (AV23GridPageSize))+((((int)((AV60GAMConnections.size()) % (AV23GridPageSize)))>0) ? 1 : 0)) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV13GridPageCount", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13GridPageCount), 10, 0));
      }
      AV24GridRecordCount = AV60GAMConnections.size() ;
      AV75GXV1 = 1 ;
      while ( AV75GXV1 <= AV60GAMConnections.size() )
      {
         AV20RepositoryConnection = (genexus.security.api.genexussecurity.SdtGAMRepositoryConnection)((genexus.security.api.genexussecurity.SdtGAMRepositoryConnection)AV60GAMConnections.elementAt(-1+AV75GXV1));
         AV22UserName = AV20RepositoryConnection.getgxTv_SdtGAMRepositoryConnection_Username() ;
         httpContext.ajax_rsp_assign_attri("", false, edtavUsername_Internalname, AV22UserName);
         AV18Name = AV20RepositoryConnection.getgxTv_SdtGAMRepositoryConnection_Name() ;
         httpContext.ajax_rsp_assign_attri("", false, edtavName_Internalname, AV18Name);
         AV63Display = "<i class=\"fa fa-search\"></i>" ;
         httpContext.ajax_rsp_assign_attri("", false, edtavDisplay_Internalname, AV63Display);
         if ( AV65IsAuthorized_Display )
         {
            edtavDisplay_Link = formatLink("com.mujermorena.gamconnectionentry", new String[] {GXutil.URLEncode(GXutil.rtrim("DSP")),GXutil.URLEncode(GXutil.rtrim(AV18Name))}, new String[] {"Mode","pConnectionName"})  ;
         }
         AV64Update = "<i class=\"fa fa-pen\"></i>" ;
         httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV64Update);
         if ( AV66IsAuthorized_Update )
         {
            edtavUpdate_Link = formatLink("com.mujermorena.gamconnectionentry", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.rtrim(AV18Name))}, new String[] {"Mode","pConnectionName"})  ;
         }
         AV5Delete = "<i class=\"fa fa-times\"></i>" ;
         httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV5Delete);
         if ( AV67IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("com.mujermorena.gamconnectionentry", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.rtrim(AV18Name))}, new String[] {"Mode","pConnectionName"})  ;
         }
         AV69BtnKeys = "<i class=\"fa fa-key\"></i>" ;
         httpContext.ajax_rsp_assign_attri("", false, edtavBtnkeys_Internalname, AV69BtnKeys);
         if ( AV70IsAuthorized_BtnKeys )
         {
            edtavBtnkeys_Link = formatLink("com.mujermorena.gamconnectionentry", new String[] {GXutil.URLEncode(GXutil.rtrim("KEY")),GXutil.URLEncode(GXutil.rtrim(AV18Name))}, new String[] {"Mode","pConnectionName"})  ;
         }
         if ( AV17IsAuthorized_Name )
         {
            edtavName_Link = formatLink("com.mujermorena.gamconnectionentry", new String[] {GXutil.URLEncode(GXutil.rtrim("DSP")),GXutil.URLEncode(GXutil.rtrim(AV18Name))}, new String[] {"Mode","pConnectionName"})  ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
   ...
   public void e111K2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S142 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("GAMWWConnectionsFilters")),GXutil.URLEncode(GXutil.rtrim(AV74Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV51ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV51ManageFiltersExecutionStep", GXutil.str( AV51ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("GAMWWConnectionsFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV51ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV51ManageFiltersExecutionStep", GXutil.str( AV51ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      ...
      {
         GXt_char4 = AV52ManageFiltersXml ;
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "GAMWWConnectionsFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         gamwwconnections_impl.this.GXt_char4 = GXv_char5[0] ;
         AV52ManageFiltersXml = GXt_char4 ;
         ...
         else
         {
            ...
            S152 ();
            if (returnInSub) return;
            new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV74Pgmname+"GridState", AV52ManageFiltersXml) ;
            AV31GridState.fromxml(AV52ManageFiltersXml, null, null);
   ...
   public void e141K2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.gamconnectionentry", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"Mode","pConnectionName"}) );
   ...
   public void S132( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV70IsAuthorized_BtnKeys", AV70IsAuthorized_BtnKeys);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_BTNKEYS", getSecureSignedToken( "", AV70IsAuthorized_BtnKeys));
      if ( ! ( AV70IsAuthorized_BtnKeys ) )
      {
         edtavBtnkeys_Visible = 0 ;
         httpContext.ajax_rsp_assign_prop("", false, edtavBtnkeys_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavBtnkeys_Visible), 5, 0), !bGXsfl_39_Refreshing);
      }
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "GAMWWConnectionsFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item8) ;
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV50Session.getValue(AV74Pgmname+"GridState"), "") == 0 )
      {
         AV31GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV74Pgmname+"GridState"), null, null);
      }
      else
      {
         AV31GridState.fromxml(AV50Session.getValue(AV74Pgmname+"GridState"), null, null);
      }
      /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
      S162 ();
      if (returnInSub) return;
   ...
   public void S162( )
   {
      ...
      returnInSub = false ;
      AV76GXV2 = 1 ;
      while ( AV76GXV2 <= AV31GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV32GridStateFilterValue = (com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)AV31GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV76GXV2));
         if ( GXutil.strcmp(AV32GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "FILNAME") == 0 )
         {
            AV11FilName = AV32GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV11FilName", AV11FilName);
         }
   ...
   public void S142( )
   {
      ...
      GXv_SdtWWPGridState9[0] = AV31GridState;
      ...
      AV31GridState = GXv_SdtWWPGridState9[0] ;
      ...
      new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV74Pgmname+"GridState", AV31GridState.toxml(false, true, "WWPGridState", "Mujer_Morena")) ;
   }

   public void wb_table1_20_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         wb_table2_25_1K2( true) ;
      }
      else
      {
         wb_table2_25_1K2( false) ;
      }
      return  ;
   }

   public void wb_table2_25_1K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_20_1K2e( true) ;
      }
      else
      {
         wb_table1_20_1K2e( false) ;
      }
   }

   public void wb_table2_25_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_25_1K2e( true) ;
      }
      else
      {
         wb_table2_25_1K2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211114851", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gamwwconnections.js", "?20241211114862", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_392( )
   {
      ...
      edtavBtnkeys_Internalname = "vBTNKEYS_"+sGXsfl_39_idx ;
      edtavName_Internalname = "vNAME_"+sGXsfl_39_idx ;
      edtavUsername_Internalname = "vUSERNAME_"+sGXsfl_39_idx ;
   }
   ...
   public void subsflControlProps_fel_392( )
   {
      ...
      edtavBtnkeys_Internalname = "vBTNKEYS_"+sGXsfl_39_fel_idx ;
      edtavName_Internalname = "vNAME_"+sGXsfl_39_fel_idx ;
      edtavUsername_Internalname = "vUSERNAME_"+sGXsfl_39_fel_idx ;
   }
   ...
   public void sendrow_392( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtavBtnkeys_Visible==0) ? "display:none;" : "")+"\">") ;
         }
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavBtnkeys_Internalname,GXutil.rtrim( AV69BtnKeys),"","","'"+""+"'"+",false,"+"'"+""+"'",edtavBtnkeys_Link,"",httpContext.getMessage( "WWP_GAM_Keys", ""),"",edtavBtnkeys_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWIconActionColumn hidden-xs","",Integer.valueOf(edtavBtnkeys_Visible),Integer.valueOf(edtavBtnkeys_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(1),Integer.valueOf(39),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavUsername_Internalname,GXutil.rtrim( AV22UserName),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavUsername_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(edtavUsername_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(570),"px",Integer.valueOf(17),"px",Integer.valueOf(254),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(39),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"GeneXusSecurityCommon\\GAMDescriptionLong","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol39( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtavBtnkeys_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         httpContext.writeValue( edtavBtnkeys_Title) ;
         httpContext.writeTextNL( "</th>") ;
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrimstr( DecimalUtil.doubleToDec(570), 4, 0)+"px"+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "WWP_GAM_UserName", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV69BtnKeys));
         GridColumn.AddObjectProperty("Title", GXutil.rtrim( edtavBtnkeys_Title));
         GridColumn.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavBtnkeys_Enabled, (byte)(5), (byte)(0), ".", "")));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtavBtnkeys_Link));
         GridColumn.AddObjectProperty("Visible", GXutil.ltrim( localUtil.ntoc( edtavBtnkeys_Visible, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV22UserName));
         GridColumn.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavUsername_Enabled, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavBtnkeys_Title',ctrl:'vBTNKEYS',prop:'Title'},{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV62GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'edtavBtnkeys_Visible',ctrl:'vBTNKEYS',prop:'Visible'},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'lblBtninsert_Visible',ctrl:'BTNINSERT',prop:'Visible'},{av:'AV55ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV31GridState',fld:'vGRIDSTATE',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e121K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'edtavBtnkeys_Title',ctrl:'vBTNKEYS',prop:'Title'},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e171K2',iparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV13GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV22UserName',fld:'vUSERNAME',pic:''},{av:'AV18Name',fld:'vNAME',pic:''},{av:'AV63Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV64Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV5Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'AV69BtnKeys',fld:'vBTNKEYS',pic:''},{av:'edtavBtnkeys_Link',ctrl:'vBTNKEYS',prop:'Link'},{av:'edtavName_Link',ctrl:'vNAME',prop:'Link'}]}");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV31GridState',fld:'vGRIDSTATE',pic:''},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV58GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV62GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'edtavBtnkeys_Visible',ctrl:'vBTNKEYS',prop:'Visible'},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'lblBtninsert_Visible',ctrl:'BTNINSERT',prop:'Visible'},{av:'AV55ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
      setEventMetadata("'DOINSERT'","{handler:'e141K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'edtavBtnkeys_Title',ctrl:'vBTNKEYS',prop:'Title'},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV62GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'edtavBtnkeys_Visible',ctrl:'vBTNKEYS',prop:'Visible'},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'lblBtninsert_Visible',ctrl:'BTNINSERT',prop:'Visible'},{av:'AV55ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV31GridState',fld:'vGRIDSTATE',pic:''}]}");
   ...
   public void initialize( )
   {
      ...
      AV31GridState = new com.mujermorena.wwpbaseobjects.SdtWWPGridState(remoteHandle, context);
      ...
      AV28WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext3 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      AV12Filter = new genexus.security.api.genexussecurity.SdtGAMRepositoryConnectionFilter(remoteHandle, context);
      AV60GAMConnections = new GXExternalCollection<genexus.security.api.genexussecurity.SdtGAMRepositoryConnection>(genexus.security.api.genexussecurity.SdtGAMRepositoryConnection.class, "GAMRepositoryConnection", "http://tempuri.org/", remoteHandle);
      ...
      AV20RepositoryConnection = new genexus.security.api.genexussecurity.SdtGAMRepositoryConnection(remoteHandle, context);
      ...
      AV32GridStateFilterValue = new com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue(remoteHandle, context);
   ...
   private boolean AV70IsAuthorized_BtnKeys ;
   ...
   private genexus.security.api.genexussecurity.SdtGAMRepositoryConnectionFilter AV12Filter ;
   ...
   private GXExternalCollection<genexus.security.api.genexussecurity.SdtGAMRepositoryConnection> AV60GAMConnections ;
   ...
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV28WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext3[] ;
   private genexus.security.api.genexussecurity.SdtGAMRepositoryConnection AV20RepositoryConnection ;
   private com.mujermorena.wwpbaseobjects.SdtWWPGridState AV31GridState ;
   private com.mujermorena.wwpbaseobjects.SdtWWPGridState GXv_SdtWWPGridState9[] ;
   private com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue AV32GridStateFilterValue ;
}
