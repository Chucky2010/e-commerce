...
public final  class sdsvc_myproductscartcheckout_level_detail extends GXProcedure
{
   public sdsvc_myproductscartcheckout_level_detail( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( sdsvc_myproductscartcheckout_level_detail.class ), "" );
   }
   ...
   public GxJsonArray cartproductcollection__talladl( )
   {
      initialize();
      ...
      /* End function cartproductcollection__talladl */
   }
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.sdsvc_myproductscartcheckout_level_detail__default(),
         new Object[] {
             new Object[] {
...
final  class sdsvc_myproductscartcheckout_level_detail__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
