...
public final  class gamwwrepositories_impl extends GXDataArea
{
   public gamwwrepositories_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gamwwrepositories_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gamwwrepositories_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV69Search = httpContext.GetPar( "Search") ;
      ...
      AV21IsAuthorized_Id = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_Id")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV52ManageFiltersExecutionStep, AV72Pgmname, AV69Search, AV65IsAuthorized_Display, AV66IsAuthorized_Update, AV67IsAuthorized_Delete, AV21IsAuthorized_Id, AV68IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.gamwwrepositories", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV72Pgmname, ""))));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_ID", getSecureSignedToken( "", AV21IsAuthorized_Id));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV24GridPageCount, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV72Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV72Pgmname, ""))));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV67IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_ID", AV21IsAuthorized_Id);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_ID", getSecureSignedToken( "", AV21IsAuthorized_Id));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   {
      return formatLink("com.mujermorena.gamwwrepositories", new String[] {}, new String[] {})  ;
   }
   ...
   {
      return httpContext.getMessage( "WWP_GAM_Repositories", "") ;
   }
   ...
   public void wb1M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, lblTextblocktitle_Caption, "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_GAMWWRepositories.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_GAMWWRepositories.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         wb_table1_20_1M2( true) ;
      }
      else
      {
         wb_table1_20_1M2( false) ;
      }
      return  ;
   }

   public void wb_table1_20_1M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start1M2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "WWP_GAM_Repositories", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV13Id = localUtil.ctol( httpContext.cgiGet( edtavId_Internalname), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
                           httpContext.ajax_rsp_assign_attri("", false, edtavId_Internalname, GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13Id), 12, 0));
                           AV14Name = httpContext.cgiGet( edtavName_Internalname) ;
                           httpContext.ajax_rsp_assign_attri("", false, edtavName_Internalname, AV14Name);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   public void strup1M0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV69Search = httpContext.cgiGet( edtavSearch_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV69Search", AV69Search);
   ...
   public void e151M2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "gamrepositoryconfiguration_Execute", GXv_boolean2) ;
      gamwwrepositories_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV21IsAuthorized_Id = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV21IsAuthorized_Id", AV21IsAuthorized_Id);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_ID", getSecureSignedToken( "", AV21IsAuthorized_Id));
      Form.setCaption( httpContext.getMessage( "WWP_GAM_Repositories", "") );
   ...
   public void e161M2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV72Pgmname, GXv_char5) ;
      gamwwrepositories_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e171M2( )
   {
      ...
      if ( ! (GXutil.strcmp("", AV69Search)==0) )
      {
         AV11Filter.setgxTv_SdtGAMRepositoryFilter_Name( "%"+AV69Search );
      }
      GXv_objcol_SdtGAMError6[0] = AV9Errors ;
      AV16RepositoryCollection = AV12GAM.getallrepositories(AV11Filter, GXv_objcol_SdtGAMError6) ;
      AV9Errors = GXv_objcol_SdtGAMError6[0] ;
      if ( AV16RepositoryCollection.size() == 0 )
      {
         AV24GridPageCount = 0 ;
      ...
      {
         AV24GridPageCount = (long)((AV16RepositoryCollection.size()/ (double) (AV25GridPageSize))+((((int)((AV16RepositoryCollection.size()) % (AV25GridPageSize)))>0) ? 1 : 0)) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV24GridPageCount", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV24GridPageCount), 10, 0));
      }
      AV26GridRecordCount = AV16RepositoryCollection.size() ;
      if ( AV9Errors.size() > 0 )
      {
      ...
      {
         AV73GXV1 = 1 ;
         while ( AV73GXV1 <= AV16RepositoryCollection.size() )
         {
            AV15Repository = (genexus.security.api.genexussecurity.SdtGAMRepository)((genexus.security.api.genexussecurity.SdtGAMRepository)AV16RepositoryCollection.elementAt(-1+AV73GXV1));
            AV13Id = AV15Repository.getgxTv_SdtGAMRepository_Id() ;
            httpContext.ajax_rsp_assign_attri("", false, edtavId_Internalname, GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13Id), 12, 0));
            AV14Name = AV15Repository.getgxTv_SdtGAMRepository_Name() ;
            httpContext.ajax_rsp_assign_attri("", false, edtavName_Internalname, AV14Name);
            AV63Display = "<i class=\"fa fa-search\"></i>" ;
            httpContext.ajax_rsp_assign_attri("", false, edtavDisplay_Internalname, AV63Display);
            if ( AV65IsAuthorized_Display )
            {
               edtavDisplay_Link = formatLink("com.mujermorena.gamrepositoryconfiguration", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV13Id,12,0))}, new String[] {"Id"})  ;
            }
            AV64Update = "<i class=\"fa fa-pen\"></i>" ;
            httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV64Update);
            if ( AV66IsAuthorized_Update )
            {
               edtavUpdate_Link = formatLink("com.mujermorena.gamrepositoryconfiguration", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV13Id,12,0))}, new String[] {"Id"})  ;
            }
            AV5Delete = "<i class=\"fa fa-times\"></i>" ;
            httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV5Delete);
            if ( AV67IsAuthorized_Delete )
            {
               edtavDelete_Link = formatLink("com.mujermorena.gamrepositoryentry", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(AV13Id,12,0))}, new String[] {"Mode","Id"})  ;
            }
            if ( AV21IsAuthorized_Id )
            {
               edtavId_Link = formatLink("com.mujermorena.gamrepositoryconfiguration", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV13Id,12,0))}, new String[] {"Id"})  ;
            }
            /* Load Method */
            if ( wbStart != -1 )
            {
   ...
   public void e111M2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S142 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("GAMWWRepositoriesFilters")),GXutil.URLEncode(GXutil.rtrim(AV72Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV52ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV52ManageFiltersExecutionStep", GXutil.str( AV52ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("GAMWWRepositoriesFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV52ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV52ManageFiltersExecutionStep", GXutil.str( AV52ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "GAMWWRepositoriesFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         gamwwrepositories_impl.this.GXt_char4 = GXv_char5[0] ;
         ...
         else
         {
            ...
            S162 ();
            if (returnInSub) return;
            new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV72Pgmname+"GridState", AV53ManageFiltersXml) ;
            AV33GridState.fromxml(AV53ManageFiltersXml, null, null);
   ...
   public void e141M2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.gamrepositoryentry", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","Id"}) );
   ...
   public void S132( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "gamrepositoryentry_Execute", GXv_boolean2) ;
      gamwwrepositories_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "GAMWWRepositoriesFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item8) ;
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV51Session.getValue(AV72Pgmname+"GridState"), "") == 0 )
      {
         AV33GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV72Pgmname+"GridState"), null, null);
      }
      else
      {
         AV33GridState.fromxml(AV51Session.getValue(AV72Pgmname+"GridState"), null, null);
      }
      /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
      S172 ();
      if (returnInSub) return;
   ...
   public void S172( )
   {
      ...
      returnInSub = false ;
      AV74GXV2 = 1 ;
      while ( AV74GXV2 <= AV33GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV34GridStateFilterValue = (com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)AV33GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV74GXV2));
         if ( GXutil.strcmp(AV34GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "SEARCH") == 0 )
         {
            AV69Search = AV34GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV69Search", AV69Search);
         }
   ...
   public void S142( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState9, "SEARCH", httpContext.getMessage( "WWP_GAM_Name", ""), !(GXutil.strcmp("", AV69Search)==0), (short)(0), AV69Search, "") ;
      ...
      new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV72Pgmname+"GridState", AV33GridState.toxml(false, true, "WWPGridState", "Mujer_Morena")) ;
   }
   ...
   public void S152( )
   {
      ...
      returnInSub = false ;
      AV75GXV3 = 1 ;
      while ( AV75GXV3 <= AV9Errors.size() )
      {
         AV8Error = (genexus.security.api.genexussecurity.SdtGAMError)((genexus.security.api.genexussecurity.SdtGAMError)AV9Errors.elementAt(-1+AV75GXV3));
   ...
   public void wb_table1_20_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         wb_table2_25_1M2( true) ;
      }
      else
      {
         wb_table2_25_1M2( false) ;
      }
      return  ;
   }

   public void wb_table2_25_1M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_20_1M2e( true) ;
      }
      else
      {
         wb_table1_20_1M2e( false) ;
      }
   }

   public void wb_table2_25_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+edtavSearch_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavSearch_Internalname, httpContext.getMessage( "WWP_GAM_Name", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavSearch_Internalname, GXutil.rtrim( AV69Search), GXutil.rtrim( localUtil.format( AV69Search, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSearch_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavSearch_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "GeneXusSecurityCommon\\GAMDescriptionShort", "left", true, "", "HLP_GAMWWRepositories.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_25_1M2e( true) ;
      }
      else
      {
         wb_table2_25_1M2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111151557", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gamwwrepositories.js", "?202412111151571", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void sendrow_392( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavId_Internalname,GXutil.ltrim( localUtil.ntoc( AV13Id, (byte)(12), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( ((edtavId_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV13Id), "ZZZZZZZZZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV13Id), "ZZZZZZZZZZZ9")))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'",edtavId_Link,"","","",edtavId_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(edtavId_Enabled),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(12),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(39),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXusSecurityCommon\\GAMKeyNumLong","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void startgridcontrol39( )
   {
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( AV13Id, (byte)(12), (byte)(0), ".", "")));
         GridColumn.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavId_Enabled, (byte)(5), (byte)(0), ".", "")));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtavId_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV14Name));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV52ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV69Search',fld:'vSEARCH',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV52ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV59GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV62GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'lblBtninsert_Visible',ctrl:'BTNINSERT',prop:'Visible'},{av:'AV56ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV33GridState',fld:'vGRIDSTATE',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e121M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV52ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV69Search',fld:'vSEARCH',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e131M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV52ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV69Search',fld:'vSEARCH',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e171M2',iparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69Search',fld:'vSEARCH',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e111M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV52ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV69Search',fld:'vSEARCH',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV33GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e141M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV52ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV69Search',fld:'vSEARCH',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      AV11Filter = new genexus.security.api.genexussecurity.SdtGAMRepositoryFilter(remoteHandle, context);
      AV16RepositoryCollection = new GXExternalCollection<genexus.security.api.genexussecurity.SdtGAMRepository>(genexus.security.api.genexussecurity.SdtGAMRepository.class, "GAMRepository", "http://tempuri.org/", remoteHandle);
      ...
      AV12GAM = new genexus.security.api.genexussecurity.SdtGAM(remoteHandle, context);
   ...
   private boolean AV21IsAuthorized_Id ;
   ...
   private genexus.security.api.genexussecurity.SdtGAMRepositoryFilter AV11Filter ;
   private genexus.security.api.genexussecurity.SdtGAM AV12GAM ;
   ...
   private GXExternalCollection<genexus.security.api.genexussecurity.SdtGAMRepository> AV16RepositoryCollection ;
