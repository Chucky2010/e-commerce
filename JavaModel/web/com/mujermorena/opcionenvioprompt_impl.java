...
public final  class opcionenvioprompt_impl extends GXDataArea
{
   public opcionenvioprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public opcionenvioprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( opcionenvioprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutOpcionEnvioId") ;
         ...
         {
            AV8InOutOpcionEnvioId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutOpcionEnvioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutOpcionEnvioId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutOpcionEnvioDescripcion = httpContext.GetPar( "InOutOpcionEnvioDescripcion") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutOpcionEnvioDescripcion", AV9InOutOpcionEnvioDescripcion);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.opcionenvioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutOpcionEnvioId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutOpcionEnvioDescripcion))}, new String[] {"InOutOpcionEnvioId","InOutOpcionEnvioDescripcion"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTOPCIONENVIOID", GXutil.ltrim( localUtil.ntoc( AV8InOutOpcionEnvioId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTOPCIONENVIODESCRIPCION", AV9InOutOpcionEnvioDescripcion);
   ...
   {
      return formatLink("com.mujermorena.opcionenvioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutOpcionEnvioId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutOpcionEnvioDescripcion))}, new String[] {"InOutOpcionEnvioId","InOutOpcionEnvioDescripcion"})  ;
   }

   public String getPgmname( )
   {
      return "OpcionEnvioPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Opcion Envio", "") ;
   }
   ...
   public void wb6H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_6H2( true) ;
      }
      else
      {
         wb_table1_14_6H2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_6H2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start6H2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Opcion Envio", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_OPCIONENVIODESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A284OpcionEnvioDescripcion, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "OPCIONENVIODESCRIPCION", A284OpcionEnvioDescripcion);
   }
   ...
   public void rf6H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A284OpcionEnvioDescripcion = H006H2_A284OpcionEnvioDescripcion[0] ;
            A283OpcionEnvioId = H006H2_A283OpcionEnvioId[0] ;
            e176H2 ();
   ...
   public void send_integrity_lvl_hashes6H2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_OPCIONENVIOID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A283OpcionEnvioId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_OPCIONENVIODESCRIPCION"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A284OpcionEnvioDescripcion, ""))));
   }
   ...
   public void e156H2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Opcion Envio", "") );
   ...
   public void e166H2( )
   {
      ...
      opcionenvioprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e186H2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutOpcionEnvioId = A283OpcionEnvioId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutOpcionEnvioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutOpcionEnvioId), 11, 0));
      AV9InOutOpcionEnvioDescripcion = A284OpcionEnvioDescripcion ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutOpcionEnvioDescripcion", AV9InOutOpcionEnvioDescripcion);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutOpcionEnvioId),AV9InOutOpcionEnvioDescripcion});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutOpcionEnvioId","AV9InOutOpcionEnvioDescripcion"});
   ...
   public void wb_table1_14_6H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_OpcionEnvioPrompt.htm");
   ...
   {
      AV8InOutOpcionEnvioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutOpcionEnvioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutOpcionEnvioId), 11, 0));
      AV9InOutOpcionEnvioDescripcion = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutOpcionEnvioDescripcion", AV9InOutOpcionEnvioDescripcion);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111225581", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("opcionenvioprompt.js", "?202412111225581", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtOpcionEnvioDescripcion_Internalname,A284OpcionEnvioDescripcion,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtOpcionEnvioDescripcion_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:OpcionEnvioId|2:OpcionEnvioDescripcion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e176H2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e186H2',iparms:[{av:'A283OpcionEnvioId',fld:'OPCIONENVIOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A284OpcionEnvioDescripcion',fld:'OPCIONENVIODESCRIPCION',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutOpcionEnvioId',fld:'vINOUTOPCIONENVIOID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutOpcionEnvioDescripcion',fld:'vINOUTOPCIONENVIODESCRIPCION',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   {
      return "opcionenvioprompt_Execute";
   }
   ...
   {
      wcpOAV9InOutOpcionEnvioDescripcion = "" ;
      Gridpaginationbar_Selectedpage = "" ;
      Ddo_grid_Activeeventkey = "" ;
      Ddo_grid_Selectedvalue_get = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV9InOutOpcionEnvioDescripcion = "" ;
      AV13FilterFullText = "" ;
      AV22Pgmname = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H006H2_A284OpcionEnvioDescripcion = new String[] {""} ;
      H006H2_A283OpcionEnvioId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.opcionenvioprompt__default(),
         new Object[] {
             new Object[] {
            H006H2_A284OpcionEnvioDescripcion, H006H2_A283OpcionEnvioId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutOpcionEnvioId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutOpcionEnvioId ;
   ...
   private String wcpOAV9InOutOpcionEnvioDescripcion ;
   private String AV9InOutOpcionEnvioDescripcion ;
   ...
   private String[] H006H2_A284OpcionEnvioDescripcion ;
   private long[] H006H2_A283OpcionEnvioId ;
...
final  class opcionenvioprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006H2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H006H3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A283OpcionEnvioId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006H2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H006H3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006H2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006H3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
