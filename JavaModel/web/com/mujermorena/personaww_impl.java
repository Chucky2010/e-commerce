...
public final  class personaww_impl extends GXDataArea
{
   public personaww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public personaww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( personaww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV34IsAuthorized_CiudadNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_CiudadNombre")) ;
      AV35IsAuthorized_DepartamentoNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_DepartamentoNombre")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV42Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_LocalidadNombre, AV34IsAuthorized_CiudadNombre, AV35IsAuthorized_DepartamentoNombre, AV38IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.personaww", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV34IsAuthorized_CiudadNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV35IsAuthorized_DepartamentoNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_LocalidadNombre));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_CIUDADNOMBRE", AV34IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV34IsAuthorized_CiudadNombre));
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DEPARTAMENTONOMBRE", AV35IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV35IsAuthorized_DepartamentoNombre));
   ...
   {
      return formatLink("com.mujermorena.personaww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Persona", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_PersonaWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_PersonaWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0H2( true) ;
      }
      else
      {
         wb_table1_22_0H2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0H2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV34IsAuthorized_CiudadNombre ,
                                 boolean AV35IsAuthorized_DepartamentoNombre ,
   ...
   public void rf0H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV43Personawwds_1_filterfulltext ,
         ...
         lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
         lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
         lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
         lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
         lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
         ...
         lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000H2 */
         pr_default.execute(0, new Object[] {lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A7CiudadId = H000H2_A7CiudadId[0] ;
            A6DepartamentoId = H000H2_A6DepartamentoId[0] ;
            A69PersonaCorreo = H000H2_A69PersonaCorreo[0] ;
            A68PersonaTelefono2 = H000H2_A68PersonaTelefono2[0] ;
            A67PersonaTelefono1 = H000H2_A67PersonaTelefono1[0] ;
            A66PersonaTelefono = H000H2_A66PersonaTelefono[0] ;
            A65PersonaBarrio = H000H2_A65PersonaBarrio[0] ;
            A61DepartamentoNombre = H000H2_A61DepartamentoNombre[0] ;
            A62CiudadNombre = H000H2_A62CiudadNombre[0] ;
            A64LocalidadNombre = H000H2_A64LocalidadNombre[0] ;
            A3LocalidadId = H000H2_A3LocalidadId[0] ;
            A57PersonaDireccion = H000H2_A57PersonaDireccion[0] ;
            A2TipoPersonaId = H000H2_A2TipoPersonaId[0] ;
            A1PersonaId = H000H2_A1PersonaId[0] ;
            A56PersonaApellido = H000H2_A56PersonaApellido[0] ;
            A55PersonaNombre = H000H2_A55PersonaNombre[0] ;
            A7CiudadId = H000H2_A7CiudadId[0] ;
            A64LocalidadNombre = H000H2_A64LocalidadNombre[0] ;
            A6DepartamentoId = H000H2_A6DepartamentoId[0] ;
            A62CiudadNombre = H000H2_A62CiudadNombre[0] ;
   ...
   public void send_integrity_lvl_hashes0H2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV38IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV38IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_PERSONAID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A1PersonaId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV43Personawwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV43Personawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Personawwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000H3 */
      pr_default.execute(1, new Object[] {lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext, lV43Personawwds_1_filterfulltext});
   ...
   public void e170H2( )
   {
      ...
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_LocalidadNombre));
      GXt_boolean1 = AV34IsAuthorized_CiudadNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      ...
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV34IsAuthorized_CiudadNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV34IsAuthorized_CiudadNombre", AV34IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV34IsAuthorized_CiudadNombre));
      GXt_boolean1 = AV35IsAuthorized_DepartamentoNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      ...
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV35IsAuthorized_DepartamentoNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV35IsAuthorized_DepartamentoNombre", AV35IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV35IsAuthorized_DepartamentoNombre));
   ...
   public void e180H2( )
   {
      ...
      personaww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e190H2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.personaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A1PersonaId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"PersonaId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.persona", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A1PersonaId,11,0))}, new String[] {"Mode","PersonaId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.persona", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A1PersonaId,11,0))}, new String[] {"Mode","PersonaId"})  ;
      }
      ...
      if ( AV34IsAuthorized_CiudadNombre )
      {
      ...
      if ( AV35IsAuthorized_DepartamentoNombre )
      {
   ...
   public void e110H2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PersonaWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV42Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PersonaWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PersonaWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         personaww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e160H2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.persona", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","PersonaId"}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "personaview_Execute", GXv_boolean2) ;
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "persona_Update", GXv_boolean2) ;
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "persona_Delete", GXv_boolean2) ;
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "persona_Insert", GXv_boolean2) ;
      personaww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PersonaWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Persona" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.personawwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      personaww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      personaww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.personawwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0H2( true) ;
      }
      else
      {
         wb_table2_27_0H2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0H2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0H2e( true) ;
      }
      else
      {
         wb_table1_22_0H2e( false) ;
      }
   }

   public void wb_table2_27_0H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_27_0H2e( true) ;
      }
      else
      {
         wb_table2_27_0H2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211112310", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("personaww.js", "?20241211112310", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtTipoPersonaId_Internalname = "TIPOPERSONAID_"+sGXsfl_40_idx ;
      edtPersonaNombre_Internalname = "PERSONANOMBRE_"+sGXsfl_40_idx ;
      edtPersonaApellido_Internalname = "PERSONAAPELLIDO_"+sGXsfl_40_idx ;
      ...
      edtPersonaBarrio_Internalname = "PERSONABARRIO_"+sGXsfl_40_idx ;
      edtPersonaTelefono_Internalname = "PERSONATELEFONO_"+sGXsfl_40_idx ;
      edtPersonaTelefono1_Internalname = "PERSONATELEFONO1_"+sGXsfl_40_idx ;
      edtPersonaTelefono2_Internalname = "PERSONATELEFONO2_"+sGXsfl_40_idx ;
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtTipoPersonaId_Internalname = "TIPOPERSONAID_"+sGXsfl_40_fel_idx ;
      edtPersonaNombre_Internalname = "PERSONANOMBRE_"+sGXsfl_40_fel_idx ;
      edtPersonaApellido_Internalname = "PERSONAAPELLIDO_"+sGXsfl_40_fel_idx ;
      ...
      edtPersonaBarrio_Internalname = "PERSONABARRIO_"+sGXsfl_40_fel_idx ;
      edtPersonaTelefono_Internalname = "PERSONATELEFONO_"+sGXsfl_40_fel_idx ;
      edtPersonaTelefono1_Internalname = "PERSONATELEFONO1_"+sGXsfl_40_fel_idx ;
      edtPersonaTelefono2_Internalname = "PERSONATELEFONO2_"+sGXsfl_40_fel_idx ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:PersonaId|4:TipoPersonaId|5:PersonaNombre|6:PersonaApellido|8:PersonaDireccion|9:LocalidadId|10:LocalidadNombre|11:CiudadNombre|12:DepartamentoNombre|13:PersonaBarrio|14:PersonaTelefono|15:PersonaTelefono1|16:PersonaTelefono2|17:PersonaCorreo" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e120H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e130H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e150H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e190H2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A1PersonaId',fld:'PERSONAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'A3LocalidadId',fld:'LOCALIDADID',pic:'ZZZZZZZZZZ9'},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'A7CiudadId',fld:'CIUDADID',pic:'ZZZZZZZZZZ9'},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'A6DepartamentoId',fld:'DEPARTAMENTOID',pic:'ZZZZZZZZZZ9'}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e110H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A1PersonaId',fld:'PERSONAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140H2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
   ...
   public void initialize( )
   {
      ...
      A69PersonaCorreo = "" ;
      scmdbuf = "" ;
      lV43Personawwds_1_filterfulltext = "" ;
      AV43Personawwds_1_filterfulltext = "" ;
      H000H2_A7CiudadId = new long[1] ;
      H000H2_A6DepartamentoId = new long[1] ;
      H000H2_A69PersonaCorreo = new String[] {""} ;
      H000H2_A68PersonaTelefono2 = new String[] {""} ;
      H000H2_A67PersonaTelefono1 = new String[] {""} ;
      H000H2_A66PersonaTelefono = new String[] {""} ;
      H000H2_A65PersonaBarrio = new String[] {""} ;
      H000H2_A61DepartamentoNombre = new String[] {""} ;
      H000H2_A62CiudadNombre = new String[] {""} ;
      H000H2_A64LocalidadNombre = new String[] {""} ;
      H000H2_A3LocalidadId = new long[1] ;
      H000H2_A57PersonaDireccion = new String[] {""} ;
      H000H2_A2TipoPersonaId = new long[1] ;
      H000H2_A1PersonaId = new long[1] ;
      H000H2_A56PersonaApellido = new String[] {""} ;
      H000H2_A55PersonaNombre = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.personaww__default(),
         new Object[] {
             new Object[] {
            H000H2_A7CiudadId, H000H2_A6DepartamentoId, H000H2_A69PersonaCorreo, H000H2_A68PersonaTelefono2, H000H2_A67PersonaTelefono1, H000H2_A66PersonaTelefono, H000H2_A65PersonaBarrio, H000H2_A61DepartamentoNombre, H000H2_A62CiudadNombre, H000H2_A64LocalidadNombre,
            H000H2_A3LocalidadId, H000H2_A57PersonaDireccion, H000H2_A2TipoPersonaId, H000H2_A1PersonaId, H000H2_A56PersonaApellido, H000H2_A55PersonaNombre
            }
            , new Object[] {
   ...
   private boolean AV34IsAuthorized_CiudadNombre ;
   private boolean AV35IsAuthorized_DepartamentoNombre ;
   ...
   private String lV43Personawwds_1_filterfulltext ;
   private String AV43Personawwds_1_filterfulltext ;
   ...
   private long[] H000H2_A7CiudadId ;
   private long[] H000H2_A6DepartamentoId ;
   private String[] H000H2_A69PersonaCorreo ;
   private String[] H000H2_A68PersonaTelefono2 ;
   private String[] H000H2_A67PersonaTelefono1 ;
   private String[] H000H2_A66PersonaTelefono ;
   private String[] H000H2_A65PersonaBarrio ;
   private String[] H000H2_A61DepartamentoNombre ;
   private String[] H000H2_A62CiudadNombre ;
   private String[] H000H2_A64LocalidadNombre ;
   private long[] H000H2_A3LocalidadId ;
   private String[] H000H2_A57PersonaDireccion ;
   private long[] H000H2_A2TipoPersonaId ;
   private long[] H000H2_A1PersonaId ;
   private String[] H000H2_A56PersonaApellido ;
   private String[] H000H2_A55PersonaNombre ;
...
final  class personaww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000H2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV43Personawwds_1_filterfulltext ,
                                          long A1PersonaId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV43Personawwds_1_filterfulltext)==0) )
      {
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000H2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000H3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
