...
public final  class tipoarticulowwexportreport_impl extends GXWebReport
{
   public tipoarticulowwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipoarticuloww_Execute", GXv_boolean2) ;
         tipoarticulowwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Tipo Articulo", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Articulo Id", ""), 30, Gx_line+10, 281, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Articulo Nombre", ""), 285, Gx_line+10, 787, Gx_line+27, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Tipoarticulowwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Tipoarticulowwds_1_filterfulltext ,
      ...
      lV35Tipoarticulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipoarticulowwds_1_filterfulltext), "%", "") ;
      lV35Tipoarticulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipoarticulowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P00452 */
      pr_default.execute(0, new Object[] {lV35Tipoarticulowwds_1_filterfulltext, lV35Tipoarticulowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A17TipoArticuloId = P00452_A17TipoArticuloId[0] ;
         A103TipoArticuloNombre = P00452_A103TipoArticuloNombre[0] ;
         ...
         h450( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A17TipoArticuloId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A103TipoArticuloNombre, "")), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("TipoArticuloWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "TipoArticuloWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("TipoArticuloWWGridState"), null, null);
      }
   ...
   public void h450( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Tipoarticulowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Tipoarticulowwds_1_filterfulltext = "" ;
      P00452_A17TipoArticuloId = new long[1] ;
      P00452_A103TipoArticuloNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipoarticulowwexportreport__default(),
         new Object[] {
             new Object[] {
            P00452_A17TipoArticuloId, P00452_A103TipoArticuloNombre
            }
         }
      );
   ...
   private String AV35Tipoarticulowwds_1_filterfulltext ;
   private String lV35Tipoarticulowwds_1_filterfulltext ;
   ...
   private long[] P00452_A17TipoArticuloId ;
   private String[] P00452_A103TipoArticuloNombre ;
...
final  class tipoarticulowwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00452( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Tipoarticulowwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Tipoarticulowwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00452(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
