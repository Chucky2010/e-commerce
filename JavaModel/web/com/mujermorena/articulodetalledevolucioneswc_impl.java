...
public final  class articulodetalledevolucioneswc_impl extends GXWebComponent
{
   public articulodetalledevolucioneswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public articulodetalledevolucioneswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( articulodetalledevolucioneswc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ArticuloId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_MotivoDevolucionDescripcion, AV34IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Articulo Detalle Devoluciones WC", "")) ;
   ...
   {
      return "ArticuloDetalleDevolucionesWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Articulo Detalle Devoluciones WC", "") ;
   }
   ...
   public void wb6R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.articulodetalledevolucioneswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ArticuloDetalleDevolucionesWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_6R2( true) ;
      }
      else
      {
         wb_table1_21_6R2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_6R2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6R2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Articulo Detalle Devoluciones WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV37Pgmname = "ArticuloDetalleDevolucionesWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf6R2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H006R3 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8ArticuloId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A13ArticuloId = H006R3_A13ArticuloId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A13ArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A13ArticuloId), 11, 0));
            A279DevolucionesObservacion = H006R3_A279DevolucionesObservacion[0] ;
            A280MotivoDevolucionDescripcion = H006R3_A280MotivoDevolucionDescripcion[0] ;
            A273MotivoDevolucionID = H006R3_A273MotivoDevolucionID[0] ;
            A9TipoPagoId = H006R3_A9TipoPagoId[0] ;
            A4ClienteId = H006R3_A4ClienteId[0] ;
            A91VentasFecha = H006R3_A91VentasFecha[0] ;
            A19VentasId = H006R3_A19VentasId[0] ;
            A275DevolucionesFecha = H006R3_A275DevolucionesFecha[0] ;
            A272DevolucionesID = H006R3_A272DevolucionesID[0] ;
            A276DevolucionesTotal = H006R3_A276DevolucionesTotal[0] ;
            n276DevolucionesTotal = H006R3_n276DevolucionesTotal[0] ;
            A279DevolucionesObservacion = H006R3_A279DevolucionesObservacion[0] ;
            A273MotivoDevolucionID = H006R3_A273MotivoDevolucionID[0] ;
            A19VentasId = H006R3_A19VentasId[0] ;
            A275DevolucionesFecha = H006R3_A275DevolucionesFecha[0] ;
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H006R5 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8ArticuloId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      GRID_nRecordCount = H006R5_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e166R2( )
   {
      ...
      articulodetalledevolucioneswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void e176R2( )
   {
      ...
      articulodetalledevolucioneswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e116R2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ArticuloDetalleDevolucionesWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV37Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ArticuloDetalleDevolucionesWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ArticuloDetalleDevolucionesWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         articulodetalledevolucioneswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ArticuloDetalleDevolucionesWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_21_6R2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_6R2( true) ;
      }
      else
      {
         wb_table2_26_6R2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_6R2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_6R2e( true) ;
      }
      else
      {
         wb_table1_21_6R2e( false) ;
      }
   }

   public void wb_table2_26_6R2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "articulodetalledevolucioneswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111111496", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("articulodetalledevolucioneswc.js", "?202412111111497", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void startgridcontrol36( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ventas Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ventas Fecha", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e186R2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A272DevolucionesID',fld:'DEVOLUCIONESID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'A273MotivoDevolucionID',fld:'MOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H006R3_A274DevolucionesDetalleID = new long[1] ;
      H006R3_A13ArticuloId = new long[1] ;
      H006R3_A279DevolucionesObservacion = new String[] {""} ;
      H006R3_A280MotivoDevolucionDescripcion = new String[] {""} ;
      H006R3_A273MotivoDevolucionID = new long[1] ;
      H006R3_A9TipoPagoId = new long[1] ;
      H006R3_A4ClienteId = new long[1] ;
      H006R3_A91VentasFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006R3_A19VentasId = new long[1] ;
      H006R3_A275DevolucionesFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006R3_A272DevolucionesID = new long[1] ;
      H006R3_A276DevolucionesTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006R3_n276DevolucionesTotal = new boolean[] {false} ;
      H006R5_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.articulodetalledevolucioneswc__default(),
         new Object[] {
             new Object[] {
            H006R3_A274DevolucionesDetalleID, H006R3_A13ArticuloId, H006R3_A279DevolucionesObservacion, H006R3_A280MotivoDevolucionDescripcion, H006R3_A273MotivoDevolucionID, H006R3_A9TipoPagoId, H006R3_A4ClienteId, H006R3_A91VentasFecha, H006R3_A19VentasId, H006R3_A275DevolucionesFecha,
            H006R3_A272DevolucionesID, H006R3_A276DevolucionesTotal, H006R3_n276DevolucionesTotal
            }
            , new Object[] {
            H006R5_AGRID_nRecordCount
            }
         }
      );
      AV37Pgmname = "ArticuloDetalleDevolucionesWC" ;
   ...
   private long[] H006R3_A274DevolucionesDetalleID ;
   private long[] H006R3_A13ArticuloId ;
   private String[] H006R3_A279DevolucionesObservacion ;
   private String[] H006R3_A280MotivoDevolucionDescripcion ;
   private long[] H006R3_A273MotivoDevolucionID ;
   private long[] H006R3_A9TipoPagoId ;
   private long[] H006R3_A4ClienteId ;
   private java.util.Date[] H006R3_A91VentasFecha ;
   private long[] H006R3_A19VentasId ;
   private java.util.Date[] H006R3_A275DevolucionesFecha ;
   private long[] H006R3_A272DevolucionesID ;
   private java.math.BigDecimal[] H006R3_A276DevolucionesTotal ;
   private boolean[] H006R3_n276DevolucionesTotal ;
   private long[] H006R5_AGRID_nRecordCount ;
...
final  class articulodetalledevolucioneswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006R3( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[DevolucionesDetalleID], T1.[ArticuloId], T2.[DevolucionesObservacion], T3.[MotivoDevolucionDescripcion], T2.[MotivoDevolucionID], T4.[TipoPagoId], T4.[ClienteId]," ;
      sSelectString += " T4.[VentasFecha], T2.[VentasId], T2.[DevolucionesFecha], T1.[DevolucionesID], COALESCE( T5.[DevolucionesTotal], 0) AS DevolucionesTotal" ;
      sFromString = " FROM (((([DevolucionesDetalle] T1 INNER JOIN [Devoluciones] T2 ON T2.[DevolucionesID] = T1.[DevolucionesID]) INNER JOIN [MotivoDevolucion] T3 ON T3.[MotivoDevolucionID]" ;
      sFromString += " = T2.[MotivoDevolucionID]) INNER JOIN [Ventas] T4 ON T4.[VentasId] = T2.[VentasId]) LEFT JOIN (SELECT SUM(T7.[ArticuloPrecioVenta] * CAST(T6.[DevolucionesDetalleCant]" ;
      sFromString += " AS decimal( 27, 10))) AS DevolucionesTotal, T6.[DevolucionesID] FROM ([DevolucionesDetalle] T6 INNER JOIN [Articulo] T7 ON T7.[ArticuloId] = T6.[ArticuloId]) GROUP" ;
      sFromString += " BY T6.[DevolucionesID] ) T5 ON T5.[DevolucionesID] = T1.[DevolucionesID])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[ArticuloId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(10), CAST(T1.[DevolucionesID] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T2.[VentasId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T4.[ClienteId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T4.[TipoPagoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T2.[MotivoDevolucionID] AS decimal(10,0))) like '%' + ?) or ( T3.[MotivoDevolucionDescripcion] like '%' + ?) or ( T2.[DevolucionesObservacion] like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T5.[DevolucionesTotal], 0) AS decimal(17,2))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T1.[DevolucionesID]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T1.[DevolucionesID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T2.[DevolucionesFecha]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T2.[DevolucionesFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T2.[VentasId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T2.[VentasId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T4.[VentasFecha]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T4.[VentasFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T4.[ClienteId]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T4.[ClienteId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T4.[TipoPagoId]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T4.[TipoPagoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T2.[MotivoDevolucionID]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T2.[MotivoDevolucionID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T3.[MotivoDevolucionDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T3.[MotivoDevolucionDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T2.[DevolucionesObservacion]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T2.[DevolucionesObservacion] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H006R5( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          long A272DevolucionesID ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (((([DevolucionesDetalle] T1 INNER JOIN [Devoluciones] T2 ON T2.[DevolucionesID] = T1.[DevolucionesID]) INNER JOIN [MotivoDevolucion] T4 ON" ;
      scmdbuf += " T4.[MotivoDevolucionID] = T2.[MotivoDevolucionID]) INNER JOIN [Ventas] T3 ON T3.[VentasId] = T2.[VentasId]) LEFT JOIN (SELECT SUM(T7.[ArticuloPrecioVenta] * CAST(T6.[DevolucionesDetalleCant]" ;
      scmdbuf += " AS decimal( 27, 10))) AS DevolucionesTotal, T6.[DevolucionesID] FROM ([DevolucionesDetalle] T6 INNER JOIN [Articulo] T7 ON T7.[ArticuloId] = T6.[ArticuloId]) GROUP" ;
      scmdbuf += " BY T6.[DevolucionesID] ) T5 ON T5.[DevolucionesID] = T1.[DevolucionesID])" ;
      addWhere(sWhereString, "(T1.[ArticuloId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(10), CAST(T1.[DevolucionesID] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T2.[VentasId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T3.[ClienteId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T3.[TipoPagoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T2.[MotivoDevolucionID] AS decimal(10,0))) like '%' + ?) or ( T4.[MotivoDevolucionDescripcion] like '%' + ?) or ( T2.[DevolucionesObservacion] like '%' + ?) or ( CONVERT( char(17), CAST(T5.[DevolucionesTotal] AS decimal(17,2))) like '%' + ?))");
      }
      else
      {
         GXv_int13[1] = (byte)(1) ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006R3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , (String)dynConstraints[6] , (String)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() , ((Number) dynConstraints[11]).longValue() , ((Number) dynConstraints[12]).longValue() );
            case 1 :
                  return conditional_H006R5(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , (String)dynConstraints[6] , (String)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() , ((Number) dynConstraints[11]).longValue() , ((Number) dynConstraints[12]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006R3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006R5", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
