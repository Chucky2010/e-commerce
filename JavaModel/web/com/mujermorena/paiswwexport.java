...
public final  class paiswwexport extends GXProcedure
{
   ...
   public void S151( )
   {
      /* 'WRITEDATA' Routine */
      returnInSub = false ;
      AV27Paiswwds_1_filterfulltext = AV19FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV27Paiswwds_1_filterfulltext ,
      ...
      lV27Paiswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Paiswwds_1_filterfulltext), "%", "") ;
      lV27Paiswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Paiswwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003S2 */
      pr_default.execute(0, new Object[] {lV27Paiswwds_1_filterfulltext, lV27Paiswwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A5PaisId = P003S2_A5PaisId[0] ;
         A60PaisNombre = P003S2_A60PaisNombre[0] ;
         ...
         AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).setNumber( A5PaisId );
         GXt_char4 = "" ;
         GXv_char5[0] = GXt_char4 ;
   ...
   public void S191( )
   {
      ...
      {
         AV22GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "PaisWWGridState"), null, null);
      }
      else
      {
   ...
   public void initialize( )
   {
      ...
      AV27Paiswwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV27Paiswwds_1_filterfulltext = "" ;
      P003S2_A5PaisId = new long[1] ;
      P003S2_A60PaisNombre = new String[] {""} ;
      GXt_char4 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.paiswwexport__default(),
         new Object[] {
             new Object[] {
            P003S2_A5PaisId, P003S2_A60PaisNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String AV27Paiswwds_1_filterfulltext ;
   private String lV27Paiswwds_1_filterfulltext ;
   private com.genexus.webpanels.WebSession AV20Session ;
   private String[] aP1 ;
   private String[] aP0 ;
   private IDataStoreProvider pr_default ;
   private long[] P003S2_A5PaisId ;
   private String[] P003S2_A60PaisNombre ;
...
final  class paiswwexport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P003S2( ModelContext context ,
                                          ...
                                          String AV27Paiswwds_1_filterfulltext ,
                                          long A5PaisId ,
                                          ...
                                          boolean AV18OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV27Paiswwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003S2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
