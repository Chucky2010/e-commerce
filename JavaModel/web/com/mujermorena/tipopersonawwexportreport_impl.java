...
public final  class tipopersonawwexportreport_impl extends GXWebReport
{
   public tipopersonawwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopersonaww_Execute", GXv_boolean2) ;
         tipopersonawwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Tipo Persona", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Tipo Persona Id", ""), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Tipo Persona Nombre", ""), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Tipopersonawwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Tipopersonawwds_1_filterfulltext ,
      ...
      lV35Tipopersonawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipopersonawwds_1_filterfulltext), "%", "") ;
      lV35Tipopersonawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipopersonawwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003P2 */
      pr_default.execute(0, new Object[] {lV35Tipopersonawwds_1_filterfulltext, lV35Tipopersonawwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A2TipoPersonaId = P003P2_A2TipoPersonaId[0] ;
         A58TipoPersonaNombre = P003P2_A58TipoPersonaNombre[0] ;
         ...
         h3P0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A2TipoPersonaId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A58TipoPersonaNombre, "")), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("TipoPersonaWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "TipoPersonaWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("TipoPersonaWWGridState"), null, null);
      }
   ...
   public void h3P0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Tipopersonawwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Tipopersonawwds_1_filterfulltext = "" ;
      P003P2_A2TipoPersonaId = new long[1] ;
      P003P2_A58TipoPersonaNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopersonawwexportreport__default(),
         new Object[] {
             new Object[] {
            P003P2_A2TipoPersonaId, P003P2_A58TipoPersonaNombre
            }
         }
      );
   ...
   private String AV35Tipopersonawwds_1_filterfulltext ;
   private String lV35Tipopersonawwds_1_filterfulltext ;
   ...
   private long[] P003P2_A2TipoPersonaId ;
   private String[] P003P2_A58TipoPersonaNombre ;
...
final  class tipopersonawwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P003P2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Tipopersonawwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Tipopersonawwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003P2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
