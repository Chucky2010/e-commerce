...
public final  class numeradorprompt_impl extends GXDataArea
{
   public numeradorprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public numeradorprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( numeradorprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutNumeradorID") ;
         ...
         {
            AV8InOutNumeradorID = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutNumeradorID", AV8InOutNumeradorID);
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.numeradorprompt", new String[] {GXutil.URLEncode(GXutil.rtrim(AV8InOutNumeradorID))}, new String[] {"InOutNumeradorID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTNUMERADORID", GXutil.rtrim( AV8InOutNumeradorID));
   ...
   {
      return formatLink("com.mujermorena.numeradorprompt", new String[] {GXutil.URLEncode(GXutil.rtrim(AV8InOutNumeradorID))}, new String[] {"InOutNumeradorID"})  ;
   }

   public String getPgmname( )
   {
      return "NumeradorPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Numerador", "") ;
   }
   ...
   public void wb5C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_5C2( true) ;
      }
      else
      {
         wb_table1_14_5C2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_5C2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5C2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Numerador", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf5C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H005C2 */
         pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A232NumeradorUltimoNRO = H005C2_A232NumeradorUltimoNRO[0] ;
            A49NumeradorID = H005C2_A49NumeradorID[0] ;
            e175C2 ();
   ...
   public void send_integrity_lvl_hashes5C2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_NUMERADORID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A49NumeradorID, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H005C3 */
      pr_default.execute(1, new Object[] {lV12FilterFullText, lV12FilterFullText});
   ...
   public void e155C2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Numerador", "") );
   ...
   public void e165C2( )
   {
      ...
      numeradorprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e185C2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutNumeradorID = A49NumeradorID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutNumeradorID", AV8InOutNumeradorID);
      httpContext.setWebReturnParms(new Object[] {AV8InOutNumeradorID});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutNumeradorID"});
   ...
   public void wb_table1_14_5C2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_NumeradorPrompt.htm");
   ...
   {
      AV8InOutNumeradorID = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutNumeradorID", AV8InOutNumeradorID);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122351", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("numeradorprompt.js", "?20241211122351", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtNumeradorID_Internalname = "NUMERADORID_"+sGXsfl_26_idx ;
      edtNumeradorUltimoNRO_Internalname = "NUMERADORULTIMONRO_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtNumeradorID_Internalname = "NUMERADORID_"+sGXsfl_26_fel_idx ;
      edtNumeradorUltimoNRO_Internalname = "NUMERADORULTIMONRO_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:NumeradorID|2:NumeradorUltimoNRO" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e175C2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e185C2',iparms:[{av:'A49NumeradorID',fld:'NUMERADORID',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutNumeradorID',fld:'vINOUTNUMERADORID',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H005C2_A232NumeradorUltimoNRO = new long[1] ;
      H005C2_A49NumeradorID = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.numeradorprompt__default(),
         new Object[] {
             new Object[] {
            H005C2_A232NumeradorUltimoNRO, H005C2_A49NumeradorID
            }
            , new Object[] {
   ...
   private String wcpOAV8InOutNumeradorID ;
   private String Gridpaginationbar_Selectedpage ;
   private String Ddo_grid_Activeeventkey ;
   private String Ddo_grid_Selectedvalue_get ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV8InOutNumeradorID ;
   ...
   private long[] H005C2_A232NumeradorUltimoNRO ;
   private String[] H005C2_A49NumeradorID ;
...
final  class numeradorprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005C2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H005C3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          String A49NumeradorID ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005C2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H005C3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005C2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005C3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
