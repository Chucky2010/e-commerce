...
public final  class paisview_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10PaisId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PaisId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAISID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaisId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.paisview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaisId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaisId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"PaisView");
      forbiddenHiddens.add("PaisNombre", GXutil.rtrim( localUtil.format( A60PaisNombre, "")));
      ...
      GXutil.writeLogInfo("paisview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPAISID", GXutil.ltrim( localUtil.ntoc( AV10PaisId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAISID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaisId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.paisview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaisId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaisId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Pais View", "") ;
   }
   ...
   public void wb400( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Pais :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_PaisView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtPaisNombre_Internalname, httpContext.getMessage( "Pais Nombre", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtPaisNombre_Internalname, GXutil.rtrim( A60PaisNombre), GXutil.rtrim( localUtil.format( A60PaisNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Nombre", "left", true, "", "HLP_PaisView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Pais", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_PaisView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PaisView.htm");
         /* Div Control */
   ...
   public void start402( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Pais View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf402( )
   {
      ...
      {
         /* Using cursor H00402 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10PaisId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A5PaisId = H00402_A5PaisId[0] ;
            A60PaisNombre = H00402_A60PaisNombre[0] ;
   ...
   public void send_integrity_lvl_hashes402( )
   {
   }
   ...
   public void strup400( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10PaisId = localUtil.ctol( httpContext.cgiGet( "vPAISID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("paisview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e11402( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.paisww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H00403 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10PaisId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A5PaisId = H00403_A5PaisId[0] ;
         A60PaisNombre = H00403_A60PaisNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A60PaisNombre", A60PaisNombre);
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A60PaisNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "PaisGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.paisgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PaisGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10PaisId)});
   ...
   {
      AV10PaisId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PaisId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAISID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaisId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122598", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paisview.js", "?20241211122598", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Pais View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaisId',fld:'vPAISID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A60PaisNombre',fld:'PAISNOMBRE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H00402_A5PaisId = new long[1] ;
      H00402_A60PaisNombre = new String[] {""} ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H00403_A5PaisId = new long[1] ;
      H00403_A60PaisNombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.paisview__default(),
         new Object[] {
             new Object[] {
            H00402_A5PaisId, H00402_A60PaisNombre
            }
            , new Object[] {
            H00403_A5PaisId, H00403_A60PaisNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10PaisId ;
   private long AV10PaisId ;
   ...
   private long[] H00402_A5PaisId ;
   private String[] H00402_A60PaisNombre ;
   private long[] H00403_A5PaisId ;
   private String[] H00403_A60PaisNombre ;
...
final  class paisview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00402", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = ? ORDER BY [PaisId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00403", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = ? ORDER BY [PaisId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
