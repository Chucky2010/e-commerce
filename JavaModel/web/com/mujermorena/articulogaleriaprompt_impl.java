...
public final  class articulogaleriaprompt_impl extends GXDataArea
{
   public articulogaleriaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public articulogaleriaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( articulogaleriaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV9InOutArticuloGaleriaId = GXutil.lval( httpContext.GetPar( "InOutArticuloGaleriaId")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutArticuloGaleriaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutArticuloGaleriaId), 11, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV12FilterFullText, AV8InArticuloId, AV21Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.articulogaleriaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InArticuloId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutArticuloGaleriaId,11,0))}, new String[] {"InArticuloId","InOutArticuloGaleriaId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTARTICULOGALERIAID", GXutil.ltrim( localUtil.ntoc( AV9InOutArticuloGaleriaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.articulogaleriaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InArticuloId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutArticuloGaleriaId,11,0))}, new String[] {"InArticuloId","InOutArticuloGaleriaId"})  ;
   }

   public String getPgmname( )
   {
      return "ArticuloGaleriaPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Galeria", "") ;
   }
   ...
   public void wb4O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_4O2( true) ;
      }
      else
      {
         wb_table1_14_4O2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_4O2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start4O2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Galeria", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtArticuloGaleriaImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A230ArticuloGaleriaImagen)==0) ? A40000ArticuloGaleriaImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A230ArticuloGaleriaImagen))), !bGXsfl_26_Refreshing);
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_ARTICULOGALERIAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A48ArticuloGaleriaId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "ARTICULOGALERIAID", GXutil.ltrim( localUtil.ntoc( A48ArticuloGaleriaId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV21Pgmname = "ArticuloGaleriaPrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV12FilterFullText ,
                                              Long.valueOf(A48ArticuloGaleriaId) ,
                                              Boolean.valueOf(AV11OrderedDsc) ,
                                              Long.valueOf(AV8InArticuloId) ,
                                              Long.valueOf(A13ArticuloId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.LONG
                                              }
         });
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H004O2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InArticuloId), lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A13ArticuloId = H004O2_A13ArticuloId[0] ;
            A230ArticuloGaleriaImagen = H004O2_A230ArticuloGaleriaImagen[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloGaleriaImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A230ArticuloGaleriaImagen)==0) ? A40000ArticuloGaleriaImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A230ArticuloGaleriaImagen))), !bGXsfl_26_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloGaleriaImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A230ArticuloGaleriaImagen), true);
            A40000ArticuloGaleriaImagen_GXI = H004O2_A40000ArticuloGaleriaImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloGaleriaImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A230ArticuloGaleriaImagen)==0) ? A40000ArticuloGaleriaImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A230ArticuloGaleriaImagen))), !bGXsfl_26_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloGaleriaImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A230ArticuloGaleriaImagen), true);
            A48ArticuloGaleriaId = H004O2_A48ArticuloGaleriaId[0] ;
            e174O2 ();
   ...
   public void send_integrity_lvl_hashes4O2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_ARTICULOGALERIAID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A48ArticuloGaleriaId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H004O3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InArticuloId), lV12FilterFullText});
   ...
   public void e154O2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Galeria", "") );
   ...
   public void e164O2( )
   {
      ...
      articulogaleriaprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e184O2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutArticuloGaleriaId = A48ArticuloGaleriaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutArticuloGaleriaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutArticuloGaleriaId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV9InOutArticuloGaleriaId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutArticuloGaleriaId"});
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      Ddo_grid_Sortedstatus = "-1:"+(AV11OrderedDsc ? "DSC" : "ASC") ;
   ...
   public void wb_table1_14_4O2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ArticuloGaleriaPrompt.htm");
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV8InArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InArticuloId), 11, 0));
      AV9InOutArticuloGaleriaId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutArticuloGaleriaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutArticuloGaleriaId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111221360", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("articulogaleriaprompt.js", "?202412111221360", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtArticuloGaleriaId_Internalname = "ARTICULOGALERIAID_"+sGXsfl_26_idx ;
      edtArticuloGaleriaImagen_Internalname = "ARTICULOGALERIAIMAGEN_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtArticuloGaleriaId_Internalname = "ARTICULOGALERIAID_"+sGXsfl_26_fel_idx ;
      edtArticuloGaleriaImagen_Internalname = "ARTICULOGALERIAIMAGEN_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ArticuloGaleriaId" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e114O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e124O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e134O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'AV11OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV11OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e174O2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e184O2',iparms:[{av:'A48ArticuloGaleriaId',fld:'ARTICULOGALERIAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutArticuloGaleriaId',fld:'vINOUTARTICULOGALERIAID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e144O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   {
      return "articulogaleriaprompt_Execute";
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H004O2_A13ArticuloId = new long[1] ;
      H004O2_A230ArticuloGaleriaImagen = new String[] {""} ;
      H004O2_A40000ArticuloGaleriaImagen_GXI = new String[] {""} ;
      H004O2_A48ArticuloGaleriaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.articulogaleriaprompt__default(),
         new Object[] {
             new Object[] {
            H004O2_A13ArticuloId, H004O2_A230ArticuloGaleriaImagen, H004O2_A40000ArticuloGaleriaImagen_GXI, H004O2_A48ArticuloGaleriaId
            }
            , new Object[] {
   ...
   private long wcpOAV9InOutArticuloGaleriaId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InArticuloId ;
   private long AV9InOutArticuloGaleriaId ;
   ...
   private long[] H004O2_A13ArticuloId ;
   private String[] H004O2_A230ArticuloGaleriaImagen ;
   private String[] H004O2_A40000ArticuloGaleriaImagen_GXI ;
   private long[] H004O2_A48ArticuloGaleriaId ;
...
final  class articulogaleriaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004O2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A48ArticuloGaleriaId ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([ArticuloGaleriaId] AS decimal(11,0))) like '%' + ?))");
      }
      else
      {
         GXv_int6[1] = (byte)(1) ;
      ...
      if ( ! AV11OrderedDsc )
      {
         sOrderString += " ORDER BY [ArticuloGaleriaId]" ;
      }
      else if ( AV11OrderedDsc )
      {
         sOrderString += " ORDER BY [ArticuloGaleriaId] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H004O3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A48ArticuloGaleriaId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004O2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Boolean) dynConstraints[2]).booleanValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() );
            case 1 :
                  return conditional_H004O3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Boolean) dynConstraints[2]).booleanValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004O2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004O3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
