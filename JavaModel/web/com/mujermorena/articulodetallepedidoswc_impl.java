...
public final  class articulodetallepedidoswc_impl extends GXWebComponent
{
   public articulodetallepedidoswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public articulodetallepedidoswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( articulodetallepedidoswc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ArticuloId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_OpcionEnvioDescripcion, AV34IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Articulo Detalle Pedidos WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.articulodetallepedidoswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ArticuloId,11,0))}, new String[] {"ArticuloId"}) +"\">") ;
   ...
   public void renderHtmlCloseForm6P2( )
   {
   ...
   {
      return "ArticuloDetallePedidosWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Articulo Detalle Pedidos WC", "") ;
   }
   ...
   public void wb6P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.articulodetallepedidoswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ArticuloDetallePedidosWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_6P2( true) ;
      }
      else
      {
         wb_table1_21_6P2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_6P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6P2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Articulo Detalle Pedidos WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV37Pgmname = "ArticuloDetallePedidosWC" ;
      Gx_err = (short)(0) ;
   ...
   public int subgridclient_rec_count_fnc( )
   {
      ...
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           ...
                                           new int[]{
                                           TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.DECIMAL,
                                           TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.LONG
                                           }
      });
      /* Using cursor H006P3 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV8ArticuloId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A13ArticuloId = H006P3_A13ArticuloId[0] ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A13ArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A13ArticuloId), 11, 0));
         A284OpcionEnvioDescripcion = H006P3_A284OpcionEnvioDescripcion[0] ;
         A283OpcionEnvioId = H006P3_A283OpcionEnvioId[0] ;
         A9TipoPagoId = H006P3_A9TipoPagoId[0] ;
         A247PedidosEstado = H006P3_A247PedidosEstado[0] ;
         A246PedidosFecha = H006P3_A246PedidosFecha[0] ;
         A4ClienteId = H006P3_A4ClienteId[0] ;
         A51PedidosID = H006P3_A51PedidosID[0] ;
         A248PedidosTotal = H006P3_A248PedidosTotal[0] ;
         A250PedidosSubTotal = H006P3_A250PedidosSubTotal[0] ;
         A283OpcionEnvioId = H006P3_A283OpcionEnvioId[0] ;
         A9TipoPagoId = H006P3_A9TipoPagoId[0] ;
         A247PedidosEstado = H006P3_A247PedidosEstado[0] ;
         A246PedidosFecha = H006P3_A246PedidosFecha[0] ;
         ...
         A248PedidosTotal = H006P3_A248PedidosTotal[0] ;
         A250PedidosSubTotal = H006P3_A250PedidosSubTotal[0] ;
         if ( (GXutil.strcmp("", AV16FilterFullText)==0) || ( ( GXutil.like( GXutil.str( A51PedidosID, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A4ClienteId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( httpContext.getMessage( "pendiente", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "PEN") == 0 ) ) || ( GXutil.like( httpContext.getMessage( "confirmado", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "FIN") == 0 ) ) || ( GXutil.like( GXutil.str( A9TipoPagoId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A283OpcionEnvioId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( A284OpcionEnvioDescripcion , GXutil.padr( "%" + AV16FilterFullText , 101 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A250PedidosSubTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A248PedidosTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) ) )
         {
   ...
   public void rf6P2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A13ArticuloId = H006P5_A13ArticuloId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A13ArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A13ArticuloId), 11, 0));
            A284OpcionEnvioDescripcion = H006P5_A284OpcionEnvioDescripcion[0] ;
            A283OpcionEnvioId = H006P5_A283OpcionEnvioId[0] ;
            A9TipoPagoId = H006P5_A9TipoPagoId[0] ;
            A247PedidosEstado = H006P5_A247PedidosEstado[0] ;
            A246PedidosFecha = H006P5_A246PedidosFecha[0] ;
            A4ClienteId = H006P5_A4ClienteId[0] ;
            A51PedidosID = H006P5_A51PedidosID[0] ;
            A248PedidosTotal = H006P5_A248PedidosTotal[0] ;
            A250PedidosSubTotal = H006P5_A250PedidosSubTotal[0] ;
            A283OpcionEnvioId = H006P5_A283OpcionEnvioId[0] ;
            A9TipoPagoId = H006P5_A9TipoPagoId[0] ;
            A247PedidosEstado = H006P5_A247PedidosEstado[0] ;
            A246PedidosFecha = H006P5_A246PedidosFecha[0] ;
   ...
   public void e166P2( )
   {
      ...
      articulodetallepedidoswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void e176P2( )
   {
      ...
      articulodetallepedidoswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e116P2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ArticuloDetallePedidosWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV37Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ArticuloDetallePedidosWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ArticuloDetallePedidosWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         articulodetallepedidoswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ArticuloDetallePedidosWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_21_6P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_6P2( true) ;
      }
      else
      {
         wb_table2_26_6P2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_6P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_6P2e( true) ;
      }
      else
      {
         wb_table1_21_6P2e( false) ;
      }
   }

   public void wb_table2_26_6P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "articulodetallepedidoswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211111344", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("articulodetallepedidoswc.js", "?20241211111344", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtTipoPagoId_Internalname = sPrefix+"TIPOPAGOID_"+sGXsfl_36_idx ;
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtTipoPagoId_Internalname = sPrefix+"TIPOPAGOID_"+sGXsfl_36_fel_idx ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:PedidosID|4:ClienteId|5:PedidosFecha|6:PedidosEstado|7:TipoPagoId|8:OpcionEnvioId|9:OpcionEnvioDescripcion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e186P2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A51PedidosID',fld:'PEDIDOSID',pic:'ZZZZZZZZZZ9'},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_OpcionEnvioDescripcion',fld:'vISAUTHORIZED_OPCIONENVIODESCRIPCION',pic:'',hsh:true},{av:'A283OpcionEnvioId',fld:'OPCIONENVIOID',pic:'ZZZZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H006P3_A52PedidosDetalleID = new long[1] ;
      H006P3_A13ArticuloId = new long[1] ;
      H006P3_A284OpcionEnvioDescripcion = new String[] {""} ;
      H006P3_A283OpcionEnvioId = new long[1] ;
      H006P3_A9TipoPagoId = new long[1] ;
      H006P3_A247PedidosEstado = new String[] {""} ;
      H006P3_A246PedidosFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006P3_A4ClienteId = new long[1] ;
      H006P3_A51PedidosID = new long[1] ;
      H006P3_A248PedidosTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006P3_A250PedidosSubTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006P5_A52PedidosDetalleID = new long[1] ;
      H006P5_A13ArticuloId = new long[1] ;
      H006P5_A284OpcionEnvioDescripcion = new String[] {""} ;
      H006P5_A283OpcionEnvioId = new long[1] ;
      H006P5_A9TipoPagoId = new long[1] ;
      H006P5_A247PedidosEstado = new String[] {""} ;
      H006P5_A246PedidosFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006P5_A4ClienteId = new long[1] ;
      H006P5_A51PedidosID = new long[1] ;
      H006P5_A248PedidosTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006P5_A250PedidosSubTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.articulodetallepedidoswc__default(),
         new Object[] {
             new Object[] {
            H006P3_A52PedidosDetalleID, H006P3_A13ArticuloId, H006P3_A284OpcionEnvioDescripcion, H006P3_A283OpcionEnvioId, H006P3_A9TipoPagoId, H006P3_A247PedidosEstado, H006P3_A246PedidosFecha, H006P3_A4ClienteId, H006P3_A51PedidosID, H006P3_A248PedidosTotal,
            H006P3_A250PedidosSubTotal
            }
            , new Object[] {
            H006P5_A52PedidosDetalleID, H006P5_A13ArticuloId, H006P5_A284OpcionEnvioDescripcion, H006P5_A283OpcionEnvioId, H006P5_A9TipoPagoId, H006P5_A247PedidosEstado, H006P5_A246PedidosFecha, H006P5_A4ClienteId, H006P5_A51PedidosID, H006P5_A248PedidosTotal,
            H006P5_A250PedidosSubTotal
            }
         }
      );
      AV37Pgmname = "ArticuloDetallePedidosWC" ;
   ...
   private long[] H006P3_A52PedidosDetalleID ;
   private long[] H006P3_A13ArticuloId ;
   private String[] H006P3_A284OpcionEnvioDescripcion ;
   private long[] H006P3_A283OpcionEnvioId ;
   private long[] H006P3_A9TipoPagoId ;
   private String[] H006P3_A247PedidosEstado ;
   private java.util.Date[] H006P3_A246PedidosFecha ;
   private long[] H006P3_A4ClienteId ;
   private long[] H006P3_A51PedidosID ;
   private java.math.BigDecimal[] H006P3_A248PedidosTotal ;
   private java.math.BigDecimal[] H006P3_A250PedidosSubTotal ;
   private long[] H006P5_A52PedidosDetalleID ;
   private long[] H006P5_A13ArticuloId ;
   private String[] H006P5_A284OpcionEnvioDescripcion ;
   private long[] H006P5_A283OpcionEnvioId ;
   private long[] H006P5_A9TipoPagoId ;
   private String[] H006P5_A247PedidosEstado ;
   private java.util.Date[] H006P5_A246PedidosFecha ;
   private long[] H006P5_A4ClienteId ;
   private long[] H006P5_A51PedidosID ;
   private java.math.BigDecimal[] H006P5_A248PedidosTotal ;
   private java.math.BigDecimal[] H006P5_A250PedidosSubTotal ;
...
final  class articulodetallepedidoswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006P3( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      scmdbuf = "SELECT T1.[PedidosDetalleID], T1.[ArticuloId], T3.[OpcionEnvioDescripcion], T2.[OpcionEnvioId], T2.[TipoPagoId], T2.[PedidosEstado], T2.[PedidosFecha], T2.[ClienteId]," ;
      scmdbuf += " T1.[PedidosID], COALESCE( T4.[PedidosTotal], 0) AS PedidosTotal, COALESCE( T4.[PedidosTotal], 0) AS PedidosSubTotal FROM ((([PedidosDetalle] T1 INNER JOIN [Pedidos]" ;
      scmdbuf += " T2 ON T2.[PedidosID] = T1.[PedidosID]) INNER JOIN [OpcionEnvio] T3 ON T3.[OpcionEnvioId] = T2.[OpcionEnvioId]) LEFT JOIN (SELECT T5.[PedidosID], SUM(T6.[ArticuloPrecioVenta]" ;
      scmdbuf += " * CAST(T5.[PedidosDetalleCantidad] AS decimal( 27, 10))) AS PedidosTotal FROM ([PedidosDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId])" ;
      scmdbuf += " GROUP BY T5.[PedidosID] ) T4 ON T4.[PedidosID] = T1.[PedidosID])" ;
      addWhere(sWhereString, "(T1.[ArticuloId] = ?)");
      scmdbuf += sWhereString ;
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T1.[PedidosID]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T1.[PedidosID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T2.[ClienteId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T2.[ClienteId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T2.[PedidosFecha]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T2.[PedidosFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T2.[PedidosEstado]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T2.[PedidosEstado] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T2.[TipoPagoId]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T2.[TipoPagoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T2.[OpcionEnvioId]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T2.[OpcionEnvioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId], T3.[OpcionEnvioDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ArticuloId] DESC, T3.[OpcionEnvioDescripcion] DESC" ;
      }
   ...
   protected Object[] conditional_H006P5( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006P3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() , (String)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).longValue() , ((Number) dynConstraints[12]).longValue() );
            case 1 :
                  return conditional_H006P5(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() , (String)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).longValue() , ((Number) dynConstraints[12]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006P3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006P5", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
      };
   }
