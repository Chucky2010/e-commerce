...
public final  class proveedorwwexport extends GXProcedure
{
   public proveedorwwexport( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( proveedorwwexport.class ), "" );
   }
   ...
   {
      proveedorwwexport.this.aP1 = new String[] {""};
      execute_int(aP0, aP1);
      return aP1[0];
   }
   ...
   private void execute_int( String[] aP0 ,
                             String[] aP1 )
   {
      proveedorwwexport.this.aP0 = aP0;
      proveedorwwexport.this.aP1 = aP1;
      initialize();
      /* GeneXus formulas */
   ...
   public void S111( )
   {
      ...
      AV12Filename = "ProveedorWWExport-" + GXutil.trim( GXutil.str( AV16Random, 8, 0)) + ".xlsx" ;
   ...
   public void S141( )
   {
      ...
      AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).setText( httpContext.getMessage( "Proveedor Id", "") );
      ...
      AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).setText( httpContext.getMessage( "Persona Id", "") );
      ...
      AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+2, 1, 1).setText( httpContext.getMessage( "Nombre Completo", "") );
      ...
      AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+3, 1, 1).setText( httpContext.getMessage( "Direccion", "") );
      ...
      AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+4, 1, 1).setText( httpContext.getMessage( "Telefono", "") );
   }
   ...
   public void S151( )
   {
      /* 'WRITEDATA' Routine */
      returnInSub = false ;
      AV27Proveedorwwds_1_filterfulltext = AV19FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV27Proveedorwwds_1_filterfulltext ,
      ...
      lV27Proveedorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Proveedorwwds_1_filterfulltext), "%", "") ;
      lV27Proveedorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Proveedorwwds_1_filterfulltext), "%", "") ;
      lV27Proveedorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Proveedorwwds_1_filterfulltext), "%", "") ;
      lV27Proveedorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Proveedorwwds_1_filterfulltext), "%", "") ;
      lV27Proveedorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Proveedorwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P00422 */
      pr_default.execute(0, new Object[] {lV27Proveedorwwds_1_filterfulltext, lV27Proveedorwwds_1_filterfulltext, lV27Proveedorwwds_1_filterfulltext, lV27Proveedorwwds_1_filterfulltext, lV27Proveedorwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1PersonaId = P00422_A1PersonaId[0] ;
         A10ProveedorId = P00422_A10ProveedorId[0] ;
         A66PersonaTelefono = P00422_A66PersonaTelefono[0] ;
         A57PersonaDireccion = P00422_A57PersonaDireccion[0] ;
         A56PersonaApellido = P00422_A56PersonaApellido[0] ;
         A55PersonaNombre = P00422_A55PersonaNombre[0] ;
         A66PersonaTelefono = P00422_A66PersonaTelefono[0] ;
         A57PersonaDireccion = P00422_A57PersonaDireccion[0] ;
         A56PersonaApellido = P00422_A56PersonaApellido[0] ;
         A55PersonaNombre = P00422_A55PersonaNombre[0] ;
         ...
         AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).setNumber( A10ProveedorId );
         AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).setNumber( A1PersonaId );
         GXt_char4 = "" ;
         GXv_char5[0] = GXt_char4 ;
   ...
   public void S191( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV20Session.getValue("ProveedorWWGridState"), "") == 0 )
      {
         AV22GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "ProveedorWWGridState"), null, null);
      }
      else
      {
         AV22GridState.fromxml(AV20Session.getValue("ProveedorWWGridState"), null, null);
      }
   ...
   {
      this.aP0[0] = proveedorwwexport.this.AV12Filename;
      this.aP1[0] = proveedorwwexport.this.AV13ErrorMessage;
      CloseOpenCursors();
   ...
   public void initialize( )
   {
      ...
      AV27Proveedorwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV27Proveedorwwds_1_filterfulltext = "" ;
      A55PersonaNombre = "" ;
      A56PersonaApellido = "" ;
      P00422_A1PersonaId = new long[1] ;
      P00422_A10ProveedorId = new long[1] ;
      P00422_A66PersonaTelefono = new String[] {""} ;
      P00422_A57PersonaDireccion = new String[] {""} ;
      P00422_A56PersonaApellido = new String[] {""} ;
      P00422_A55PersonaNombre = new String[] {""} ;
      GXt_char4 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.proveedorwwexport__default(),
         new Object[] {
             new Object[] {
            P00422_A1PersonaId, P00422_A10ProveedorId, P00422_A66PersonaTelefono, P00422_A57PersonaDireccion, P00422_A56PersonaApellido, P00422_A55PersonaNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String AV27Proveedorwwds_1_filterfulltext ;
   private String lV27Proveedorwwds_1_filterfulltext ;
   private com.genexus.webpanels.WebSession AV20Session ;
   private String[] aP1 ;
   private String[] aP0 ;
   private IDataStoreProvider pr_default ;
   private long[] P00422_A1PersonaId ;
   private long[] P00422_A10ProveedorId ;
   private String[] P00422_A66PersonaTelefono ;
   private String[] P00422_A57PersonaDireccion ;
   private String[] P00422_A56PersonaApellido ;
   private String[] P00422_A55PersonaNombre ;
...
final  class proveedorwwexport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00422( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV27Proveedorwwds_1_filterfulltext ,
                                          long A10ProveedorId ,
                                          long A1PersonaId ,
                                          ...
                                          boolean AV18OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV27Proveedorwwds_1_filterfulltext)==0) )
      {
