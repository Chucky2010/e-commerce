...
public final  class inventarioww_impl extends GXDataArea
{
   public inventarioww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public inventarioww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( inventarioww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV41Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV36IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.inventarioww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.inventarioww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb1G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Inventario", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_InventarioWW.htm");
   ...
   public void wb_table1_22_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 18), "VPROCESARINV.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 22), "VINVENTARIOFINAL.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 18), "VPROCESARINV.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 22), "VINVENTARIOFINAL.CLICK") == 0 ) )
                        {
                           ...
                           AV37ProcesarINV = httpContext.cgiGet( edtavProcesarinv_Internalname) ;
                           httpContext.ajax_rsp_assign_prop("", false, edtavProcesarinv_Internalname, "Bitmap", ((GXutil.strcmp("", AV37ProcesarINV)==0) ? AV43Procesarinv_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV37ProcesarINV))), !bGXsfl_40_Refreshing);
                           httpContext.ajax_rsp_assign_prop("", false, edtavProcesarinv_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV37ProcesarINV), true);
                           AV38InventarioFinal = httpContext.cgiGet( edtavInventariofinal_Internalname) ;
                           httpContext.ajax_rsp_assign_prop("", false, edtavInventariofinal_Internalname, "Bitmap", ((GXutil.strcmp("", AV38InventarioFinal)==0) ? AV44Inventariofinal_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38InventarioFinal))), !bGXsfl_40_Refreshing);
                           httpContext.ajax_rsp_assign_prop("", false, edtavInventariofinal_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV38InventarioFinal), true);
                           ...
                           A257InventarioFecha = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtInventarioFecha_Internalname), 0)) ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "VPROCESARINV.CLICK") == 0 )
                              {
                                 httpContext.wbHandled = (byte)(1) ;
                                 dynload_actions( ) ;
                                 e201G2 ();
                              }
                              else if ( GXutil.strcmp(sEvt, "VINVENTARIOFINAL.CLICK") == 0 )
                              {
                                 httpContext.wbHandled = (byte)(1) ;
                                 dynload_actions( ) ;
                                 e211G2 ();
   ...
   public void rf1G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV42Inventariowwds_1_filterfulltext ,
         ...
         lV42Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Inventariowwds_1_filterfulltext), "%", "") ;
         lV42Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Inventariowwds_1_filterfulltext), "%", "") ;
         lV42Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Inventariowwds_1_filterfulltext), "%", "") ;
         /* Using cursor H001G2 */
         pr_default.execute(0, new Object[] {lV42Inventariowwds_1_filterfulltext, lV42Inventariowwds_1_filterfulltext, lV42Inventariowwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A265InventarioNumeroProceso = H001G2_A265InventarioNumeroProceso[0] ;
            A258InventarioDetalle = H001G2_A258InventarioDetalle[0] ;
            A257InventarioFecha = H001G2_A257InventarioFecha[0] ;
            A53InventarioID = H001G2_A53InventarioID[0] ;
            e191G2 ();
   ...
   {
      AV42Inventariowwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV42Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Inventariowwds_1_filterfulltext), "%", "") ;
      /* Using cursor H001G3 */
      pr_default.execute(1, new Object[] {lV42Inventariowwds_1_filterfulltext, lV42Inventariowwds_1_filterfulltext, lV42Inventariowwds_1_filterfulltext});
   ...
   public void e181G2( )
   {
      ...
      inventarioww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e191G2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.inventarioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A53InventarioID,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"InventarioID","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.inventario", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A53InventarioID,11,0))}, new String[] {"Mode","InventarioID"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.inventario", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A53InventarioID,11,0))}, new String[] {"Mode","InventarioID"})  ;
      }
      edtavProcesarinv_gximage = "ActionManage" ;
      AV37ProcesarINV = context.getHttpContext().getImagePath( "653f6166-5d82-407a-af84-19e0dde65efd", "", context.getHttpContext().getTheme( )) ;
      httpContext.ajax_rsp_assign_attri("", false, edtavProcesarinv_Internalname, AV37ProcesarINV);
      AV43Procesarinv_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "653f6166-5d82-407a-af84-19e0dde65efd", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      edtavProcesarinv_Tooltiptext = httpContext.getMessage( "ProcesarINV", "") ;
      edtavInventariofinal_gximage = "ActionInsert" ;
      AV38InventarioFinal = context.getHttpContext().getImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", context.getHttpContext().getTheme( )) ;
      httpContext.ajax_rsp_assign_attri("", false, edtavInventariofinal_Internalname, AV38InventarioFinal);
      AV44Inventariofinal_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      edtavInventariofinal_Tooltiptext = httpContext.getMessage( "InventarioFinal", "") ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(40) ;
   ...
   public void e111G2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("InventarioWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV41Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("InventarioWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "InventarioWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         inventarioww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e201G2( )
   {
      /* Procesarinv_Click Routine */
      returnInSub = false ;
      GXv_int6[0] = A53InventarioID ;
      new com.mujermorena.procesarinventariostock(remoteHandle, context).execute( GXv_int6) ;
      inventarioww_impl.this.A53InventarioID = GXv_int6[0] ;
      /*  Sending Event outputs  */
   }
   ...
   public void e161G2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.inventario", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","InventarioID"}) );
   ...
   public void S152( )
   {
      ...
      returnInSub = false ;
      GXt_boolean7 = AV28IsAuthorized_Display ;
      GXv_boolean8[0] = GXt_boolean7 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "inventarioview_Execute", GXv_boolean8) ;
      inventarioww_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      AV28IsAuthorized_Display = GXt_boolean7 ;
      ...
      GXt_boolean7 = AV30IsAuthorized_Update ;
      GXv_boolean8[0] = GXt_boolean7 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "inventario_Update", GXv_boolean8) ;
      inventarioww_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      AV30IsAuthorized_Update = GXt_boolean7 ;
      ...
      GXt_boolean7 = AV32IsAuthorized_Delete ;
      GXv_boolean8[0] = GXt_boolean7 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "inventario_Delete", GXv_boolean8) ;
      inventarioww_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      AV32IsAuthorized_Delete = GXt_boolean7 ;
      ...
      GXt_boolean7 = AV36IsAuthorized_Insert ;
      GXv_boolean8[0] = GXt_boolean7 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "inventario_Insert", GXv_boolean8) ;
      inventarioww_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      AV36IsAuthorized_Insert = GXt_boolean7 ;
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item9 = AV19ManageFiltersData ;
      GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item10[0] = GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item9 ;
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "InventarioWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item10) ;
      GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item9 = GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item10[0] ;
      AV19ManageFiltersData = GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item9 ;
   }
   ...
   public void S182( )
   {
      ...
      returnInSub = false ;
      AV45GXV1 = 1 ;
      while ( AV45GXV1 <= AV11GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV12GridStateFilterValue = (com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV45GXV1));
   ...
   public void S162( )
   {
      ...
      GXv_SdtWWPGridState11[0] = AV11GridState;
      new com.mujermorena.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState11, "FILTERFULLTEXT", httpContext.getMessage( "WWP_FullTextFilterDescription", ""), !(GXutil.strcmp("", AV15FilterFullText)==0), (short)(0), AV15FilterFullText, "") ;
      AV11GridState = GXv_SdtWWPGridState11[0] ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Inventario" );
   ...
   public void S192( )
   {
      ...
      GXv_char12[0] = AV17ErrorMessage ;
      new com.mujermorena.inventariowwexport(remoteHandle, context).execute( GXv_char5, GXv_char12) ;
      inventarioww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      inventarioww_impl.this.AV17ErrorMessage = GXv_char12[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.inventariowwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void e211G2( )
   {
      /* Inventariofinal_Click Routine */
      returnInSub = false ;
      /* Execute user subroutine: 'LOADGRIDSTATE' */
      S132 ();
      if (returnInSub) return;
      GXv_char12[0] = AV16ExcelFilename ;
      GXv_char5[0] = AV17ErrorMessage ;
      new com.mujermorena.inventariofinal(remoteHandle, context).execute( A53InventarioID, GXv_char12, GXv_char5) ;
      inventarioww_impl.this.AV16ExcelFilename = GXv_char12[0] ;
      inventarioww_impl.this.AV17ErrorMessage = GXv_char5[0] ;
      if ( GXutil.strcmp(AV16ExcelFilename, "") != 0 )
      {
         callWebObject(formatLink(AV16ExcelFilename, new String[] {}, new String[] {}) );
         httpContext.wjLocDisableFrm = (byte)(0) ;
   ...
   public void wb_table1_22_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_1G2( true) ;
      }
      else
      {
         wb_table2_27_1G2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_27_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111132943", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("inventarioww.js", "?202412111132943", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtavProcesarinv_Internalname = "vPROCESARINV_"+sGXsfl_40_idx ;
      edtavInventariofinal_Internalname = "vINVENTARIOFINAL_"+sGXsfl_40_idx ;
      edtInventarioID_Internalname = "INVENTARIOID_"+sGXsfl_40_idx ;
      edtInventarioFecha_Internalname = "INVENTARIOFECHA_"+sGXsfl_40_idx ;
      edtInventarioDetalle_Internalname = "INVENTARIODETALLE_"+sGXsfl_40_idx ;
      edtInventarioNumeroProceso_Internalname = "INVENTARIONUMEROPROCESO_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtavProcesarinv_Internalname = "vPROCESARINV_"+sGXsfl_40_fel_idx ;
      edtavInventariofinal_Internalname = "vINVENTARIOFINAL_"+sGXsfl_40_fel_idx ;
      edtInventarioID_Internalname = "INVENTARIOID_"+sGXsfl_40_fel_idx ;
      edtInventarioFecha_Internalname = "INVENTARIOFECHA_"+sGXsfl_40_fel_idx ;
      edtInventarioDetalle_Internalname = "INVENTARIODETALLE_"+sGXsfl_40_fel_idx ;
      edtInventarioNumeroProceso_Internalname = "INVENTARIONUMEROPROCESO_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         TempTags = " " + ((edtavProcesarinv_Enabled!=0)&&(edtavProcesarinv_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 44,'',false,'',40)\"" : " ") ;
         ClassString = "ActionBaseColorAttribute" + " " + ((GXutil.strcmp(edtavProcesarinv_gximage, "")==0) ? "" : "GX_Image_"+edtavProcesarinv_gximage+"_Class") ;
         StyleString = "" ;
         AV37ProcesarINV_IsBlob = (boolean)(((GXutil.strcmp("", AV37ProcesarINV)==0)&&(GXutil.strcmp("", AV43Procesarinv_GXI)==0))||!(GXutil.strcmp("", AV37ProcesarINV)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV37ProcesarINV)==0) ? AV43Procesarinv_GXI : httpContext.getResourceRelative(AV37ProcesarINV)) ;
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {edtavProcesarinv_Internalname,sImgUrl,"","","",context.getHttpContext().getTheme( ),Integer.valueOf(-1),Integer.valueOf(1),"",edtavProcesarinv_Tooltiptext,Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),"px",Integer.valueOf(0),"px",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(5),edtavProcesarinv_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVPROCESARINV.CLICK."+sGXsfl_40_idx+"'",StyleString,ClassString,"WWActionColumn","","","",""+TempTags,"","",Integer.valueOf(1),Boolean.valueOf(AV37ProcesarINV_IsBlob),Boolean.valueOf(false),context.getHttpContext().getImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
         ...
         /* Active Bitmap Variable */
         TempTags = " " + ((edtavInventariofinal_Enabled!=0)&&(edtavInventariofinal_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 45,'',false,'',40)\"" : " ") ;
         ClassString = "ActionBaseColorAttribute" + " " + ((GXutil.strcmp(edtavInventariofinal_gximage, "")==0) ? "" : "GX_Image_"+edtavInventariofinal_gximage+"_Class") ;
         StyleString = "" ;
         AV38InventarioFinal_IsBlob = (boolean)(((GXutil.strcmp("", AV38InventarioFinal)==0)&&(GXutil.strcmp("", AV44Inventariofinal_GXI)==0))||!(GXutil.strcmp("", AV38InventarioFinal)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV38InventarioFinal)==0) ? AV44Inventariofinal_GXI : httpContext.getResourceRelative(AV38InventarioFinal)) ;
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {edtavInventariofinal_Internalname,sImgUrl,"","","",context.getHttpContext().getTheme( ),Integer.valueOf(-1),Integer.valueOf(1),"",edtavInventariofinal_Tooltiptext,Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),"px",Integer.valueOf(0),"px",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(5),edtavInventariofinal_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVINVENTARIOFINAL.CLICK."+sGXsfl_40_idx+"'",StyleString,ClassString,"WWActionColumn","","","",""+TempTags,"","",Integer.valueOf(1),Boolean.valueOf(AV38InventarioFinal_IsBlob),Boolean.valueOf(false),context.getHttpContext().getImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioID_Internalname,GXutil.ltrim( localUtil.ntoc( A53InventarioID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A53InventarioID), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalle_Internalname,A258InventarioDetalle,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalle_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Detalle","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioNumeroProceso_Internalname,GXutil.ltrim( localUtil.ntoc( A265InventarioNumeroProceso, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A265InventarioNumeroProceso), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioNumeroProceso_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ActionBaseColorAttribute"+" "+((GXutil.strcmp(edtavProcesarinv_gximage, "")==0) ? "" : "GX_Image_"+edtavProcesarinv_gximage+"_Class")+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ActionBaseColorAttribute"+" "+((GXutil.strcmp(edtavInventariofinal_gximage, "")==0) ? "" : "GX_Image_"+edtavInventariofinal_gximage+"_Class")+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Inventario ID", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Inventario Fecha", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Inventario Detalle", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Numero Proceso", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", httpContext.convertURL( AV37ProcesarINV));
         GridColumn.AddObjectProperty("Tooltiptext", GXutil.rtrim( edtavProcesarinv_Tooltiptext));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", httpContext.convertURL( AV38InventarioFinal));
         GridColumn.AddObjectProperty("Tooltiptext", GXutil.rtrim( edtavInventariofinal_Tooltiptext));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A53InventarioID, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A257InventarioFecha, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A258InventarioDetalle);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A265InventarioNumeroProceso, (byte)(4), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void init_default_properties( )
   {
      ...
      edtavProcesarinv_Internalname = "vPROCESARINV" ;
      edtavInventariofinal_Internalname = "vINVENTARIOFINAL" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavInventariofinal_Jsonclick = "" ;
      edtavInventariofinal_gximage = "" ;
      edtavInventariofinal_Visible = -1 ;
      edtavInventariofinal_Enabled = 1 ;
      edtavInventariofinal_Tooltiptext = httpContext.getMessage( "InventarioFinal", "") ;
      edtavProcesarinv_Jsonclick = "" ;
      edtavProcesarinv_gximage = "" ;
      edtavProcesarinv_Visible = -1 ;
      edtavProcesarinv_Enabled = 1 ;
      edtavProcesarinv_Tooltiptext = httpContext.getMessage( "ProcesarINV", "") ;
      ...
      Ddo_grid_Columnids = "5:InventarioID|6:InventarioFecha|7:InventarioDetalle|8:InventarioNumeroProceso" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e121G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e131G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e151G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e191G2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A53InventarioID',fld:'INVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'AV37ProcesarINV',fld:'vPROCESARINV',pic:''},{av:'edtavProcesarinv_Tooltiptext',ctrl:'vPROCESARINV',prop:'Tooltiptext'},{av:'AV38InventarioFinal',fld:'vINVENTARIOFINAL',pic:''},{av:'edtavInventariofinal_Tooltiptext',ctrl:'vINVENTARIOFINAL',prop:'Tooltiptext'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e111G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("VPROCESARINV.CLICK","{handler:'e201G2',iparms:[{av:'A53InventarioID',fld:'INVENTARIOID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("VPROCESARINV.CLICK",",oparms:[{av:'A53InventarioID',fld:'INVENTARIOID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e161G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A53InventarioID',fld:'INVENTARIOID',pic:'ZZZZZZZZZZ9'}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e141G2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("VINVENTARIOFINAL.CLICK","{handler:'e211G2',iparms:[{av:'A53InventarioID',fld:'INVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("VINVENTARIOFINAL.CLICK",",oparms:[{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("NULL","{handler:'valid_Inventarionumeroproceso',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      AV43Procesarinv_GXI = "" ;
      AV38InventarioFinal = "" ;
      AV44Inventariofinal_GXI = "" ;
      A257InventarioFecha = GXutil.nullDate() ;
      A258InventarioDetalle = "" ;
      scmdbuf = "" ;
      lV42Inventariowwds_1_filterfulltext = "" ;
      AV42Inventariowwds_1_filterfulltext = "" ;
      H001G2_A265InventarioNumeroProceso = new short[1] ;
      H001G2_A258InventarioDetalle = new String[] {""} ;
      H001G2_A257InventarioFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H001G2_A53InventarioID = new long[1] ;
      ...
      GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item9 = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle);
      ...
      GXv_SdtWWPGridState11 = new com.mujermorena.wwpbaseobjects.SdtWWPGridState[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.inventarioww__default(),
         new Object[] {
             new Object[] {
            H001G2_A265InventarioNumeroProceso, H001G2_A258InventarioDetalle, H001G2_A257InventarioFecha, H001G2_A53InventarioID
            }
            , new Object[] {
   ...
   private int edtavProcesarinv_Enabled ;
   private int edtavProcesarinv_Visible ;
   private int edtavInventariofinal_Enabled ;
   private int edtavInventariofinal_Visible ;
   ...
   private String edtavProcesarinv_Internalname ;
   private String edtavInventariofinal_Internalname ;
   ...
   private String edtavProcesarinv_gximage ;
   private String edtavProcesarinv_Tooltiptext ;
   private String edtavInventariofinal_gximage ;
   private String edtavInventariofinal_Tooltiptext ;
   ...
   private String edtavProcesarinv_Jsonclick ;
   private String edtavInventariofinal_Jsonclick ;
   ...
   private boolean AV37ProcesarINV_IsBlob ;
   private boolean AV38InventarioFinal_IsBlob ;
   private String AV20ManageFiltersXml ;
   private String AV15FilterFullText ;
   private String AV26GridAppliedFilters ;
   private String AV43Procesarinv_GXI ;
   private String AV44Inventariofinal_GXI ;
   private String A258InventarioDetalle ;
   private String lV42Inventariowwds_1_filterfulltext ;
   private String AV42Inventariowwds_1_filterfulltext ;
   private String AV16ExcelFilename ;
   private String AV17ErrorMessage ;
   private String AV37ProcesarINV ;
   private String AV38InventarioFinal ;
   ...
   private short[] H001G2_A265InventarioNumeroProceso ;
   private String[] H001G2_A258InventarioDetalle ;
   private java.util.Date[] H001G2_A257InventarioFecha ;
   private long[] H001G2_A53InventarioID ;
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item9 ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item10[] ;
   ...
   private com.mujermorena.wwpbaseobjects.SdtWWPGridState GXv_SdtWWPGridState11[] ;
...
final  class inventarioww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001G2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV42Inventariowwds_1_filterfulltext ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [InventarioNumeroProceso], [InventarioDetalle], [InventarioFecha], [InventarioID]" ;
      sFromString = " FROM [Inventario]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV42Inventariowwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY [InventarioID]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [InventarioID] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [InventarioFecha]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [InventarioFecha] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [InventarioDetalle]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [InventarioDetalle] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [InventarioNumeroProceso]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [InventarioNumeroProceso] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [InventarioID]" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001G2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H001G3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
