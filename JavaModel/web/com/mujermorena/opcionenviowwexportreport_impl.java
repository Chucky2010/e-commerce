...
public final  class opcionenviowwexportreport_impl extends GXWebReport
{
   public opcionenviowwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "opcionenvioww_Execute", GXv_boolean2) ;
         opcionenviowwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Opcion Envio", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Envio Id", ""), 30, Gx_line+10, 281, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Envio Descripcion", ""), 285, Gx_line+10, 787, Gx_line+27, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Opcionenviowwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Opcionenviowwds_1_filterfulltext ,
      ...
      lV35Opcionenviowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Opcionenviowwds_1_filterfulltext), "%", "") ;
      lV35Opcionenviowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Opcionenviowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P006X2 */
      pr_default.execute(0, new Object[] {lV35Opcionenviowwds_1_filterfulltext, lV35Opcionenviowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A283OpcionEnvioId = P006X2_A283OpcionEnvioId[0] ;
         A284OpcionEnvioDescripcion = P006X2_A284OpcionEnvioDescripcion[0] ;
         ...
         h6X0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A283OpcionEnvioId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A284OpcionEnvioDescripcion, "")), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("OpcionEnvioWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "OpcionEnvioWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("OpcionEnvioWWGridState"), null, null);
      }
   ...
   public void h6X0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Opcionenviowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Opcionenviowwds_1_filterfulltext = "" ;
      P006X2_A283OpcionEnvioId = new long[1] ;
      P006X2_A284OpcionEnvioDescripcion = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.opcionenviowwexportreport__default(),
         new Object[] {
             new Object[] {
            P006X2_A283OpcionEnvioId, P006X2_A284OpcionEnvioDescripcion
            }
         }
      );
   ...
   private String AV35Opcionenviowwds_1_filterfulltext ;
   private String lV35Opcionenviowwds_1_filterfulltext ;
   ...
   private long[] P006X2_A283OpcionEnvioId ;
   private String[] P006X2_A284OpcionEnvioDescripcion ;
...
final  class opcionenviowwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P006X2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Opcionenviowwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Opcionenviowwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P006X2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P006X2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
