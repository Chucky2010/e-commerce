...
public final  class calificacionprompt_impl extends GXDataArea
{
   public calificacionprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public calificacionprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( calificacionprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutCalificacionId") ;
         ...
         {
            AV8InOutCalificacionId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCalificacionId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCalificacionId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutCalificacionNro = (short)(GXutil.lval( httpContext.GetPar( "InOutCalificacionNro"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutCalificacionNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutCalificacionNro), 4, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.calificacionprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCalificacionId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutCalificacionNro,4,0))}, new String[] {"InOutCalificacionId","InOutCalificacionNro"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCALIFICACIONID", GXutil.ltrim( localUtil.ntoc( AV8InOutCalificacionId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCALIFICACIONNRO", GXutil.ltrim( localUtil.ntoc( AV9InOutCalificacionNro, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.calificacionprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCalificacionId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutCalificacionNro,4,0))}, new String[] {"InOutCalificacionId","InOutCalificacionNro"})  ;
   }

   public String getPgmname( )
   {
      return "CalificacionPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Calificacion", "") ;
   }
   ...
   public void wb6Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_6Y2( true) ;
      }
      else
      {
         wb_table1_14_6Y2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_6Y2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start6Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Calificacion", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CALIFICACIONNRO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A299CalificacionNro), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "CALIFICACIONNRO", GXutil.ltrim( localUtil.ntoc( A299CalificacionNro, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "CalificacionPrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf6Y2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H006Y2 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A302CalificacionFechaHora = H006Y2_A302CalificacionFechaHora[0] ;
            A301CalificacionUsuario = H006Y2_A301CalificacionUsuario[0] ;
            A300CalificacionDesc = H006Y2_A300CalificacionDesc[0] ;
            A299CalificacionNro = H006Y2_A299CalificacionNro[0] ;
            A298CalificacionId = H006Y2_A298CalificacionId[0] ;
            e176Y2 ();
   ...
   public void send_integrity_lvl_hashes6Y2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CALIFICACIONID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A298CalificacionId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CALIFICACIONNRO"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A299CalificacionNro), "ZZZ9")));
   }
   ...
   public void e156Y2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Calificacion", "") );
   ...
   public void e166Y2( )
   {
      ...
      calificacionprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e186Y2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutCalificacionId = A298CalificacionId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCalificacionId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCalificacionId), 11, 0));
      AV9InOutCalificacionNro = A299CalificacionNro ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutCalificacionNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutCalificacionNro), 4, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutCalificacionId),Short.valueOf(AV9InOutCalificacionNro)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutCalificacionId","AV9InOutCalificacionNro"});
   ...
   public void wb_table1_14_6Y2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_CalificacionPrompt.htm");
   ...
   {
      AV8InOutCalificacionId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCalificacionId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCalificacionId), 11, 0));
      AV9InOutCalificacionNro = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutCalificacionNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutCalificacionNro), 4, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111231181", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("calificacionprompt.js", "?202412111231181", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtCalificacionId_Internalname = "CALIFICACIONID_"+sGXsfl_26_idx ;
      edtCalificacionNro_Internalname = "CALIFICACIONNRO_"+sGXsfl_26_idx ;
      edtCalificacionDesc_Internalname = "CALIFICACIONDESC_"+sGXsfl_26_idx ;
      edtCalificacionUsuario_Internalname = "CALIFICACIONUSUARIO_"+sGXsfl_26_idx ;
      edtCalificacionFechaHora_Internalname = "CALIFICACIONFECHAHORA_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtCalificacionId_Internalname = "CALIFICACIONID_"+sGXsfl_26_fel_idx ;
      edtCalificacionNro_Internalname = "CALIFICACIONNRO_"+sGXsfl_26_fel_idx ;
      edtCalificacionDesc_Internalname = "CALIFICACIONDESC_"+sGXsfl_26_fel_idx ;
      edtCalificacionUsuario_Internalname = "CALIFICACIONUSUARIO_"+sGXsfl_26_fel_idx ;
      edtCalificacionFechaHora_Internalname = "CALIFICACIONFECHAHORA_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:CalificacionId|2:CalificacionNro|3:CalificacionDesc|4:CalificacionUsuario|5:CalificacionFechaHora" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e176Y2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e186Y2',iparms:[{av:'A298CalificacionId',fld:'CALIFICACIONID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A299CalificacionNro',fld:'CALIFICACIONNRO',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCalificacionId',fld:'vINOUTCALIFICACIONID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutCalificacionNro',fld:'vINOUTCALIFICACIONNRO',pic:'ZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H006Y2_A302CalificacionFechaHora = new java.util.Date[] {GXutil.nullDate()} ;
      H006Y2_A301CalificacionUsuario = new String[] {""} ;
      H006Y2_A300CalificacionDesc = new String[] {""} ;
      H006Y2_A299CalificacionNro = new short[1] ;
      H006Y2_A298CalificacionId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.calificacionprompt__default(),
         new Object[] {
             new Object[] {
            H006Y2_A302CalificacionFechaHora, H006Y2_A301CalificacionUsuario, H006Y2_A300CalificacionDesc, H006Y2_A299CalificacionNro, H006Y2_A298CalificacionId
            }
            , new Object[] {
   ...
   private short wcpOAV9InOutCalificacionNro ;
   private short AV9InOutCalificacionNro ;
   ...
   private long wcpOAV8InOutCalificacionId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutCalificacionId ;
   ...
   private java.util.Date[] H006Y2_A302CalificacionFechaHora ;
   private String[] H006Y2_A301CalificacionUsuario ;
   private String[] H006Y2_A300CalificacionDesc ;
   private short[] H006Y2_A299CalificacionNro ;
   private long[] H006Y2_A298CalificacionId ;
...
final  class calificacionprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006Y2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H006Y3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A298CalificacionId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006Y2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H006Y3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006Y2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006Y3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
