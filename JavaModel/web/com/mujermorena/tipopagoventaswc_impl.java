...
public final  class tipopagoventaswc_impl extends GXWebComponent
{
   public tipopagoventaswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopagoventaswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopagoventaswc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "TipoPagoId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8TipoPagoId = GXutil.lval( httpContext.GetPar( "TipoPagoId")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoPagoId), 11, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(AV8TipoPagoId)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8TipoPagoId, AV20ManageFiltersExecutionStep, AV36Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Tipo Pago Ventas WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tipopagoventaswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8TipoPagoId,11,0))}, new String[] {"TipoPagoId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8TipoPagoId", GXutil.ltrim( localUtil.ntoc( wcpOAV8TipoPagoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( sPrefix, AV33IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTIPOPAGOID", GXutil.ltrim( localUtil.ntoc( AV8TipoPagoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseForm6U2( )
   {
   ...
   {
      return "TipoPagoVentasWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Pago Ventas WC", "") ;
   }
   ...
   public void wb6U0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.tipopagoventaswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_TipoPagoVentasWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_6U2( true) ;
      }
      else
      {
         wb_table1_21_6U2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_6U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6U2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Pago Ventas WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_VENTASID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A19VentasId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"VENTASID", GXutil.ltrim( localUtil.ntoc( A19VentasId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf6U2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A241VentasTotalIVA ,
                                              Long.valueOf(AV8TipoPagoId) ,
                                              Long.valueOf(A9TipoPagoId) } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL,
                                              TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL,
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H006U8 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8TipoPagoId), AV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A9TipoPagoId = H006U8_A9TipoPagoId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A9TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A9TipoPagoId), 11, 0));
            A237VentasTotalIva10 = H006U8_A237VentasTotalIva10[0] ;
            n237VentasTotalIva10 = H006U8_n237VentasTotalIva10[0] ;
            A235VentasTotalIva5 = H006U8_A235VentasTotalIva5[0] ;
            n235VentasTotalIva5 = H006U8_n235VentasTotalIva5[0] ;
            A251VentasPedido = H006U8_A251VentasPedido[0] ;
            A242VentasSerial = H006U8_A242VentasSerial[0] ;
            A4ClienteId = H006U8_A4ClienteId[0] ;
            A91VentasFecha = H006U8_A91VentasFecha[0] ;
            A19VentasId = H006U8_A19VentasId[0] ;
            A241VentasTotalIVA = H006U8_A241VentasTotalIVA[0] ;
            n241VentasTotalIVA = H006U8_n241VentasTotalIVA[0] ;
            A238VentasTotal10 = H006U8_A238VentasTotal10[0] ;
            n238VentasTotal10 = H006U8_n238VentasTotal10[0] ;
            A236VentasTotal5 = H006U8_A236VentasTotal5[0] ;
            n236VentasTotal5 = H006U8_n236VentasTotal5[0] ;
            A240VentasTotal = H006U8_A240VentasTotal[0] ;
            n240VentasTotal = H006U8_n240VentasTotal[0] ;
            A239VentasTotalExento = H006U8_A239VentasTotalExento[0] ;
            n239VentasTotalExento = H006U8_n239VentasTotalExento[0] ;
            A237VentasTotalIva10 = H006U8_A237VentasTotalIva10[0] ;
            n237VentasTotalIva10 = H006U8_n237VentasTotalIva10[0] ;
            A235VentasTotalIva5 = H006U8_A235VentasTotalIva5[0] ;
            n235VentasTotalIva5 = H006U8_n235VentasTotalIva5[0] ;
   ...
   public void send_integrity_lvl_hashes6U2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_INSERT", AV33IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( sPrefix, AV33IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_VENTASID"+"_"+sGXsfl_36_idx, getSecureSignedToken( sPrefix+sGXsfl_36_idx, localUtil.format( DecimalUtil.doubleToDec(A19VentasId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      pr_default.execute(1, new Object[] {Long.valueOf(AV8TipoPagoId), AV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      GRID_nRecordCount = H006U15_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup6U0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8TipoPagoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8TipoPagoId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e166U2( )
   {
      ...
      edtTipoPagoId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTipoPagoId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtTipoPagoId_Visible), 5, 0), true);
   ...
   public void e176U2( )
   {
      ...
      tipopagoventaswc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e116U2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPagoVentasWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV36Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPagoVentasWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "TipoPagoVentasWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         tipopagoventaswc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      tipopagoventaswc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "TipoPagoVentasWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Ventas" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "TipoPagoId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8TipoPagoId, 11, 0) );
   ...
   public void wb_table1_21_6U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_6U2( true) ;
      }
      else
      {
         wb_table2_26_6U2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_6U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_6U2e( true) ;
      }
      else
      {
         wb_table1_21_6U2e( false) ;
      }
   }

   public void wb_table2_26_6U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8TipoPagoId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoPagoId), 11, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8TipoPagoId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "tipopagoventaswc", GetJustCreated( ));
      ...
      {
         AV8TipoPagoId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoPagoId), 11, 0));
      }
      wcpOAV8TipoPagoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8TipoPagoId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( AV8TipoPagoId != wcpOAV8TipoPagoId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8TipoPagoId = AV8TipoPagoId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8TipoPagoId = httpContext.cgiGet( sPrefix+"AV8TipoPagoId_CTRL") ;
      if ( GXutil.len( sCtrlAV8TipoPagoId) > 0 )
      {
         AV8TipoPagoId = localUtil.ctol( httpContext.cgiGet( sCtrlAV8TipoPagoId), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoPagoId), 11, 0));
      }
      else
      {
         AV8TipoPagoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8TipoPagoId_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8TipoPagoId_PARM", GXutil.ltrim( localUtil.ntoc( AV8TipoPagoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8TipoPagoId)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8TipoPagoId_CTRL", GXutil.rtrim( sCtrlAV8TipoPagoId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111103589", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("tipopagoventaswc.js", "?202412111103589", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtVentasId_Internalname = sPrefix+"VENTASID_"+sGXsfl_36_idx ;
      edtVentasFecha_Internalname = sPrefix+"VENTASFECHA_"+sGXsfl_36_idx ;
      edtClienteId_Internalname = sPrefix+"CLIENTEID_"+sGXsfl_36_idx ;
      edtVentasSerial_Internalname = sPrefix+"VENTASSERIAL_"+sGXsfl_36_idx ;
      edtVentasPedido_Internalname = sPrefix+"VENTASPEDIDO_"+sGXsfl_36_idx ;
      edtVentasTotalExento_Internalname = sPrefix+"VENTASTOTALEXENTO_"+sGXsfl_36_idx ;
      edtVentasTotal5_Internalname = sPrefix+"VENTASTOTAL5_"+sGXsfl_36_idx ;
      edtVentasTotal10_Internalname = sPrefix+"VENTASTOTAL10_"+sGXsfl_36_idx ;
      edtVentasTotal_Internalname = sPrefix+"VENTASTOTAL_"+sGXsfl_36_idx ;
      edtVentasTotalIva5_Internalname = sPrefix+"VENTASTOTALIVA5_"+sGXsfl_36_idx ;
      edtVentasTotalIva10_Internalname = sPrefix+"VENTASTOTALIVA10_"+sGXsfl_36_idx ;
      edtVentasTotalIVA_Internalname = sPrefix+"VENTASTOTALIVA_"+sGXsfl_36_idx ;
   }
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtVentasId_Internalname = sPrefix+"VENTASID_"+sGXsfl_36_fel_idx ;
      edtVentasFecha_Internalname = sPrefix+"VENTASFECHA_"+sGXsfl_36_fel_idx ;
      edtClienteId_Internalname = sPrefix+"CLIENTEID_"+sGXsfl_36_fel_idx ;
      edtVentasSerial_Internalname = sPrefix+"VENTASSERIAL_"+sGXsfl_36_fel_idx ;
      edtVentasPedido_Internalname = sPrefix+"VENTASPEDIDO_"+sGXsfl_36_fel_idx ;
      edtVentasTotalExento_Internalname = sPrefix+"VENTASTOTALEXENTO_"+sGXsfl_36_fel_idx ;
      edtVentasTotal5_Internalname = sPrefix+"VENTASTOTAL5_"+sGXsfl_36_fel_idx ;
      edtVentasTotal10_Internalname = sPrefix+"VENTASTOTAL10_"+sGXsfl_36_fel_idx ;
      edtVentasTotal_Internalname = sPrefix+"VENTASTOTAL_"+sGXsfl_36_fel_idx ;
      edtVentasTotalIva5_Internalname = sPrefix+"VENTASTOTALIVA5_"+sGXsfl_36_fel_idx ;
      edtVentasTotalIva10_Internalname = sPrefix+"VENTASTOTALIVA10_"+sGXsfl_36_fel_idx ;
      edtVentasTotalIVA_Internalname = sPrefix+"VENTASTOTALIVA_"+sGXsfl_36_fel_idx ;
   }
   ...
   public void sendrow_362( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_36_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasSerial_Internalname,GXutil.ltrim( localUtil.ntoc( A242VentasSerial, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A242VentasSerial), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasSerial_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Serial","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotalExento_Internalname,GXutil.ltrim( localUtil.ntoc( A239VentasTotalExento, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A239VentasTotalExento, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotalExento_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotal5_Internalname,GXutil.ltrim( localUtil.ntoc( A236VentasTotal5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A236VentasTotal5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotal5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotal10_Internalname,GXutil.ltrim( localUtil.ntoc( A238VentasTotal10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A238VentasTotal10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotal10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A240VentasTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A240VentasTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotalIva5_Internalname,GXutil.ltrim( localUtil.ntoc( A235VentasTotalIva5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A235VentasTotalIva5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotalIva5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotalIva10_Internalname,GXutil.ltrim( localUtil.ntoc( A237VentasTotalIva10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A237VentasTotalIva10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotalIva10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasTotalIVA_Internalname,GXutil.ltrim( localUtil.ntoc( A241VentasTotalIVA, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A241VentasTotalIVA, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasTotalIVA_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:VentasId|4:VentasFecha|5:ClienteId|6:VentasSerial|7:VentasPedido" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e186U2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A19VentasId',fld:'VENTASID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e156U2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TipoPagoId',fld:'vTIPOPAGOID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV36Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A19VentasId',fld:'VENTASID',pic:'ZZZZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H006U8_A9TipoPagoId = new long[1] ;
      H006U8_A237VentasTotalIva10 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n237VentasTotalIva10 = new boolean[] {false} ;
      H006U8_A235VentasTotalIva5 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n235VentasTotalIva5 = new boolean[] {false} ;
      H006U8_A251VentasPedido = new long[1] ;
      H006U8_A242VentasSerial = new long[1] ;
      H006U8_A4ClienteId = new long[1] ;
      H006U8_A91VentasFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006U8_A19VentasId = new long[1] ;
      H006U8_A241VentasTotalIVA = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n241VentasTotalIVA = new boolean[] {false} ;
      H006U8_A238VentasTotal10 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n238VentasTotal10 = new boolean[] {false} ;
      H006U8_A236VentasTotal5 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n236VentasTotal5 = new boolean[] {false} ;
      H006U8_A240VentasTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n240VentasTotal = new boolean[] {false} ;
      H006U8_A239VentasTotalExento = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006U8_n239VentasTotalExento = new boolean[] {false} ;
      H006U15_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopagoventaswc__default(),
         new Object[] {
             new Object[] {
            H006U8_A9TipoPagoId, H006U8_A237VentasTotalIva10, H006U8_n237VentasTotalIva10, H006U8_A235VentasTotalIva5, H006U8_n235VentasTotalIva5, H006U8_A251VentasPedido, H006U8_A242VentasSerial, H006U8_A4ClienteId, H006U8_A91VentasFecha, H006U8_A19VentasId,
            H006U8_A241VentasTotalIVA, H006U8_n241VentasTotalIVA, H006U8_A238VentasTotal10, H006U8_n238VentasTotal10, H006U8_A236VentasTotal5, H006U8_n236VentasTotal5, H006U8_A240VentasTotal, H006U8_n240VentasTotal, H006U8_A239VentasTotalExento
            }
            , new Object[] {
            H006U15_AGRID_nRecordCount
            }
         }
      );
      AV36Pgmname = "TipoPagoVentasWC" ;
   ...
   private int edtTipoPagoId_Visible ;
   ...
   private long wcpOAV8TipoPagoId ;
   ...
   private String sCtrlAV8TipoPagoId ;
   ...
   private long[] H006U8_A9TipoPagoId ;
   private java.math.BigDecimal[] H006U8_A237VentasTotalIva10 ;
   private boolean[] H006U8_n237VentasTotalIva10 ;
   private java.math.BigDecimal[] H006U8_A235VentasTotalIva5 ;
   private boolean[] H006U8_n235VentasTotalIva5 ;
   private long[] H006U8_A251VentasPedido ;
   private long[] H006U8_A242VentasSerial ;
   private long[] H006U8_A4ClienteId ;
   private java.util.Date[] H006U8_A91VentasFecha ;
   private long[] H006U8_A19VentasId ;
   private java.math.BigDecimal[] H006U8_A241VentasTotalIVA ;
   private boolean[] H006U8_n241VentasTotalIVA ;
   private java.math.BigDecimal[] H006U8_A238VentasTotal10 ;
   private boolean[] H006U8_n238VentasTotal10 ;
   private java.math.BigDecimal[] H006U8_A236VentasTotal5 ;
   private boolean[] H006U8_n236VentasTotal5 ;
   private java.math.BigDecimal[] H006U8_A240VentasTotal ;
   private boolean[] H006U8_n240VentasTotal ;
   private java.math.BigDecimal[] H006U8_A239VentasTotalExento ;
   private boolean[] H006U8_n239VentasTotalExento ;
   private long[] H006U15_AGRID_nRecordCount ;
...
final  class tipopagoventaswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006U8( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A9TipoPagoId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[TipoPagoId], ROUND(CAST(COALESCE( T2.[VentasTotal10], 0) AS decimal( 27, 10)) / 11, 0) AS VentasTotalIva10, ROUND(CAST(COALESCE( T3.[VentasTotal5], 0) AS decimal(" ;
      sSelectString += " 27, 10)) / 21, 0) AS VentasTotalIva5, T1.[VentasPedido], T1.[VentasSerial], T1.[ClienteId], T1.[VentasFecha], T1.[VentasId], COALESCE( T4.[VentasTotalIVA], 0) AS" ;
      sSelectString += " VentasTotalIVA, COALESCE( T3.[VentasTotal10], 0) AS VentasTotal10, COALESCE( T3.[VentasTotal5], 0) AS VentasTotal5, COALESCE( T4.[VentasTotal], 0) AS VentasTotal," ;
      sSelectString += " COALESCE( T3.[VentasTotalExento], 0) AS VentasTotalExento" ;
      sFromString = " FROM ((([Ventas] T1 LEFT JOIN (SELECT SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10 THEN T5.[VentasDetalleCantidad] * CAST(T6.[ArticuloPrecioVenta] AS decimal( 27," ;
      sFromString += " 10)) END) AS VentasTotal10, T5.[VentasId] FROM (([VentasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) INNER JOIN [Impuesto] T7 ON T7.[ImpuestoId]" ;
      sFromString += " = T6.[ImpuestoId]) GROUP BY T5.[VentasId] ) T2 ON T2.[VentasId] = T1.[VentasId]) LEFT JOIN (SELECT T5.[VentasId], SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10 THEN" ;
      sFromString += " T5.[VentasDetalleCantidad] * CAST(T6.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal10, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 5 THEN T5.[VentasDetalleCantidad]" ;
      sFromString += " * CAST(T6.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal5, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 0 THEN T5.[VentasDetalleCantidad] * CAST(T6.[ArticuloPrecioVenta]" ;
      sFromString += " AS decimal( 27, 10)) END) AS VentasTotalExento FROM (([VentasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) INNER JOIN [Impuesto] T7" ;
      sFromString += " ON T7.[ImpuestoId] = T6.[ImpuestoId]) GROUP BY T5.[VentasId] ) T3 ON T3.[VentasId] = T1.[VentasId]) INNER JOIN (SELECT COALESCE( T6.[VentasTotalExento], 0) + COALESCE(" ;
      sFromString += " COALESCE( T7.[VentasTotal5], 0), 0) + COALESCE( COALESCE( T8.[VentasTotal10], 0), 0) AS VentasTotal, T5.[VentasId], ROUND(CAST(( ( COALESCE( T7.[VentasTotal5]," ;
      sFromString += " 0))) AS decimal( 27, 10)) / 21, 0) + ROUND(CAST(( ( COALESCE( T8.[VentasTotal10], 0))) AS decimal( 27, 10)) / 11, 0) AS VentasTotalIVA FROM ((([Ventas] T5 LEFT" ;
      sFromString += " JOIN (SELECT SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 0 THEN T9.[VentasDetalleCantidad] * CAST(T10.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotalExento," ;
      sFromString += " T9.[VentasId] FROM (([VentasDetalle] T9 INNER JOIN [Articulo] T10 ON T10.[ArticuloId] = T9.[ArticuloId]) INNER JOIN [Impuesto] T11 ON T11.[ImpuestoId] = T10.[ImpuestoId])" ;
      sFromString += " GROUP BY T9.[VentasId] ) T6 ON T6.[VentasId] = T5.[VentasId]) LEFT JOIN (SELECT T9.[VentasId], SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 10 THEN T9.[VentasDetalleCantidad]" ;
      sFromString += " * CAST(T10.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal10, SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 5 THEN T9.[VentasDetalleCantidad] * CAST(T10.[ArticuloPrecioVenta]" ;
      sFromString += " AS decimal( 27, 10)) END) AS VentasTotal5, SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 0 THEN T9.[VentasDetalleCantidad] * CAST(T10.[ArticuloPrecioVenta] AS decimal(" ;
      sFromString += " 27, 10)) END) AS VentasTotalExento FROM (([VentasDetalle] T9 INNER JOIN [Articulo] T10 ON T10.[ArticuloId] = T9.[ArticuloId]) INNER JOIN [Impuesto] T11 ON T11.[ImpuestoId]" ;
      sFromString += " = T10.[ImpuestoId]) GROUP BY T9.[VentasId] ) T7 ON T7.[VentasId] = T5.[VentasId]) LEFT JOIN (SELECT SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 10 THEN T9.[VentasDetalleCantidad]" ;
      sFromString += " * CAST(T10.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal10, T9.[VentasId] FROM (([VentasDetalle] T9 INNER JOIN [Articulo] T10 ON T10.[ArticuloId]" ;
      sFromString += " = T9.[ArticuloId]) INNER JOIN [Impuesto] T11 ON T11.[ImpuestoId] = T10.[ImpuestoId]) GROUP BY T9.[VentasId] ) T8 ON T8.[VentasId] = T5.[VentasId]) ) T4 ON T4.[VentasId]" ;
      sFromString += " = T1.[VentasId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[TipoPagoId] = ?)");
      addWhere(sWhereString, "((? = '') or ( ( CONVERT( char(11), CAST(T1.[VentasId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ClienteId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[VentasSerial] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[VentasPedido] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[VentasTotalExento], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[VentasTotal5], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[VentasTotal10], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[VentasTotal], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(ROUND(CAST(COALESCE( T3.[VentasTotal5], 0) AS decimal( 27, 10)) / 21, 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(ROUND(CAST(COALESCE( T2.[VentasTotal10], 0) AS decimal( 27, 10)) / 11, 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[VentasTotalIVA], 0) AS decimal(17,2))) like '%' + ?)))");
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId], T1.[VentasId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId] DESC, T1.[VentasId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId], T1.[VentasFecha]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId] DESC, T1.[VentasFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId], T1.[ClienteId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId] DESC, T1.[ClienteId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId], T1.[VentasSerial]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId] DESC, T1.[VentasSerial] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId], T1.[VentasPedido]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoPagoId] DESC, T1.[VentasPedido] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H006U15( ModelContext context ,
                                           int remoteHandle ,
                                           com.genexus.IHttpContext httpContext ,
                                           short AV14OrderedBy ,
                                           boolean AV15OrderedDsc ,
                                           ...
                                           long A9TipoPagoId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ((([Ventas] T1 LEFT JOIN (SELECT SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10 THEN T5.[VentasDetalleCantidad] * CAST(T6.[ArticuloPrecioVenta]" ;
      scmdbuf += " AS decimal( 27, 10)) END) AS VentasTotal10, T5.[VentasId] FROM (([VentasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) INNER JOIN [Impuesto]" ;
      scmdbuf += " T7 ON T7.[ImpuestoId] = T6.[ImpuestoId]) GROUP BY T5.[VentasId] ) T2 ON T2.[VentasId] = T1.[VentasId]) LEFT JOIN (SELECT T5.[VentasId], SUM(CASE  WHEN T7.[ImpuestoPorcentaje]" ;
      scmdbuf += " = 10 THEN T5.[VentasDetalleCantidad] * CAST(T6.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal10, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 5 THEN" ;
      scmdbuf += " T5.[VentasDetalleCantidad] * CAST(T6.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal5, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 0 THEN T5.[VentasDetalleCantidad]" ;
      scmdbuf += " * CAST(T6.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotalExento FROM (([VentasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId])" ;
      scmdbuf += " INNER JOIN [Impuesto] T7 ON T7.[ImpuestoId] = T6.[ImpuestoId]) GROUP BY T5.[VentasId] ) T3 ON T3.[VentasId] = T1.[VentasId]) INNER JOIN (SELECT COALESCE( T6.[VentasTotalExento]," ;
      scmdbuf += " 0) + COALESCE( COALESCE( T7.[VentasTotal5], 0), 0) + COALESCE( COALESCE( T8.[VentasTotal10], 0), 0) AS VentasTotal, T5.[VentasId], ROUND(CAST(( ( COALESCE( T7.[VentasTotal5]," ;
      scmdbuf += " 0))) AS decimal( 27, 10)) / 21, 0) + ROUND(CAST(( ( COALESCE( T8.[VentasTotal10], 0))) AS decimal( 27, 10)) / 11, 0) AS VentasTotalIVA FROM ((([Ventas] T5 LEFT" ;
      scmdbuf += " JOIN (SELECT SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 0 THEN T9.[VentasDetalleCantidad] * CAST(T10.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotalExento," ;
      scmdbuf += " T9.[VentasId] FROM (([VentasDetalle] T9 INNER JOIN [Articulo] T10 ON T10.[ArticuloId] = T9.[ArticuloId]) INNER JOIN [Impuesto] T11 ON T11.[ImpuestoId] = T10.[ImpuestoId])" ;
      scmdbuf += " GROUP BY T9.[VentasId] ) T6 ON T6.[VentasId] = T5.[VentasId]) LEFT JOIN (SELECT T9.[VentasId], SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 10 THEN T9.[VentasDetalleCantidad]" ;
      scmdbuf += " * CAST(T10.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal10, SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 5 THEN T9.[VentasDetalleCantidad] * CAST(T10.[ArticuloPrecioVenta]" ;
      scmdbuf += " AS decimal( 27, 10)) END) AS VentasTotal5, SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 0 THEN T9.[VentasDetalleCantidad] * CAST(T10.[ArticuloPrecioVenta] AS decimal(" ;
      scmdbuf += " 27, 10)) END) AS VentasTotalExento FROM (([VentasDetalle] T9 INNER JOIN [Articulo] T10 ON T10.[ArticuloId] = T9.[ArticuloId]) INNER JOIN [Impuesto] T11 ON T11.[ImpuestoId]" ;
      scmdbuf += " = T10.[ImpuestoId]) GROUP BY T9.[VentasId] ) T7 ON T7.[VentasId] = T5.[VentasId]) LEFT JOIN (SELECT SUM(CASE  WHEN T11.[ImpuestoPorcentaje] = 10 THEN T9.[VentasDetalleCantidad]" ;
      scmdbuf += " * CAST(T10.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS VentasTotal10, T9.[VentasId] FROM (([VentasDetalle] T9 INNER JOIN [Articulo] T10 ON T10.[ArticuloId]" ;
      scmdbuf += " = T9.[ArticuloId]) INNER JOIN [Impuesto] T11 ON T11.[ImpuestoId] = T10.[ImpuestoId]) GROUP BY T9.[VentasId] ) T8 ON T8.[VentasId] = T5.[VentasId]) ) T4 ON T4.[VentasId]" ;
      scmdbuf += " = T1.[VentasId])" ;
      addWhere(sWhereString, "(T1.[TipoPagoId] = ?)");
      addWhere(sWhereString, "((? = '') or ( ( CONVERT( char(11), CAST(T1.[VentasId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ClienteId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[VentasSerial] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[VentasPedido] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[VentasTotalExento], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[VentasTotal5], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[VentasTotal10], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[VentasTotal], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(ROUND(CAST(COALESCE( T3.[VentasTotal5], 0) AS decimal( 27, 10)) / 21, 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(ROUND(CAST(COALESCE( T2.[VentasTotal10], 0) AS decimal( 27, 10)) / 11, 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[VentasTotalIVA], 0) AS decimal(17,2))) like '%' + ?)))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006U8(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , (java.math.BigDecimal)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , (java.math.BigDecimal)dynConstraints[11] , (java.math.BigDecimal)dynConstraints[12] , (java.math.BigDecimal)dynConstraints[13] , ((Number) dynConstraints[14]).longValue() , ((Number) dynConstraints[15]).longValue() );
            case 1 :
                  return conditional_H006U15(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , (java.math.BigDecimal)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , (java.math.BigDecimal)dynConstraints[11] , (java.math.BigDecimal)dynConstraints[12] , (java.math.BigDecimal)dynConstraints[13] , ((Number) dynConstraints[14]).longValue() , ((Number) dynConstraints[15]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006U8", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006U15", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
