...
public final  class devicesprompt_impl extends GXDataArea
{
   public devicesprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devicesprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devicesprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutDeviceType") ;
         ...
         {
            AV8InOutDeviceType = (byte)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDeviceType", GXutil.str( AV8InOutDeviceType, 1, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutDeviceId = httpContext.GetPar( "InOutDeviceId") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDeviceId", AV9InOutDeviceId);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.devicesprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutDeviceType,1,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutDeviceId))}, new String[] {"InOutDeviceType","InOutDeviceId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTDEVICETYPE", GXutil.ltrim( localUtil.ntoc( AV8InOutDeviceType, (byte)(1), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTDEVICEID", GXutil.rtrim( AV9InOutDeviceId));
   ...
   {
      return formatLink("com.mujermorena.devicesprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutDeviceType,1,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutDeviceId))}, new String[] {"InOutDeviceType","InOutDeviceId"})  ;
   }

   public String getPgmname( )
   {
      return "DevicesPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Devices", "") ;
   }
   ...
   public void wb_table1_14_0W2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Devices", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public int subgridclient_rec_count_fnc( )
   {
      ...
      {
         A270DeviceName = H000W2_A270DeviceName[0] ;
         A269DeviceToken = H000W2_A269DeviceToken[0] ;
         A16DeviceId = H000W2_A16DeviceId[0] ;
         A15DeviceType = H000W2_A15DeviceType[0] ;
         if ( (GXutil.strcmp("", AV13FilterFullText)==0) || ( ( GXutil.like( httpContext.getMessage( "ios", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 0 ) ) || ( GXutil.like( httpContext.getMessage( "android", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 1 ) ) || ( GXutil.like( httpContext.getMessage( "blackberry", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 2 ) ) || ( GXutil.like( httpContext.getMessage( "windows", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 3 ) ) || ( GXutil.like( A16DeviceId , GXutil.padr( "%" + AV13FilterFullText , 128 , "%"),  ' ' ) ) || ( GXutil.like( A269DeviceToken , GXutil.padr( "%" + AV13FilterFullText , 1000 , "%"),  ' ' ) ) || ( GXutil.like( A270DeviceName , GXutil.padr( "%" + AV13FilterFullText , 128 , "%"),  ' ' ) ) ) )
         {
   ...
   public void rf0W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A270DeviceName = H000W3_A270DeviceName[0] ;
            A269DeviceToken = H000W3_A269DeviceToken[0] ;
            A16DeviceId = H000W3_A16DeviceId[0] ;
            A15DeviceType = H000W3_A15DeviceType[0] ;
            if ( (GXutil.strcmp("", AV13FilterFullText)==0) || ( ( GXutil.like( httpContext.getMessage( "ios", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 0 ) ) || ( GXutil.like( httpContext.getMessage( "android", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 1 ) ) || ( GXutil.like( httpContext.getMessage( "blackberry", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 2 ) ) || ( GXutil.like( httpContext.getMessage( "windows", "") , GXutil.padr( "%" + GXutil.lower( AV13FilterFullText) , 255 , "%"),  ' ' ) && ( A15DeviceType == 3 ) ) || ( GXutil.like( A16DeviceId , GXutil.padr( "%" + AV13FilterFullText , 128 , "%"),  ' ' ) ) || ( GXutil.like( A269DeviceToken , GXutil.padr( "%" + AV13FilterFullText , 1000 , "%"),  ' ' ) ) || ( GXutil.like( A270DeviceName , GXutil.padr( "%" + AV13FilterFullText , 128 , "%"),  ' ' ) ) ) )
            {
               e170W2 ();
            }
   ...
   public void send_integrity_lvl_hashes0W2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVICETYPE"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A15DeviceType), "9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVICEID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A16DeviceId, ""))));
   }
   ...
   public void e150W2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Devices", "") );
   ...
   public void e160W2( )
   {
      ...
      devicesprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e180W2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutDeviceType = A15DeviceType ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDeviceType", GXutil.str( AV8InOutDeviceType, 1, 0));
      AV9InOutDeviceId = A16DeviceId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDeviceId", AV9InOutDeviceId);
      httpContext.setWebReturnParms(new Object[] {Byte.valueOf(AV8InOutDeviceType),AV9InOutDeviceId});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutDeviceType","AV9InOutDeviceId"});
   ...
   public void wb_table1_14_0W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_DevicesPrompt.htm");
   ...
   {
      AV8InOutDeviceType = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.BYTE)).byteValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDeviceType", GXutil.str( AV8InOutDeviceType, 1, 0));
      AV9InOutDeviceId = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDeviceId", AV9InOutDeviceId);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111123181", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("devicesprompt.js", "?202412111123181", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtDeviceToken_Internalname = "DEVICETOKEN_"+sGXsfl_26_idx ;
      edtDeviceName_Internalname = "DEVICENAME_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtDeviceToken_Internalname = "DEVICETOKEN_"+sGXsfl_26_fel_idx ;
      edtDeviceName_Internalname = "DEVICENAME_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:DeviceType|2:DeviceId|3:DeviceToken|4:DeviceName" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e170W2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e180W2',iparms:[{av:'cmbDeviceType'},{av:'A15DeviceType',fld:'DEVICETYPE',pic:'9',hsh:true},{av:'A16DeviceId',fld:'DEVICEID',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutDeviceType',fld:'vINOUTDEVICETYPE',pic:'9'},{av:'AV9InOutDeviceId',fld:'vINOUTDEVICEID',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e140W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H000W2_A270DeviceName = new String[] {""} ;
      H000W2_A269DeviceToken = new String[] {""} ;
      H000W2_A16DeviceId = new String[] {""} ;
      H000W2_A15DeviceType = new byte[1] ;
      H000W3_A270DeviceName = new String[] {""} ;
      H000W3_A269DeviceToken = new String[] {""} ;
      H000W3_A16DeviceId = new String[] {""} ;
      H000W3_A15DeviceType = new byte[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devicesprompt__default(),
         new Object[] {
             new Object[] {
            H000W2_A270DeviceName, H000W2_A269DeviceToken, H000W2_A16DeviceId, H000W2_A15DeviceType
            }
            , new Object[] {
            H000W3_A270DeviceName, H000W3_A269DeviceToken, H000W3_A16DeviceId, H000W3_A15DeviceType
            }
         }
      );
      AV22Pgmname = "DevicesPrompt" ;
   ...
   private byte wcpOAV8InOutDeviceType ;
   private byte GRID_nEOF ;
   private byte nGotPars ;
   private byte GxWebError ;
   private byte AV8InOutDeviceType ;
   ...
   private String wcpOAV9InOutDeviceId ;
   private String Gridpaginationbar_Selectedpage ;
   private String Ddo_grid_Activeeventkey ;
   private String Ddo_grid_Selectedvalue_get ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV9InOutDeviceId ;
   ...
   private String[] H000W2_A270DeviceName ;
   private String[] H000W2_A269DeviceToken ;
   private String[] H000W2_A16DeviceId ;
   private byte[] H000W2_A15DeviceType ;
   private String[] H000W3_A270DeviceName ;
   private String[] H000W3_A269DeviceToken ;
   private String[] H000W3_A16DeviceId ;
   private byte[] H000W3_A15DeviceType ;
...
final  class devicesprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000W2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).byteValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] );
            case 1 :
                  return conditional_H000W3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).byteValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000W2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000W3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
      };
   }
