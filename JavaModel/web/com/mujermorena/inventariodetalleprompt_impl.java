...
public final  class inventariodetalleprompt_impl extends GXDataArea
{
   public inventariodetalleprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public inventariodetalleprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( inventariodetalleprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InInventarioID") ;
         ...
         {
            AV8InInventarioID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InInventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InInventarioID), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutInventarioDetalleID = GXutil.lval( httpContext.GetPar( "InOutInventarioDetalleID")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutInventarioDetalleID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutInventarioDetalleID), 11, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV8InInventarioID = GXutil.lval( httpContext.GetPar( "InInventarioID")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InInventarioID, AV22Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.inventariodetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InInventarioID,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutInventarioDetalleID,11,0))}, new String[] {"InInventarioID","InOutInventarioDetalleID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vININVENTARIOID", GXutil.ltrim( localUtil.ntoc( AV8InInventarioID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTINVENTARIODETALLEID", GXutil.ltrim( localUtil.ntoc( AV9InOutInventarioDetalleID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.inventariodetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InInventarioID,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutInventarioDetalleID,11,0))}, new String[] {"InInventarioID","InOutInventarioDetalleID"})  ;
   }

   public String getPgmname( )
   {
      return "InventarioDetallePrompt" ;
   }
   ...
   public void wb5X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_5X2( true) ;
      }
      else
      {
         wb_table1_14_5X2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_5X2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_INVENTARIODETALLEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A54InventarioDetalleID), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "INVENTARIODETALLEID", GXutil.ltrim( localUtil.ntoc( A54InventarioDetalleID, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "InventarioDetallePrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf5X2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV13FilterFullText ,
                                              Long.valueOf(A54InventarioDetalleID) ,
                                              Long.valueOf(A13ArticuloId) ,
                                              A76ArticuloNombre ,
                                              Long.valueOf(A79ArticuloStock) ,
                                              Long.valueOf(A259InventarioDetalleStock) ,
                                              Long.valueOf(A262InventarioDetalleStock2) ,
                                              Long.valueOf(A263InventarioDetalleStock3) ,
                                              Long.valueOf(A264InventarioDetalleStock4) ,
                                              Long.valueOf(A261InventarioDetalleStockOk) ,
                                              Short.valueOf(AV11OrderedBy) ,
                                              Boolean.valueOf(AV12OrderedDsc) ,
                                              Long.valueOf(AV8InInventarioID) ,
                                              Long.valueOf(A53InventarioID) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG,
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H005X2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InInventarioID), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A53InventarioID = H005X2_A53InventarioID[0] ;
            A264InventarioDetalleStock4 = H005X2_A264InventarioDetalleStock4[0] ;
            A263InventarioDetalleStock3 = H005X2_A263InventarioDetalleStock3[0] ;
            A262InventarioDetalleStock2 = H005X2_A262InventarioDetalleStock2[0] ;
            A259InventarioDetalleStock = H005X2_A259InventarioDetalleStock[0] ;
            A76ArticuloNombre = H005X2_A76ArticuloNombre[0] ;
            A13ArticuloId = H005X2_A13ArticuloId[0] ;
            A54InventarioDetalleID = H005X2_A54InventarioDetalleID[0] ;
            A79ArticuloStock = H005X2_A79ArticuloStock[0] ;
            A261InventarioDetalleStockOk = H005X2_A261InventarioDetalleStockOk[0] ;
            A76ArticuloNombre = H005X2_A76ArticuloNombre[0] ;
            A79ArticuloStock = H005X2_A79ArticuloStock[0] ;
   ...
   public void send_integrity_lvl_hashes5X2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_INVENTARIODETALLEID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A54InventarioDetalleID), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H005X3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InInventarioID), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e165X2( )
   {
      ...
      inventariodetalleprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e185X2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutInventarioDetalleID = A54InventarioDetalleID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutInventarioDetalleID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutInventarioDetalleID), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV9InOutInventarioDetalleID)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutInventarioDetalleID"});
   ...
   public void wb_table1_14_5X2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_InventarioDetallePrompt.htm");
   ...
   {
      AV8InInventarioID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InInventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InInventarioID), 11, 0));
      AV9InOutInventarioDetalleID = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutInventarioDetalleID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutInventarioDetalleID), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224913", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("inventariodetalleprompt.js", "?202412111224913", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtInventarioDetalleID_Internalname = "INVENTARIODETALLEID_"+sGXsfl_26_idx ;
      ...
      edtInventarioDetalleStock_Internalname = "INVENTARIODETALLESTOCK_"+sGXsfl_26_idx ;
      edtInventarioDetalleStock2_Internalname = "INVENTARIODETALLESTOCK2_"+sGXsfl_26_idx ;
      edtInventarioDetalleStock3_Internalname = "INVENTARIODETALLESTOCK3_"+sGXsfl_26_idx ;
      edtInventarioDetalleStock4_Internalname = "INVENTARIODETALLESTOCK4_"+sGXsfl_26_idx ;
      edtInventarioDetalleStockOk_Internalname = "INVENTARIODETALLESTOCKOK_"+sGXsfl_26_idx ;
      edtInventarioDetalleDiferencia_Internalname = "INVENTARIODETALLEDIFERENCIA_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalleID_Internalname = "INVENTARIODETALLEID_"+sGXsfl_26_fel_idx ;
      ...
      edtInventarioDetalleStock_Internalname = "INVENTARIODETALLESTOCK_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalleStock2_Internalname = "INVENTARIODETALLESTOCK2_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalleStock3_Internalname = "INVENTARIODETALLESTOCK3_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalleStock4_Internalname = "INVENTARIODETALLESTOCK4_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalleStockOk_Internalname = "INVENTARIODETALLESTOCKOK_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalleDiferencia_Internalname = "INVENTARIODETALLEDIFERENCIA_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStock_Internalname,GXutil.ltrim( localUtil.ntoc( A259InventarioDetalleStock, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A259InventarioDetalleStock), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStock_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStock2_Internalname,GXutil.ltrim( localUtil.ntoc( A262InventarioDetalleStock2, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A262InventarioDetalleStock2), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStock2_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStock3_Internalname,GXutil.ltrim( localUtil.ntoc( A263InventarioDetalleStock3, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A263InventarioDetalleStock3), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStock3_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStock4_Internalname,GXutil.ltrim( localUtil.ntoc( A264InventarioDetalleStock4, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A264InventarioDetalleStock4), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStock4_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStockOk_Internalname,GXutil.ltrim( localUtil.ntoc( A261InventarioDetalleStockOk, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A261InventarioDetalleStockOk), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStockOk_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleDiferencia_Internalname,GXutil.ltrim( localUtil.ntoc( A260InventarioDetalleDiferencia, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A260InventarioDetalleDiferencia), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleDiferencia_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Inventario Detalle ID", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Articulo Stock", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Stock", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Stock2", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Stock3", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Stock4", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Stock Ok", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Diferencia", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A54InventarioDetalleID, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A259InventarioDetalleStock, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A262InventarioDetalleStock2, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A263InventarioDetalleStock3, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A264InventarioDetalleStock4, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A261InventarioDetalleStockOk, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A260InventarioDetalleDiferencia, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:InventarioDetalleID|2:ArticuloId|3:ArticuloNombre|4:ArticuloStock|5:InventarioDetalleStock|6:InventarioDetalleStock2|7:InventarioDetalleStock3|8:InventarioDetalleStock4|9:InventarioDetalleStockOk" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InInventarioID',fld:'vININVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e115X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InInventarioID',fld:'vININVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e125X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InInventarioID',fld:'vININVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e135X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InInventarioID',fld:'vININVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("ENTER","{handler:'e185X2',iparms:[{av:'A54InventarioDetalleID',fld:'INVENTARIODETALLEID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutInventarioDetalleID',fld:'vINOUTINVENTARIODETALLEID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InInventarioID',fld:'vININVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Inventariodetallediferencia',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H005X2_A53InventarioID = new long[1] ;
      H005X2_A264InventarioDetalleStock4 = new long[1] ;
      H005X2_A263InventarioDetalleStock3 = new long[1] ;
      H005X2_A262InventarioDetalleStock2 = new long[1] ;
      H005X2_A259InventarioDetalleStock = new long[1] ;
      H005X2_A76ArticuloNombre = new String[] {""} ;
      H005X2_A13ArticuloId = new long[1] ;
      H005X2_A54InventarioDetalleID = new long[1] ;
      H005X2_A79ArticuloStock = new long[1] ;
      H005X2_A261InventarioDetalleStockOk = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.inventariodetalleprompt__default(),
         new Object[] {
             new Object[] {
            H005X2_A53InventarioID, H005X2_A264InventarioDetalleStock4, H005X2_A263InventarioDetalleStock3, H005X2_A262InventarioDetalleStock2, H005X2_A259InventarioDetalleStock, H005X2_A76ArticuloNombre, H005X2_A13ArticuloId, H005X2_A54InventarioDetalleID, H005X2_A79ArticuloStock, H005X2_A261InventarioDetalleStockOk
            }
            , new Object[] {
   ...
   private long wcpOAV8InInventarioID ;
   private long wcpOAV9InOutInventarioDetalleID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InInventarioID ;
   private long AV9InOutInventarioDetalleID ;
   ...
   private long[] H005X2_A53InventarioID ;
   private long[] H005X2_A264InventarioDetalleStock4 ;
   private long[] H005X2_A263InventarioDetalleStock3 ;
   private long[] H005X2_A262InventarioDetalleStock2 ;
   private long[] H005X2_A259InventarioDetalleStock ;
   private String[] H005X2_A76ArticuloNombre ;
   private long[] H005X2_A13ArticuloId ;
   private long[] H005X2_A54InventarioDetalleID ;
   private long[] H005X2_A79ArticuloStock ;
   private long[] H005X2_A261InventarioDetalleStockOk ;
...
final  class inventariodetalleprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005X2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A54InventarioDetalleID ,
                                          long A13ArticuloId ,
                                          String A76ArticuloNombre ,
                                          long A79ArticuloStock ,
                                          long A259InventarioDetalleStock ,
                                          long A262InventarioDetalleStock2 ,
                                          long A263InventarioDetalleStock3 ,
                                          long A264InventarioDetalleStock4 ,
                                          long A261InventarioDetalleStockOk ,
                                          short AV11OrderedBy ,
                                          ...
                                          long A53InventarioID )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[InventarioID], T1.[InventarioDetalleStock4], T1.[InventarioDetalleStock3], T1.[InventarioDetalleStock2], T1.[InventarioDetalleStock], T2.[ArticuloNombre], T1.[ArticuloId]," ;
      sSelectString += " T1.[InventarioDetalleID], T2.[ArticuloStock], T1.[InventarioDetalleStockOk]" ;
      sFromString = " FROM ([InventarioDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[InventarioID] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[InventarioDetalleID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(10), CAST(T2.[ArticuloStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock2] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock3] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock4] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStockOk] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(( T2.[ArticuloStock] - T1.[InventarioDetalleStockOk]) AS decimal(10,0))) like '%' + ?))");
      }
      else
      {
         GXv_int6[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleID]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleID] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T2.[ArticuloStock]" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[ArticuloStock] DESC" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock]" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock] DESC" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock2]" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock2] DESC" ;
      }
      else if ( ( AV11OrderedBy == 7 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock3]" ;
      }
      else if ( ( AV11OrderedBy == 7 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock3] DESC" ;
      }
      else if ( ( AV11OrderedBy == 8 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock4]" ;
      }
      else if ( ( AV11OrderedBy == 8 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStock4] DESC" ;
      }
      else if ( ( AV11OrderedBy == 9 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStockOk]" ;
      }
      else if ( ( AV11OrderedBy == 9 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioDetalleStockOk] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleID]" ;
      }
                                          ...
                                          long A53InventarioID )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([InventarioDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      addWhere(sWhereString, "(T1.[InventarioID] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[InventarioDetalleID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(10), CAST(T2.[ArticuloStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock2] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock3] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStock4] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[InventarioDetalleStockOk] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(10), CAST(( T2.[ArticuloStock] - T1.[InventarioDetalleStockOk]) AS decimal(10,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005X2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).longValue() , ((Number) dynConstraints[13]).longValue() );
            case 1 :
                  return conditional_H005X3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).longValue() , ((Number) dynConstraints[13]).longValue() );
      }
