...
public final  class timbradoview_impl extends GXDataArea
{
   public timbradoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public timbradoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( timbradoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10TimbradoId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TimbradoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TimbradoId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIMBRADOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TimbradoId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.timbradoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TimbradoId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TimbradoId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vTIMBRADOID", GXutil.ltrim( localUtil.ntoc( AV10TimbradoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIMBRADOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TimbradoId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.timbradoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TimbradoId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TimbradoId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Timbrado View", "") ;
   }
   ...
   public void wb5P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Timbrado :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_TimbradoView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Timbrado", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_TimbradoView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TimbradoView.htm");
         /* Div Control */
   ...
   public void start5P2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Timbrado View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup5P0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10TimbradoId = localUtil.ctol( httpContext.cgiGet( "vTIMBRADOID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e115P2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.timbradoww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H005P2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10TimbradoId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A29TimbradoId = H005P2_A29TimbradoId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TimbradoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.timbradogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TimbradoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10TimbradoId)});
   ...
   {
      AV10TimbradoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TimbradoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TimbradoId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIMBRADOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TimbradoId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224154", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("timbradoview.js", "?202412111224156", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Timbrado View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TimbradoId',fld:'vTIMBRADOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H005P2_A29TimbradoId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.timbradoview__default(),
         new Object[] {
             new Object[] {
            H005P2_A29TimbradoId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10TimbradoId ;
   private long AV10TimbradoId ;
   ...
   private long[] H005P2_A29TimbradoId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class timbradoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005P2", "SELECT [TimbradoId] FROM [Timbrado] WHERE [TimbradoId] = ? ORDER BY [TimbradoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
