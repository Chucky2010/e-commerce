...
public final  class devolucionesdetalleprompt_impl extends GXDataArea
{
   public devolucionesdetalleprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devolucionesdetalleprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devolucionesdetalleprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InDevolucionesID") ;
         ...
         {
            AV8InDevolucionesID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InDevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InDevolucionesID), 10, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutDevolucionesDetalleID = GXutil.lval( httpContext.GetPar( "InOutDevolucionesDetalleID")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDevolucionesDetalleID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutDevolucionesDetalleID), 10, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV8InDevolucionesID = GXutil.lval( httpContext.GetPar( "InDevolucionesID")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InDevolucionesID, AV22Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.devolucionesdetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InDevolucionesID,10,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutDevolucionesDetalleID,10,0))}, new String[] {"InDevolucionesID","InOutDevolucionesDetalleID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINDEVOLUCIONESID", GXutil.ltrim( localUtil.ntoc( AV8InDevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTDEVOLUCIONESDETALLEID", GXutil.ltrim( localUtil.ntoc( AV9InOutDevolucionesDetalleID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.devolucionesdetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InDevolucionesID,10,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutDevolucionesDetalleID,10,0))}, new String[] {"InDevolucionesID","InOutDevolucionesDetalleID"})  ;
   }

   public String getPgmname( )
   {
      return "DevolucionesDetallePrompt" ;
   }
   ...
   public void wb6D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_6D2( true) ;
      }
      else
      {
         wb_table1_14_6D2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_6D2e( boolean wbgen )
   {
      if ( wbgen )
      {
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A303DevolucionesDetalleTallaID = localUtil.ctol( httpContext.cgiGet( edtDevolucionesDetalleTallaID_Internalname), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVOLUCIONESDETALLEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A274DevolucionesDetalleID), "ZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DEVOLUCIONESDETALLEID", GXutil.ltrim( localUtil.ntoc( A274DevolucionesDetalleID, (byte)(10), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "DevolucionesDetallePrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf6D2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV13FilterFullText ,
                                              Long.valueOf(A274DevolucionesDetalleID) ,
                                              Long.valueOf(A13ArticuloId) ,
                                              A76ArticuloNombre ,
                                              A78ArticuloPrecioVenta ,
                                              Long.valueOf(A303DevolucionesDetalleTallaID) ,
                                              Integer.valueOf(A278DevolucionesDetalleCant) ,
                                              Short.valueOf(AV11OrderedBy) ,
                                              Boolean.valueOf(AV12OrderedDsc) ,
                                              Long.valueOf(AV8InDevolucionesID) ,
                                              Long.valueOf(A272DevolucionesID) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG,
                                              TypeConstants.LONG
                                              }
         });
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H006D2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InDevolucionesID), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A272DevolucionesID = H006D2_A272DevolucionesID[0] ;
            A303DevolucionesDetalleTallaID = H006D2_A303DevolucionesDetalleTallaID[0] ;
            A76ArticuloNombre = H006D2_A76ArticuloNombre[0] ;
            A13ArticuloId = H006D2_A13ArticuloId[0] ;
            A274DevolucionesDetalleID = H006D2_A274DevolucionesDetalleID[0] ;
            A78ArticuloPrecioVenta = H006D2_A78ArticuloPrecioVenta[0] ;
            A278DevolucionesDetalleCant = H006D2_A278DevolucionesDetalleCant[0] ;
            A76ArticuloNombre = H006D2_A76ArticuloNombre[0] ;
            A78ArticuloPrecioVenta = H006D2_A78ArticuloPrecioVenta[0] ;
   ...
   public void send_integrity_lvl_hashes6D2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVOLUCIONESDETALLEID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A274DevolucionesDetalleID), "ZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H006D3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InDevolucionesID), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e166D2( )
   {
      ...
      devolucionesdetalleprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e186D2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutDevolucionesDetalleID = A274DevolucionesDetalleID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDevolucionesDetalleID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutDevolucionesDetalleID), 10, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV9InOutDevolucionesDetalleID)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutDevolucionesDetalleID"});
   ...
   public void wb_table1_14_6D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_DevolucionesDetallePrompt.htm");
   ...
   {
      AV8InDevolucionesID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InDevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InDevolucionesID), 10, 0));
      AV9InOutDevolucionesDetalleID = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDevolucionesDetalleID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutDevolucionesDetalleID), 10, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111225818", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("devolucionesdetalleprompt.js", "?202412111225819", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtDevolucionesDetalleID_Internalname = "DEVOLUCIONESDETALLEID_"+sGXsfl_26_idx ;
      ...
      edtDevolucionesDetalleTallaID_Internalname = "DEVOLUCIONESDETALLETALLAID_"+sGXsfl_26_idx ;
      edtDevolucionesDetalleCant_Internalname = "DEVOLUCIONESDETALLECANT_"+sGXsfl_26_idx ;
      edtDevolucionesDetalleTotal_Internalname = "DEVOLUCIONESDETALLETOTAL_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtDevolucionesDetalleID_Internalname = "DEVOLUCIONESDETALLEID_"+sGXsfl_26_fel_idx ;
      ...
      edtDevolucionesDetalleTallaID_Internalname = "DEVOLUCIONESDETALLETALLAID_"+sGXsfl_26_fel_idx ;
      edtDevolucionesDetalleCant_Internalname = "DEVOLUCIONESDETALLECANT_"+sGXsfl_26_fel_idx ;
      edtDevolucionesDetalleTotal_Internalname = "DEVOLUCIONESDETALLETOTAL_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesDetalleTallaID_Internalname,GXutil.ltrim( localUtil.ntoc( A303DevolucionesDetalleTallaID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A303DevolucionesDetalleTallaID), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesDetalleTallaID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesDetalleCant_Internalname,GXutil.ltrim( localUtil.ntoc( A278DevolucionesDetalleCant, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A278DevolucionesDetalleCant), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesDetalleCant_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesDetalleTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A277DevolucionesDetalleTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A277DevolucionesDetalleTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesDetalleTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void init_default_properties( )
   {
      ...
      edtDevolucionesDetalleTallaID_Internalname = "DEVOLUCIONESDETALLETALLAID" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtDevolucionesDetalleTallaID_Jsonclick = "" ;
      ...
      Ddo_grid_Columnids = "1:DevolucionesDetalleID|2:ArticuloId|3:ArticuloNombre|4:ArticuloPrecioVenta|5:DevolucionesDetalleTallaID|6:DevolucionesDetalleCant" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDevolucionesID',fld:'vINDEVOLUCIONESID',pic:'ZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e116D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDevolucionesID',fld:'vINDEVOLUCIONESID',pic:'ZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e126D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDevolucionesID',fld:'vINDEVOLUCIONESID',pic:'ZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e136D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDevolucionesID',fld:'vINDEVOLUCIONESID',pic:'ZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e176D2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e186D2',iparms:[{av:'A274DevolucionesDetalleID',fld:'DEVOLUCIONESDETALLEID',pic:'ZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDevolucionesDetalleID',fld:'vINOUTDEVOLUCIONESDETALLEID',pic:'ZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDevolucionesID',fld:'vINDEVOLUCIONESID',pic:'ZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H006D2_A272DevolucionesID = new long[1] ;
      H006D2_A303DevolucionesDetalleTallaID = new long[1] ;
      H006D2_A76ArticuloNombre = new String[] {""} ;
      H006D2_A13ArticuloId = new long[1] ;
      H006D2_A274DevolucionesDetalleID = new long[1] ;
      H006D2_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006D2_A278DevolucionesDetalleCant = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devolucionesdetalleprompt__default(),
         new Object[] {
             new Object[] {
            H006D2_A272DevolucionesID, H006D2_A303DevolucionesDetalleTallaID, H006D2_A76ArticuloNombre, H006D2_A13ArticuloId, H006D2_A274DevolucionesDetalleID, H006D2_A78ArticuloPrecioVenta, H006D2_A278DevolucionesDetalleCant
            }
            , new Object[] {
   ...
   private long wcpOAV8InDevolucionesID ;
   private long wcpOAV9InOutDevolucionesDetalleID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InDevolucionesID ;
   private long AV9InOutDevolucionesDetalleID ;
   ...
   private String edtDevolucionesDetalleTallaID_Internalname ;
   ...
   private String edtDevolucionesDetalleTallaID_Jsonclick ;
   ...
   private long[] H006D2_A272DevolucionesID ;
   private long[] H006D2_A303DevolucionesDetalleTallaID ;
   private String[] H006D2_A76ArticuloNombre ;
   private long[] H006D2_A13ArticuloId ;
   private long[] H006D2_A274DevolucionesDetalleID ;
   private java.math.BigDecimal[] H006D2_A78ArticuloPrecioVenta ;
   private int[] H006D2_A278DevolucionesDetalleCant ;
...
final  class devolucionesdetalleprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006D2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A274DevolucionesDetalleID ,
                                          long A13ArticuloId ,
                                          String A76ArticuloNombre ,
                                          java.math.BigDecimal A78ArticuloPrecioVenta ,
                                          long A303DevolucionesDetalleTallaID ,
                                          int A278DevolucionesDetalleCant ,
                                          short AV11OrderedBy ,
                                          ...
                                          long A272DevolucionesID )
   {
      ...
      {
         addWhere(sWhereString, "(( CONVERT( char(10), CAST(T1.[DevolucionesDetalleID] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(17), CAST(T2.[ArticuloPrecioVenta] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[DevolucionesDetalleTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[DevolucionesDetalleCant] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(17), CAST(( T2.[ArticuloPrecioVenta] * CAST(T1.[DevolucionesDetalleCant] AS decimal( 27, 10))) AS decimal(17,2))) like '%' + ?))");
      }
      else
      {
         GXv_int6[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[DevolucionesDetalleID]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesDetalleID] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T1.[DevolucionesDetalleTallaID]" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesDetalleTallaID] DESC" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesDetalleCant]" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesDetalleCant] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H006D3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A274DevolucionesDetalleID ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006D2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).longValue() );
            case 1 :
                  return conditional_H006D3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006D2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006D3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
