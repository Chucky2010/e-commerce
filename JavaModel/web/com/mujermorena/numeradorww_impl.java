...
public final  class numeradorww_impl extends GXDataArea
{
   public numeradorww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public numeradorww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( numeradorww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.numeradorww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.numeradorww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb1D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Numerador", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_NumeradorWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_NumeradorWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_1D2( true) ;
      }
      else
      {
         wb_table1_22_1D2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_1D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_NUMERADORID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A49NumeradorID, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "NUMERADORID", GXutil.rtrim( A49NumeradorID));
   }
   ...
   public void rf1D2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV39Numeradorwwds_1_filterfulltext ,
                                              A49NumeradorID ,
                                              Long.valueOf(A232NumeradorUltimoNRO) ,
                                              Short.valueOf(AV13OrderedBy) ,
                                              Boolean.valueOf(AV14OrderedDsc) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         lV39Numeradorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Numeradorwwds_1_filterfulltext), "%", "") ;
         lV39Numeradorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Numeradorwwds_1_filterfulltext), "%", "") ;
         /* Using cursor H001D2 */
         pr_default.execute(0, new Object[] {lV39Numeradorwwds_1_filterfulltext, lV39Numeradorwwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A232NumeradorUltimoNRO = H001D2_A232NumeradorUltimoNRO[0] ;
            A49NumeradorID = H001D2_A49NumeradorID[0] ;
            e191D2 ();
   ...
   public void send_integrity_lvl_hashes1D2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV38Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV38Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DISPLAY", AV28IsAuthorized_Display);
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV35IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_NUMERADORID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, GXutil.rtrim( localUtil.format( A49NumeradorID, ""))));
   }
   ...
   {
      AV39Numeradorwwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV39Numeradorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Numeradorwwds_1_filterfulltext), "%", "") ;
      /* Using cursor H001D3 */
      pr_default.execute(1, new Object[] {lV39Numeradorwwds_1_filterfulltext, lV39Numeradorwwds_1_filterfulltext});
   ...
   public void e181D2( )
   {
      ...
      numeradorww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e191D2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.numeradorview", new String[] {GXutil.URLEncode(GXutil.rtrim(A49NumeradorID)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"NumeradorID","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.numerador", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.rtrim(A49NumeradorID))}, new String[] {"Mode","NumeradorID"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.numerador", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.rtrim(A49NumeradorID))}, new String[] {"Mode","NumeradorID"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e111D2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("NumeradorWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV38Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("NumeradorWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "NumeradorWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         numeradorww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e161D2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.numerador", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"Mode","NumeradorID"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "numeradorview_Execute", GXv_boolean7) ;
      numeradorww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "numerador_Update", GXv_boolean7) ;
      numeradorww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "numerador_Delete", GXv_boolean7) ;
      numeradorww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "numerador_Insert", GXv_boolean7) ;
      numeradorww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "NumeradorWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Numerador" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.numeradorwwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      numeradorww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      numeradorww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.numeradorwwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_1D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_1D2( true) ;
      }
      else
      {
         wb_table2_27_1D2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_1D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_1D2e( true) ;
      }
      else
      {
         wb_table1_22_1D2e( false) ;
      }
   }

   public void wb_table2_27_1D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111131275", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("numeradorww.js", "?202412111131277", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtNumeradorID_Internalname = "NUMERADORID_"+sGXsfl_40_idx ;
      edtNumeradorUltimoNRO_Internalname = "NUMERADORULTIMONRO_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtNumeradorID_Internalname = "NUMERADORID_"+sGXsfl_40_fel_idx ;
      edtNumeradorUltimoNRO_Internalname = "NUMERADORULTIMONRO_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtNumeradorID_Internalname,GXutil.rtrim( A49NumeradorID),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtNumeradorID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(56),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtNumeradorUltimoNRO_Internalname,GXutil.ltrim( localUtil.ntoc( A232NumeradorUltimoNRO, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A232NumeradorUltimoNRO), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtNumeradorUltimoNRO_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Ultimo NRO", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A49NumeradorID));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A232NumeradorUltimoNRO, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:NumeradorID|4:NumeradorUltimoNRO" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e191D2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A49NumeradorID',fld:'NUMERADORID',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e161D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A49NumeradorID',fld:'NUMERADORID',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e141D2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Numeradorultimonro',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A49NumeradorID = "" ;
      scmdbuf = "" ;
      lV39Numeradorwwds_1_filterfulltext = "" ;
      AV39Numeradorwwds_1_filterfulltext = "" ;
      H001D2_A232NumeradorUltimoNRO = new long[1] ;
      H001D2_A49NumeradorID = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.numeradorww__default(),
         new Object[] {
             new Object[] {
            H001D2_A232NumeradorUltimoNRO, H001D2_A49NumeradorID
            }
            , new Object[] {
   ...
   private String lV39Numeradorwwds_1_filterfulltext ;
   private String AV39Numeradorwwds_1_filterfulltext ;
   ...
   private long[] H001D2_A232NumeradorUltimoNRO ;
   private String[] H001D2_A49NumeradorID ;
...
final  class numeradorww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001D2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Numeradorwwds_1_filterfulltext ,
                                          String A49NumeradorID ,
                                          long A232NumeradorUltimoNRO ,
                                          short AV13OrderedBy ,
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [NumeradorUltimoNRO], [NumeradorID]" ;
      sFromString = " FROM [Numerador]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV39Numeradorwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( [NumeradorID] like '%' + ?) or ( CONVERT( char(10), CAST([NumeradorUltimoNRO] AS decimal(10,0))) like '%' + ?))");
      }
      else
      {
         GXv_int12[0] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [NumeradorID]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [NumeradorID] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [NumeradorUltimoNRO]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [NumeradorUltimoNRO] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [NumeradorID]" ;
   ...
   protected Object[] conditional_H001D3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Numeradorwwds_1_filterfulltext ,
                                          String A49NumeradorID ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Numerador]" ;
      if ( ! (GXutil.strcmp("", AV39Numeradorwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( [NumeradorID] like '%' + ?) or ( CONVERT( char(10), CAST([NumeradorUltimoNRO] AS decimal(10,0))) like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001D2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H001D3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001D2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001D3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[1])[0] = rslt.getString(2, 56);
               return;
            case 1 :
               ((long[]) buf[0])[0] = rslt.getLong(1);
               return;
