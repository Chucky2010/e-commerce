...
public final  class ventasdetalleprompt_impl extends GXDataArea
{
   public ventasdetalleprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ventasdetalleprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ventasdetalleprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InVentasId") ;
         ...
         {
            AV8InVentasId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InVentasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InVentasId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutVentasDetalleId = GXutil.lval( httpContext.GetPar( "InOutVentasDetalleId")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutVentasDetalleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutVentasDetalleId), 11, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV8InVentasId = GXutil.lval( httpContext.GetPar( "InVentasId")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InVentasId, AV22Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.ventasdetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InVentasId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutVentasDetalleId,11,0))}, new String[] {"InVentasId","InOutVentasDetalleId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINVENTASID", GXutil.ltrim( localUtil.ntoc( AV8InVentasId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTVENTASDETALLEID", GXutil.ltrim( localUtil.ntoc( AV9InOutVentasDetalleId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.ventasdetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InVentasId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutVentasDetalleId,11,0))}, new String[] {"InVentasId","InOutVentasDetalleId"})  ;
   }

   public String getPgmname( )
   {
      return "VentasDetallePrompt" ;
   }
   ...
   public void wb530( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_532( true) ;
      }
      else
      {
         wb_table1_14_532( false) ;
      }
      return  ;
   }

   public void wb_table1_14_532e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_VENTASDETALLEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A20VentasDetalleId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "VENTASDETALLEID", GXutil.ltrim( localUtil.ntoc( A20VentasDetalleId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "VentasDetallePrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf532( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV13FilterFullText ,
                                              Long.valueOf(A20VentasDetalleId) ,
                                              Long.valueOf(A13ArticuloId) ,
                                              A76ArticuloNombre ,
                                              A83ImpuestoPorcentaje ,
                                              Integer.valueOf(A92VentasDetalleCantidad) ,
                                              A78ArticuloPrecioVenta ,
                                              Long.valueOf(A292VentasDetalleTallaID) ,
                                              Short.valueOf(AV11OrderedBy) ,
                                              Boolean.valueOf(AV12OrderedDsc) ,
                                              Long.valueOf(AV8InVentasId) ,
                                              Long.valueOf(A19VentasId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.INT, TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN,
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H00532 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InVentasId), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A18ImpuestoId = H00532_A18ImpuestoId[0] ;
            A19VentasId = H00532_A19VentasId[0] ;
            A292VentasDetalleTallaID = H00532_A292VentasDetalleTallaID[0] ;
            A76ArticuloNombre = H00532_A76ArticuloNombre[0] ;
            A13ArticuloId = H00532_A13ArticuloId[0] ;
            A20VentasDetalleId = H00532_A20VentasDetalleId[0] ;
            A83ImpuestoPorcentaje = H00532_A83ImpuestoPorcentaje[0] ;
            A78ArticuloPrecioVenta = H00532_A78ArticuloPrecioVenta[0] ;
            A92VentasDetalleCantidad = H00532_A92VentasDetalleCantidad[0] ;
            A18ImpuestoId = H00532_A18ImpuestoId[0] ;
            A76ArticuloNombre = H00532_A76ArticuloNombre[0] ;
            A78ArticuloPrecioVenta = H00532_A78ArticuloPrecioVenta[0] ;
            A83ImpuestoPorcentaje = H00532_A83ImpuestoPorcentaje[0] ;
   ...
   public void send_integrity_lvl_hashes532( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_VENTASDETALLEID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A20VentasDetalleId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H00533 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InVentasId), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e16532( )
   {
      ...
      ventasdetalleprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e18532( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutVentasDetalleId = A20VentasDetalleId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutVentasDetalleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutVentasDetalleId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV9InOutVentasDetalleId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutVentasDetalleId"});
   ...
   public void wb_table1_14_532( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_VentasDetallePrompt.htm");
   ...
   {
      AV8InVentasId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InVentasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InVentasId), 11, 0));
      AV9InOutVentasDetalleId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutVentasDetalleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutVentasDetalleId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224186", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("ventasdetalleprompt.js", "?202412111224186", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtVentasDetalleId_Internalname = "VENTASDETALLEID_"+sGXsfl_26_idx ;
      ...
      edtVentasDetalleCantidad_Internalname = "VENTASDETALLECANTIDAD_"+sGXsfl_26_idx ;
      edtArticuloPrecioVenta_Internalname = "ARTICULOPRECIOVENTA_"+sGXsfl_26_idx ;
      edtVentasDetalleTallaID_Internalname = "VENTASDETALLETALLAID_"+sGXsfl_26_idx ;
      edtVentasDetalleExento_Internalname = "VENTASDETALLEEXENTO_"+sGXsfl_26_idx ;
      edtVentasDetalleIva5_Internalname = "VENTASDETALLEIVA5_"+sGXsfl_26_idx ;
      edtVentasDetalleIva10_Internalname = "VENTASDETALLEIVA10_"+sGXsfl_26_idx ;
      edtVentasDetalleSubTotal_Internalname = "VENTASDETALLESUBTOTAL_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtVentasDetalleId_Internalname = "VENTASDETALLEID_"+sGXsfl_26_fel_idx ;
      ...
      edtVentasDetalleCantidad_Internalname = "VENTASDETALLECANTIDAD_"+sGXsfl_26_fel_idx ;
      edtArticuloPrecioVenta_Internalname = "ARTICULOPRECIOVENTA_"+sGXsfl_26_fel_idx ;
      edtVentasDetalleTallaID_Internalname = "VENTASDETALLETALLAID_"+sGXsfl_26_fel_idx ;
      edtVentasDetalleExento_Internalname = "VENTASDETALLEEXENTO_"+sGXsfl_26_fel_idx ;
      edtVentasDetalleIva5_Internalname = "VENTASDETALLEIVA5_"+sGXsfl_26_fel_idx ;
      edtVentasDetalleIva10_Internalname = "VENTASDETALLEIVA10_"+sGXsfl_26_fel_idx ;
      edtVentasDetalleSubTotal_Internalname = "VENTASDETALLESUBTOTAL_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleCantidad_Internalname,GXutil.ltrim( localUtil.ntoc( A92VentasDetalleCantidad, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A92VentasDetalleCantidad), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleCantidad_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleTallaID_Internalname,GXutil.ltrim( localUtil.ntoc( A292VentasDetalleTallaID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A292VentasDetalleTallaID), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleTallaID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleExento_Internalname,GXutil.ltrim( localUtil.ntoc( A94VentasDetalleExento, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A94VentasDetalleExento, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleExento_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleIva5_Internalname,GXutil.ltrim( localUtil.ntoc( A96VentasDetalleIva5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A96VentasDetalleIva5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleIva5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleIva10_Internalname,GXutil.ltrim( localUtil.ntoc( A95VentasDetalleIva10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A95VentasDetalleIva10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleIva10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleSubTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A252VentasDetalleSubTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A252VentasDetalleSubTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleSubTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Articulo Precio Venta", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      else
      {
         ...
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A20VentasDetalleId, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A92VentasDetalleCantidad, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A78ArticuloPrecioVenta, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A292VentasDetalleTallaID, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A94VentasDetalleExento, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A96VentasDetalleIva5, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A95VentasDetalleIva10, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A252VentasDetalleSubTotal, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:VentasDetalleId|2:ArticuloId|3:ArticuloNombre|4:ImpuestoPorcentaje|5:VentasDetalleCantidad|6:ArticuloPrecioVenta|7:VentasDetalleTallaID" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InVentasId',fld:'vINVENTASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11532',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InVentasId',fld:'vINVENTASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12532',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InVentasId',fld:'vINVENTASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13532',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InVentasId',fld:'vINVENTASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17532',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18532',iparms:[{av:'A20VentasDetalleId',fld:'VENTASDETALLEID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutVentasDetalleId',fld:'vINOUTVENTASDETALLEID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14532',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InVentasId',fld:'vINVENTASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Ventasdetallesubtotal',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00532_A18ImpuestoId = new long[1] ;
      H00532_A19VentasId = new long[1] ;
      H00532_A292VentasDetalleTallaID = new long[1] ;
      H00532_A76ArticuloNombre = new String[] {""} ;
      H00532_A13ArticuloId = new long[1] ;
      H00532_A20VentasDetalleId = new long[1] ;
      H00532_A83ImpuestoPorcentaje = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00532_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00532_A92VentasDetalleCantidad = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.ventasdetalleprompt__default(),
         new Object[] {
             new Object[] {
            H00532_A18ImpuestoId, H00532_A19VentasId, H00532_A292VentasDetalleTallaID, H00532_A76ArticuloNombre, H00532_A13ArticuloId, H00532_A20VentasDetalleId, H00532_A83ImpuestoPorcentaje, H00532_A78ArticuloPrecioVenta, H00532_A92VentasDetalleCantidad
            }
            , new Object[] {
   ...
   private long wcpOAV8InVentasId ;
   private long wcpOAV9InOutVentasDetalleId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InVentasId ;
   private long AV9InOutVentasDetalleId ;
   ...
   private long[] H00532_A18ImpuestoId ;
   private long[] H00532_A19VentasId ;
   private long[] H00532_A292VentasDetalleTallaID ;
   private String[] H00532_A76ArticuloNombre ;
   private long[] H00532_A13ArticuloId ;
   private long[] H00532_A20VentasDetalleId ;
   private java.math.BigDecimal[] H00532_A83ImpuestoPorcentaje ;
   private java.math.BigDecimal[] H00532_A78ArticuloPrecioVenta ;
   private int[] H00532_A92VentasDetalleCantidad ;
...
final  class ventasdetalleprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00532( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A20VentasDetalleId ,
                                          long A13ArticuloId ,
                                          String A76ArticuloNombre ,
                                          java.math.BigDecimal A83ImpuestoPorcentaje ,
                                          int A92VentasDetalleCantidad ,
                                          java.math.BigDecimal A78ArticuloPrecioVenta ,
                                          long A292VentasDetalleTallaID ,
                                          short AV11OrderedBy ,
                                          ...
                                          long A19VentasId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T2.[ImpuestoId], T1.[VentasId], T1.[VentasDetalleTallaID], T2.[ArticuloNombre], T1.[ArticuloId], T1.[VentasDetalleId], T3.[ImpuestoPorcentaje], T2.[ArticuloPrecioVenta]," ;
      sSelectString += " T1.[VentasDetalleCantidad]" ;
      sFromString = " FROM (([VentasDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId]) INNER JOIN [Impuesto] T3 ON T3.[ImpuestoId] = T2.[ImpuestoId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[VentasId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[VentasDetalleId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(9), CAST(T3.[ImpuestoPorcentaje] AS decimal(9,2))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[VentasDetalleCantidad] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(17), CAST(T2.[ArticuloPrecioVenta] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[VentasDetalleTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 0 THEN T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 5 THEN T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 10 THEN T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10))) AS decimal(17,2))) like '%' + ?))");
      }
      else
      {
         GXv_int6[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[VentasDetalleId]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasDetalleId] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T1.[VentasDetalleCantidad]" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasDetalleCantidad] DESC" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[ArticuloPrecioVenta]" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[ArticuloPrecioVenta] DESC" ;
      }
      else if ( ( AV11OrderedBy == 7 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasDetalleTallaID]" ;
      }
      else if ( ( AV11OrderedBy == 7 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasDetalleTallaID] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[VentasId], T1.[VentasDetalleId]" ;
      }
                                          ...
                                          long A19VentasId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (([VentasDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId]) INNER JOIN [Impuesto] T3 ON T3.[ImpuestoId] = T2.[ImpuestoId])" ;
      addWhere(sWhereString, "(T1.[VentasId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[VentasDetalleId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(9), CAST(T3.[ImpuestoPorcentaje] AS decimal(9,2))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[VentasDetalleCantidad] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(17), CAST(T2.[ArticuloPrecioVenta] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[VentasDetalleTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 0 THEN T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 5 THEN T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 10 THEN T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( T1.[VentasDetalleCantidad] * CAST(T2.[ArticuloPrecioVenta] AS decimal( 27, 10))) AS decimal(17,2))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00532(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).intValue() , (java.math.BigDecimal)dynConstraints[6] , ((Number) dynConstraints[7]).longValue() , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).longValue() , ((Number) dynConstraints[11]).longValue() );
            case 1 :
                  return conditional_H00533(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).intValue() , (java.math.BigDecimal)dynConstraints[6] , ((Number) dynConstraints[7]).longValue() , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).longValue() , ((Number) dynConstraints[11]).longValue() );
      }
