...
public final  class paiswwexportreport_impl extends GXWebReport
{
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "paisww_Execute", GXv_boolean2) ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Pais", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Paiswwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Paiswwds_1_filterfulltext ,
      ...
      lV35Paiswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Paiswwds_1_filterfulltext), "%", "") ;
      lV35Paiswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Paiswwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003T2 */
      pr_default.execute(0, new Object[] {lV35Paiswwds_1_filterfulltext, lV35Paiswwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A5PaisId = P003T2_A5PaisId[0] ;
         A60PaisNombre = P003T2_A60PaisNombre[0] ;
         ...
         h3T0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A5PaisId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A60PaisNombre, "")), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("PaisWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "PaisWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("PaisWWGridState"), null, null);
      }
   ...
   public void h3T0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Paiswwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Paiswwds_1_filterfulltext = "" ;
      P003T2_A5PaisId = new long[1] ;
      P003T2_A60PaisNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.paiswwexportreport__default(),
         new Object[] {
             new Object[] {
            P003T2_A5PaisId, P003T2_A60PaisNombre
            }
         }
      );
   ...
   private String AV35Paiswwds_1_filterfulltext ;
   private String lV35Paiswwds_1_filterfulltext ;
   ...
   private long[] P003T2_A5PaisId ;
   private String[] P003T2_A60PaisNombre ;
...
{
   protected Object[] conditional_P003T2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Paiswwds_1_filterfulltext ,
                                          long A5PaisId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT [PaisId], [PaisNombre] FROM [Pais]" ;
      if ( ! (GXutil.strcmp("", AV35Paiswwds_1_filterfulltext)==0) )
      {
      ...
      {
         scmdbuf += " ORDER BY [PaisNombre]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY [PaisNombre] DESC" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003T2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003T2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
