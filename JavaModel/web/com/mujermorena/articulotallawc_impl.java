...
public final  class articulotallawc_impl extends GXWebComponent
{
   public articulotallawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public articulotallawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( articulotallawc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV23IsAuthorized_TallaNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_TallaNombre")) ;
      sPrefix = httpContext.GetPar( "sPrefix") ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8ArticuloId, AV26Pgmname, AV14OrderedBy, AV15OrderedDsc, AV23IsAuthorized_TallaNombre, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Articulo Talla WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.articulotallawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ArticuloId,11,0))}, new String[] {"ArticuloId"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_TALLANOMBRE", getSecureSignedToken( sPrefix, AV23IsAuthorized_TallaNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_TALLANOMBRE", AV23IsAuthorized_TallaNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_TALLANOMBRE", getSecureSignedToken( sPrefix, AV23IsAuthorized_TallaNombre));
   ...
   {
      return "ArticuloTallaWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Articulo Talla WC", "") ;
   }
   ...
   public void wb6O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.articulotallawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void start6O2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Articulo Talla WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV23IsAuthorized_TallaNombre ,
                                 String sPrefix )
   {
      initialize_formulas( ) ;
      com.mujermorena.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void rf6O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A13ArticuloId = H006O2_A13ArticuloId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A13ArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A13ArticuloId), 11, 0));
            A290ArticuloTallaStock = H006O2_A290ArticuloTallaStock[0] ;
            A288TallaNumero = H006O2_A288TallaNumero[0] ;
            A287TallaNombre = H006O2_A287TallaNombre[0] ;
            A286TallaID = H006O2_A286TallaID[0] ;
            A285ArticuloTallaID = H006O2_A285ArticuloTallaID[0] ;
            A288TallaNumero = H006O2_A288TallaNumero[0] ;
            A287TallaNombre = H006O2_A287TallaNombre[0] ;
            e166O2 ();
   ...
   public void e146O2( )
   {
      ...
      GXt_boolean1 = AV23IsAuthorized_TallaNombre ;
      ...
      articulotallawc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV23IsAuthorized_TallaNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV23IsAuthorized_TallaNombre", AV23IsAuthorized_TallaNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_TALLANOMBRE", getSecureSignedToken( sPrefix, AV23IsAuthorized_TallaNombre));
   ...
   public void e156O2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV26Pgmname, GXv_char7) ;
      articulotallawc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e166O2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      if ( AV23IsAuthorized_TallaNombre )
      {
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "articulotallawc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211191294", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("articulotallawc.js", "?20241211191294", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtArticuloTallaID_Internalname = sPrefix+"ARTICULOTALLAID_"+sGXsfl_15_idx ;
      edtTallaID_Internalname = sPrefix+"TALLAID_"+sGXsfl_15_idx ;
      edtTallaNombre_Internalname = sPrefix+"TALLANOMBRE_"+sGXsfl_15_idx ;
      edtTallaNumero_Internalname = sPrefix+"TALLANUMERO_"+sGXsfl_15_idx ;
      edtArticuloTallaStock_Internalname = sPrefix+"ARTICULOTALLASTOCK_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtArticuloTallaID_Internalname = sPrefix+"ARTICULOTALLAID_"+sGXsfl_15_fel_idx ;
      edtTallaID_Internalname = sPrefix+"TALLAID_"+sGXsfl_15_fel_idx ;
      edtTallaNombre_Internalname = sPrefix+"TALLANOMBRE_"+sGXsfl_15_fel_idx ;
      edtTallaNumero_Internalname = sPrefix+"TALLANUMERO_"+sGXsfl_15_fel_idx ;
      edtArticuloTallaStock_Internalname = sPrefix+"ARTICULOTALLASTOCK_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTallaNumero_Internalname,GXutil.ltrim( localUtil.ntoc( A288TallaNumero, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A288TallaNumero), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTallaNumero_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtArticuloTallaStock_Internalname,GXutil.ltrim( localUtil.ntoc( A290ArticuloTallaStock, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A290ArticuloTallaStock), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtArticuloTallaStock_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
   ...
   {
      edtArticuloTallaID_Internalname = sPrefix+"ARTICULOTALLAID" ;
      ...
      edtArticuloTallaStock_Internalname = sPrefix+"ARTICULOTALLASTOCK" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:ArticuloTallaID|1:TallaID|2:TallaNombre|3:TallaNumero|4:ArticuloTallaStock" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8ArticuloId',fld:'vARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_TallaNombre',fld:'vISAUTHORIZED_TALLANOMBRE',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e116O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8ArticuloId',fld:'vARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_TallaNombre',fld:'vISAUTHORIZED_TALLANOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e126O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8ArticuloId',fld:'vARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_TallaNombre',fld:'vISAUTHORIZED_TALLANOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e136O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8ArticuloId',fld:'vARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_TallaNombre',fld:'vISAUTHORIZED_TALLANOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e166O2',iparms:[{av:'AV23IsAuthorized_TallaNombre',fld:'vISAUTHORIZED_TALLANOMBRE',pic:'',hsh:true},{av:'A286TallaID',fld:'TALLAID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtTallaNombre_Link',ctrl:'TALLANOMBRE',prop:'Link'}]}");
   ...
   public void initialize( )
   {
      ...
      A287TallaNombre = "" ;
      scmdbuf = "" ;
      H006O2_A13ArticuloId = new long[1] ;
      H006O2_A290ArticuloTallaStock = new long[1] ;
      H006O2_A288TallaNumero = new short[1] ;
      H006O2_A287TallaNombre = new String[] {""} ;
      H006O2_A286TallaID = new long[1] ;
      H006O2_A285ArticuloTallaID = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.articulotallawc__default(),
         new Object[] {
             new Object[] {
            H006O2_A13ArticuloId, H006O2_A290ArticuloTallaStock, H006O2_A288TallaNumero, H006O2_A287TallaNombre, H006O2_A286TallaID, H006O2_A285ArticuloTallaID
            }
            , new Object[] {
   ...
   private boolean AV23IsAuthorized_TallaNombre ;
   ...
   private long[] H006O2_A13ArticuloId ;
   private long[] H006O2_A290ArticuloTallaStock ;
   private short[] H006O2_A288TallaNumero ;
   private String[] H006O2_A287TallaNombre ;
   private long[] H006O2_A286TallaID ;
   private long[] H006O2_A285ArticuloTallaID ;
...
final  class articulotallawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006O2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T1.[ArticuloTallaID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T1.[TallaID]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T1.[TallaID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T2.[TallaNombre]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T2.[TallaNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T2.[TallaNumero]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T2.[TallaNumero] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T1.[ArticuloTallaStock]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloId] DESC, T1.[ArticuloTallaStock] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T1.[ArticuloTallaID]" ;
   ...
   protected Object[] conditional_H006O3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006O2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
            case 1 :
                  return conditional_H006O3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006O2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006O3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
