...
public final  class gamappmenuentry_impl extends GXDataArea
{
   public gamappmenuentry_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gamappmenuentry_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gamappmenuentry_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13Id = GXutil.lval( httpContext.GetPar( "Id")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13Id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13Id), 12, 0));
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Id), "ZZZZZZZZZZZ9")));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.gamappmenuentry", new String[] {GXutil.URLEncode(GXutil.rtrim(Gx_mode)),GXutil.URLEncode(GXutil.ltrimstr(AV7ApplicationId,12,0)),GXutil.URLEncode(GXutil.ltrimstr(AV13Id,12,0))}, new String[] {"Gx_mode","ApplicationId","Id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMODE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( Gx_mode, "@!"))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vID", GXutil.ltrim( localUtil.ntoc( AV13Id, (byte)(12), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Id), "ZZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.gamappmenuentry", new String[] {GXutil.URLEncode(GXutil.rtrim(Gx_mode)),GXutil.URLEncode(GXutil.ltrimstr(AV7ApplicationId,12,0)),GXutil.URLEncode(GXutil.ltrimstr(AV13Id,12,0))}, new String[] {"Gx_mode","ApplicationId","Id"})  ;
   }
   ...
   {
      return httpContext.getMessage( "WWP_GAM_AppMenuEntry", "") ;
   }
   ...
   public void wb3K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_html_textarea( httpContext, edtavGamapplication_name_Internalname, GXutil.rtrim( AV5GAMApplication.getgxTv_SdtGAMApplication_Name()), "", "", (short)(0), 1, edtavGamapplication_name_Enabled, 0, 80, "chr", 4, "row", (byte)(0), StyleString, ClassString, "", "", "254", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_GAMAppMenuEntry.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavGuid_Internalname, GXutil.rtrim( AV12GUID), GXutil.rtrim( localUtil.format( AV12GUID, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavGuid_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavGuid_Enabled, 1, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_GAMAppMenuEntry.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavDsc_Internalname, GXutil.rtrim( AV9Dsc), GXutil.rtrim( localUtil.format( AV9Dsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDsc_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavDsc_Enabled, 1, "text", "", 0, "px", 1, "row", 254, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "GeneXusSecurityCommon\\GAMDescriptionLong", "left", true, "", "HLP_GAMAppMenuEntry.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavName_Internalname, GXutil.rtrim( AV14Name), GXutil.rtrim( localUtil.format( AV14Name, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavName_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavName_Enabled, 1, "text", "", 0, "px", 1, "row", 254, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "GeneXusSecurityCommon\\GAMDescriptionLong", "left", true, "", "HLP_GAMAppMenuEntry.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtnenter_Internalname, "", bttBtnenter_Caption, bttBtnenter_Jsonclick, 5, httpContext.getMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GAMAppMenuEntry.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtncancel_Internalname, "", httpContext.getMessage( "GX_BtnCancel", ""), bttBtncancel_Jsonclick, 1, httpContext.getMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GAMAppMenuEntry.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3K2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "WWP_GAM_AppMenuEntry", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup3K0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12GUID = httpContext.cgiGet( edtavGuid_Internalname) ;
   ...
   public void e113K2( )
   {
      ...
      AV8ApplicationMenu = AV5GAMApplication.getmenu(AV13Id, GXv_objcol_SdtGAMError1);
      AV11Errors = GXv_objcol_SdtGAMError1[0] ;
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         AV14Name = AV8ApplicationMenu.getgxTv_SdtGAMApplicationMenu_Name() ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14Name", AV14Name);
         AV9Dsc = AV8ApplicationMenu.getgxTv_SdtGAMApplicationMenu_Description() ;
         httpContext.ajax_rsp_assign_attri("", false, "AV9Dsc", AV9Dsc);
         AV12GUID = AV8ApplicationMenu.getgxTv_SdtGAMApplicationMenu_Guid() ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12GUID", AV12GUID);
         edtavGuid_Enabled = 0 ;
   ...
   public void e123K2( )
   {
      ...
      returnInSub = false ;
      AV5GAMApplication.load(AV7ApplicationId);
      if ( ! (GXutil.strcmp("", AV14Name)==0) )
      {
         if ( GXutil.strcmp(Gx_mode, "INS") == 0 )
         {
            AV8ApplicationMenu.setgxTv_SdtGAMApplicationMenu_Guid( AV12GUID );
            AV8ApplicationMenu.setgxTv_SdtGAMApplicationMenu_Name( AV14Name );
            AV8ApplicationMenu.setgxTv_SdtGAMApplicationMenu_Description( AV9Dsc );
            GXv_objcol_SdtGAMError1[0] = AV11Errors ;
            AV6isOK = AV5GAMApplication.addmenu(AV8ApplicationMenu, GXv_objcol_SdtGAMError1) ;
         ...
         else if ( GXutil.strcmp(Gx_mode, "UPD") == 0 )
         {
            ...
            AV8ApplicationMenu.setgxTv_SdtGAMApplicationMenu_Description( AV9Dsc );
            GXv_objcol_SdtGAMError1[0] = AV11Errors ;
            AV6isOK = AV5GAMApplication.updatemenu(AV8ApplicationMenu, GXv_objcol_SdtGAMError1) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6isOK", AV6isOK);
            AV11Errors = GXv_objcol_SdtGAMError1[0] ;
         }
         else if ( GXutil.strcmp(Gx_mode, "DLT") == 0 )
         {
            ...
            AV11Errors = GXv_objcol_SdtGAMError1[0] ;
            GXv_objcol_SdtGAMError1[0] = AV11Errors ;
            AV6isOK = AV5GAMApplication.deletemenu(AV8ApplicationMenu, GXv_objcol_SdtGAMError1) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6isOK", AV6isOK);
            AV11Errors = GXv_objcol_SdtGAMError1[0] ;
         }
      }
      else
      {
         AV6isOK = false ;
         httpContext.ajax_rsp_assign_attri("", false, "AV6isOK", AV6isOK);
         AV10Error = (genexus.security.api.genexussecurity.SdtGAMError)new genexus.security.api.genexussecurity.SdtGAMError(remoteHandle, context);
         AV10Error.setgxTv_SdtGAMError_Code( 239 );
         AV10Error.setgxTv_SdtGAMError_Message( genexus.security.api.genexussecuritycommon.gxdomaingamerrormessages.getDescription(httpContext,(long)AV10Error.getgxTv_SdtGAMError_Code()) );
         AV11Errors.add(AV10Error, 0);
      }
      if ( AV6isOK )
      {
         Application.commitDataStores(context, remoteHandle, pr_default, "gamappmenuentry");
         httpContext.setWebReturnParms(new Object[] {Gx_mode,Long.valueOf(AV7ApplicationId),Long.valueOf(AV13Id)});
         httpContext.setWebReturnParmsMetadata(new Object[] {"Gx_mode","AV7ApplicationId","AV13Id"});
      ...
      {
         AV24GXV2 = 1 ;
         while ( AV24GXV2 <= AV11Errors.size() )
         {
            AV10Error = (genexus.security.api.genexussecurity.SdtGAMError)((genexus.security.api.genexussecurity.SdtGAMError)AV11Errors.elementAt(-1+AV24GXV2));
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV8ApplicationMenu", AV8ApplicationMenu);
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV7ApplicationId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV7ApplicationId), 12, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAPPLICATIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV7ApplicationId), "ZZZZZZZZZZZ9")));
      AV13Id = ((Number) GXutil.testNumericType( getParm(obj,2), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13Id), 12, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Id), "ZZZZZZZZZZZ9")));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111213085", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gamappmenuentry.js", "?202412111213087", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Dvpanel_tableattributes_Title = httpContext.getMessage( "WWP_GAM_Menu", "") ;
      ...
      Form.setCaption( httpContext.getMessage( "WWP_GAM_AppMenuEntry", "") );
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("ENTER","{handler:'e123K2',iparms:[{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV14Name',fld:'vNAME',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV12GUID',fld:'vGUID',pic:''},{av:'AV9Dsc',fld:'vDSC',pic:''},{av:'AV13Id',fld:'vID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6isOK',fld:'vISOK',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      pr_gam = new DataStoreProvider(context, remoteHandle, new com.mujermorena.gamappmenuentry__gam(),
         new Object[] {
         }
      );
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.gamappmenuentry__default(),
         new Object[] {
         }
      );
      /* GeneXus formulas. */
...
final  class gamappmenuentry__gam extends DataStoreHelperBase implements ILocalDataStoreHelper
{
...
final  class gamappmenuentry__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
