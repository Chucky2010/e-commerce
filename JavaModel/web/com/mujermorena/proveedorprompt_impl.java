...
public final  class proveedorprompt_impl extends GXDataArea
{
   public proveedorprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public proveedorprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( proveedorprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutProveedorId") ;
         ...
         {
            AV8InOutProveedorId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutProveedorId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.proveedorprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutProveedorId,11,0))}, new String[] {"InOutProveedorId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTPROVEEDORID", GXutil.ltrim( localUtil.ntoc( AV8InOutProveedorId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.proveedorprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutProveedorId,11,0))}, new String[] {"InOutProveedorId"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Selecciona Proveedor", "") ;
   }
   ...
   public void wb0U0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_0U2( true) ;
      }
      else
      {
         wb_table1_14_0U2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0U2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Proveedor", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf0U2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H000U2 */
         pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A66PersonaTelefono = H000U2_A66PersonaTelefono[0] ;
            A57PersonaDireccion = H000U2_A57PersonaDireccion[0] ;
            A1PersonaId = H000U2_A1PersonaId[0] ;
            A10ProveedorId = H000U2_A10ProveedorId[0] ;
            A56PersonaApellido = H000U2_A56PersonaApellido[0] ;
            A55PersonaNombre = H000U2_A55PersonaNombre[0] ;
            A66PersonaTelefono = H000U2_A66PersonaTelefono[0] ;
            A57PersonaDireccion = H000U2_A57PersonaDireccion[0] ;
            A56PersonaApellido = H000U2_A56PersonaApellido[0] ;
            A55PersonaNombre = H000U2_A55PersonaNombre[0] ;
   ...
   public void send_integrity_lvl_hashes0U2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_PROVEEDORID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A10ProveedorId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H000U3 */
      pr_default.execute(1, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText});
   ...
   public void e150U2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Proveedor", "") );
   ...
   public void e160U2( )
   {
      ...
      proveedorprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e180U2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutProveedorId = A10ProveedorId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutProveedorId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutProveedorId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutProveedorId"});
   ...
   public void wb_table1_14_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ProveedorPrompt.htm");
   ...
   {
      AV8InOutProveedorId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutProveedorId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111123949", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("proveedorprompt.js", "?202412111123949", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ProveedorId|2:PersonaId|4:PersonaDireccion|5:PersonaTelefono" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e170U2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e180U2',iparms:[{av:'A10ProveedorId',fld:'PROVEEDORID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutProveedorId',fld:'vINOUTPROVEEDORID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e140U2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   {
      return "proveedorprompt_Execute";
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H000U2_A66PersonaTelefono = new String[] {""} ;
      H000U2_A57PersonaDireccion = new String[] {""} ;
      H000U2_A1PersonaId = new long[1] ;
      H000U2_A10ProveedorId = new long[1] ;
      H000U2_A56PersonaApellido = new String[] {""} ;
      H000U2_A55PersonaNombre = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.proveedorprompt__default(),
         new Object[] {
             new Object[] {
            H000U2_A66PersonaTelefono, H000U2_A57PersonaDireccion, H000U2_A1PersonaId, H000U2_A10ProveedorId, H000U2_A56PersonaApellido, H000U2_A55PersonaNombre
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutProveedorId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutProveedorId ;
   ...
   private String[] H000U2_A66PersonaTelefono ;
   private String[] H000U2_A57PersonaDireccion ;
   private long[] H000U2_A1PersonaId ;
   private long[] H000U2_A10ProveedorId ;
   private String[] H000U2_A56PersonaApellido ;
   private String[] H000U2_A55PersonaNombre ;
...
final  class proveedorprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      switch ( cursor )
      {
            ...
            case 1 :
                  return conditional_H000U3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
      }
