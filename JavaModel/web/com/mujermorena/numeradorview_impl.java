...
public final  class numeradorview_impl extends GXDataArea
{
   public numeradorview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public numeradorview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( numeradorview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10NumeradorID = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10NumeradorID", AV10NumeradorID);
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vNUMERADORID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10NumeradorID, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.numeradorview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10NumeradorID)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"NumeradorID","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vNUMERADORID", GXutil.rtrim( AV10NumeradorID));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vNUMERADORID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10NumeradorID, ""))));
   ...
   {
      return formatLink("com.mujermorena.numeradorview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10NumeradorID)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"NumeradorID","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "NumeradorView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Numerador View", "") ;
   }
   ...
   public void wb5A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Numerador :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_NumeradorView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Numerador", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_NumeradorView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_NumeradorView.htm");
         /* Div Control */
   ...
   public void start5A2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Numerador View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes5A2( )
   {
   }
   ...
   public void strup5A0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10NumeradorID = httpContext.cgiGet( "vNUMERADORID") ;
   ...
   public void e115A2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.numeradorww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H005A2 */
      pr_default.execute(0, new Object[] {AV10NumeradorID});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A49NumeradorID = H005A2_A49NumeradorID[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "NumeradorGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.numeradorgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "NumeradorGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",AV10NumeradorID});
   ...
   {
      AV10NumeradorID = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10NumeradorID", AV10NumeradorID);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vNUMERADORID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10NumeradorID, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111222482", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("numeradorview.js", "?202412111222482", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Numerador View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10NumeradorID',fld:'vNUMERADORID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H005A2_A49NumeradorID = new String[] {""} ;
      A49NumeradorID = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.numeradorview__default(),
         new Object[] {
             new Object[] {
            H005A2_A49NumeradorID
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10NumeradorID ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV10NumeradorID ;
   ...
   private String[] H005A2_A49NumeradorID ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class numeradorview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005A2", "SELECT [NumeradorID] FROM [Numerador] WHERE [NumeradorID] = ? ORDER BY [NumeradorID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
