...
public final  class motivodevolucionww_impl extends GXDataArea
{
   public motivodevolucionww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public motivodevolucionww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( motivodevolucionww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.motivodevolucionww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.motivodevolucionww", new String[] {}, new String[] {})  ;
   }

   public String getPgmname( )
   {
      return "MotivoDevolucionWW" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( " Motivo Devolucion", "") ;
   }
   ...
   public void wb670( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Motivo Devolucion", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_MotivoDevolucionWW.htm");
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_672( true) ;
      }
      else
      {
         wb_table1_22_672( false) ;
      }
      return  ;
   }

   public void wb_table1_22_672e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start672( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( " Motivo Devolucion", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_MOTIVODEVOLUCIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A273MotivoDevolucionID), "ZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "MOTIVODEVOLUCIONID", GXutil.ltrim( localUtil.ntoc( A273MotivoDevolucionID, (byte)(10), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV39Pgmname = "MotivoDevolucionWW" ;
      Gx_err = (short)(0) ;
   ...
   public void rf672( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV40Motivodevolucionwwds_1_filterfulltext ,
         ...
         lV40Motivodevolucionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Motivodevolucionwwds_1_filterfulltext), "%", "") ;
         lV40Motivodevolucionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Motivodevolucionwwds_1_filterfulltext), "%", "") ;
         /* Using cursor H00672 */
         pr_default.execute(0, new Object[] {lV40Motivodevolucionwwds_1_filterfulltext, lV40Motivodevolucionwwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A280MotivoDevolucionDescripcion = H00672_A280MotivoDevolucionDescripcion[0] ;
            A273MotivoDevolucionID = H00672_A273MotivoDevolucionID[0] ;
            e19672 ();
   ...
   public void send_integrity_lvl_hashes672( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_MOTIVODEVOLUCIONID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A273MotivoDevolucionID), "ZZZZZZZZZ9")));
   }
   ...
   {
      AV40Motivodevolucionwwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV40Motivodevolucionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Motivodevolucionwwds_1_filterfulltext), "%", "") ;
      /* Using cursor H00673 */
      pr_default.execute(1, new Object[] {lV40Motivodevolucionwwds_1_filterfulltext, lV40Motivodevolucionwwds_1_filterfulltext});
      GRID_nRecordCount = H00673_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e17672( )
   {
      ...
      motivodevolucionww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      Form.setCaption( httpContext.getMessage( " Motivo Devolucion", "") );
   ...
   public void e18672( )
   {
      ...
      motivodevolucionww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e19672( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.motivodevolucionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A273MotivoDevolucionID,10,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"MotivoDevolucionID","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.motivodevolucion", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A273MotivoDevolucionID,10,0))}, new String[] {"Mode","MotivoDevolucionID"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.motivodevolucion", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A273MotivoDevolucionID,10,0))}, new String[] {"Mode","MotivoDevolucionID"})  ;
      }
   ...
   public void e11672( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("MotivoDevolucionWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV39Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("MotivoDevolucionWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "MotivoDevolucionWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         motivodevolucionww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e16672( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.motivodevolucion", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","MotivoDevolucionID"}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "motivodevolucion_Update", GXv_boolean2) ;
      motivodevolucionww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "motivodevolucion_Delete", GXv_boolean2) ;
      motivodevolucionww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "motivodevolucion_Insert", GXv_boolean2) ;
      motivodevolucionww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "MotivoDevolucionWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "MotivoDevolucion" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.motivodevolucionwwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      motivodevolucionww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      motivodevolucionww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.motivodevolucionwwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_672( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_672( true) ;
      }
      else
      {
         wb_table2_27_672( false) ;
      }
      return  ;
   }

   public void wb_table2_27_672e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_672e( true) ;
      }
      else
      {
         wb_table1_22_672e( false) ;
      }
   }

   public void wb_table2_27_672( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111225550", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("motivodevolucionww.js", "?202412111225550", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:MotivoDevolucionID|4:MotivoDevolucionDescripcion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e19672',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A273MotivoDevolucionID',fld:'MOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e16672',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_MotivoDevolucionDescripcion',fld:'vISAUTHORIZED_MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A273MotivoDevolucionID',fld:'MOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e14672',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Motivodevoluciondescripcion',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A280MotivoDevolucionDescripcion = "" ;
      scmdbuf = "" ;
      lV40Motivodevolucionwwds_1_filterfulltext = "" ;
      AV40Motivodevolucionwwds_1_filterfulltext = "" ;
      H00672_A280MotivoDevolucionDescripcion = new String[] {""} ;
      H00672_A273MotivoDevolucionID = new long[1] ;
      H00673_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.motivodevolucionww__default(),
         new Object[] {
             new Object[] {
            H00672_A280MotivoDevolucionDescripcion, H00672_A273MotivoDevolucionID
            }
            , new Object[] {
            H00673_AGRID_nRecordCount
            }
         }
      );
      AV39Pgmname = "MotivoDevolucionWW" ;
   ...
   private String lV40Motivodevolucionwwds_1_filterfulltext ;
   private String AV40Motivodevolucionwwds_1_filterfulltext ;
   ...
   private String[] H00672_A280MotivoDevolucionDescripcion ;
   private long[] H00672_A273MotivoDevolucionID ;
   private long[] H00673_AGRID_nRecordCount ;
...
final  class motivodevolucionww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00672( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Motivodevolucionwwds_1_filterfulltext ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [MotivoDevolucionDescripcion], [MotivoDevolucionID]" ;
      sFromString = " FROM [MotivoDevolucion]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV40Motivodevolucionwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(10), CAST([MotivoDevolucionID] AS decimal(10,0))) like '%' + ?) or ( [MotivoDevolucionDescripcion] like '%' + ?))");
      }
      else
      {
         GXv_int12[0] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [MotivoDevolucionDescripcion]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MotivoDevolucionDescripcion] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [MotivoDevolucionID]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MotivoDevolucionID] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [MotivoDevolucionID]" ;
   ...
   protected Object[] conditional_H00673( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Motivodevolucionwwds_1_filterfulltext ,
                                          long A273MotivoDevolucionID ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [MotivoDevolucion]" ;
      if ( ! (GXutil.strcmp("", AV40Motivodevolucionwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(10), CAST([MotivoDevolucionID] AS decimal(10,0))) like '%' + ?) or ( [MotivoDevolucionDescripcion] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00672(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H00673(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00672", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00673", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
