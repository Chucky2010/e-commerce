...
public final  class empresaprompt_impl extends GXDataArea
{
   public empresaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutEmpresaId") ;
         ...
         {
            AV8InOutEmpresaId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutEmpresaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutEmpresaId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.empresaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutEmpresaId,11,0))}, new String[] {"InOutEmpresaId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTEMPRESAID", GXutil.ltrim( localUtil.ntoc( AV8InOutEmpresaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.empresaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutEmpresaId,11,0))}, new String[] {"InOutEmpresaId"})  ;
   }

   public String getPgmname( )
   {
      return "EmpresaPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Empresa", "") ;
   }
   ...
   public void wb5O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_5O2( true) ;
      }
      else
      {
         wb_table1_14_5O2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_5O2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5O2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Empresa", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf5O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H005O2 */
         pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A129EmpresaTelefono = H005O2_A129EmpresaTelefono[0] ;
            A124EmpresaEmail = H005O2_A124EmpresaEmail[0] ;
            A123EmpresaRuc = H005O2_A123EmpresaRuc[0] ;
            A122EmpresaDireccion = H005O2_A122EmpresaDireccion[0] ;
            A121EmpresaNombre = H005O2_A121EmpresaNombre[0] ;
            A28EmpresaId = H005O2_A28EmpresaId[0] ;
            e175O2 ();
   ...
   public void send_integrity_lvl_hashes5O2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_EMPRESAID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A28EmpresaId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H005O3 */
      pr_default.execute(1, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText});
   ...
   public void e155O2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Empresa", "") );
   ...
   public void e165O2( )
   {
      ...
      empresaprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e185O2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutEmpresaId = A28EmpresaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutEmpresaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutEmpresaId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutEmpresaId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutEmpresaId"});
   ...
   public void wb_table1_14_5O2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_EmpresaPrompt.htm");
   ...
   {
      AV8InOutEmpresaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutEmpresaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutEmpresaId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224345", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresaprompt.js", "?202412111224345", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtEmpresaId_Internalname = "EMPRESAID_"+sGXsfl_26_idx ;
      edtEmpresaNombre_Internalname = "EMPRESANOMBRE_"+sGXsfl_26_idx ;
      edtEmpresaDireccion_Internalname = "EMPRESADIRECCION_"+sGXsfl_26_idx ;
      edtEmpresaRuc_Internalname = "EMPRESARUC_"+sGXsfl_26_idx ;
      edtEmpresaEmail_Internalname = "EMPRESAEMAIL_"+sGXsfl_26_idx ;
      edtEmpresaTelefono_Internalname = "EMPRESATELEFONO_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtEmpresaId_Internalname = "EMPRESAID_"+sGXsfl_26_fel_idx ;
      edtEmpresaNombre_Internalname = "EMPRESANOMBRE_"+sGXsfl_26_fel_idx ;
      edtEmpresaDireccion_Internalname = "EMPRESADIRECCION_"+sGXsfl_26_fel_idx ;
      edtEmpresaRuc_Internalname = "EMPRESARUC_"+sGXsfl_26_fel_idx ;
      edtEmpresaEmail_Internalname = "EMPRESAEMAIL_"+sGXsfl_26_fel_idx ;
      edtEmpresaTelefono_Internalname = "EMPRESATELEFONO_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:EmpresaId|2:EmpresaNombre|3:EmpresaDireccion|4:EmpresaRuc|5:EmpresaEmail|6:EmpresaTelefono" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e175O2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e185O2',iparms:[{av:'A28EmpresaId',fld:'EMPRESAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutEmpresaId',fld:'vINOUTEMPRESAID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H005O2_A129EmpresaTelefono = new String[] {""} ;
      H005O2_A124EmpresaEmail = new String[] {""} ;
      H005O2_A123EmpresaRuc = new String[] {""} ;
      H005O2_A122EmpresaDireccion = new String[] {""} ;
      H005O2_A121EmpresaNombre = new String[] {""} ;
      H005O2_A28EmpresaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.empresaprompt__default(),
         new Object[] {
             new Object[] {
            H005O2_A129EmpresaTelefono, H005O2_A124EmpresaEmail, H005O2_A123EmpresaRuc, H005O2_A122EmpresaDireccion, H005O2_A121EmpresaNombre, H005O2_A28EmpresaId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutEmpresaId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutEmpresaId ;
   ...
   private String[] H005O2_A129EmpresaTelefono ;
   private String[] H005O2_A124EmpresaEmail ;
   private String[] H005O2_A123EmpresaRuc ;
   private String[] H005O2_A122EmpresaDireccion ;
   private String[] H005O2_A121EmpresaNombre ;
   private long[] H005O2_A28EmpresaId ;
...
final  class empresaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005O2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H005O3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A28EmpresaId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005O2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
            case 1 :
                  return conditional_H005O3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005O2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005O3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
