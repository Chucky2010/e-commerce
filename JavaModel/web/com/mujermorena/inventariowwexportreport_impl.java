...
public final  class inventariowwexportreport_impl extends GXWebReport
{
   public inventariowwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "inventarioww_Execute", GXv_boolean2) ;
         inventariowwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Inventario", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Inventario ID", ""), 30, Gx_line+10, 179, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Inventario Fecha", ""), 183, Gx_line+10, 332, Gx_line+27, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Inventario Detalle", ""), 336, Gx_line+10, 634, Gx_line+27, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Numero Proceso", ""), 638, Gx_line+10, 787, Gx_line+27, 2, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Inventariowwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Inventariowwds_1_filterfulltext ,
      ...
      lV35Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Inventariowwds_1_filterfulltext), "%", "") ;
      lV35Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Inventariowwds_1_filterfulltext), "%", "") ;
      lV35Inventariowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Inventariowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P00502 */
      pr_default.execute(0, new Object[] {lV35Inventariowwds_1_filterfulltext, lV35Inventariowwds_1_filterfulltext, lV35Inventariowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A265InventarioNumeroProceso = P00502_A265InventarioNumeroProceso[0] ;
         A53InventarioID = P00502_A53InventarioID[0] ;
         A258InventarioDetalle = P00502_A258InventarioDetalle[0] ;
         A257InventarioFecha = P00502_A257InventarioFecha[0] ;
         ...
         h500( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A53InventarioID), "ZZZZZZZZZZ9")), 30, Gx_line+10, 179, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(localUtil.format( A257InventarioFecha, "99/99/99"), 183, Gx_line+10, 332, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A258InventarioDetalle, "")), 336, Gx_line+10, 634, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A265InventarioNumeroProceso), "ZZZ9")), 638, Gx_line+10, 787, Gx_line+25, 2, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("InventarioWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "InventarioWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("InventarioWWGridState"), null, null);
      }
   ...
   public void initialize( )
   {
      ...
      AV35Inventariowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Inventariowwds_1_filterfulltext = "" ;
      P00502_A265InventarioNumeroProceso = new short[1] ;
      P00502_A53InventarioID = new long[1] ;
      P00502_A258InventarioDetalle = new String[] {""} ;
      P00502_A257InventarioFecha = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.inventariowwexportreport__default(),
         new Object[] {
             new Object[] {
            P00502_A265InventarioNumeroProceso, P00502_A53InventarioID, P00502_A258InventarioDetalle, P00502_A257InventarioFecha
            }
         }
      );
   ...
   private String AV35Inventariowwds_1_filterfulltext ;
   private String lV35Inventariowwds_1_filterfulltext ;
   ...
   private short[] P00502_A265InventarioNumeroProceso ;
   private long[] P00502_A53InventarioID ;
   private String[] P00502_A258InventarioDetalle ;
   private java.util.Date[] P00502_A257InventarioFecha ;
...
final  class inventariowwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00502( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Inventariowwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Inventariowwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00502(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
