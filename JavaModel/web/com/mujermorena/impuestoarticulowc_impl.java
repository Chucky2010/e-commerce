...
public final  class impuestoarticulowc_impl extends GXWebComponent
{
   public impuestoarticulowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public impuestoarticulowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( impuestoarticulowc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "ImpuestoId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8ImpuestoId = GXutil.lval( httpContext.GetPar( "ImpuestoId")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ImpuestoId), 11, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(AV8ImpuestoId)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ImpuestoId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_TipoArticuloNombre, AV34IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Impuesto Articulo WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.impuestoarticulowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ImpuestoId,11,0))}, new String[] {"ImpuestoId"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_TIPOARTICULONOMBRE", getSecureSignedToken( sPrefix, AV33IsAuthorized_TipoArticuloNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8ImpuestoId", GXutil.ltrim( localUtil.ntoc( wcpOAV8ImpuestoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_TIPOARTICULONOMBRE", AV33IsAuthorized_TipoArticuloNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_TIPOARTICULONOMBRE", getSecureSignedToken( sPrefix, AV33IsAuthorized_TipoArticuloNombre));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( sPrefix, AV34IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vIMPUESTOID", GXutil.ltrim( localUtil.ntoc( AV8ImpuestoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return "ImpuestoArticuloWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Impuesto Articulo WC", "") ;
   }
   ...
   public void wb4L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.impuestoarticulowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ImpuestoArticuloWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_4L2( true) ;
      }
      else
      {
         wb_table1_21_4L2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_4L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4L2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Impuesto Articulo WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_36_Refreshing);
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ARTICULOID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A13ArticuloId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ARTICULOID", GXutil.ltrim( localUtil.ntoc( A13ArticuloId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV37Pgmname = "ImpuestoArticuloWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004L2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8ImpuestoId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A18ImpuestoId = H004L2_A18ImpuestoId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A18ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A18ImpuestoId), 11, 0));
            A231ArticuloImagen = H004L2_A231ArticuloImagen[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_36_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
            A40000ArticuloImagen_GXI = H004L2_A40000ArticuloImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_36_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
            A103TipoArticuloNombre = H004L2_A103TipoArticuloNombre[0] ;
            A17TipoArticuloId = H004L2_A17TipoArticuloId[0] ;
            A79ArticuloStock = H004L2_A79ArticuloStock[0] ;
            A222ArticuloPrecioPromedio = H004L2_A222ArticuloPrecioPromedio[0] ;
            A78ArticuloPrecioVenta = H004L2_A78ArticuloPrecioVenta[0] ;
            A77ArticuloPrecioCompra = H004L2_A77ArticuloPrecioCompra[0] ;
            A215ArticuloDescripcionLarga = H004L2_A215ArticuloDescripcionLarga[0] ;
            A214ArticuloDescripcionCorta = H004L2_A214ArticuloDescripcionCorta[0] ;
            A76ArticuloNombre = H004L2_A76ArticuloNombre[0] ;
            A13ArticuloId = H004L2_A13ArticuloId[0] ;
            A103TipoArticuloNombre = H004L2_A103TipoArticuloNombre[0] ;
            e184L2 ();
   ...
   public void send_integrity_lvl_hashes4L2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_INSERT", AV34IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( sPrefix, AV34IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ARTICULOID"+"_"+sGXsfl_36_idx, getSecureSignedToken( sPrefix+sGXsfl_36_idx, localUtil.format( DecimalUtil.doubleToDec(A13ArticuloId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004L3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8ImpuestoId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup4L0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8ImpuestoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ImpuestoId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e164L2( )
   {
      ...
      impuestoarticulowc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV33IsAuthorized_TipoArticuloNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV33IsAuthorized_TipoArticuloNombre", AV33IsAuthorized_TipoArticuloNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_TIPOARTICULONOMBRE", getSecureSignedToken( sPrefix, AV33IsAuthorized_TipoArticuloNombre));
      Ddo_grid_Gridinternalname = subGrid_Internalname ;
      ucDdo_grid.sendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
      edtImpuestoId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtImpuestoId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtImpuestoId_Visible), 5, 0), true);
   ...
   public void e174L2( )
   {
      ...
      impuestoarticulowc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e114L2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ImpuestoArticuloWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV37Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ImpuestoArticuloWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ImpuestoArticuloWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         impuestoarticulowc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ImpuestoArticuloWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ImpuestoId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8ImpuestoId, 11, 0) );
   ...
   public void wb_table1_21_4L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_4L2( true) ;
      }
      else
      {
         wb_table2_26_4L2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_4L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_4L2e( true) ;
      }
      else
      {
         wb_table1_21_4L2e( false) ;
      }
   }

   public void wb_table2_26_4L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8ImpuestoId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ImpuestoId), 11, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8ImpuestoId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "impuestoarticulowc", GetJustCreated( ));
      ...
      {
         AV8ImpuestoId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ImpuestoId), 11, 0));
      }
      wcpOAV8ImpuestoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ImpuestoId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( AV8ImpuestoId != wcpOAV8ImpuestoId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8ImpuestoId = AV8ImpuestoId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8ImpuestoId = httpContext.cgiGet( sPrefix+"AV8ImpuestoId_CTRL") ;
      if ( GXutil.len( sCtrlAV8ImpuestoId) > 0 )
      {
         AV8ImpuestoId = localUtil.ctol( httpContext.cgiGet( sCtrlAV8ImpuestoId), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ImpuestoId), 11, 0));
      }
      else
      {
         AV8ImpuestoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8ImpuestoId_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ImpuestoId_PARM", GXutil.ltrim( localUtil.ntoc( AV8ImpuestoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8ImpuestoId)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ImpuestoId_CTRL", GXutil.rtrim( sCtrlAV8ImpuestoId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211192474", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("impuestoarticulowc.js", "?20241211192474", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtArticuloId_Internalname = sPrefix+"ARTICULOID_"+sGXsfl_36_idx ;
      edtArticuloNombre_Internalname = sPrefix+"ARTICULONOMBRE_"+sGXsfl_36_idx ;
      edtArticuloDescripcionCorta_Internalname = sPrefix+"ARTICULODESCRIPCIONCORTA_"+sGXsfl_36_idx ;
      edtArticuloDescripcionLarga_Internalname = sPrefix+"ARTICULODESCRIPCIONLARGA_"+sGXsfl_36_idx ;
      edtArticuloPrecioCompra_Internalname = sPrefix+"ARTICULOPRECIOCOMPRA_"+sGXsfl_36_idx ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA_"+sGXsfl_36_idx ;
      edtArticuloPrecioPromedio_Internalname = sPrefix+"ARTICULOPRECIOPROMEDIO_"+sGXsfl_36_idx ;
      edtArticuloStock_Internalname = sPrefix+"ARTICULOSTOCK_"+sGXsfl_36_idx ;
      edtTipoArticuloId_Internalname = sPrefix+"TIPOARTICULOID_"+sGXsfl_36_idx ;
      edtTipoArticuloNombre_Internalname = sPrefix+"TIPOARTICULONOMBRE_"+sGXsfl_36_idx ;
      edtArticuloImagen_Internalname = sPrefix+"ARTICULOIMAGEN_"+sGXsfl_36_idx ;
   }
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtArticuloId_Internalname = sPrefix+"ARTICULOID_"+sGXsfl_36_fel_idx ;
      edtArticuloNombre_Internalname = sPrefix+"ARTICULONOMBRE_"+sGXsfl_36_fel_idx ;
      edtArticuloDescripcionCorta_Internalname = sPrefix+"ARTICULODESCRIPCIONCORTA_"+sGXsfl_36_fel_idx ;
      edtArticuloDescripcionLarga_Internalname = sPrefix+"ARTICULODESCRIPCIONLARGA_"+sGXsfl_36_fel_idx ;
      edtArticuloPrecioCompra_Internalname = sPrefix+"ARTICULOPRECIOCOMPRA_"+sGXsfl_36_fel_idx ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA_"+sGXsfl_36_fel_idx ;
      edtArticuloPrecioPromedio_Internalname = sPrefix+"ARTICULOPRECIOPROMEDIO_"+sGXsfl_36_fel_idx ;
      edtArticuloStock_Internalname = sPrefix+"ARTICULOSTOCK_"+sGXsfl_36_fel_idx ;
      edtTipoArticuloId_Internalname = sPrefix+"TIPOARTICULOID_"+sGXsfl_36_fel_idx ;
      edtTipoArticuloNombre_Internalname = sPrefix+"TIPOARTICULONOMBRE_"+sGXsfl_36_fel_idx ;
      edtArticuloImagen_Internalname = sPrefix+"ARTICULOIMAGEN_"+sGXsfl_36_fel_idx ;
   }
   ...
   public void sendrow_362( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_36_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtArticuloDescripcionCorta_Internalname,A214ArticuloDescripcionCorta,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtArticuloDescripcionCorta_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtArticuloPrecioVenta_Internalname,GXutil.ltrim( localUtil.ntoc( A78ArticuloPrecioVenta, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A78ArticuloPrecioVenta, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtArticuloPrecioVenta_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtArticuloStock_Internalname,GXutil.ltrim( localUtil.ntoc( A79ArticuloStock, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A79ArticuloStock), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtArticuloStock_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTipoArticuloNombre_Internalname,GXutil.rtrim( A103TipoArticuloNombre),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtTipoArticuloNombre_Link,"","","",edtTipoArticuloNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void init_default_properties( )
   {
      ...
      edtArticuloImagen_Internalname = sPrefix+"ARTICULOIMAGEN" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:ArticuloId|4:ArticuloNombre|5:ArticuloDescripcionCorta|6:ArticuloDescripcionLarga|7:ArticuloPrecioCompra|8:ArticuloPrecioVenta|9:ArticuloPrecioPromedio|10:ArticuloStock|11:TipoArticuloId|12:TipoArticuloNombre" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8ImpuestoId',fld:'vIMPUESTOID',pic:'ZZZZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ImpuestoId',fld:'vIMPUESTOID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A13ArticuloId',fld:'ARTICULOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004L2_A18ImpuestoId = new long[1] ;
      H004L2_A231ArticuloImagen = new String[] {""} ;
      H004L2_A40000ArticuloImagen_GXI = new String[] {""} ;
      H004L2_A103TipoArticuloNombre = new String[] {""} ;
      H004L2_A17TipoArticuloId = new long[1] ;
      H004L2_A79ArticuloStock = new long[1] ;
      H004L2_A222ArticuloPrecioPromedio = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004L2_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004L2_A77ArticuloPrecioCompra = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004L2_A215ArticuloDescripcionLarga = new String[] {""} ;
      H004L2_A214ArticuloDescripcionCorta = new String[] {""} ;
      H004L2_A76ArticuloNombre = new String[] {""} ;
      H004L2_A13ArticuloId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.impuestoarticulowc__default(),
         new Object[] {
             new Object[] {
            H004L2_A18ImpuestoId, H004L2_A231ArticuloImagen, H004L2_A40000ArticuloImagen_GXI, H004L2_A103TipoArticuloNombre, H004L2_A17TipoArticuloId, H004L2_A79ArticuloStock, H004L2_A222ArticuloPrecioPromedio, H004L2_A78ArticuloPrecioVenta, H004L2_A77ArticuloPrecioCompra, H004L2_A215ArticuloDescripcionLarga,
            H004L2_A214ArticuloDescripcionCorta, H004L2_A76ArticuloNombre, H004L2_A13ArticuloId
            }
            , new Object[] {
   ...
   private int edtImpuestoId_Visible ;
   ...
   private long wcpOAV8ImpuestoId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8ImpuestoId ;
   ...
   private String sCtrlAV8ImpuestoId ;
   ...
   private long[] H004L2_A18ImpuestoId ;
   private String[] H004L2_A231ArticuloImagen ;
   private String[] H004L2_A40000ArticuloImagen_GXI ;
   private String[] H004L2_A103TipoArticuloNombre ;
   private long[] H004L2_A17TipoArticuloId ;
   private long[] H004L2_A79ArticuloStock ;
   private java.math.BigDecimal[] H004L2_A222ArticuloPrecioPromedio ;
   private java.math.BigDecimal[] H004L2_A78ArticuloPrecioVenta ;
   private java.math.BigDecimal[] H004L2_A77ArticuloPrecioCompra ;
   private String[] H004L2_A215ArticuloDescripcionLarga ;
   private String[] H004L2_A214ArticuloDescripcionCorta ;
   private String[] H004L2_A76ArticuloNombre ;
   private long[] H004L2_A13ArticuloId ;
...
final  class impuestoarticulowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004L2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A18ImpuestoId )
   {
      ...
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloNombre]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloDescripcionCorta]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloDescripcionCorta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloDescripcionLarga]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloDescripcionLarga] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloPrecioCompra]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloPrecioCompra] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloPrecioVenta]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloPrecioVenta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloPrecioPromedio]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloPrecioPromedio] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[ArticuloStock]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[ArticuloStock] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T1.[TipoArticuloId]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T1.[TipoArticuloId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId], T2.[TipoArticuloNombre]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ImpuestoId] DESC, T2.[TipoArticuloNombre] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H004L3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          long A13ArticuloId ,
                                          ...
                                          long A18ImpuestoId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Articulo] T1 INNER JOIN [TipoArticulo] T2 ON T2.[TipoArticuloId] = T1.[TipoArticuloId])" ;
      addWhere(sWhereString, "(T1.[ImpuestoId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T1.[ArticuloNombre] like '%' + ?) or ( T1.[ArticuloDescripcionCorta] like '%' + ?) or ( T1.[ArticuloDescripcionLarga] like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioCompra] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioVenta] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioPromedio] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[ArticuloStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TipoArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[TipoArticuloNombre] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004L2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , (java.math.BigDecimal)dynConstraints[6] , (java.math.BigDecimal)dynConstraints[7] , ((Number) dynConstraints[8]).longValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).longValue() , ((Number) dynConstraints[13]).longValue() );
            case 1 :
                  return conditional_H004L3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , (java.math.BigDecimal)dynConstraints[6] , (java.math.BigDecimal)dynConstraints[7] , ((Number) dynConstraints[8]).longValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).longValue() , ((Number) dynConstraints[13]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004L2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004L3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
