...
public final  class localidadww_impl extends GXDataArea
{
   public localidadww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public localidadww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( localidadww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV33IsAuthorized_LocalidadNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_LocalidadNombre")) ;
      AV37IsAuthorized_CiudadNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_CiudadNombre")) ;
      AV38IsAuthorized_DepartamentoNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_DepartamentoNombre")) ;
      AV39IsAuthorized_PaisNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_PaisNombre")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV42Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_LocalidadNombre, AV37IsAuthorized_CiudadNombre, AV38IsAuthorized_DepartamentoNombre, AV39IsAuthorized_PaisNombre, AV36IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.localidadww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV42Pgmname, ""))));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_LocalidadNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV37IsAuthorized_CiudadNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV38IsAuthorized_DepartamentoNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_PAISNOMBRE", getSecureSignedToken( "", AV39IsAuthorized_PaisNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV42Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV42Pgmname, ""))));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_LOCALIDADNOMBRE", AV33IsAuthorized_LocalidadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_LocalidadNombre));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_CIUDADNOMBRE", AV37IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV37IsAuthorized_CiudadNombre));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DEPARTAMENTONOMBRE", AV38IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV38IsAuthorized_DepartamentoNombre));
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_PAISNOMBRE", AV39IsAuthorized_PaisNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_PAISNOMBRE", getSecureSignedToken( "", AV39IsAuthorized_PaisNombre));
   ...
   {
      return formatLink("com.mujermorena.localidadww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Localidad", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_LocalidadWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_LocalidadWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0Q2( true) ;
      }
      else
      {
         wb_table1_22_0Q2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV33IsAuthorized_LocalidadNombre ,
                                 boolean AV37IsAuthorized_CiudadNombre ,
                                 boolean AV38IsAuthorized_DepartamentoNombre ,
                                 boolean AV39IsAuthorized_PaisNombre ,
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_LOCALIDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A3LocalidadId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "LOCALIDADID", GXutil.ltrim( localUtil.ntoc( A3LocalidadId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf0Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV43Localidadwwds_1_filterfulltext ,
         ...
         lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
         lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
         lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
         lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
         lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
         lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000Q2 */
         pr_default.execute(0, new Object[] {lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A6DepartamentoId = H000Q2_A6DepartamentoId[0] ;
            A5PaisId = H000Q2_A5PaisId[0] ;
            A60PaisNombre = H000Q2_A60PaisNombre[0] ;
            A61DepartamentoNombre = H000Q2_A61DepartamentoNombre[0] ;
            A62CiudadNombre = H000Q2_A62CiudadNombre[0] ;
            A7CiudadId = H000Q2_A7CiudadId[0] ;
            A64LocalidadNombre = H000Q2_A64LocalidadNombre[0] ;
            A3LocalidadId = H000Q2_A3LocalidadId[0] ;
            A6DepartamentoId = H000Q2_A6DepartamentoId[0] ;
            A62CiudadNombre = H000Q2_A62CiudadNombre[0] ;
            A5PaisId = H000Q2_A5PaisId[0] ;
            A61DepartamentoNombre = H000Q2_A61DepartamentoNombre[0] ;
   ...
   public void send_integrity_lvl_hashes0Q2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_LOCALIDADID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A3LocalidadId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV43Localidadwwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV43Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV43Localidadwwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000Q3 */
      pr_default.execute(1, new Object[] {lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext, lV43Localidadwwds_1_filterfulltext});
   ...
   public void e170Q2( )
   {
      ...
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV34AGExportData.add(AV35AGExportDataItem, 0);
      GXt_boolean1 = AV33IsAuthorized_LocalidadNombre ;
      ...
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV33IsAuthorized_LocalidadNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV33IsAuthorized_LocalidadNombre", AV33IsAuthorized_LocalidadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_LocalidadNombre));
      GXt_boolean1 = AV37IsAuthorized_CiudadNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      ...
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV37IsAuthorized_CiudadNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV37IsAuthorized_CiudadNombre", AV37IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV37IsAuthorized_CiudadNombre));
      GXt_boolean1 = AV38IsAuthorized_DepartamentoNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      ...
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV38IsAuthorized_DepartamentoNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV38IsAuthorized_DepartamentoNombre", AV38IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV38IsAuthorized_DepartamentoNombre));
      GXt_boolean1 = AV39IsAuthorized_PaisNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "paisview_Execute", GXv_boolean2) ;
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV39IsAuthorized_PaisNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV39IsAuthorized_PaisNombre", AV39IsAuthorized_PaisNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_PAISNOMBRE", getSecureSignedToken( "", AV39IsAuthorized_PaisNombre));
   ...
   public void e180Q2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV42Pgmname, GXv_char7) ;
      localidadww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e190Q2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.localidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3LocalidadId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"LocalidadId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.localidad", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A3LocalidadId,11,0))}, new String[] {"Mode","LocalidadId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.localidad", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A3LocalidadId,11,0))}, new String[] {"Mode","LocalidadId"})  ;
      }
      if ( AV33IsAuthorized_LocalidadNombre )
      {
      ...
      if ( AV37IsAuthorized_CiudadNombre )
      {
      ...
      if ( AV38IsAuthorized_DepartamentoNombre )
      {
      ...
      if ( AV39IsAuthorized_PaisNombre )
      {
         edtPaisNombre_Link = formatLink("com.mujermorena.paisview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A5PaisId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"PaisId","TabCode"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e110Q2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("LocalidadWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV42Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("LocalidadWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "LocalidadWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         localidadww_impl.this.GXt_char6 = GXv_char7[0] ;
         ...
         else
         {
            ...
            S172 ();
            if (returnInSub) return;
            new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV42Pgmname+"GridState", AV20ManageFiltersXml) ;
   ...
   public void e160Q2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.localidad", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","LocalidadId"}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "localidad_Update", GXv_boolean2) ;
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "localidad_Delete", GXv_boolean2) ;
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "localidad_Insert", GXv_boolean2) ;
      localidadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "LocalidadWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S132( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV18Session.getValue(AV42Pgmname+"GridState"), "") == 0 )
      {
         AV11GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV42Pgmname+"GridState"), null, null);
      }
      else
      {
         AV11GridState.fromxml(AV18Session.getValue(AV42Pgmname+"GridState"), null, null);
      }
      AV13OrderedBy = AV11GridState.getgxTv_SdtWWPGridState_Orderedby() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13OrderedBy", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13OrderedBy), 4, 0));
      AV14OrderedDsc = AV11GridState.getgxTv_SdtWWPGridState_Ordereddsc() ;
   ...
   public void S162( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV42Pgmname+"GridState", AV11GridState.toxml(false, true, "WWPGridState", "Mujer_Morena")) ;
   }
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV42Pgmname );
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Localidad" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.localidadwwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      localidadww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      localidadww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.localidadwwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0Q2( true) ;
      }
      else
      {
         wb_table2_27_0Q2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0Q2e( true) ;
      }
      else
      {
         wb_table1_22_0Q2e( false) ;
      }
   }

   public void wb_table2_27_0Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111122213", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("localidadww.js", "?202412111122213", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtLocalidadId_Internalname = "LOCALIDADID_"+sGXsfl_40_idx ;
      edtLocalidadNombre_Internalname = "LOCALIDADNOMBRE_"+sGXsfl_40_idx ;
      edtCiudadId_Internalname = "CIUDADID_"+sGXsfl_40_idx ;
      ...
      edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtLocalidadId_Internalname = "LOCALIDADID_"+sGXsfl_40_fel_idx ;
      edtLocalidadNombre_Internalname = "LOCALIDADNOMBRE_"+sGXsfl_40_fel_idx ;
      edtCiudadId_Internalname = "CIUDADID_"+sGXsfl_40_fel_idx ;
      ...
      edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiudadId_Internalname,GXutil.ltrim( localUtil.ntoc( A7CiudadId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A7CiudadId), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCiudadId_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPaisNombre_Internalname,GXutil.rtrim( A60PaisNombre),"","","'"+""+"'"+",false,"+"'"+""+"'",edtPaisNombre_Link,"","","",edtPaisNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A7CiudadId, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A60PaisNombre));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtPaisNombre_Link));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:LocalidadId|4:LocalidadNombre|5:CiudadId|6:CiudadNombre|7:DepartamentoNombre|8:PaisNombre" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e120Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e130Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e150Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e190Q2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A3LocalidadId',fld:'LOCALIDADID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'A7CiudadId',fld:'CIUDADID',pic:'ZZZZZZZZZZ9'},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'A6DepartamentoId',fld:'DEPARTAMENTOID',pic:'ZZZZZZZZZZ9'},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'A5PaisId',fld:'PAISID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLocalidadNombre_Link',ctrl:'LOCALIDADNOMBRE',prop:'Link'},{av:'edtCiudadNombre_Link',ctrl:'CIUDADNOMBRE',prop:'Link'},{av:'edtDepartamentoNombre_Link',ctrl:'DEPARTAMENTONOMBRE',prop:'Link'},{av:'edtPaisNombre_Link',ctrl:'PAISNOMBRE',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e110Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A3LocalidadId',fld:'LOCALIDADID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140Q2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV37IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
   ...
   public void initialize( )
   {
      ...
      lV43Localidadwwds_1_filterfulltext = "" ;
      AV43Localidadwwds_1_filterfulltext = "" ;
      H000Q2_A6DepartamentoId = new long[1] ;
      H000Q2_A5PaisId = new long[1] ;
      H000Q2_A60PaisNombre = new String[] {""} ;
      H000Q2_A61DepartamentoNombre = new String[] {""} ;
      H000Q2_A62CiudadNombre = new String[] {""} ;
      H000Q2_A7CiudadId = new long[1] ;
      H000Q2_A64LocalidadNombre = new String[] {""} ;
      H000Q2_A3LocalidadId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.localidadww__default(),
         new Object[] {
             new Object[] {
            H000Q2_A6DepartamentoId, H000Q2_A5PaisId, H000Q2_A60PaisNombre, H000Q2_A61DepartamentoNombre, H000Q2_A62CiudadNombre, H000Q2_A7CiudadId, H000Q2_A64LocalidadNombre, H000Q2_A3LocalidadId
            }
            , new Object[] {
   ...
   private boolean AV33IsAuthorized_LocalidadNombre ;
   private boolean AV37IsAuthorized_CiudadNombre ;
   private boolean AV38IsAuthorized_DepartamentoNombre ;
   private boolean AV39IsAuthorized_PaisNombre ;
   ...
   private String lV43Localidadwwds_1_filterfulltext ;
   private String AV43Localidadwwds_1_filterfulltext ;
   ...
   private long[] H000Q2_A6DepartamentoId ;
   private long[] H000Q2_A5PaisId ;
   private String[] H000Q2_A60PaisNombre ;
   private String[] H000Q2_A61DepartamentoNombre ;
   private String[] H000Q2_A62CiudadNombre ;
   private long[] H000Q2_A7CiudadId ;
   private String[] H000Q2_A64LocalidadNombre ;
   private long[] H000Q2_A3LocalidadId ;
...
final  class localidadww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000Q2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV43Localidadwwds_1_filterfulltext ,
                                          long A3LocalidadId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T2.[DepartamentoId], T3.[PaisId], T4.[PaisNombre], T3.[DepartamentoNombre], T2.[CiudadNombre], T1.[CiudadId], T1.[LocalidadNombre], T1.[LocalidadId]" ;
      sFromString = " FROM ((([Localidad] T1 INNER JOIN [Ciudad] T2 ON T2.[CiudadId] = T1.[CiudadId]) INNER JOIN [Departamento] T3 ON T3.[DepartamentoId] = T2.[DepartamentoId]) INNER" ;
      sFromString += " JOIN [Pais] T4 ON T4.[PaisId] = T3.[PaisId])" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV43Localidadwwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY T1.[LocalidadNombre]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[LocalidadNombre] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T1.[CiudadId]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[CiudadId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[CiudadNombre]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[CiudadNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T3.[DepartamentoNombre]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[DepartamentoNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T4.[PaisNombre]" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T4.[PaisNombre] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[LocalidadId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ((([Localidad] T1 INNER JOIN [Ciudad] T2 ON T2.[CiudadId] = T1.[CiudadId]) INNER JOIN [Departamento] T3 ON T3.[DepartamentoId] = T2.[DepartamentoId])" ;
      scmdbuf += " INNER JOIN [Pais] T4 ON T4.[PaisId] = T3.[PaisId])" ;
      if ( ! (GXutil.strcmp("", AV43Localidadwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[LocalidadId] AS decimal(11,0))) like '%' + ?) or ( T1.[LocalidadNombre] like '%' + ?) or ( CONVERT( char(11), CAST(T1.[CiudadId] AS decimal(11,0))) like '%' + ?) or ( T2.[CiudadNombre] like '%' + ?) or ( T3.[DepartamentoNombre] like '%' + ?) or ( T4.[PaisNombre] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000Q2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
            case 1 :
                  return conditional_H000Q3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
      }
