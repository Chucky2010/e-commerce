...
public final  class cajeroprompt_impl extends GXDataArea
{
   public cajeroprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public cajeroprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( cajeroprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutCajeroId") ;
         ...
         {
            AV8InOutCajeroId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCajeroId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCajeroId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.cajeroprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCajeroId,11,0))}, new String[] {"InOutCajeroId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCAJEROID", GXutil.ltrim( localUtil.ntoc( AV8InOutCajeroId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.cajeroprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCajeroId,11,0))}, new String[] {"InOutCajeroId"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Selecciona Cajero", "") ;
   }
   ...
   public void wb160( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_162( true) ;
      }
      else
      {
         wb_table1_14_162( false) ;
      }
      return  ;
   }

   public void wb_table1_14_162e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start162( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Cajero", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf162( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A254CajeroUsuarioID = H00162_A254CajeroUsuarioID[0] ;
            A113CajeroIdentificador = H00162_A113CajeroIdentificador[0] ;
            A112CajeroNombre = H00162_A112CajeroNombre[0] ;
            A26CajeroId = H00162_A26CajeroId[0] ;
            e17162 ();
   ...
   public void send_integrity_lvl_hashes162( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CAJEROID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A26CajeroId), "ZZZZZZZZZZ9")));
   }
   ...
   public void e15162( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Cajero", "") );
   ...
   public void e16162( )
   {
      ...
      cajeroprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e18162( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutCajeroId = A26CajeroId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCajeroId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCajeroId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutCajeroId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutCajeroId"});
   ...
   public void wb_table1_14_162( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_CajeroPrompt.htm");
   ...
   {
      AV8InOutCajeroId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCajeroId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCajeroId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111125988", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("cajeroprompt.js", "?202412111125988", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtCajeroIdentificador_Internalname = "CAJEROIDENTIFICADOR_"+sGXsfl_26_idx ;
      edtCajeroUsuarioID_Internalname = "CAJEROUSUARIOID_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtCajeroIdentificador_Internalname = "CAJEROIDENTIFICADOR_"+sGXsfl_26_fel_idx ;
      edtCajeroUsuarioID_Internalname = "CAJEROUSUARIOID_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:CajeroId|2:CajeroNombre|3:CajeroIdentificador|4:CajeroUsuarioID" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17162',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18162',iparms:[{av:'A26CajeroId',fld:'CAJEROID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCajeroId',fld:'vINOUTCAJEROID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14162',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00162_A254CajeroUsuarioID = new String[] {""} ;
      H00162_A113CajeroIdentificador = new long[1] ;
      H00162_A112CajeroNombre = new String[] {""} ;
      H00162_A26CajeroId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.cajeroprompt__default(),
         new Object[] {
             new Object[] {
            H00162_A254CajeroUsuarioID, H00162_A113CajeroIdentificador, H00162_A112CajeroNombre, H00162_A26CajeroId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutCajeroId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutCajeroId ;
   ...
   private String[] H00162_A254CajeroUsuarioID ;
   private long[] H00162_A113CajeroIdentificador ;
   private String[] H00162_A112CajeroNombre ;
   private long[] H00162_A26CajeroId ;
...
final  class cajeroprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00162(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H00163(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00162", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00163", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
