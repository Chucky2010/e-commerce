...
public final  class clientepedidoswc_impl extends GXWebComponent
{
   public clientepedidoswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clientepedidoswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clientepedidoswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8ClienteId = GXutil.lval( httpContext.GetPar( "ClienteId")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClienteId), 11, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(AV8ClienteId)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ClienteId, AV20ManageFiltersExecutionStep, AV36Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Cliente Pedidos WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.clientepedidoswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ClienteId,11,0))}, new String[] {"ClienteId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8ClienteId", GXutil.ltrim( localUtil.ntoc( wcpOAV8ClienteId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( sPrefix, AV33IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCLIENTEID", GXutil.ltrim( localUtil.ntoc( AV8ClienteId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseForm4B2( )
   {
   ...
   {
      return "ClientePedidosWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Cliente Pedidos WC", "") ;
   }
   ...
   public void wb4B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.clientepedidoswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ClientePedidosWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_4B2( true) ;
      }
      else
      {
         wb_table1_21_4B2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_4B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Cliente Pedidos WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public int subgridclient_rec_count_fnc( )
   {
      ...
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           ...
                                           A250PedidosSubTotal ,
                                           A248PedidosTotal ,
                                           Long.valueOf(AV8ClienteId) ,
                                           Long.valueOf(A4ClienteId) } ,
                                           new int[]{
                                           TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.LONG
                                           }
      });
      /* Using cursor H004B3 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV8ClienteId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A4ClienteId = H004B3_A4ClienteId[0] ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A4ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A4ClienteId), 11, 0));
         A247PedidosEstado = H004B3_A247PedidosEstado[0] ;
         A246PedidosFecha = H004B3_A246PedidosFecha[0] ;
         A51PedidosID = H004B3_A51PedidosID[0] ;
         A248PedidosTotal = H004B3_A248PedidosTotal[0] ;
         A250PedidosSubTotal = H004B3_A250PedidosSubTotal[0] ;
         A248PedidosTotal = H004B3_A248PedidosTotal[0] ;
         A250PedidosSubTotal = H004B3_A250PedidosSubTotal[0] ;
         if ( (GXutil.strcmp("", AV16FilterFullText)==0) || ( ( GXutil.like( GXutil.str( A51PedidosID, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( httpContext.getMessage( "pendiente", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "PEN") == 0 ) ) || ( GXutil.like( httpContext.getMessage( "confirmado", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "FIN") == 0 ) ) || ( GXutil.like( GXutil.str( A250PedidosSubTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A248PedidosTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) ) )
         {
   ...
   public void rf4B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H004B5 */
         pr_default.execute(1, new Object[] {Long.valueOf(AV8ClienteId)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         GRID_nEOF = (byte)(0) ;
         ...
         {
            A4ClienteId = H004B5_A4ClienteId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A4ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A4ClienteId), 11, 0));
            A247PedidosEstado = H004B5_A247PedidosEstado[0] ;
            A246PedidosFecha = H004B5_A246PedidosFecha[0] ;
            A51PedidosID = H004B5_A51PedidosID[0] ;
            A248PedidosTotal = H004B5_A248PedidosTotal[0] ;
            A250PedidosSubTotal = H004B5_A250PedidosSubTotal[0] ;
            A248PedidosTotal = H004B5_A248PedidosTotal[0] ;
            A250PedidosSubTotal = H004B5_A250PedidosSubTotal[0] ;
            if ( (GXutil.strcmp("", AV16FilterFullText)==0) || ( ( GXutil.like( GXutil.str( A51PedidosID, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( httpContext.getMessage( "pendiente", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "PEN") == 0 ) ) || ( GXutil.like( httpContext.getMessage( "confirmado", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "FIN") == 0 ) ) || ( GXutil.like( GXutil.str( A250PedidosSubTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A248PedidosTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) ) )
            {
   ...
   public void send_integrity_lvl_hashes4B2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV36Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV36Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DISPLAY", AV28IsAuthorized_Display);
   ...
   public void strup4B0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8ClienteId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ClienteId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e164B2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtClienteId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtClienteId_Visible), 5, 0), true);
   ...
   public void e174B2( )
   {
      ...
      clientepedidoswc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e114B2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ClientePedidosWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV36Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ClientePedidosWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ClientePedidosWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         clientepedidoswc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidosview_Execute", GXv_boolean7) ;
      clientepedidoswc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidos_Update", GXv_boolean7) ;
      clientepedidoswc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidos_Delete", GXv_boolean7) ;
      clientepedidoswc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidos_Insert", GXv_boolean7) ;
      clientepedidoswc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ClientePedidosWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ClienteId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8ClienteId, 11, 0) );
   ...
   public void wb_table1_21_4B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_4B2( true) ;
      }
      else
      {
         wb_table2_26_4B2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_4B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_4B2e( true) ;
      }
      else
      {
         wb_table1_21_4B2e( false) ;
      }
   }

   public void wb_table2_26_4B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8ClienteId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClienteId), 11, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8ClienteId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "clientepedidoswc", GetJustCreated( ));
      ...
      {
         AV8ClienteId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClienteId), 11, 0));
      }
      wcpOAV8ClienteId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ClienteId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( AV8ClienteId != wcpOAV8ClienteId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8ClienteId = AV8ClienteId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8ClienteId = httpContext.cgiGet( sPrefix+"AV8ClienteId_CTRL") ;
      if ( GXutil.len( sCtrlAV8ClienteId) > 0 )
      {
         AV8ClienteId = localUtil.ctol( httpContext.cgiGet( sCtrlAV8ClienteId), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClienteId), 11, 0));
      }
      else
      {
         AV8ClienteId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8ClienteId_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ClienteId_PARM", GXutil.ltrim( localUtil.ntoc( AV8ClienteId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8ClienteId)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ClienteId_CTRL", GXutil.rtrim( sCtrlAV8ClienteId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111105654", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("clientepedidoswc.js", "?202412111105654", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:PedidosID|4:PedidosFecha|5:PedidosEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184B2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A51PedidosID',fld:'PEDIDOSID',pic:'ZZZZZZZZZZ9'},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ClienteId',fld:'vCLIENTEID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV36Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A51PedidosID',fld:'PEDIDOSID',pic:'ZZZZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004B3_A4ClienteId = new long[1] ;
      H004B3_A247PedidosEstado = new String[] {""} ;
      H004B3_A246PedidosFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H004B3_A51PedidosID = new long[1] ;
      H004B3_A248PedidosTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004B3_A250PedidosSubTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004B5_A4ClienteId = new long[1] ;
      H004B5_A247PedidosEstado = new String[] {""} ;
      H004B5_A246PedidosFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H004B5_A51PedidosID = new long[1] ;
      H004B5_A248PedidosTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004B5_A250PedidosSubTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.clientepedidoswc__default(),
         new Object[] {
             new Object[] {
            H004B3_A4ClienteId, H004B3_A247PedidosEstado, H004B3_A246PedidosFecha, H004B3_A51PedidosID, H004B3_A248PedidosTotal, H004B3_A250PedidosSubTotal
            }
            , new Object[] {
            H004B5_A4ClienteId, H004B5_A247PedidosEstado, H004B5_A246PedidosFecha, H004B5_A51PedidosID, H004B5_A248PedidosTotal, H004B5_A250PedidosSubTotal
            }
         }
      );
      AV36Pgmname = "ClientePedidosWC" ;
   ...
   private String sCtrlAV8ClienteId ;
   ...
   private long[] H004B3_A4ClienteId ;
   private String[] H004B3_A247PedidosEstado ;
   private java.util.Date[] H004B3_A246PedidosFecha ;
   private long[] H004B3_A51PedidosID ;
   private java.math.BigDecimal[] H004B3_A248PedidosTotal ;
   private java.math.BigDecimal[] H004B3_A250PedidosSubTotal ;
   private long[] H004B5_A4ClienteId ;
   private String[] H004B5_A247PedidosEstado ;
   private java.util.Date[] H004B5_A246PedidosFecha ;
   private long[] H004B5_A51PedidosID ;
   private java.math.BigDecimal[] H004B5_A248PedidosTotal ;
   private java.math.BigDecimal[] H004B5_A250PedidosSubTotal ;
...
final  class clientepedidoswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004B3( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A4ClienteId )
   {
      ...
      scmdbuf = "SELECT T1.[ClienteId], T1.[PedidosEstado], T1.[PedidosFecha], T1.[PedidosID], COALESCE( T2.[PedidosTotal], 0) AS PedidosTotal, COALESCE( T2.[PedidosTotal], 0) AS" ;
      scmdbuf += " PedidosSubTotal FROM ([Pedidos] T1 LEFT JOIN (SELECT T3.[PedidosID], SUM(T4.[ArticuloPrecioVenta] * CAST(T3.[PedidosDetalleCantidad] AS decimal( 27, 10))) AS PedidosTotal" ;
      scmdbuf += " FROM ([PedidosDetalle] T3 INNER JOIN [Articulo] T4 ON T4.[ArticuloId] = T3.[ArticuloId]) GROUP BY T3.[PedidosID] ) T2 ON T2.[PedidosID] = T1.[PedidosID])" ;
      addWhere(sWhereString, "(T1.[ClienteId] = ?)");
      scmdbuf += sWhereString ;
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ClienteId], T1.[PedidosID]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ClienteId] DESC, T1.[PedidosID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ClienteId], T1.[PedidosFecha]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ClienteId] DESC, T1.[PedidosFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[ClienteId], T1.[PedidosEstado]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[ClienteId] DESC, T1.[PedidosEstado] DESC" ;
      }
   ...
   protected Object[] conditional_H004B5( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004B3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , (java.math.BigDecimal)dynConstraints[6] , ((Number) dynConstraints[7]).longValue() , ((Number) dynConstraints[8]).longValue() );
            case 1 :
                  return conditional_H004B5(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , (java.math.BigDecimal)dynConstraints[6] , ((Number) dynConstraints[7]).longValue() , ((Number) dynConstraints[8]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004B3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004B5", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
      };
   }
