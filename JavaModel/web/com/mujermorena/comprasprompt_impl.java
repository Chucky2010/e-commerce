...
public final  class comprasprompt_impl extends GXDataArea
{
   public comprasprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public comprasprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( comprasprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutComprasId") ;
         ...
         {
            AV8InOutComprasId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutComprasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutComprasId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.comprasprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutComprasId,11,0))}, new String[] {"InOutComprasId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCOMPRASID", GXutil.ltrim( localUtil.ntoc( AV8InOutComprasId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.comprasprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutComprasId,11,0))}, new String[] {"InOutComprasId"})  ;
   }

   public String getPgmname( )
   {
      return "ComprasPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Compras", "") ;
   }
   ...
   public void wb4W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_4W2( true) ;
      }
      else
      {
         wb_table1_14_4W2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_4W2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start4W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Compras", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf4W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H004W7 */
         pr_default.execute(0, new Object[] {AV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A88ComprasTotal10 = H004W7_A88ComprasTotal10[0] ;
            A86ComprasTotal5 = H004W7_A86ComprasTotal5[0] ;
            A227ComprasNumeroFactura = H004W7_A227ComprasNumeroFactura[0] ;
            A226ComprasTimbrado = H004W7_A226ComprasTimbrado[0] ;
            A10ProveedorId = H004W7_A10ProveedorId[0] ;
            A74ComprasFecha = H004W7_A74ComprasFecha[0] ;
            A11ComprasId = H004W7_A11ComprasId[0] ;
            A225ComprasTotalIva = H004W7_A225ComprasTotalIva[0] ;
            n225ComprasTotalIva = H004W7_n225ComprasTotalIva[0] ;
            A89ComprasTotalIva10 = H004W7_A89ComprasTotalIva10[0] ;
            A87ComprasTotalIva5 = H004W7_A87ComprasTotalIva5[0] ;
            A229ComprasTotal = H004W7_A229ComprasTotal[0] ;
            n229ComprasTotal = H004W7_n229ComprasTotal[0] ;
            A90ComprasTotalExento = H004W7_A90ComprasTotalExento[0] ;
            A88ComprasTotal10 = H004W7_A88ComprasTotal10[0] ;
            A86ComprasTotal5 = H004W7_A86ComprasTotal5[0] ;
            A225ComprasTotalIva = H004W7_A225ComprasTotalIva[0] ;
            n225ComprasTotalIva = H004W7_n225ComprasTotalIva[0] ;
   ...
   public void send_integrity_lvl_hashes4W2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_COMPRASID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A11ComprasId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H004W13 */
      pr_default.execute(1, new Object[] {AV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText});
      GRID_nRecordCount = H004W13_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e154W2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Compras", "") );
   ...
   public void e164W2( )
   {
      ...
      comprasprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e184W2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutComprasId = A11ComprasId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutComprasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutComprasId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutComprasId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutComprasId"});
   ...
   public void wb_table1_14_4W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ComprasPrompt.htm");
   ...
   {
      AV8InOutComprasId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutComprasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutComprasId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111231263", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("comprasprompt.js", "?202412111231263", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtComprasId_Internalname = "COMPRASID_"+sGXsfl_26_idx ;
      edtComprasFecha_Internalname = "COMPRASFECHA_"+sGXsfl_26_idx ;
      edtProveedorId_Internalname = "PROVEEDORID_"+sGXsfl_26_idx ;
      edtComprasTimbrado_Internalname = "COMPRASTIMBRADO_"+sGXsfl_26_idx ;
      edtComprasNumeroFactura_Internalname = "COMPRASNUMEROFACTURA_"+sGXsfl_26_idx ;
      edtComprasTotalExento_Internalname = "COMPRASTOTALEXENTO_"+sGXsfl_26_idx ;
      edtComprasTotalIva5_Internalname = "COMPRASTOTALIVA5_"+sGXsfl_26_idx ;
      edtComprasTotalIva10_Internalname = "COMPRASTOTALIVA10_"+sGXsfl_26_idx ;
      edtComprasTotal_Internalname = "COMPRASTOTAL_"+sGXsfl_26_idx ;
      edtComprasTotal5_Internalname = "COMPRASTOTAL5_"+sGXsfl_26_idx ;
      edtComprasTotal10_Internalname = "COMPRASTOTAL10_"+sGXsfl_26_idx ;
      edtComprasTotalIva_Internalname = "COMPRASTOTALIVA_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtComprasId_Internalname = "COMPRASID_"+sGXsfl_26_fel_idx ;
      edtComprasFecha_Internalname = "COMPRASFECHA_"+sGXsfl_26_fel_idx ;
      edtProveedorId_Internalname = "PROVEEDORID_"+sGXsfl_26_fel_idx ;
      edtComprasTimbrado_Internalname = "COMPRASTIMBRADO_"+sGXsfl_26_fel_idx ;
      edtComprasNumeroFactura_Internalname = "COMPRASNUMEROFACTURA_"+sGXsfl_26_fel_idx ;
      edtComprasTotalExento_Internalname = "COMPRASTOTALEXENTO_"+sGXsfl_26_fel_idx ;
      edtComprasTotalIva5_Internalname = "COMPRASTOTALIVA5_"+sGXsfl_26_fel_idx ;
      edtComprasTotalIva10_Internalname = "COMPRASTOTALIVA10_"+sGXsfl_26_fel_idx ;
      edtComprasTotal_Internalname = "COMPRASTOTAL_"+sGXsfl_26_fel_idx ;
      edtComprasTotal5_Internalname = "COMPRASTOTAL5_"+sGXsfl_26_fel_idx ;
      edtComprasTotal10_Internalname = "COMPRASTOTAL10_"+sGXsfl_26_fel_idx ;
      edtComprasTotalIva_Internalname = "COMPRASTOTALIVA_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ComprasId|2:ComprasFecha|3:ProveedorId|4:ComprasTimbrado|5:ComprasNumeroFactura" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e174W2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e184W2',iparms:[{av:'A11ComprasId',fld:'COMPRASID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutComprasId',fld:'vINOUTCOMPRASID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e144W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H004W7_A88ComprasTotal10 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W7_A86ComprasTotal5 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W7_A227ComprasNumeroFactura = new long[1] ;
      H004W7_A226ComprasTimbrado = new long[1] ;
      H004W7_A10ProveedorId = new long[1] ;
      H004W7_A74ComprasFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H004W7_A11ComprasId = new long[1] ;
      H004W7_A225ComprasTotalIva = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W7_n225ComprasTotalIva = new boolean[] {false} ;
      H004W7_A89ComprasTotalIva10 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W7_A87ComprasTotalIva5 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W7_A229ComprasTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W7_n229ComprasTotal = new boolean[] {false} ;
      H004W7_A90ComprasTotalExento = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004W13_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.comprasprompt__default(),
         new Object[] {
             new Object[] {
            H004W7_A88ComprasTotal10, H004W7_A86ComprasTotal5, H004W7_A227ComprasNumeroFactura, H004W7_A226ComprasTimbrado, H004W7_A10ProveedorId, H004W7_A74ComprasFecha, H004W7_A11ComprasId, H004W7_A225ComprasTotalIva, H004W7_n225ComprasTotalIva, H004W7_A89ComprasTotalIva10,
            H004W7_A87ComprasTotalIva5, H004W7_A229ComprasTotal, H004W7_n229ComprasTotal, H004W7_A90ComprasTotalExento
            }
            , new Object[] {
            H004W13_AGRID_nRecordCount
            }
         }
      );
      AV21Pgmname = "ComprasPrompt" ;
   ...
   private long wcpOAV8InOutComprasId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutComprasId ;
   ...
   private java.math.BigDecimal[] H004W7_A88ComprasTotal10 ;
   private java.math.BigDecimal[] H004W7_A86ComprasTotal5 ;
   private long[] H004W7_A227ComprasNumeroFactura ;
   private long[] H004W7_A226ComprasTimbrado ;
   private long[] H004W7_A10ProveedorId ;
   private java.util.Date[] H004W7_A74ComprasFecha ;
   private long[] H004W7_A11ComprasId ;
   private java.math.BigDecimal[] H004W7_A225ComprasTotalIva ;
   private boolean[] H004W7_n225ComprasTotalIva ;
   private java.math.BigDecimal[] H004W7_A89ComprasTotalIva10 ;
   private java.math.BigDecimal[] H004W7_A87ComprasTotalIva5 ;
   private java.math.BigDecimal[] H004W7_A229ComprasTotal ;
   private boolean[] H004W7_n229ComprasTotal ;
   private java.math.BigDecimal[] H004W7_A90ComprasTotalExento ;
   private long[] H004W13_AGRID_nRecordCount ;
...
final  class comprasprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004W7( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H004W13( ModelContext context ,
                                           int remoteHandle ,
                                           com.genexus.IHttpContext httpContext ,
                                           short AV10OrderedBy ,
                                           boolean AV11OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004W7(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , (java.math.BigDecimal)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , (java.math.BigDecimal)dynConstraints[11] , (java.math.BigDecimal)dynConstraints[12] , (java.math.BigDecimal)dynConstraints[13] );
            case 1 :
                  return conditional_H004W13(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , (java.math.BigDecimal)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , (java.math.BigDecimal)dynConstraints[11] , (java.math.BigDecimal)dynConstraints[12] , (java.math.BigDecimal)dynConstraints[13] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004W7", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004W13", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
