...
public final  class tipopagoprompt_impl extends GXDataArea
{
   public tipopagoprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopagoprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopagoprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutTipoPagoId") ;
         ...
         {
            AV8InOutTipoPagoId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoPagoId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.tipopagoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTipoPagoId,11,0))}, new String[] {"InOutTipoPagoId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTIPOPAGOID", GXutil.ltrim( localUtil.ntoc( AV8InOutTipoPagoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.tipopagoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTipoPagoId,11,0))}, new String[] {"InOutTipoPagoId"})  ;
   }

   public String getPgmname( )
   {
      return "TipoPagoPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Tipo Pago", "") ;
   }
   ...
   public void wb1E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_1E2( true) ;
      }
      else
      {
         wb_table1_14_1E2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_1E2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1E2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Tipo Pago", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf1E2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H001E2 */
         pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A297TipoPagoDato = H001E2_A297TipoPagoDato[0] ;
            A71TipoPagoNombre = H001E2_A71TipoPagoNombre[0] ;
            A9TipoPagoId = H001E2_A9TipoPagoId[0] ;
            e171E2 ();
   ...
   public void send_integrity_lvl_hashes1E2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOPAGOID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A9TipoPagoId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H001E3 */
      pr_default.execute(1, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText});
   ...
   public void e151E2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Tipo Pago", "") );
   ...
   public void e161E2( )
   {
      ...
      tipopagoprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e181E2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutTipoPagoId = A9TipoPagoId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoPagoId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutTipoPagoId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutTipoPagoId"});
   ...
   public void wb_table1_14_1E2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_TipoPagoPrompt.htm");
   ...
   {
      AV8InOutTipoPagoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoPagoId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111131914", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipopagoprompt.js", "?202412111131914", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtTipoPagoDato_Internalname = "TIPOPAGODATO_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtTipoPagoDato_Internalname = "TIPOPAGODATO_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:TipoPagoId|2:TipoPagoNombre|3:TipoPagoDato" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e171E2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e181E2',iparms:[{av:'A9TipoPagoId',fld:'TIPOPAGOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTipoPagoId',fld:'vINOUTTIPOPAGOID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e141E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H001E2_A297TipoPagoDato = new String[] {""} ;
      H001E2_A71TipoPagoNombre = new String[] {""} ;
      H001E2_A9TipoPagoId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopagoprompt__default(),
         new Object[] {
             new Object[] {
            H001E2_A297TipoPagoDato, H001E2_A71TipoPagoNombre, H001E2_A9TipoPagoId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutTipoPagoId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutTipoPagoId ;
   ...
   private String[] H001E2_A297TipoPagoDato ;
   private String[] H001E2_A71TipoPagoNombre ;
   private long[] H001E2_A9TipoPagoId ;
...
final  class tipopagoprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001E2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H001E3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A9TipoPagoId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001E2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H001E3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001E2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001E3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
