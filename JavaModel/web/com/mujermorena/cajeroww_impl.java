...
public final  class cajeroww_impl extends GXDataArea
{
   public cajeroww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public cajeroww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( cajeroww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.cajeroww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.cajeroww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb150( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Cajero", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_CajeroWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_CajeroWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_152( true) ;
      }
      else
      {
         wb_table1_22_152( false) ;
      }
      return  ;
   }

   public void wb_table1_22_152e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CAJEROID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A26CajeroId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "CAJEROID", GXutil.ltrim( localUtil.ntoc( A26CajeroId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf152( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV40Cajerowwds_1_filterfulltext ,
         ...
         lV40Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajerowwds_1_filterfulltext), "%", "") ;
         lV40Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajerowwds_1_filterfulltext), "%", "") ;
         lV40Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajerowwds_1_filterfulltext), "%", "") ;
         lV40Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajerowwds_1_filterfulltext), "%", "") ;
         /* Using cursor H00152 */
         pr_default.execute(0, new Object[] {lV40Cajerowwds_1_filterfulltext, lV40Cajerowwds_1_filterfulltext, lV40Cajerowwds_1_filterfulltext, lV40Cajerowwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A254CajeroUsuarioID = H00152_A254CajeroUsuarioID[0] ;
            A113CajeroIdentificador = H00152_A113CajeroIdentificador[0] ;
            A112CajeroNombre = H00152_A112CajeroNombre[0] ;
            A26CajeroId = H00152_A26CajeroId[0] ;
            e19152 ();
   ...
   public void send_integrity_lvl_hashes152( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CAJEROID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A26CajeroId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV40Cajerowwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV40Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajerowwds_1_filterfulltext), "%", "") ;
      /* Using cursor H00153 */
      pr_default.execute(1, new Object[] {lV40Cajerowwds_1_filterfulltext, lV40Cajerowwds_1_filterfulltext, lV40Cajerowwds_1_filterfulltext, lV40Cajerowwds_1_filterfulltext});
   ...
   public void e18152( )
   {
      ...
      cajeroww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e19152( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.cajeroview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A26CajeroId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"CajeroId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.cajero", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A26CajeroId,11,0))}, new String[] {"Mode","CajeroId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.cajero", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A26CajeroId,11,0))}, new String[] {"Mode","CajeroId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e11152( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("CajeroWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV39Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("CajeroWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "CajeroWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         cajeroww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e16152( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.cajero", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","CajeroId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cajeroview_Execute", GXv_boolean7) ;
      cajeroww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cajero_Update", GXv_boolean7) ;
      cajeroww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cajero_Delete", GXv_boolean7) ;
      cajeroww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cajero_Insert", GXv_boolean7) ;
      cajeroww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "CajeroWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Cajero" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.cajerowwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      cajeroww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      cajeroww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.cajerowwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_152( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_152( true) ;
      }
      else
      {
         wb_table2_27_152( false) ;
      }
      return  ;
   }

   public void wb_table2_27_152e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_152e( true) ;
      }
      else
      {
         wb_table1_22_152e( false) ;
      }
   }

   public void wb_table2_27_152( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211113399", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("cajeroww.js", "?2024121111340", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtCajeroIdentificador_Internalname = "CAJEROIDENTIFICADOR_"+sGXsfl_40_idx ;
      edtCajeroUsuarioID_Internalname = "CAJEROUSUARIOID_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtCajeroIdentificador_Internalname = "CAJEROIDENTIFICADOR_"+sGXsfl_40_fel_idx ;
      edtCajeroUsuarioID_Internalname = "CAJEROUSUARIOID_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCajeroIdentificador_Internalname,GXutil.ltrim( localUtil.ntoc( A113CajeroIdentificador, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A113CajeroIdentificador), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCajeroIdentificador_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDentificador","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCajeroUsuarioID_Internalname,GXutil.rtrim( A254CajeroUsuarioID),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCajeroUsuarioID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Usuario ID", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A113CajeroIdentificador, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A254CajeroUsuarioID));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:CajeroId|4:CajeroNombre|5:CajeroIdentificador|6:CajeroUsuarioID" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e19152',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A26CajeroId',fld:'CAJEROID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e16152',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A26CajeroId',fld:'CAJEROID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e14152',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Cajerousuarioid',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A254CajeroUsuarioID = "" ;
      scmdbuf = "" ;
      lV40Cajerowwds_1_filterfulltext = "" ;
      AV40Cajerowwds_1_filterfulltext = "" ;
      H00152_A254CajeroUsuarioID = new String[] {""} ;
      H00152_A113CajeroIdentificador = new long[1] ;
      H00152_A112CajeroNombre = new String[] {""} ;
      H00152_A26CajeroId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.cajeroww__default(),
         new Object[] {
             new Object[] {
            H00152_A254CajeroUsuarioID, H00152_A113CajeroIdentificador, H00152_A112CajeroNombre, H00152_A26CajeroId
            }
            , new Object[] {
   ...
   private String lV40Cajerowwds_1_filterfulltext ;
   private String AV40Cajerowwds_1_filterfulltext ;
   ...
   private String[] H00152_A254CajeroUsuarioID ;
   private long[] H00152_A113CajeroIdentificador ;
   private String[] H00152_A112CajeroNombre ;
   private long[] H00152_A26CajeroId ;
...
final  class cajeroww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00152( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Cajerowwds_1_filterfulltext ,
                                          long A26CajeroId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [CajeroUsuarioID], [CajeroIdentificador], [CajeroNombre], [CajeroId]" ;
      sFromString = " FROM [Cajero]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV40Cajerowwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY [CajeroId]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajeroId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajeroNombre]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajeroNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajeroIdentificador]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajeroIdentificador] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajeroUsuarioID]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajeroUsuarioID] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [CajeroId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Cajero]" ;
      if ( ! (GXutil.strcmp("", AV40Cajerowwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([CajeroId] AS decimal(11,0))) like '%' + ?) or ( [CajeroNombre] like '%' + ?) or ( CONVERT( char(10), CAST([CajeroIdentificador] AS decimal(10,0))) like '%' + ?) or ( [CajeroUsuarioID] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00152(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H00153(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
