...
public final  class proveedorview_impl extends GXDataArea
{
   public proveedorview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public proveedorview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( proveedorview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "ProveedorId") ;
         ...
         {
            AV10ProveedorId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10ProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ProveedorId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPROVEEDORID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ProveedorId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.proveedorview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ProveedorId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ProveedorId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPROVEEDORID", GXutil.ltrim( localUtil.ntoc( AV10ProveedorId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPROVEEDORID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ProveedorId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.proveedorview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ProveedorId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ProveedorId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Proveedor View", "") ;
   }
   ...
   public void wb4D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Proveedor :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_ProveedorView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Proveedor", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_ProveedorView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ProveedorView.htm");
         /* Div Control */
   ...
   public void start4D2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Proveedor View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup4D0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10ProveedorId = localUtil.ctol( httpContext.cgiGet( "vPROVEEDORID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e114D2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.proveedorww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H004D2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10ProveedorId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A10ProveedorId = H004D2_A10ProveedorId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ProveedorGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.proveedorgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ProveedorGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10ProveedorId)});
   ...
   {
      AV10ProveedorId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10ProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ProveedorId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPROVEEDORID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ProveedorId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111221579", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("proveedorview.js", "?202412111221579", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Proveedor View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10ProveedorId',fld:'vPROVEEDORID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H004D2_A10ProveedorId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.proveedorview__default(),
         new Object[] {
             new Object[] {
            H004D2_A10ProveedorId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10ProveedorId ;
   private long AV10ProveedorId ;
   ...
   private long[] H004D2_A10ProveedorId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class proveedorview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004D2", "SELECT [ProveedorId] FROM [Proveedor] WHERE [ProveedorId] = ? ORDER BY [ProveedorId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
