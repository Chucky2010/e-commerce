...
public final  class tipopersonaview_impl extends GXDataArea
{
   public tipopersonaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopersonaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopersonaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10TipoPersonaId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TipoPersonaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TipoPersonaId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOPERSONAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TipoPersonaId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tipopersonaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TipoPersonaId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipoPersonaId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vTIPOPERSONAID", GXutil.ltrim( localUtil.ntoc( AV10TipoPersonaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOPERSONAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TipoPersonaId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.tipopersonaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TipoPersonaId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipoPersonaId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "TipoPersonaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Persona View", "") ;
   }
   ...
   public void wb3T0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Tipo Persona :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_TipoPersonaView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Tipo Persona", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_TipoPersonaView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TipoPersonaView.htm");
         /* Div Control */
   ...
   public void start3T2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Persona View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup3T0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10TipoPersonaId = localUtil.ctol( httpContext.cgiGet( "vTIPOPERSONAID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e113T2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.tipopersonaww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H003T2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10TipoPersonaId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A2TipoPersonaId = H003T2_A2TipoPersonaId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TipoPersonaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.tipopersonageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TipoPersonaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10TipoPersonaId)});
   ...
   {
      AV10TipoPersonaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TipoPersonaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TipoPersonaId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOPERSONAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TipoPersonaId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122150", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipopersonaview.js", "?20241211122150", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Tipo Persona View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TipoPersonaId',fld:'vTIPOPERSONAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   {
      return "tipopersonaview_Execute";
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H003T2_A2TipoPersonaId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopersonaview__default(),
         new Object[] {
             new Object[] {
            H003T2_A2TipoPersonaId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10TipoPersonaId ;
   private long AV10TipoPersonaId ;
   ...
   private long[] H003T2_A2TipoPersonaId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipopersonaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003T2", "SELECT [TipoPersonaId] FROM [TipoPersona] WHERE [TipoPersonaId] = ? ORDER BY [TipoPersonaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
