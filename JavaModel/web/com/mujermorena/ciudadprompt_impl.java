...
public final  class ciudadprompt_impl extends GXDataArea
{
   public ciudadprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ciudadprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ciudadprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutCiudadId") ;
         ...
         {
            AV8InOutCiudadId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCiudadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCiudadId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutCiudadNombre = httpContext.GetPar( "InOutCiudadNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutCiudadNombre", AV9InOutCiudadNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.ciudadprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCiudadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutCiudadNombre))}, new String[] {"InOutCiudadId","InOutCiudadNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCIUDADID", GXutil.ltrim( localUtil.ntoc( AV8InOutCiudadId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCIUDADNOMBRE", GXutil.rtrim( AV9InOutCiudadNombre));
   ...
   {
      return formatLink("com.mujermorena.ciudadprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutCiudadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutCiudadNombre))}, new String[] {"InOutCiudadId","InOutCiudadNombre"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Selecciona Ciudad", "") ;
   }
   ...
   public void wb0P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_0P2( true) ;
      }
      else
      {
         wb_table1_14_0P2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_0P2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0P2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Ciudad", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUDADNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A62CiudadNombre, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "CIUDADNOMBRE", GXutil.rtrim( A62CiudadNombre));
   }
   ...
   public void rf0P2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H000P2 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A5PaisId = H000P2_A5PaisId[0] ;
            A60PaisNombre = H000P2_A60PaisNombre[0] ;
            A61DepartamentoNombre = H000P2_A61DepartamentoNombre[0] ;
            A6DepartamentoId = H000P2_A6DepartamentoId[0] ;
            A62CiudadNombre = H000P2_A62CiudadNombre[0] ;
            A7CiudadId = H000P2_A7CiudadId[0] ;
            A5PaisId = H000P2_A5PaisId[0] ;
            A61DepartamentoNombre = H000P2_A61DepartamentoNombre[0] ;
            A60PaisNombre = H000P2_A60PaisNombre[0] ;
            e170P2 ();
   ...
   public void send_integrity_lvl_hashes0P2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUDADID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A7CiudadId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUDADNOMBRE"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A62CiudadNombre, ""))));
   }
   ...
   public void e150P2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Ciudad", "") );
   ...
   public void e160P2( )
   {
      ...
      ciudadprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e180P2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutCiudadId = A7CiudadId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCiudadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCiudadId), 11, 0));
      AV9InOutCiudadNombre = A62CiudadNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutCiudadNombre", AV9InOutCiudadNombre);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutCiudadId),AV9InOutCiudadNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutCiudadId","AV9InOutCiudadNombre"});
   ...
   public void wb_table1_14_0P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_CiudadPrompt.htm");
   ...
   {
      AV8InOutCiudadId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutCiudadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutCiudadId), 11, 0));
      AV9InOutCiudadNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutCiudadNombre", AV9InOutCiudadNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111115764", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("ciudadprompt.js", "?202412111115764", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Departamento Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:CiudadId|2:CiudadNombre|3:DepartamentoId|4:DepartamentoNombre|5:PaisNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e170P2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e180P2',iparms:[{av:'A7CiudadId',fld:'CIUDADID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A62CiudadNombre',fld:'CIUDADNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCiudadId',fld:'vINOUTCIUDADID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutCiudadNombre',fld:'vINOUTCIUDADNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e140P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   {
      wcpOAV9InOutCiudadNombre = "" ;
      Gridpaginationbar_Selectedpage = "" ;
      Ddo_grid_Activeeventkey = "" ;
      Ddo_grid_Selectedvalue_get = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV9InOutCiudadNombre = "" ;
      AV13FilterFullText = "" ;
      AV22Pgmname = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H000P2_A5PaisId = new long[1] ;
      H000P2_A60PaisNombre = new String[] {""} ;
      H000P2_A61DepartamentoNombre = new String[] {""} ;
      H000P2_A6DepartamentoId = new long[1] ;
      H000P2_A62CiudadNombre = new String[] {""} ;
      H000P2_A7CiudadId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.ciudadprompt__default(),
         new Object[] {
             new Object[] {
            H000P2_A5PaisId, H000P2_A60PaisNombre, H000P2_A61DepartamentoNombre, H000P2_A6DepartamentoId, H000P2_A62CiudadNombre, H000P2_A7CiudadId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutCiudadId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutCiudadId ;
   ...
   private String wcpOAV9InOutCiudadNombre ;
   private String Gridpaginationbar_Selectedpage ;
   private String Ddo_grid_Activeeventkey ;
   private String Ddo_grid_Selectedvalue_get ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV9InOutCiudadNombre ;
   ...
   private long[] H000P2_A5PaisId ;
   private String[] H000P2_A60PaisNombre ;
   private String[] H000P2_A61DepartamentoNombre ;
   private long[] H000P2_A6DepartamentoId ;
   private String[] H000P2_A62CiudadNombre ;
   private long[] H000P2_A7CiudadId ;
...
final  class ciudadprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000P2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H000P3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
