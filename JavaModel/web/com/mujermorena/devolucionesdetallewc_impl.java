...
public final  class devolucionesdetallewc_impl extends GXWebComponent
{
   public devolucionesdetallewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devolucionesdetallewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devolucionesdetallewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8DevolucionesID = GXutil.lval( httpContext.GetPar( "DevolucionesID")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DevolucionesID), 10, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(AV8DevolucionesID)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8DevolucionesID, AV25Pgmname, AV14OrderedBy, AV15OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Devoluciones Detalle WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.devolucionesdetallewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8DevolucionesID,10,0))}, new String[] {"DevolucionesID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8DevolucionesID", GXutil.ltrim( localUtil.ntoc( wcpOAV8DevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDEVOLUCIONESID", GXutil.ltrim( localUtil.ntoc( AV8DevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseForm6A2( )
   {
   ...
   {
      return "DevolucionesDetalleWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Devoluciones Detalle WC", "") ;
   }
   ...
   public void wb6A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.devolucionesdetallewc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtDevolucionesID_Internalname, GXutil.ltrim( localUtil.ntoc( A272DevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A272DevolucionesID), "ZZZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDevolucionesID_Jsonclick, 0, "Attribute", "", "", "", "", edtDevolucionesID_Visible, 0, 0, "text", "1", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "IDentificador", "right", false, "", "HLP_DevolucionesDetalleWC.htm");
         /* User Defined Control */
   ...
   public void start6A2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Devoluciones Detalle WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV25Pgmname = "DevolucionesDetalleWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf6A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Long.valueOf(AV8DevolucionesID) ,
         ...
         /* Using cursor H006A2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8DevolucionesID), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A272DevolucionesID = H006A2_A272DevolucionesID[0] ;
            ...
            A303DevolucionesDetalleTallaID = H006A2_A303DevolucionesDetalleTallaID[0] ;
            A76ArticuloNombre = H006A2_A76ArticuloNombre[0] ;
            A13ArticuloId = H006A2_A13ArticuloId[0] ;
            A274DevolucionesDetalleID = H006A2_A274DevolucionesDetalleID[0] ;
            A78ArticuloPrecioVenta = H006A2_A78ArticuloPrecioVenta[0] ;
            A278DevolucionesDetalleCant = H006A2_A278DevolucionesDetalleCant[0] ;
            A76ArticuloNombre = H006A2_A76ArticuloNombre[0] ;
            A78ArticuloPrecioVenta = H006A2_A78ArticuloPrecioVenta[0] ;
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H006A3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8DevolucionesID)});
      GRID_nRecordCount = H006A3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup6A0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8DevolucionesID = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8DevolucionesID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e146A2( )
   {
      ...
      edtDevolucionesID_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtDevolucionesID_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtDevolucionesID_Visible), 5, 0), true);
   ...
   public void e156A2( )
   {
      ...
      devolucionesdetallewc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "DevolucionesID" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8DevolucionesID, 10, 0) );
   ...
   {
      AV8DevolucionesID = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DevolucionesID), 10, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8DevolucionesID = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "devolucionesdetallewc", GetJustCreated( ));
      ...
      {
         AV8DevolucionesID = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DevolucionesID), 10, 0));
      }
      wcpOAV8DevolucionesID = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8DevolucionesID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( AV8DevolucionesID != wcpOAV8DevolucionesID ) ) )
      {
         setjustcreated();
      }
      wcpOAV8DevolucionesID = AV8DevolucionesID ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8DevolucionesID = httpContext.cgiGet( sPrefix+"AV8DevolucionesID_CTRL") ;
      if ( GXutil.len( sCtrlAV8DevolucionesID) > 0 )
      {
         AV8DevolucionesID = localUtil.ctol( httpContext.cgiGet( sCtrlAV8DevolucionesID), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DevolucionesID), 10, 0));
      }
      else
      {
         AV8DevolucionesID = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8DevolucionesID_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8DevolucionesID_PARM", GXutil.ltrim( localUtil.ntoc( AV8DevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8DevolucionesID)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8DevolucionesID_CTRL", GXutil.rtrim( sCtrlAV8DevolucionesID));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211111562", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("devolucionesdetallewc.js", "?20241211111562", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtDevolucionesDetalleID_Internalname = sPrefix+"DEVOLUCIONESDETALLEID_"+sGXsfl_15_idx ;
      edtArticuloId_Internalname = sPrefix+"ARTICULOID_"+sGXsfl_15_idx ;
      edtArticuloNombre_Internalname = sPrefix+"ARTICULONOMBRE_"+sGXsfl_15_idx ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA_"+sGXsfl_15_idx ;
      dynDevolucionesDetalleTallaID.setInternalname( sPrefix+"DEVOLUCIONESDETALLETALLAID_"+sGXsfl_15_idx );
      edtDevolucionesDetalleCant_Internalname = sPrefix+"DEVOLUCIONESDETALLECANT_"+sGXsfl_15_idx ;
      edtDevolucionesDetalleTotal_Internalname = sPrefix+"DEVOLUCIONESDETALLETOTAL_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtDevolucionesDetalleID_Internalname = sPrefix+"DEVOLUCIONESDETALLEID_"+sGXsfl_15_fel_idx ;
      edtArticuloId_Internalname = sPrefix+"ARTICULOID_"+sGXsfl_15_fel_idx ;
      edtArticuloNombre_Internalname = sPrefix+"ARTICULONOMBRE_"+sGXsfl_15_fel_idx ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA_"+sGXsfl_15_fel_idx ;
      dynDevolucionesDetalleTallaID.setInternalname( sPrefix+"DEVOLUCIONESDETALLETALLAID_"+sGXsfl_15_fel_idx );
      edtDevolucionesDetalleCant_Internalname = sPrefix+"DEVOLUCIONESDETALLECANT_"+sGXsfl_15_fel_idx ;
      edtDevolucionesDetalleTotal_Internalname = sPrefix+"DEVOLUCIONESDETALLETOTAL_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesDetalleID_Internalname,GXutil.ltrim( localUtil.ntoc( A274DevolucionesDetalleID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A274DevolucionesDetalleID), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesDetalleID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDentificador","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "DEVOLUCIONESDETALLETALLAID_" + sGXsfl_15_idx ;
            ...
            {
               dynDevolucionesDetalleTallaID.addItem(GXutil.trim( GXutil.str( H006A4_A286TallaID[0], 11, 0)), GXutil.str( H006A4_A288TallaNumero[0], 4, 0), (short)(0));
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesDetalleCant_Internalname,GXutil.ltrim( localUtil.ntoc( A278DevolucionesDetalleCant, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A278DevolucionesDetalleCant), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesDetalleCant_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDevolucionesDetalleTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A277DevolucionesDetalleTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A277DevolucionesDetalleTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDevolucionesDetalleTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol15( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Cant", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Total", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A274DevolucionesDetalleID, (byte)(10), (byte)(0), ".", "")));
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A303DevolucionesDetalleTallaID, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A278DevolucionesDetalleCant, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A277DevolucionesDetalleTotal, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtDevolucionesDetalleID_Internalname = sPrefix+"DEVOLUCIONESDETALLEID" ;
      ...
      dynDevolucionesDetalleTallaID.setInternalname( sPrefix+"DEVOLUCIONESDETALLETALLAID" );
      edtDevolucionesDetalleCant_Internalname = sPrefix+"DEVOLUCIONESDETALLECANT" ;
      edtDevolucionesDetalleTotal_Internalname = sPrefix+"DEVOLUCIONESDETALLETOTAL" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtDevolucionesID_Visible = 1 ;
      Grid_empowerer_Hastitlesettings = GXutil.toBoolean( -1) ;
      Ddo_grid_Includesortasc = "T" ;
      Ddo_grid_Columnssortvalues = "1|2|3|4|5|6" ;
      Ddo_grid_Columnids = "0:DevolucionesDetalleID|1:ArticuloId|2:ArticuloNombre|3:ArticuloPrecioVenta|4:DevolucionesDetalleTallaID|5:DevolucionesDetalleCant" ;
   ...
   public void init_web_controls( )
   {
      ...
      {
         dynDevolucionesDetalleTallaID.addItem(GXutil.trim( GXutil.str( H006A5_A286TallaID[0], 11, 0)), GXutil.str( H006A5_A288TallaNumero[0], 4, 0), (short)(0));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8DevolucionesID',fld:'vDEVOLUCIONESID',pic:'ZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e166A2',iparms:[]");
      ...
      setEventMetadata("NULL","{handler:'valid_Devolucionesdetalletotal',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H006A2_A272DevolucionesID = new long[1] ;
      H006A2_A303DevolucionesDetalleTallaID = new long[1] ;
      H006A2_A76ArticuloNombre = new String[] {""} ;
      H006A2_A13ArticuloId = new long[1] ;
      H006A2_A274DevolucionesDetalleID = new long[1] ;
      H006A2_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006A2_A278DevolucionesDetalleCant = new int[1] ;
      H006A3_AGRID_nRecordCount = new long[1] ;
      ...
      sCtrlAV8DevolucionesID = "" ;
      subGrid_Linesclass = "" ;
      ROClassString = "" ;
      GXCCtl = "" ;
      H006A4_A286TallaID = new long[1] ;
      H006A4_A288TallaNumero = new short[1] ;
      GridColumn = new com.genexus.webpanels.GXWebColumn();
      H006A5_A286TallaID = new long[1] ;
      H006A5_A288TallaNumero = new short[1] ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devolucionesdetallewc__default(),
         new Object[] {
             new Object[] {
            H006A2_A272DevolucionesID, H006A2_A303DevolucionesDetalleTallaID, H006A2_A76ArticuloNombre, H006A2_A13ArticuloId, H006A2_A274DevolucionesDetalleID, H006A2_A78ArticuloPrecioVenta, H006A2_A278DevolucionesDetalleCant
            }
            , new Object[] {
            H006A3_AGRID_nRecordCount
            }
            , new Object[] {
            H006A4_A286TallaID, H006A4_A288TallaNumero
            }
            , new Object[] {
            H006A5_A286TallaID, H006A5_A288TallaNumero
            }
         }
      );
      AV25Pgmname = "DevolucionesDetalleWC" ;
   ...
   private int edtDevolucionesID_Visible ;
   ...
   private long wcpOAV8DevolucionesID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8DevolucionesID ;
   ...
   private String sCtrlAV8DevolucionesID ;
   ...
   private long[] H006A2_A272DevolucionesID ;
   private long[] H006A2_A303DevolucionesDetalleTallaID ;
   private String[] H006A2_A76ArticuloNombre ;
   private long[] H006A2_A13ArticuloId ;
   private long[] H006A2_A274DevolucionesDetalleID ;
   private java.math.BigDecimal[] H006A2_A78ArticuloPrecioVenta ;
   private int[] H006A2_A278DevolucionesDetalleCant ;
   private long[] H006A3_AGRID_nRecordCount ;
   private long[] H006A4_A286TallaID ;
   private short[] H006A4_A288TallaNumero ;
   private long[] H006A5_A286TallaID ;
   private short[] H006A5_A288TallaNumero ;
...
final  class devolucionesdetallewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006A2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A272DevolucionesID )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[DevolucionesID], T1.[DevolucionesDetalleTallaID], T2.[ArticuloNombre], T1.[ArticuloId], T1.[DevolucionesDetalleID], T2.[ArticuloPrecioVenta], T1.[DevolucionesDetalleCant]" ;
      sFromString = " FROM ([DevolucionesDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[DevolucionesID] = ?)");
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T1.[DevolucionesDetalleID]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC, T1.[DevolucionesDetalleID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T1.[ArticuloId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC, T1.[ArticuloId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T2.[ArticuloNombre]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC, T2.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T2.[ArticuloPrecioVenta]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC, T2.[ArticuloPrecioVenta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T1.[DevolucionesDetalleTallaID]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC, T1.[DevolucionesDetalleTallaID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T1.[DevolucionesDetalleCant]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID] DESC, T1.[DevolucionesDetalleCant] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[DevolucionesID], T1.[DevolucionesDetalleID]" ;
   ...
   protected Object[] conditional_H006A3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          ...
                                          long A272DevolucionesID )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([DevolucionesDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      addWhere(sWhereString, "(T1.[DevolucionesID] = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006A2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
            case 1 :
                  return conditional_H006A3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006A2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006A3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006A4", "SELECT [TallaID], [TallaNumero] FROM [Talla] ORDER BY [TallaNumero] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006A5", "SELECT [TallaID], [TallaNumero] FROM [Talla] ORDER BY [TallaNumero] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
      };
   }
