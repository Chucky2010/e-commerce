...
public final  class clienteprompt_impl extends GXDataArea
{
   public clienteprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clienteprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clienteprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutClienteId") ;
         ...
         {
            AV8InOutClienteId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutClienteId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.clienteprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutClienteId,11,0))}, new String[] {"InOutClienteId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCLIENTEID", GXutil.ltrim( localUtil.ntoc( AV8InOutClienteId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.clienteprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutClienteId,11,0))}, new String[] {"InOutClienteId"})  ;
   }

   public String getPgmname( )
   {
      return "ClientePrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Cliente", "") ;
   }
   ...
   public void wb110( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_112( true) ;
      }
      else
      {
         wb_table1_14_112( false) ;
      }
      return  ;
   }

   public void wb_table1_14_112e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start112( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Cliente", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf112( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1PersonaId = H00112_A1PersonaId[0] ;
            A3LocalidadId = H00112_A3LocalidadId[0] ;
            A7CiudadId = H00112_A7CiudadId[0] ;
            A6DepartamentoId = H00112_A6DepartamentoId[0] ;
            A244ClienteUser = H00112_A244ClienteUser[0] ;
            A61DepartamentoNombre = H00112_A61DepartamentoNombre[0] ;
            A62CiudadNombre = H00112_A62CiudadNombre[0] ;
            A64LocalidadNombre = H00112_A64LocalidadNombre[0] ;
            A66PersonaTelefono = H00112_A66PersonaTelefono[0] ;
            A57PersonaDireccion = H00112_A57PersonaDireccion[0] ;
            A4ClienteId = H00112_A4ClienteId[0] ;
            A56PersonaApellido = H00112_A56PersonaApellido[0] ;
            A55PersonaNombre = H00112_A55PersonaNombre[0] ;
            A3LocalidadId = H00112_A3LocalidadId[0] ;
            A66PersonaTelefono = H00112_A66PersonaTelefono[0] ;
            A57PersonaDireccion = H00112_A57PersonaDireccion[0] ;
            A56PersonaApellido = H00112_A56PersonaApellido[0] ;
   ...
   public void send_integrity_lvl_hashes112( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CLIENTEID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A4ClienteId), "ZZZZZZZZZZ9")));
   }
   ...
   public void e15112( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Cliente", "") );
   ...
   public void e16112( )
   {
      ...
      clienteprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e18112( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutClienteId = A4ClienteId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutClienteId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutClienteId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutClienteId"});
   ...
   public void wb_table1_14_112( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ClientePrompt.htm");
   ...
   {
      AV8InOutClienteId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutClienteId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111124843", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("clienteprompt.js", "?202412111124843", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtClienteUser_Internalname = "CLIENTEUSER_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtClienteUser_Internalname = "CLIENTEUSER_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Persona Nombre Completo", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Persona Direccion", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Persona Telefono", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ClienteId|3:PersonaDireccion|4:PersonaTelefono|5:LocalidadNombre|6:CiudadNombre|7:DepartamentoNombre|8:ClienteUser" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17112',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18112',iparms:[{av:'A4ClienteId',fld:'CLIENTEID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutClienteId',fld:'vINOUTCLIENTEID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14112',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H00112_A1PersonaId = new long[1] ;
      H00112_A3LocalidadId = new long[1] ;
      H00112_A7CiudadId = new long[1] ;
      H00112_A6DepartamentoId = new long[1] ;
      H00112_A244ClienteUser = new String[] {""} ;
      H00112_A61DepartamentoNombre = new String[] {""} ;
      H00112_A62CiudadNombre = new String[] {""} ;
      H00112_A64LocalidadNombre = new String[] {""} ;
      H00112_A66PersonaTelefono = new String[] {""} ;
      H00112_A57PersonaDireccion = new String[] {""} ;
      H00112_A4ClienteId = new long[1] ;
      H00112_A56PersonaApellido = new String[] {""} ;
      H00112_A55PersonaNombre = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.clienteprompt__default(),
         new Object[] {
             new Object[] {
            H00112_A1PersonaId, H00112_A3LocalidadId, H00112_A7CiudadId, H00112_A6DepartamentoId, H00112_A244ClienteUser, H00112_A61DepartamentoNombre, H00112_A62CiudadNombre, H00112_A64LocalidadNombre, H00112_A66PersonaTelefono, H00112_A57PersonaDireccion,
            H00112_A4ClienteId, H00112_A56PersonaApellido, H00112_A55PersonaNombre
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutClienteId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutClienteId ;
   ...
   private long[] H00112_A1PersonaId ;
   private long[] H00112_A3LocalidadId ;
   private long[] H00112_A7CiudadId ;
   private long[] H00112_A6DepartamentoId ;
   private String[] H00112_A244ClienteUser ;
   private String[] H00112_A61DepartamentoNombre ;
   private String[] H00112_A62CiudadNombre ;
   private String[] H00112_A64LocalidadNombre ;
   private String[] H00112_A66PersonaTelefono ;
   private String[] H00112_A57PersonaDireccion ;
   private long[] H00112_A4ClienteId ;
   private String[] H00112_A56PersonaApellido ;
   private String[] H00112_A55PersonaNombre ;
...
final  class clienteprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
