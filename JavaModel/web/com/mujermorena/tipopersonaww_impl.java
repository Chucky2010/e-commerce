...
public final  class tipopersonaww_impl extends GXDataArea
{
   public tipopersonaww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopersonaww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopersonaww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tipopersonaww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.tipopersonaww", new String[] {}, new String[] {})  ;
   }

   public String getPgmname( )
   {
      return "TipoPersonaWW" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( " Tipo Persona", "") ;
   }
   ...
   public void wb0I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Tipo Persona", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_TipoPersonaWW.htm");
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0I2( true) ;
      }
      else
      {
         wb_table1_22_0I2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0I2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( " Tipo Persona", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A58TipoPersonaNombre = httpContext.cgiGet( edtTipoPersonaNombre_Internalname) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOPERSONAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A2TipoPersonaId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "TIPOPERSONAID", GXutil.ltrim( localUtil.ntoc( A2TipoPersonaId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf0I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV39Tipopersonawwds_1_filterfulltext ,
                                              Long.valueOf(A2TipoPersonaId) ,
                                              A58TipoPersonaNombre ,
         ...
         lV39Tipopersonawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopersonawwds_1_filterfulltext), "%", "") ;
         lV39Tipopersonawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopersonawwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000I2 */
         pr_default.execute(0, new Object[] {lV39Tipopersonawwds_1_filterfulltext, lV39Tipopersonawwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A58TipoPersonaNombre = H000I2_A58TipoPersonaNombre[0] ;
            A2TipoPersonaId = H000I2_A2TipoPersonaId[0] ;
            e190I2 ();
   ...
   public void send_integrity_lvl_hashes0I2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV35IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOPERSONAID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A2TipoPersonaId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV39Tipopersonawwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV39Tipopersonawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopersonawwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000I3 */
      pr_default.execute(1, new Object[] {lV39Tipopersonawwds_1_filterfulltext, lV39Tipopersonawwds_1_filterfulltext});
   ...
   public void e170I2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( " Tipo Persona", "") );
   ...
   public void e180I2( )
   {
      ...
      tipopersonaww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e190I2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.tipopersonaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A2TipoPersonaId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"TipoPersonaId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.tipopersona", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A2TipoPersonaId,11,0))}, new String[] {"Mode","TipoPersonaId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.tipopersona", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A2TipoPersonaId,11,0))}, new String[] {"Mode","TipoPersonaId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e110I2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPersonaWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV38Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPersonaWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "TipoPersonaWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         tipopersonaww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e160I2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.tipopersona", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","TipoPersonaId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopersonaview_Execute", GXv_boolean7) ;
      tipopersonaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopersona_Update", GXv_boolean7) ;
      tipopersonaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopersona_Delete", GXv_boolean7) ;
      tipopersonaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopersona_Insert", GXv_boolean7) ;
      tipopersonaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "TipoPersonaWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "TipoPersona" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.tipopersonawwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      tipopersonaww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      tipopersonaww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.tipopersonawwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0I2( true) ;
      }
      else
      {
         wb_table2_27_0I2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0I2e( true) ;
      }
      else
      {
         wb_table1_22_0I2e( false) ;
      }
   }

   public void wb_table2_27_0I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111124410", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipopersonaww.js", "?202412111124410", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtTipoPersonaNombre_Internalname = "TIPOPERSONANOMBRE_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtTipoPersonaNombre_Internalname = "TIPOPERSONANOMBRE_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTipoPersonaNombre_Internalname,GXutil.rtrim( A58TipoPersonaNombre),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTipoPersonaNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Tipo Persona Nombre", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A58TipoPersonaNombre));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void init_default_properties( )
   {
      ...
      edtTipoPersonaNombre_Internalname = "TIPOPERSONANOMBRE" ;
   ...
   public void initialize_properties( )
   {
      ...
      subGrid_Header = "" ;
      edtTipoPersonaNombre_Jsonclick = "" ;
      ...
      Ddo_grid_Columnids = "3:TipoPersonaId|4:TipoPersonaNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A2TipoPersonaId',fld:'TIPOPERSONAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140I2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Tipopersonanombre',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A58TipoPersonaNombre = "" ;
      scmdbuf = "" ;
      lV39Tipopersonawwds_1_filterfulltext = "" ;
      AV39Tipopersonawwds_1_filterfulltext = "" ;
      H000I2_A58TipoPersonaNombre = new String[] {""} ;
      H000I2_A2TipoPersonaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopersonaww__default(),
         new Object[] {
             new Object[] {
            H000I2_A58TipoPersonaNombre, H000I2_A2TipoPersonaId
            }
            , new Object[] {
   ...
   private String A58TipoPersonaNombre ;
   private String edtTipoPersonaNombre_Internalname ;
   ...
   private String edtTipoPersonaNombre_Jsonclick ;
   ...
   private String lV39Tipopersonawwds_1_filterfulltext ;
   private String AV39Tipopersonawwds_1_filterfulltext ;
   ...
   private String[] H000I2_A58TipoPersonaNombre ;
   private long[] H000I2_A2TipoPersonaId ;
...
final  class tipopersonaww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000I2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Tipopersonawwds_1_filterfulltext ,
                                          long A2TipoPersonaId ,
                                          String A58TipoPersonaNombre ,
                                          short AV13OrderedBy ,
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [TipoPersonaNombre], [TipoPersonaId]" ;
      sFromString = " FROM [TipoPersona]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV39Tipopersonawwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([TipoPersonaId] AS decimal(11,0))) like '%' + ?) or ( [TipoPersonaNombre] like '%' + ?))");
      }
      else
      {
         GXv_int12[0] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [TipoPersonaId]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoPersonaId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [TipoPersonaNombre]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoPersonaNombre] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [TipoPersonaId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [TipoPersona]" ;
      if ( ! (GXutil.strcmp("", AV39Tipopersonawwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([TipoPersonaId] AS decimal(11,0))) like '%' + ?) or ( [TipoPersonaNombre] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000I2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H000I3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
