...
public final  class ventasdetallewc_impl extends GXWebComponent
{
   public ventasdetallewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ventasdetallewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ventasdetallewc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV8VentasId = GXutil.lval( httpContext.GetPar( "VentasId")) ;
      AV26Pgmname = httpContext.GetPar( "Pgmname") ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8VentasId, AV26Pgmname, AV14OrderedBy, AV15OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Ventas Detalle WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.ventasdetallewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8VentasId,11,0))}, new String[] {"VentasId"}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV26Pgmname, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV26Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV26Pgmname, ""))));
   ...
   {
      return "VentasDetalleWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Ventas Detalle WC", "") ;
   }
   ...
   public void wb510( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.ventasdetallewc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void start512( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Ventas Detalle WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf512( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00512 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8VentasId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A18ImpuestoId = H00512_A18ImpuestoId[0] ;
            A19VentasId = H00512_A19VentasId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19VentasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19VentasId), 11, 0));
            A292VentasDetalleTallaID = H00512_A292VentasDetalleTallaID[0] ;
            A76ArticuloNombre = H00512_A76ArticuloNombre[0] ;
            A13ArticuloId = H00512_A13ArticuloId[0] ;
            A20VentasDetalleId = H00512_A20VentasDetalleId[0] ;
            A83ImpuestoPorcentaje = H00512_A83ImpuestoPorcentaje[0] ;
            A78ArticuloPrecioVenta = H00512_A78ArticuloPrecioVenta[0] ;
            A92VentasDetalleCantidad = H00512_A92VentasDetalleCantidad[0] ;
            A18ImpuestoId = H00512_A18ImpuestoId[0] ;
            A76ArticuloNombre = H00512_A76ArticuloNombre[0] ;
            A78ArticuloPrecioVenta = H00512_A78ArticuloPrecioVenta[0] ;
            A83ImpuestoPorcentaje = H00512_A83ImpuestoPorcentaje[0] ;
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00513 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8VentasId)});
   ...
   public void e15512( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV26Pgmname, GXv_char5) ;
      ventasdetallewc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV16Session.getValue(AV26Pgmname+"GridState"), "") == 0 )
      {
         AV12GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV26Pgmname+"GridState"), null, null);
      }
      else
      {
         AV12GridState.fromxml(AV16Session.getValue(AV26Pgmname+"GridState"), null, null);
      }
   ...
   public void S142( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV26Pgmname+"GridState", AV12GridState.toxml(false, true, "WWPGridState", "Mujer_Morena")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV26Pgmname );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "ventasdetallewc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024121119360", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("ventasdetallewc.js", "?2024121119361", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtVentasDetalleId_Internalname = sPrefix+"VENTASDETALLEID_"+sGXsfl_15_idx ;
      ...
      edtImpuestoPorcentaje_Internalname = sPrefix+"IMPUESTOPORCENTAJE_"+sGXsfl_15_idx ;
      edtVentasDetalleCantidad_Internalname = sPrefix+"VENTASDETALLECANTIDAD_"+sGXsfl_15_idx ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA_"+sGXsfl_15_idx ;
      edtVentasDetalleTallaID_Internalname = sPrefix+"VENTASDETALLETALLAID_"+sGXsfl_15_idx ;
      edtVentasDetalleExento_Internalname = sPrefix+"VENTASDETALLEEXENTO_"+sGXsfl_15_idx ;
      edtVentasDetalleIva5_Internalname = sPrefix+"VENTASDETALLEIVA5_"+sGXsfl_15_idx ;
      edtVentasDetalleIva10_Internalname = sPrefix+"VENTASDETALLEIVA10_"+sGXsfl_15_idx ;
      edtVentasDetalleSubTotal_Internalname = sPrefix+"VENTASDETALLESUBTOTAL_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtVentasDetalleId_Internalname = sPrefix+"VENTASDETALLEID_"+sGXsfl_15_fel_idx ;
      ...
      edtImpuestoPorcentaje_Internalname = sPrefix+"IMPUESTOPORCENTAJE_"+sGXsfl_15_fel_idx ;
      edtVentasDetalleCantidad_Internalname = sPrefix+"VENTASDETALLECANTIDAD_"+sGXsfl_15_fel_idx ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA_"+sGXsfl_15_fel_idx ;
      edtVentasDetalleTallaID_Internalname = sPrefix+"VENTASDETALLETALLAID_"+sGXsfl_15_fel_idx ;
      edtVentasDetalleExento_Internalname = sPrefix+"VENTASDETALLEEXENTO_"+sGXsfl_15_fel_idx ;
      edtVentasDetalleIva5_Internalname = sPrefix+"VENTASDETALLEIVA5_"+sGXsfl_15_fel_idx ;
      edtVentasDetalleIva10_Internalname = sPrefix+"VENTASDETALLEIVA10_"+sGXsfl_15_fel_idx ;
      edtVentasDetalleSubTotal_Internalname = sPrefix+"VENTASDETALLESUBTOTAL_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleCantidad_Internalname,GXutil.ltrim( localUtil.ntoc( A92VentasDetalleCantidad, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A92VentasDetalleCantidad), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleCantidad_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleExento_Internalname,GXutil.ltrim( localUtil.ntoc( A94VentasDetalleExento, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A94VentasDetalleExento, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleExento_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleIva5_Internalname,GXutil.ltrim( localUtil.ntoc( A96VentasDetalleIva5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A96VentasDetalleIva5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleIva5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleIva10_Internalname,GXutil.ltrim( localUtil.ntoc( A95VentasDetalleIva10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A95VentasDetalleIva10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleIva10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtVentasDetalleSubTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A252VentasDetalleSubTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A252VentasDetalleSubTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtVentasDetalleSubTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   {
      edtVentasDetalleId_Internalname = sPrefix+"VENTASDETALLEID" ;
      ...
      edtVentasDetalleCantidad_Internalname = sPrefix+"VENTASDETALLECANTIDAD" ;
      edtArticuloPrecioVenta_Internalname = sPrefix+"ARTICULOPRECIOVENTA" ;
      edtVentasDetalleTallaID_Internalname = sPrefix+"VENTASDETALLETALLAID" ;
      edtVentasDetalleExento_Internalname = sPrefix+"VENTASDETALLEEXENTO" ;
      edtVentasDetalleIva5_Internalname = sPrefix+"VENTASDETALLEIVA5" ;
      edtVentasDetalleIva10_Internalname = sPrefix+"VENTASDETALLEIVA10" ;
      edtVentasDetalleSubTotal_Internalname = sPrefix+"VENTASDETALLESUBTOTAL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:VentasDetalleId|1:ArticuloId|2:ArticuloNombre|3:ImpuestoPorcentaje|4:VentasDetalleCantidad|5:ArticuloPrecioVenta|6:VentasDetalleTallaID" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8VentasId',fld:'vVENTASID',pic:'ZZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16512',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00512_A18ImpuestoId = new long[1] ;
      H00512_A19VentasId = new long[1] ;
      H00512_A292VentasDetalleTallaID = new long[1] ;
      H00512_A76ArticuloNombre = new String[] {""} ;
      H00512_A13ArticuloId = new long[1] ;
      H00512_A20VentasDetalleId = new long[1] ;
      H00512_A83ImpuestoPorcentaje = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00512_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00512_A92VentasDetalleCantidad = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.ventasdetallewc__default(),
         new Object[] {
             new Object[] {
            H00512_A18ImpuestoId, H00512_A19VentasId, H00512_A292VentasDetalleTallaID, H00512_A76ArticuloNombre, H00512_A13ArticuloId, H00512_A20VentasDetalleId, H00512_A83ImpuestoPorcentaje, H00512_A78ArticuloPrecioVenta, H00512_A92VentasDetalleCantidad
            }
            , new Object[] {
   ...
   private long[] H00512_A18ImpuestoId ;
   private long[] H00512_A19VentasId ;
   private long[] H00512_A292VentasDetalleTallaID ;
   private String[] H00512_A76ArticuloNombre ;
   private long[] H00512_A13ArticuloId ;
   private long[] H00512_A20VentasDetalleId ;
   private java.math.BigDecimal[] H00512_A83ImpuestoPorcentaje ;
   private java.math.BigDecimal[] H00512_A78ArticuloPrecioVenta ;
   private int[] H00512_A92VentasDetalleCantidad ;
...
final  class ventasdetallewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          long A19VentasId )
   {
      ...
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T1.[VentasDetalleId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasId], T1.[ArticuloId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T1.[ArticuloId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasId], T2.[ArticuloNombre]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T2.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasId], T3.[ImpuestoPorcentaje]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T3.[ImpuestoPorcentaje] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasId], T1.[VentasDetalleCantidad]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T1.[VentasDetalleCantidad] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasId], T2.[ArticuloPrecioVenta]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T2.[ArticuloPrecioVenta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[VentasId], T1.[VentasDetalleTallaID]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[VentasId] DESC, T1.[VentasDetalleTallaID] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[VentasId], T1.[VentasDetalleId]" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00512(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
            case 1 :
                  return conditional_H00513(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
      }
