...
public final  class agenerarfacturasd_impl extends GXWebReport
{
   public agenerarfacturasd_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   public void webExecute( )
   {
      ...
      gxfirstwebparm = httpContext.GetFirstPar( "VentasPedido") ;
      toggleJsOutput = httpContext.isJsOutputEnabled( ) ;
      if ( ! entryPointCalled )
      {
         AV12VentasPedido = GXutil.lval( gxfirstwebparm) ;
      }
      if ( toggleJsOutput )
      {
      }
