...
public final  class empresaview_impl extends GXDataArea
{
   public empresaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10EmpresaId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10EmpresaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EmpresaId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPRESAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EmpresaId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.empresaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EmpresaId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EmpresaId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vEMPRESAID", GXutil.ltrim( localUtil.ntoc( AV10EmpresaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPRESAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EmpresaId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.empresaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EmpresaId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EmpresaId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Empresa View", "") ;
   }
   ...
   public void wb5M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Empresa :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Empresa", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaView.htm");
         /* Div Control */
   ...
   public void start5M2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Empresa View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup5M0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10EmpresaId = localUtil.ctol( httpContext.cgiGet( "vEMPRESAID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e115M2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.empresaww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H005M2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10EmpresaId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A28EmpresaId = H005M2_A28EmpresaId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EmpresaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.empresageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EmpresaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10EmpresaId)});
   ...
   {
      AV10EmpresaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10EmpresaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EmpresaId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPRESAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EmpresaId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122414", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresaview.js", "?20241211122414", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Empresa View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10EmpresaId',fld:'vEMPRESAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H005M2_A28EmpresaId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.empresaview__default(),
         new Object[] {
             new Object[] {
            H005M2_A28EmpresaId
            }
   ...
   private int idxLst ;
   private long wcpOAV10EmpresaId ;
   private long AV10EmpresaId ;
   ...
   private long[] H005M2_A28EmpresaId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class empresaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005M2", "SELECT [EmpresaId] FROM [Empresa] WHERE [EmpresaId] = ? ORDER BY [EmpresaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
