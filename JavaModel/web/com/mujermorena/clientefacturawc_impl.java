...
public final  class clientefacturawc_impl extends GXWebComponent
{
   public clientefacturawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clientefacturawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clientefacturawc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Cliente Factura WC", "")) ;
   ...
   {
      return httpContext.getMessage( "Cliente Factura WC", "") ;
   }
   ...
   public void wb4A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.clientefacturawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ClienteFacturaWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_4A2( true) ;
      }
      else
      {
         wb_table1_21_4A2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_4A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4A2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Cliente Factura WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf4A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG,
                                              TypeConstants.LONG
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004A2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8ClienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A4ClienteId = H004A2_A4ClienteId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A4ClienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A4ClienteId), 11, 0));
            A31TipoFacturaId = H004A2_A31TipoFacturaId[0] ;
            A112CajeroNombre = H004A2_A112CajeroNombre[0] ;
            A26CajeroId = H004A2_A26CajeroId[0] ;
            A29TimbradoId = H004A2_A29TimbradoId[0] ;
            A28EmpresaId = H004A2_A28EmpresaId[0] ;
            A130FacturaEmision = H004A2_A130FacturaEmision[0] ;
            A30FacturaId = H004A2_A30FacturaId[0] ;
            A112CajeroNombre = H004A2_A112CajeroNombre[0] ;
            e184A2 ();
   ...
   public void send_integrity_lvl_hashes4A2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV36Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV36Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DISPLAY", AV28IsAuthorized_Display);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004A3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8ClienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void e174A2( )
   {
      ...
      clientefacturawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e114A2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ClienteFacturaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV36Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ClienteFacturaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ClienteFacturaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         clientefacturawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      clientefacturawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ClienteFacturaWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_21_4A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_4A2( true) ;
      }
      else
      {
         wb_table2_26_4A2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_4A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_4A2e( true) ;
      }
      else
      {
         wb_table1_21_4A2e( false) ;
      }
   }

   public void wb_table2_26_4A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "clientefacturawc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211110764", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("clientefacturawc.js", "?20241211110764", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtCajeroId_Internalname = sPrefix+"CAJEROID_"+sGXsfl_36_idx ;
      edtCajeroNombre_Internalname = sPrefix+"CAJERONOMBRE_"+sGXsfl_36_idx ;
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtCajeroId_Internalname = sPrefix+"CAJEROID_"+sGXsfl_36_fel_idx ;
      edtCajeroNombre_Internalname = sPrefix+"CAJERONOMBRE_"+sGXsfl_36_fel_idx ;
   ...
   public void sendrow_362( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_36_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCajeroNombre_Internalname,GXutil.rtrim( A112CajeroNombre),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCajeroNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:FacturaId|4:FacturaEmision|5:EmpresaId|6:TimbradoId|7:CajeroId|8:CajeroNombre|9:TipoFacturaId" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184A2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A30FacturaId',fld:'FACTURAID',pic:'ZZZZZZZZZZ9'},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004A2_A4ClienteId = new long[1] ;
      H004A2_A31TipoFacturaId = new long[1] ;
      H004A2_A112CajeroNombre = new String[] {""} ;
      H004A2_A26CajeroId = new long[1] ;
      H004A2_A29TimbradoId = new long[1] ;
      H004A2_A28EmpresaId = new long[1] ;
      H004A2_A130FacturaEmision = new java.util.Date[] {GXutil.nullDate()} ;
      H004A2_A30FacturaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.clientefacturawc__default(),
         new Object[] {
             new Object[] {
            H004A2_A4ClienteId, H004A2_A31TipoFacturaId, H004A2_A112CajeroNombre, H004A2_A26CajeroId, H004A2_A29TimbradoId, H004A2_A28EmpresaId, H004A2_A130FacturaEmision, H004A2_A30FacturaId
            }
            , new Object[] {
   ...
   private long[] H004A2_A4ClienteId ;
   private long[] H004A2_A31TipoFacturaId ;
   private String[] H004A2_A112CajeroNombre ;
   private long[] H004A2_A26CajeroId ;
   private long[] H004A2_A29TimbradoId ;
   private long[] H004A2_A28EmpresaId ;
   private java.util.Date[] H004A2_A130FacturaEmision ;
   private long[] H004A2_A30FacturaId ;
...
final  class clientefacturawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004A2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A4ClienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[ClienteId], T1.[TipoFacturaId], T2.[CajeroNombre], T1.[CajeroId], T1.[TimbradoId], T1.[EmpresaId], T1.[FacturaEmision], T1.[FacturaId]" ;
      sFromString = " FROM ([Factura] T1 INNER JOIN [Cajero] T2 ON T2.[CajeroId] = T1.[CajeroId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[ClienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[FacturaId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[EmpresaId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TimbradoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[CajeroId] AS decimal(11,0))) like '%' + ?) or ( T2.[CajeroNombre] like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TipoFacturaId] AS decimal(11,0))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[ClienteId], T1.[FacturaId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T1.[FacturaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteId], T1.[FacturaEmision]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T1.[FacturaEmision] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteId], T1.[EmpresaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T1.[EmpresaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteId], T1.[TimbradoId]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T1.[TimbradoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteId], T1.[CajeroId]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T1.[CajeroId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteId], T2.[CajeroNombre]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T2.[CajeroNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteId], T1.[TipoFacturaId]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteId] DESC, T1.[TipoFacturaId] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H004A3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          long A30FacturaId ,
                                          ...
                                          long A4ClienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Factura] T1 INNER JOIN [Cajero] T2 ON T2.[CajeroId] = T1.[CajeroId])" ;
      addWhere(sWhereString, "(T1.[ClienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[FacturaId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[EmpresaId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TimbradoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[CajeroId] AS decimal(11,0))) like '%' + ?) or ( T2.[CajeroNombre] like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TipoFacturaId] AS decimal(11,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004A2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).longValue() );
            case 1 :
                  return conditional_H004A3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004A2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004A3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
