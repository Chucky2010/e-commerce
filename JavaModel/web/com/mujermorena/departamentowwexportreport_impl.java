...
public final  class departamentowwexportreport_impl extends GXWebReport
{
   public departamentowwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "departamentoww_Execute", GXv_boolean2) ;
         departamentowwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Departamento", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 30, Gx_line+10, 217, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 221, Gx_line+10, 595, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 599, Gx_line+10, 787, Gx_line+25, 2, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Departamentowwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Departamentowwds_1_filterfulltext ,
      ...
      lV35Departamentowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Departamentowwds_1_filterfulltext), "%", "") ;
      lV35Departamentowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Departamentowwds_1_filterfulltext), "%", "") ;
      lV35Departamentowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Departamentowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003V2 */
      pr_default.execute(0, new Object[] {lV35Departamentowwds_1_filterfulltext, lV35Departamentowwds_1_filterfulltext, lV35Departamentowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A5PaisId = P003V2_A5PaisId[0] ;
         A6DepartamentoId = P003V2_A6DepartamentoId[0] ;
         A61DepartamentoNombre = P003V2_A61DepartamentoNombre[0] ;
         ...
         h3V0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6DepartamentoId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 217, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A61DepartamentoNombre, "")), 221, Gx_line+10, 595, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A5PaisId), "ZZZZZZZZZZ9")), 599, Gx_line+10, 787, Gx_line+25, 2, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("DepartamentoWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "DepartamentoWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("DepartamentoWWGridState"), null, null);
      }
   ...
   public void h3V0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Departamentowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Departamentowwds_1_filterfulltext = "" ;
      P003V2_A5PaisId = new long[1] ;
      P003V2_A6DepartamentoId = new long[1] ;
      P003V2_A61DepartamentoNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.departamentowwexportreport__default(),
         new Object[] {
             new Object[] {
            P003V2_A5PaisId, P003V2_A6DepartamentoId, P003V2_A61DepartamentoNombre
            }
         }
      );
   ...
   private String AV35Departamentowwds_1_filterfulltext ;
   private String lV35Departamentowwds_1_filterfulltext ;
   ...
   private long[] P003V2_A5PaisId ;
   private long[] P003V2_A6DepartamentoId ;
   private String[] P003V2_A61DepartamentoNombre ;
...
final  class departamentowwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P003V2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Departamentowwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT [PaisId], [DepartamentoId], [DepartamentoNombre] FROM [Departamento]" ;
      if ( ! (GXutil.strcmp("", AV35Departamentowwds_1_filterfulltext)==0) )
      {
      ...
      {
         scmdbuf += " ORDER BY [DepartamentoId]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY [DepartamentoId] DESC" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003V2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
