...
public final  class SdtLinkList_LinkItem extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Caption", gxTv_SdtLinkList_LinkItem_Caption);
      if ( GXutil.strcmp(sNameSpace, "GeneXus") != 0 )
      {
         oWriter.writeAttribute("xmlns", "GeneXus");
      }
      oWriter.writeElement("URL", gxTv_SdtLinkList_LinkItem_Url);
      if ( GXutil.strcmp(sNameSpace, "GeneXus") != 0 )
      {
         oWriter.writeAttribute("xmlns", "GeneXus");
      }
   ...
   public com.mujermorena.SdtLinkList_LinkItem Clone( )
   {
      return (com.mujermorena.SdtLinkList_LinkItem)(clone()) ;
   }

   public void setStruct( com.mujermorena.StructSdtLinkList_LinkItem struct )
   {
   ...
   public com.mujermorena.StructSdtLinkList_LinkItem getStruct( )
   {
      com.mujermorena.StructSdtLinkList_LinkItem struct = new com.mujermorena.StructSdtLinkList_LinkItem ();
