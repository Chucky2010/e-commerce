...
public final  class cajaww_impl extends GXDataArea
{
   public cajaww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public cajaww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( cajaww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.cajaww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.cajaww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb140( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Caja", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_CajaWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_CajaWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_142( true) ;
      }
      else
      {
         wb_table1_22_142( false) ;
      }
      return  ;
   }

   public void wb_table1_22_142e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CAJAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A25CajaId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "CAJAID", GXutil.ltrim( localUtil.ntoc( A25CajaId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf142( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         lV40Cajawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajawwds_1_filterfulltext), "%", "") ;
         lV40Cajawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajawwds_1_filterfulltext), "%", "") ;
         lV40Cajawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajawwds_1_filterfulltext), "%", "") ;
         lV40Cajawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajawwds_1_filterfulltext), "%", "") ;
         lV40Cajawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajawwds_1_filterfulltext), "%", "") ;
         /* Using cursor H00142 */
         pr_default.execute(0, new Object[] {lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A255CajaAsiganacion = H00142_A255CajaAsiganacion[0] ;
            A253CajaEstado = H00142_A253CajaEstado[0] ;
            A111CajaNombreUsuario = H00142_A111CajaNombreUsuario[0] ;
            A110CajaNumero = H00142_A110CajaNumero[0] ;
            A25CajaId = H00142_A25CajaId[0] ;
            e19142 ();
   ...
   public void send_integrity_lvl_hashes142( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CAJAID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A25CajaId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV40Cajawwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV40Cajawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Cajawwds_1_filterfulltext), "%", "") ;
      /* Using cursor H00143 */
      pr_default.execute(1, new Object[] {lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext, lV40Cajawwds_1_filterfulltext});
   ...
   public void e18142( )
   {
      ...
      cajaww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e19142( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.cajaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A25CajaId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"CajaId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.caja", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A25CajaId,11,0))}, new String[] {"Mode","CajaId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.caja", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A25CajaId,11,0))}, new String[] {"Mode","CajaId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e11142( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("CajaWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV39Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("CajaWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "CajaWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         cajaww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e16142( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.caja", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","CajaId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cajaview_Execute", GXv_boolean7) ;
      cajaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "caja_Update", GXv_boolean7) ;
      cajaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "caja_Delete", GXv_boolean7) ;
      cajaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "caja_Insert", GXv_boolean7) ;
      cajaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "CajaWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Caja" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.cajawwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      cajaww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      cajaww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.cajawwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_142( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_142( true) ;
      }
      else
      {
         wb_table2_27_142( false) ;
      }
      return  ;
   }

   public void wb_table2_27_142e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_142e( true) ;
      }
      else
      {
         wb_table1_22_142e( false) ;
      }
   }

   public void wb_table2_27_142( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111125576", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("cajaww.js", "?202412111125577", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtCajaNombreUsuario_Internalname = "CAJANOMBREUSUARIO_"+sGXsfl_40_idx ;
      edtCajaEstado_Internalname = "CAJAESTADO_"+sGXsfl_40_idx ;
      edtCajaAsiganacion_Internalname = "CAJAASIGANACION_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtCajaNombreUsuario_Internalname = "CAJANOMBREUSUARIO_"+sGXsfl_40_fel_idx ;
      edtCajaEstado_Internalname = "CAJAESTADO_"+sGXsfl_40_fel_idx ;
      edtCajaAsiganacion_Internalname = "CAJAASIGANACION_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCajaNombreUsuario_Internalname,GXutil.rtrim( A111CajaNombreUsuario),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCajaNombreUsuario_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCajaEstado_Internalname,GXutil.rtrim( A253CajaEstado),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCajaEstado_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCajaAsiganacion_Internalname,GXutil.rtrim( A255CajaAsiganacion),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCajaAsiganacion_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Caja Nombre", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Estado", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Asiganacion", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A111CajaNombreUsuario));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A253CajaEstado));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A255CajaAsiganacion));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:CajaId|4:CajaNumero|5:CajaNombreUsuario|6:CajaEstado|7:CajaAsiganacion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e19142',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A25CajaId',fld:'CAJAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e16142',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A25CajaId',fld:'CAJAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e14142',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Cajaasiganacion',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A255CajaAsiganacion = "" ;
      scmdbuf = "" ;
      lV40Cajawwds_1_filterfulltext = "" ;
      AV40Cajawwds_1_filterfulltext = "" ;
      H00142_A255CajaAsiganacion = new String[] {""} ;
      H00142_A253CajaEstado = new String[] {""} ;
      H00142_A111CajaNombreUsuario = new String[] {""} ;
      H00142_A110CajaNumero = new long[1] ;
      H00142_A25CajaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.cajaww__default(),
         new Object[] {
             new Object[] {
            H00142_A255CajaAsiganacion, H00142_A253CajaEstado, H00142_A111CajaNombreUsuario, H00142_A110CajaNumero, H00142_A25CajaId
            }
            , new Object[] {
   ...
   private String lV40Cajawwds_1_filterfulltext ;
   private String AV40Cajawwds_1_filterfulltext ;
   ...
   private String[] H00142_A255CajaAsiganacion ;
   private String[] H00142_A253CajaEstado ;
   private String[] H00142_A111CajaNombreUsuario ;
   private long[] H00142_A110CajaNumero ;
   private long[] H00142_A25CajaId ;
...
final  class cajaww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00142( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Cajawwds_1_filterfulltext ,
                                          long A25CajaId ,
                                          long A110CajaNumero ,
                                          String A111CajaNombreUsuario ,
                                          String A253CajaEstado ,
                                          String A255CajaAsiganacion ,
                                          short AV13OrderedBy ,
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [CajaAsiganacion], [CajaEstado], [CajaNombreUsuario], [CajaNumero], [CajaId]" ;
      sFromString = " FROM [Caja]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV40Cajawwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([CajaId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST([CajaNumero] AS decimal(10,0))) like '%' + ?) or ( [CajaNombreUsuario] like '%' + ?) or ( [CajaEstado] like '%' + ?) or ( [CajaAsiganacion] like '%' + ?))");
      }
      else
      {
         GXv_int12[0] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [CajaId]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajaId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajaNumero]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajaNumero] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajaNombreUsuario]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajaNombreUsuario] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajaEstado]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajaEstado] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [CajaAsiganacion]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CajaAsiganacion] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [CajaId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Caja]" ;
      if ( ! (GXutil.strcmp("", AV40Cajawwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([CajaId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(10), CAST([CajaNumero] AS decimal(10,0))) like '%' + ?) or ( [CajaNombreUsuario] like '%' + ?) or ( [CajaEstado] like '%' + ?) or ( [CajaAsiganacion] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00142(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H00143(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
