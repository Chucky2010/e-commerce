...
public final  class localidadview_impl extends GXDataArea
{
   public localidadview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public localidadview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( localidadview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "LocalidadId") ;
         ...
         {
            AV10LocalidadId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10LocalidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LocalidadId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLOCALIDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10LocalidadId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.localidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10LocalidadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"LocalidadId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"LocalidadView");
      forbiddenHiddens.add("LocalidadNombre", GXutil.rtrim( localUtil.format( A64LocalidadNombre, "")));
      ...
      GXutil.writeLogInfo("localidadview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vLOCALIDADID", GXutil.ltrim( localUtil.ntoc( AV10LocalidadId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLOCALIDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10LocalidadId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.localidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10LocalidadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"LocalidadId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Localidad View", "") ;
   }
   ...
   public void wb3W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Localidad :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_LocalidadView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtLocalidadNombre_Internalname, httpContext.getMessage( "Localidad Nombre", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtLocalidadNombre_Internalname, GXutil.rtrim( A64LocalidadNombre), GXutil.rtrim( localUtil.format( A64LocalidadNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLocalidadNombre_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtLocalidadNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Nombre", "left", true, "", "HLP_LocalidadView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Localidad", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_LocalidadView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_LocalidadView.htm");
         /* Div Control */
   ...
   public void start3W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Localidad View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf3W2( )
   {
      ...
      {
         /* Using cursor H003W2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10LocalidadId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A3LocalidadId = H003W2_A3LocalidadId[0] ;
            A64LocalidadNombre = H003W2_A64LocalidadNombre[0] ;
   ...
   public void strup3W0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10LocalidadId = localUtil.ctol( httpContext.cgiGet( "vLOCALIDADID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("localidadview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e113W2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.localidadww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H003W3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10LocalidadId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A3LocalidadId = H003W3_A3LocalidadId[0] ;
         A64LocalidadNombre = H003W3_A64LocalidadNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A64LocalidadNombre", A64LocalidadNombre);
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A64LocalidadNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "LocalidadGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.localidadgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "LocalidadGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10LocalidadId)});
   ...
   {
      AV10LocalidadId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10LocalidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LocalidadId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLOCALIDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10LocalidadId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122073", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("localidadview.js", "?20241211122074", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Localidad View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10LocalidadId',fld:'vLOCALIDADID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A64LocalidadNombre',fld:'LOCALIDADNOMBRE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H003W2_A3LocalidadId = new long[1] ;
      H003W2_A64LocalidadNombre = new String[] {""} ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H003W3_A3LocalidadId = new long[1] ;
      H003W3_A64LocalidadNombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.localidadview__default(),
         new Object[] {
             new Object[] {
            H003W2_A3LocalidadId, H003W2_A64LocalidadNombre
            }
            , new Object[] {
            H003W3_A3LocalidadId, H003W3_A64LocalidadNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10LocalidadId ;
   private long AV10LocalidadId ;
   ...
   private long[] H003W2_A3LocalidadId ;
   private String[] H003W2_A64LocalidadNombre ;
   private long[] H003W3_A3LocalidadId ;
   private String[] H003W3_A64LocalidadNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class localidadview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003W2", "SELECT [LocalidadId], [LocalidadNombre] FROM [Localidad] WHERE [LocalidadId] = ? ORDER BY [LocalidadId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H003W3", "SELECT [LocalidadId], [LocalidadNombre] FROM [Localidad] WHERE [LocalidadId] = ? ORDER BY [LocalidadId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
