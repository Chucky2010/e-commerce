...
public final  class ciudadww_impl extends GXDataArea
{
   public ciudadww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ciudadww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ciudadww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV33IsAuthorized_CiudadNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_CiudadNombre")) ;
      AV34IsAuthorized_DepartamentoNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_DepartamentoNombre")) ;
      AV35IsAuthorized_PaisNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_PaisNombre")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV41Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_CiudadNombre, AV34IsAuthorized_DepartamentoNombre, AV35IsAuthorized_PaisNombre, AV38IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.ciudadww", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_CiudadNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV34IsAuthorized_DepartamentoNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_PAISNOMBRE", getSecureSignedToken( "", AV35IsAuthorized_PaisNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_CIUDADNOMBRE", AV33IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_CiudadNombre));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DEPARTAMENTONOMBRE", AV34IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV34IsAuthorized_DepartamentoNombre));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_PAISNOMBRE", AV35IsAuthorized_PaisNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_PAISNOMBRE", getSecureSignedToken( "", AV35IsAuthorized_PaisNombre));
   ...
   {
      return formatLink("com.mujermorena.ciudadww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Ciudad", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_CiudadWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_CiudadWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0O2( true) ;
      }
      else
      {
         wb_table1_22_0O2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0O2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV33IsAuthorized_CiudadNombre ,
                                 boolean AV34IsAuthorized_DepartamentoNombre ,
                                 boolean AV35IsAuthorized_PaisNombre ,
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A7CiudadId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "CIUDADID", GXutil.ltrim( localUtil.ntoc( A7CiudadId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf0O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV42Ciudadwwds_1_filterfulltext ,
         ...
         lV42Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Ciudadwwds_1_filterfulltext), "%", "") ;
         lV42Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Ciudadwwds_1_filterfulltext), "%", "") ;
         lV42Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Ciudadwwds_1_filterfulltext), "%", "") ;
         lV42Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Ciudadwwds_1_filterfulltext), "%", "") ;
         lV42Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Ciudadwwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000O2 */
         pr_default.execute(0, new Object[] {lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A5PaisId = H000O2_A5PaisId[0] ;
            A60PaisNombre = H000O2_A60PaisNombre[0] ;
            A61DepartamentoNombre = H000O2_A61DepartamentoNombre[0] ;
            A6DepartamentoId = H000O2_A6DepartamentoId[0] ;
            A62CiudadNombre = H000O2_A62CiudadNombre[0] ;
            A7CiudadId = H000O2_A7CiudadId[0] ;
            A5PaisId = H000O2_A5PaisId[0] ;
            A61DepartamentoNombre = H000O2_A61DepartamentoNombre[0] ;
            A60PaisNombre = H000O2_A60PaisNombre[0] ;
            e190O2 ();
   ...
   public void send_integrity_lvl_hashes0O2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV38IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV38IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUDADID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A7CiudadId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV42Ciudadwwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV42Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV42Ciudadwwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000O3 */
      pr_default.execute(1, new Object[] {lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext, lV42Ciudadwwds_1_filterfulltext});
   ...
   public void e170O2( )
   {
      ...
      AV37AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV36AGExportData.add(AV37AGExportDataItem, 0);
      GXt_boolean1 = AV33IsAuthorized_CiudadNombre ;
      ...
      ciudadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV33IsAuthorized_CiudadNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV33IsAuthorized_CiudadNombre", AV33IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV33IsAuthorized_CiudadNombre));
      GXt_boolean1 = AV34IsAuthorized_DepartamentoNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      ...
      ciudadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV34IsAuthorized_DepartamentoNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV34IsAuthorized_DepartamentoNombre", AV34IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV34IsAuthorized_DepartamentoNombre));
      GXt_boolean1 = AV35IsAuthorized_PaisNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      ...
      ciudadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV35IsAuthorized_PaisNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV35IsAuthorized_PaisNombre", AV35IsAuthorized_PaisNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_PAISNOMBRE", getSecureSignedToken( "", AV35IsAuthorized_PaisNombre));
   ...
   public void e180O2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV41Pgmname, GXv_char7) ;
      ciudadww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e190O2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.ciudadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A7CiudadId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"CiudadId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.ciudad", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A7CiudadId,11,0))}, new String[] {"Mode","CiudadId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.ciudad", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A7CiudadId,11,0))}, new String[] {"Mode","CiudadId"})  ;
      }
      if ( AV33IsAuthorized_CiudadNombre )
      {
      ...
      if ( AV34IsAuthorized_DepartamentoNombre )
      {
      ...
      if ( AV35IsAuthorized_PaisNombre )
      {
   ...
   public void e110O2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("CiudadWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV41Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("CiudadWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "CiudadWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         ciudadww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e160O2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.ciudad", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","CiudadId"}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "ciudad_Update", GXv_boolean2) ;
      ciudadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "ciudad_Delete", GXv_boolean2) ;
      ciudadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "ciudad_Insert", GXv_boolean2) ;
      ciudadww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "CiudadWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Ciudad" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.ciudadwwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      ciudadww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      ciudadww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.ciudadwwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0O2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0O2( true) ;
      }
      else
      {
         wb_table2_27_0O2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0O2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0O2e( true) ;
      }
      else
      {
         wb_table1_22_0O2e( false) ;
      }
   }

   public void wb_table2_27_0O2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111121591", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("ciudadww.js", "?202412111121594", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtDepartamentoId_Internalname = "DEPARTAMENTOID_"+sGXsfl_40_idx ;
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtDepartamentoId_Internalname = "DEPARTAMENTOID_"+sGXsfl_40_fel_idx ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:CiudadId|4:CiudadNombre|5:DepartamentoId|6:DepartamentoNombre|7:PaisNombre" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e120O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e130O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e150O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e190O2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A7CiudadId',fld:'CIUDADID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'A6DepartamentoId',fld:'DEPARTAMENTOID',pic:'ZZZZZZZZZZ9'},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'A5PaisId',fld:'PAISID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCiudadNombre_Link',ctrl:'CIUDADNOMBRE',prop:'Link'},{av:'edtDepartamentoNombre_Link',ctrl:'DEPARTAMENTONOMBRE',prop:'Link'},{av:'edtPaisNombre_Link',ctrl:'PAISNOMBRE',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e110O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A7CiudadId',fld:'CIUDADID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140O2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV34IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV35IsAuthorized_PaisNombre',fld:'vISAUTHORIZED_PAISNOMBRE',pic:'',hsh:true},{av:'AV38IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
   ...
   public void initialize( )
   {
      ...
      A60PaisNombre = "" ;
      scmdbuf = "" ;
      lV42Ciudadwwds_1_filterfulltext = "" ;
      AV42Ciudadwwds_1_filterfulltext = "" ;
      H000O2_A5PaisId = new long[1] ;
      H000O2_A60PaisNombre = new String[] {""} ;
      H000O2_A61DepartamentoNombre = new String[] {""} ;
      H000O2_A6DepartamentoId = new long[1] ;
      H000O2_A62CiudadNombre = new String[] {""} ;
      H000O2_A7CiudadId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.ciudadww__default(),
         new Object[] {
             new Object[] {
            H000O2_A5PaisId, H000O2_A60PaisNombre, H000O2_A61DepartamentoNombre, H000O2_A6DepartamentoId, H000O2_A62CiudadNombre, H000O2_A7CiudadId
            }
            , new Object[] {
   ...
   private boolean AV33IsAuthorized_CiudadNombre ;
   private boolean AV34IsAuthorized_DepartamentoNombre ;
   private boolean AV35IsAuthorized_PaisNombre ;
   ...
   private String lV42Ciudadwwds_1_filterfulltext ;
   private String AV42Ciudadwwds_1_filterfulltext ;
   ...
   private long[] H000O2_A5PaisId ;
   private String[] H000O2_A60PaisNombre ;
   private String[] H000O2_A61DepartamentoNombre ;
   private long[] H000O2_A6DepartamentoId ;
   private String[] H000O2_A62CiudadNombre ;
   private long[] H000O2_A7CiudadId ;
...
final  class ciudadww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000O2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV42Ciudadwwds_1_filterfulltext ,
                                          long A7CiudadId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T2.[PaisId], T3.[PaisNombre], T2.[DepartamentoNombre], T1.[DepartamentoId], T1.[CiudadNombre], T1.[CiudadId]" ;
      sFromString = " FROM (([Ciudad] T1 INNER JOIN [Departamento] T2 ON T2.[DepartamentoId] = T1.[DepartamentoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId])" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV42Ciudadwwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY T1.[CiudadNombre]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[CiudadNombre] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T1.[DepartamentoId]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DepartamentoId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[DepartamentoNombre]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[DepartamentoNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T3.[PaisNombre]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[PaisNombre] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[CiudadId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (([Ciudad] T1 INNER JOIN [Departamento] T2 ON T2.[DepartamentoId] = T1.[DepartamentoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId])" ;
      if ( ! (GXutil.strcmp("", AV42Ciudadwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[CiudadId] AS decimal(11,0))) like '%' + ?) or ( T1.[CiudadNombre] like '%' + ?) or ( CONVERT( char(11), CAST(T1.[DepartamentoId] AS decimal(11,0))) like '%' + ?) or ( T2.[DepartamentoNombre] like '%' + ?) or ( T3.[PaisNombre] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000O2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H000O3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000O2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000O3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
