...
public final  class movimientocajaview_impl extends GXDataArea
{
   public movimientocajaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public movimientocajaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( movimientocajaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10MovimientoCajaId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10MovimientoCajaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10MovimientoCajaId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMOVIMIENTOCAJAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10MovimientoCajaId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.movimientocajaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10MovimientoCajaId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"MovimientoCajaId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vMOVIMIENTOCAJAID", GXutil.ltrim( localUtil.ntoc( AV10MovimientoCajaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMOVIMIENTOCAJAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10MovimientoCajaId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.movimientocajaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10MovimientoCajaId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"MovimientoCajaId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "MovimientoCajaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Movimiento Caja View", "") ;
   }
   ...
   public void wb5J0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Movimiento Caja :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_MovimientoCajaView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Movimiento Caja", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_MovimientoCajaView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_MovimientoCajaView.htm");
         /* Div Control */
   ...
   public void start5J2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Movimiento Caja View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup5J0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10MovimientoCajaId = localUtil.ctol( httpContext.cgiGet( "vMOVIMIENTOCAJAID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e115J2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.movimientocajaww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H005J2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10MovimientoCajaId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A27MovimientoCajaId = H005J2_A27MovimientoCajaId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "MovimientoCajaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.movimientocajageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "MovimientoCajaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10MovimientoCajaId)});
   ...
   {
      AV10MovimientoCajaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10MovimientoCajaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10MovimientoCajaId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMOVIMIENTOCAJAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10MovimientoCajaId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224047", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("movimientocajaview.js", "?202412111224049", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Movimiento Caja View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10MovimientoCajaId',fld:'vMOVIMIENTOCAJAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H005J2_A27MovimientoCajaId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.movimientocajaview__default(),
         new Object[] {
             new Object[] {
            H005J2_A27MovimientoCajaId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10MovimientoCajaId ;
   private long AV10MovimientoCajaId ;
   ...
   private long[] H005J2_A27MovimientoCajaId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class movimientocajaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005J2", "SELECT [MovimientoCajaId] FROM [MovimientoCaja] WHERE [MovimientoCajaId] = ? ORDER BY [MovimientoCajaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
