...
public final  class articulotallaprompt_impl extends GXDataArea
{
   public articulotallaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public articulotallaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( articulotallaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InArticuloId") ;
         ...
         {
            AV8InArticuloId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InArticuloId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutArticuloTallaID = GXutil.lval( httpContext.GetPar( "InOutArticuloTallaID")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutArticuloTallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutArticuloTallaID), 11, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV8InArticuloId = GXutil.lval( httpContext.GetPar( "InArticuloId")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InArticuloId, AV22Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.articulotallaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InArticuloId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutArticuloTallaID,11,0))}, new String[] {"InArticuloId","InOutArticuloTallaID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINARTICULOID", GXutil.ltrim( localUtil.ntoc( AV8InArticuloId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTARTICULOTALLAID", GXutil.ltrim( localUtil.ntoc( AV9InOutArticuloTallaID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.articulotallaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InArticuloId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutArticuloTallaID,11,0))}, new String[] {"InArticuloId","InOutArticuloTallaID"})  ;
   }

   public String getPgmname( )
   {
      return "ArticuloTallaPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Talla", "") ;
   }
   ...
   public void wb6N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_6N2( true) ;
      }
      else
      {
         wb_table1_14_6N2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_6N2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start6N2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Talla", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_ARTICULOTALLAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A285ArticuloTallaID), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "ARTICULOTALLAID", GXutil.ltrim( localUtil.ntoc( A285ArticuloTallaID, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "ArticuloTallaPrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf6N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV13FilterFullText ,
                                              Long.valueOf(A285ArticuloTallaID) ,
                                              Long.valueOf(A286TallaID) ,
                                              A287TallaNombre ,
                                              Short.valueOf(A288TallaNumero) ,
                                              Long.valueOf(A290ArticuloTallaStock) ,
                                              Short.valueOf(AV11OrderedBy) ,
                                              Boolean.valueOf(AV12OrderedDsc) ,
                                              Long.valueOf(AV8InArticuloId) ,
                                              Long.valueOf(A13ArticuloId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.LONG
                                              }
         });
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H006N2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InArticuloId), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A13ArticuloId = H006N2_A13ArticuloId[0] ;
            A290ArticuloTallaStock = H006N2_A290ArticuloTallaStock[0] ;
            A288TallaNumero = H006N2_A288TallaNumero[0] ;
            A287TallaNombre = H006N2_A287TallaNombre[0] ;
            A286TallaID = H006N2_A286TallaID[0] ;
            A285ArticuloTallaID = H006N2_A285ArticuloTallaID[0] ;
            A288TallaNumero = H006N2_A288TallaNumero[0] ;
            A287TallaNombre = H006N2_A287TallaNombre[0] ;
            e176N2 ();
   ...
   public void send_integrity_lvl_hashes6N2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_ARTICULOTALLAID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A285ArticuloTallaID), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H006N3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InArticuloId), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
      GRID_nRecordCount = H006N3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e156N2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Talla", "") );
   ...
   public void e166N2( )
   {
      ...
      articulotallaprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e186N2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutArticuloTallaID = A285ArticuloTallaID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutArticuloTallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutArticuloTallaID), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV9InOutArticuloTallaID)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutArticuloTallaID"});
   ...
   public void wb_table1_14_6N2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ArticuloTallaPrompt.htm");
   ...
   {
      AV8InArticuloId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InArticuloId), 11, 0));
      AV9InOutArticuloTallaID = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutArticuloTallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutArticuloTallaID), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211123811", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("articulotallaprompt.js", "?20241211123811", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtArticuloTallaID_Internalname = "ARTICULOTALLAID_"+sGXsfl_26_idx ;
      edtTallaID_Internalname = "TALLAID_"+sGXsfl_26_idx ;
      edtTallaNombre_Internalname = "TALLANOMBRE_"+sGXsfl_26_idx ;
      edtTallaNumero_Internalname = "TALLANUMERO_"+sGXsfl_26_idx ;
      edtArticuloTallaStock_Internalname = "ARTICULOTALLASTOCK_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtArticuloTallaID_Internalname = "ARTICULOTALLAID_"+sGXsfl_26_fel_idx ;
      edtTallaID_Internalname = "TALLAID_"+sGXsfl_26_fel_idx ;
      edtTallaNombre_Internalname = "TALLANOMBRE_"+sGXsfl_26_fel_idx ;
      edtTallaNumero_Internalname = "TALLANUMERO_"+sGXsfl_26_fel_idx ;
      edtArticuloTallaStock_Internalname = "ARTICULOTALLASTOCK_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtArticuloTallaStock_Internalname,GXutil.ltrim( localUtil.ntoc( A290ArticuloTallaStock, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A290ArticuloTallaStock), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtArticuloTallaStock_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Talla Nombre", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Talla Numero", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Talla Stock", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A285ArticuloTallaID, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A290ArticuloTallaStock, (byte)(10), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ArticuloTallaID|2:TallaID|3:TallaNombre|4:TallaNumero|5:ArticuloTallaStock" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e116N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e126N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e136N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e176N2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e186N2',iparms:[{av:'A285ArticuloTallaID',fld:'ARTICULOTALLAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutArticuloTallaID',fld:'vINOUTARTICULOTALLAID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InArticuloId',fld:'vINARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H006N2_A13ArticuloId = new long[1] ;
      H006N2_A290ArticuloTallaStock = new long[1] ;
      H006N2_A288TallaNumero = new short[1] ;
      H006N2_A287TallaNombre = new String[] {""} ;
      H006N2_A286TallaID = new long[1] ;
      H006N2_A285ArticuloTallaID = new long[1] ;
      H006N3_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.articulotallaprompt__default(),
         new Object[] {
             new Object[] {
            H006N2_A13ArticuloId, H006N2_A290ArticuloTallaStock, H006N2_A288TallaNumero, H006N2_A287TallaNombre, H006N2_A286TallaID, H006N2_A285ArticuloTallaID
            }
            , new Object[] {
            H006N3_AGRID_nRecordCount
            }
         }
      );
      AV22Pgmname = "ArticuloTallaPrompt" ;
   ...
   private long wcpOAV8InArticuloId ;
   private long wcpOAV9InOutArticuloTallaID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InArticuloId ;
   private long AV9InOutArticuloTallaID ;
   ...
   private long[] H006N2_A13ArticuloId ;
   private long[] H006N2_A290ArticuloTallaStock ;
   private short[] H006N2_A288TallaNumero ;
   private String[] H006N2_A287TallaNombre ;
   private long[] H006N2_A286TallaID ;
   private long[] H006N2_A285ArticuloTallaID ;
   private long[] H006N3_AGRID_nRecordCount ;
...
final  class articulotallaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006N2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A285ArticuloTallaID ,
                                          long A286TallaID ,
                                          String A287TallaNombre ,
                                          short A288TallaNumero ,
                                          long A290ArticuloTallaStock ,
                                          short AV11OrderedBy ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[ArticuloId], T1.[ArticuloTallaStock], T2.[TallaNumero], T2.[TallaNombre], T1.[TallaID], T1.[ArticuloTallaID]" ;
      sFromString = " FROM ([ArticuloTalla] T1 INNER JOIN [Talla] T2 ON T2.[TallaID] = T1.[TallaID])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[ArticuloId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ArticuloTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TallaID] AS decimal(11,0))) like '%' + ?) or ( T2.[TallaNombre] like '%' + ?) or ( CONVERT( char(4), CAST(T2.[TallaNumero] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[ArticuloTallaStock] AS decimal(10,0))) like '%' + ?))");
      }
      else
      {
         GXv_int6[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[ArticuloTallaID]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloTallaID] DESC" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TallaID]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TallaID] DESC" ;
      }
      else if ( ( AV11OrderedBy == 3 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[TallaNombre]" ;
      }
      else if ( ( AV11OrderedBy == 3 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[TallaNombre] DESC" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[TallaNumero]" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[TallaNumero] DESC" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ArticuloTallaStock]" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ArticuloTallaStock] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[ArticuloId], T1.[ArticuloTallaID]" ;
      }
   ...
   protected Object[] conditional_H006N3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A285ArticuloTallaID ,
                                          ...
                                          long A13ArticuloId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([ArticuloTalla] T1 INNER JOIN [Talla] T2 ON T2.[TallaID] = T1.[TallaID])" ;
      addWhere(sWhereString, "(T1.[ArticuloId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ArticuloTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[TallaID] AS decimal(11,0))) like '%' + ?) or ( T2.[TallaNombre] like '%' + ?) or ( CONVERT( char(4), CAST(T2.[TallaNumero] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[ArticuloTallaStock] AS decimal(10,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).longValue() );
            case 1 :
                  return conditional_H006N3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006N2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006N3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
