...
public final  class tipopersonaprompt_impl extends GXDataArea
{
   public tipopersonaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopersonaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopersonaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutTipoPersonaId") ;
         ...
         {
            AV8InOutTipoPersonaId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoPersonaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoPersonaId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV20Pgmname = httpContext.GetPar( "Pgmname") ;
      httpContext.setAjaxCallMode();
      if ( ! httpContext.IsValidAjaxCall( true) )
      {
         GxWebError = (byte)(1) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV11FilterFullText, AV20Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.tipopersonaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTipoPersonaId,11,0))}, new String[] {"InOutTipoPersonaId"}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV20Pgmname, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GXH_vFILTERFULLTEXT", AV11FilterFullText);
      /* Send saved values. */
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV14GridCurrentPage, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV15GridPageCount, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vGRIDAPPLIEDFILTERS", AV16GridAppliedFilters);
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV20Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV20Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vORDEREDDSC", AV10OrderedDsc);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTIPOPERSONAID", GXutil.ltrim( localUtil.ntoc( AV8InOutTipoPersonaId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.tipopersonaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTipoPersonaId,11,0))}, new String[] {"InOutTipoPersonaId"})  ;
   }

   public String getPgmname( )
   {
      return "TipoPersonaPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Tipo Persona", "") ;
   }
   ...
   public void wb3V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_3V2( true) ;
      }
      else
      {
         wb_table1_14_3V2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_3V2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start3V2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Tipo Persona", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vFILTERFULLTEXT"), AV11FilterFullText) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void rf3V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV11FilterFullText = GXutil.concat( GXutil.rtrim( AV11FilterFullText), "%", "") ;
         /* Using cursor H003V2 */
         pr_default.execute(0, new Object[] {lV11FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A58TipoPersonaNombre = H003V2_A58TipoPersonaNombre[0] ;
            A2TipoPersonaId = H003V2_A2TipoPersonaId[0] ;
            e173V2 ();
   ...
   public void send_integrity_lvl_hashes3V2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV20Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV20Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOPERSONAID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A2TipoPersonaId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV11FilterFullText = GXutil.concat( GXutil.rtrim( AV11FilterFullText), "%", "") ;
      /* Using cursor H003V3 */
      pr_default.execute(1, new Object[] {lV11FilterFullText});
   ...
   public void strup3V0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV16GridAppliedFilters = httpContext.cgiGet( "vGRIDAPPLIEDFILTERS") ;
   ...
   public void e153V2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Tipo Persona", "") );
   ...
   public void e163V2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV20Pgmname, GXv_char5) ;
      tipopersonaprompt_impl.this.GXt_char4 = GXv_char5[0] ;
      AV16GridAppliedFilters = GXt_char4 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV16GridAppliedFilters", AV16GridAppliedFilters);
   ...
   public void e113V2( )
   {
      ...
      {
         AV13PageToGo = (int)(GXutil.lval( Gridpaginationbar_Selectedpage)) ;
         subgrid_gotopage( AV13PageToGo) ;
      }
   }
   ...
   public void e133V2( )
   {
      ...
      {
         AV10OrderedDsc = ((GXutil.strcmp(Ddo_grid_Activeeventkey, "<#OrderDSC#>")==0) ? true : false) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV10OrderedDsc", AV10OrderedDsc);
   ...
   public void e183V2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutTipoPersonaId = A2TipoPersonaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoPersonaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoPersonaId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutTipoPersonaId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutTipoPersonaId"});
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      Ddo_grid_Sortedstatus = "-1:"+(AV10OrderedDsc ? "DSC" : "ASC") ;
   ...
   public void wb_table1_14_3V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_TipoPersonaPrompt.htm");
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavFilterfulltext_Internalname, AV11FilterFullText, GXutil.rtrim( localUtil.format( AV11FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", httpContext.getMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "WWPFullTextFilter", "left", true, "", "HLP_TipoPersonaPrompt.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_14_3V2e( true) ;
      }
      else
      {
         wb_table1_14_3V2e( false) ;
      }
   }
   ...
   {
      AV8InOutTipoPersonaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoPersonaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoPersonaId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122322", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipopersonaprompt.js", "?20241211122322", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtTipoPersonaNombre_Internalname = "TIPOPERSONANOMBRE_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtTipoPersonaNombre_Internalname = "TIPOPERSONANOMBRE_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:TipoPersonaNombre" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV14GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV15GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV16GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e113V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e123V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e133V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'AV10OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV10OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e173V2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV17Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e183V2',iparms:[{av:'A2TipoPersonaId',fld:'TIPOPERSONAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTipoPersonaId',fld:'vINOUTTIPOPERSONAID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e143V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      setEventMetadata("'DOCLEANFILTERS'",",oparms:[{av:'AV11FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]}");
   ...
   public void initialize( )
   {
      ...
      AV12DDO_TitleSettingsIcons = new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      Ddo_grid_Caption = "" ;
      ...
      scmdbuf = "" ;
      lV11FilterFullText = "" ;
      H003V2_A58TipoPersonaNombre = new String[] {""} ;
      H003V2_A2TipoPersonaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopersonaprompt__default(),
         new Object[] {
             new Object[] {
            H003V2_A58TipoPersonaNombre, H003V2_A2TipoPersonaId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutTipoPersonaId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutTipoPersonaId ;
   ...
   private String lV11FilterFullText ;
   ...
   private String[] H003V2_A58TipoPersonaNombre ;
   private long[] H003V2_A2TipoPersonaId ;
   ...
   private com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV12DDO_TitleSettingsIcons ;
...
final  class tipopersonaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H003V2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          boolean AV10OrderedDsc )
   {
      ...
      {
         addWhere(sWhereString, "(( [TipoPersonaNombre] like '%' + ?))");
      }
      else
      {
         GXv_int6[0] = (byte)(1) ;
   ...
   protected Object[] conditional_H003V3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV11FilterFullText ,
                                          String A58TipoPersonaNombre ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003V2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Boolean) dynConstraints[2]).booleanValue() );
            case 1 :
                  return conditional_H003V3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Boolean) dynConstraints[2]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003V2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003V3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
