...
public final  class motivodevolucionwwexportreport_impl extends GXWebReport
{
   public motivodevolucionwwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "motivodevolucionww_Execute", GXv_boolean2) ;
         motivodevolucionwwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Motivo Devolucion", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Devolucion ID", ""), 30, Gx_line+10, 281, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Devolucion Descripcion", ""), 285, Gx_line+10, 787, Gx_line+27, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Motivodevolucionwwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Motivodevolucionwwds_1_filterfulltext ,
      ...
      lV35Motivodevolucionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Motivodevolucionwwds_1_filterfulltext), "%", "") ;
      lV35Motivodevolucionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Motivodevolucionwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P006V2 */
      pr_default.execute(0, new Object[] {lV35Motivodevolucionwwds_1_filterfulltext, lV35Motivodevolucionwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A273MotivoDevolucionID = P006V2_A273MotivoDevolucionID[0] ;
         A280MotivoDevolucionDescripcion = P006V2_A280MotivoDevolucionDescripcion[0] ;
         ...
         h6V0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A273MotivoDevolucionID), "ZZZZZZZZZ9")), 30, Gx_line+10, 281, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A280MotivoDevolucionDescripcion, "")), 285, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("MotivoDevolucionWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "MotivoDevolucionWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("MotivoDevolucionWWGridState"), null, null);
      }
   ...
   public void h6V0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Motivodevolucionwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Motivodevolucionwwds_1_filterfulltext = "" ;
      P006V2_A273MotivoDevolucionID = new long[1] ;
      P006V2_A280MotivoDevolucionDescripcion = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.motivodevolucionwwexportreport__default(),
         new Object[] {
             new Object[] {
            P006V2_A273MotivoDevolucionID, P006V2_A280MotivoDevolucionDescripcion
            }
         }
      );
   ...
   private String AV35Motivodevolucionwwds_1_filterfulltext ;
   private String lV35Motivodevolucionwwds_1_filterfulltext ;
   ...
   private long[] P006V2_A273MotivoDevolucionID ;
   private String[] P006V2_A280MotivoDevolucionDescripcion ;
...
final  class motivodevolucionwwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P006V2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Motivodevolucionwwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT [MotivoDevolucionID], [MotivoDevolucionDescripcion] FROM [MotivoDevolucion]" ;
      if ( ! (GXutil.strcmp("", AV35Motivodevolucionwwds_1_filterfulltext)==0) )
      {
      ...
      {
         scmdbuf += " ORDER BY [MotivoDevolucionDescripcion]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY [MotivoDevolucionDescripcion] DESC" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
      {
         scmdbuf += " ORDER BY [MotivoDevolucionID]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY [MotivoDevolucionID] DESC" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P006V2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P006V2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
