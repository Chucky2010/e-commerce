...
public final  class clienteww_impl extends GXDataArea
{
   public clienteww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clienteww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clienteww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV38IsAuthorized_LocalidadNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_LocalidadNombre")) ;
      AV39IsAuthorized_CiudadNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_CiudadNombre")) ;
      AV40IsAuthorized_DepartamentoNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_DepartamentoNombre")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV43Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV38IsAuthorized_LocalidadNombre, AV39IsAuthorized_CiudadNombre, AV40IsAuthorized_DepartamentoNombre, AV36IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.clienteww", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV38IsAuthorized_LocalidadNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV39IsAuthorized_CiudadNombre));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV40IsAuthorized_DepartamentoNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_LOCALIDADNOMBRE", AV38IsAuthorized_LocalidadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV38IsAuthorized_LocalidadNombre));
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_CIUDADNOMBRE", AV39IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV39IsAuthorized_CiudadNombre));
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DEPARTAMENTONOMBRE", AV40IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV40IsAuthorized_DepartamentoNombre));
   ...
   {
      return formatLink("com.mujermorena.clienteww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Cliente", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_ClienteWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ClienteWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0K2( true) ;
      }
      else
      {
         wb_table1_22_0K2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV38IsAuthorized_LocalidadNombre ,
                                 boolean AV39IsAuthorized_CiudadNombre ,
                                 boolean AV40IsAuthorized_DepartamentoNombre ,
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CLIENTEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A4ClienteId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "CLIENTEID", GXutil.ltrim( localUtil.ntoc( A4ClienteId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf0K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV44Clientewwds_1_filterfulltext ,
         ...
         lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
         lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
         lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
         lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
         lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
         ...
         lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000K2 */
         pr_default.execute(0, new Object[] {lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A1PersonaId = H000K2_A1PersonaId[0] ;
            A3LocalidadId = H000K2_A3LocalidadId[0] ;
            A7CiudadId = H000K2_A7CiudadId[0] ;
            A6DepartamentoId = H000K2_A6DepartamentoId[0] ;
            A244ClienteUser = H000K2_A244ClienteUser[0] ;
            A61DepartamentoNombre = H000K2_A61DepartamentoNombre[0] ;
            A62CiudadNombre = H000K2_A62CiudadNombre[0] ;
            A64LocalidadNombre = H000K2_A64LocalidadNombre[0] ;
            A66PersonaTelefono = H000K2_A66PersonaTelefono[0] ;
            A57PersonaDireccion = H000K2_A57PersonaDireccion[0] ;
            A4ClienteId = H000K2_A4ClienteId[0] ;
            A56PersonaApellido = H000K2_A56PersonaApellido[0] ;
            A55PersonaNombre = H000K2_A55PersonaNombre[0] ;
            A3LocalidadId = H000K2_A3LocalidadId[0] ;
            A66PersonaTelefono = H000K2_A66PersonaTelefono[0] ;
            A57PersonaDireccion = H000K2_A57PersonaDireccion[0] ;
            A56PersonaApellido = H000K2_A56PersonaApellido[0] ;
   ...
   public void send_integrity_lvl_hashes0K2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_CLIENTEID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A4ClienteId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV44Clientewwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV44Clientewwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV44Clientewwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000K3 */
      pr_default.execute(1, new Object[] {lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext, lV44Clientewwds_1_filterfulltext});
   ...
   public void e170K2( )
   {
      ...
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV34AGExportData.add(AV35AGExportDataItem, 0);
      GXt_boolean1 = AV38IsAuthorized_LocalidadNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "localidadview_Execute", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV38IsAuthorized_LocalidadNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV38IsAuthorized_LocalidadNombre", AV38IsAuthorized_LocalidadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_LOCALIDADNOMBRE", getSecureSignedToken( "", AV38IsAuthorized_LocalidadNombre));
      GXt_boolean1 = AV39IsAuthorized_CiudadNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "ciudadview_Execute", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV39IsAuthorized_CiudadNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV39IsAuthorized_CiudadNombre", AV39IsAuthorized_CiudadNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_CIUDADNOMBRE", getSecureSignedToken( "", AV39IsAuthorized_CiudadNombre));
      GXt_boolean1 = AV40IsAuthorized_DepartamentoNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "departamentoview_Execute", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV40IsAuthorized_DepartamentoNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV40IsAuthorized_DepartamentoNombre", AV40IsAuthorized_DepartamentoNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DEPARTAMENTONOMBRE", getSecureSignedToken( "", AV40IsAuthorized_DepartamentoNombre));
   ...
   public void e180K2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV43Pgmname, GXv_char7) ;
      clienteww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e190K2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.clienteview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A4ClienteId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"ClienteId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.cliente", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A4ClienteId,11,0))}, new String[] {"Mode","ClienteId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.cliente", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A4ClienteId,11,0))}, new String[] {"Mode","ClienteId"})  ;
      }
      if ( AV38IsAuthorized_LocalidadNombre )
      {
      ...
      if ( AV39IsAuthorized_CiudadNombre )
      {
      ...
      if ( AV40IsAuthorized_DepartamentoNombre )
      {
   ...
   public void e110K2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ClienteWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV43Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ClienteWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      ...
      {
         GXt_char6 = AV20ManageFiltersXml ;
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ClienteWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         clienteww_impl.this.GXt_char6 = GXv_char7[0] ;
         AV20ManageFiltersXml = GXt_char6 ;
         ...
         else
         {
            ...
            S172 ();
            if (returnInSub) return;
            new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV43Pgmname+"GridState", AV20ManageFiltersXml) ;
   ...
   public void e160K2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.cliente", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","ClienteId"}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "clienteview_Execute", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cliente_Update", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cliente_Delete", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cliente_Insert", GXv_boolean2) ;
      clienteww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ClienteWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S132( )
   {
      ...
      {
         AV11GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV43Pgmname+"GridState"), null, null);
      }
      else
      {
         AV11GridState.fromxml(AV18Session.getValue(AV43Pgmname+"GridState"), null, null);
      }
      AV13OrderedBy = AV11GridState.getgxTv_SdtWWPGridState_Orderedby() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13OrderedBy", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13OrderedBy), 4, 0));
      AV14OrderedDsc = AV11GridState.getgxTv_SdtWWPGridState_Ordereddsc() ;
   ...
   public void S162( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV43Pgmname+"GridState", AV11GridState.toxml(false, true, "WWPGridState", "Mujer_Morena")) ;
   }
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV43Pgmname );
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Cliente" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.clientewwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      clienteww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      clienteww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.clientewwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0K2( true) ;
      }
      else
      {
         wb_table2_27_0K2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0K2e( true) ;
      }
      else
      {
         wb_table1_22_0K2e( false) ;
      }
   }

   public void wb_table2_27_0K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111114557", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("clienteww.js", "?202412111114557", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtPersonaNombreCompleto_Internalname = "PERSONANOMBRECOMPLETO_"+sGXsfl_40_idx ;
      edtPersonaDireccion_Internalname = "PERSONADIRECCION_"+sGXsfl_40_idx ;
      edtPersonaTelefono_Internalname = "PERSONATELEFONO_"+sGXsfl_40_idx ;
      edtLocalidadNombre_Internalname = "LOCALIDADNOMBRE_"+sGXsfl_40_idx ;
      edtCiudadNombre_Internalname = "CIUDADNOMBRE_"+sGXsfl_40_idx ;
      edtDepartamentoNombre_Internalname = "DEPARTAMENTONOMBRE_"+sGXsfl_40_idx ;
      edtClienteUser_Internalname = "CLIENTEUSER_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtPersonaNombreCompleto_Internalname = "PERSONANOMBRECOMPLETO_"+sGXsfl_40_fel_idx ;
      edtPersonaDireccion_Internalname = "PERSONADIRECCION_"+sGXsfl_40_fel_idx ;
      edtPersonaTelefono_Internalname = "PERSONATELEFONO_"+sGXsfl_40_fel_idx ;
      edtLocalidadNombre_Internalname = "LOCALIDADNOMBRE_"+sGXsfl_40_fel_idx ;
      edtCiudadNombre_Internalname = "CIUDADNOMBRE_"+sGXsfl_40_fel_idx ;
      edtDepartamentoNombre_Internalname = "DEPARTAMENTONOMBRE_"+sGXsfl_40_fel_idx ;
      edtClienteUser_Internalname = "CLIENTEUSER_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLocalidadNombre_Internalname,GXutil.rtrim( A64LocalidadNombre),"","","'"+""+"'"+",false,"+"'"+""+"'",edtLocalidadNombre_Link,"","","",edtLocalidadNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiudadNombre_Internalname,GXutil.rtrim( A62CiudadNombre),"","","'"+""+"'"+",false,"+"'"+""+"'",edtCiudadNombre_Link,"","","",edtCiudadNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDepartamentoNombre_Internalname,GXutil.rtrim( A61DepartamentoNombre),"","","'"+""+"'"+",false,"+"'"+""+"'",edtDepartamentoNombre_Link,"","","",edtDepartamentoNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtClienteUser_Internalname,GXutil.rtrim( A244ClienteUser),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtClienteUser_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "User", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtLocalidadNombre_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A62CiudadNombre));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtCiudadNombre_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A61DepartamentoNombre));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtDepartamentoNombre_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A244ClienteUser));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:ClienteId|5:PersonaDireccion|6:PersonaTelefono|7:LocalidadNombre|8:CiudadNombre|9:DepartamentoNombre|10:ClienteUser" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e120K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e130K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e150K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e190K2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A4ClienteId',fld:'CLIENTEID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'A3LocalidadId',fld:'LOCALIDADID',pic:'ZZZZZZZZZZ9'},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'A7CiudadId',fld:'CIUDADID',pic:'ZZZZZZZZZZ9'},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'A6DepartamentoId',fld:'DEPARTAMENTOID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLocalidadNombre_Link',ctrl:'LOCALIDADNOMBRE',prop:'Link'},{av:'edtCiudadNombre_Link',ctrl:'CIUDADNOMBRE',prop:'Link'},{av:'edtDepartamentoNombre_Link',ctrl:'DEPARTAMENTONOMBRE',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e110K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A4ClienteId',fld:'CLIENTEID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140K2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV38IsAuthorized_LocalidadNombre',fld:'vISAUTHORIZED_LOCALIDADNOMBRE',pic:'',hsh:true},{av:'AV39IsAuthorized_CiudadNombre',fld:'vISAUTHORIZED_CIUDADNOMBRE',pic:'',hsh:true},{av:'AV40IsAuthorized_DepartamentoNombre',fld:'vISAUTHORIZED_DEPARTAMENTONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("NULL","{handler:'valid_Clienteuser',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A244ClienteUser = "" ;
      scmdbuf = "" ;
      lV44Clientewwds_1_filterfulltext = "" ;
      AV44Clientewwds_1_filterfulltext = "" ;
      H000K2_A1PersonaId = new long[1] ;
      H000K2_A3LocalidadId = new long[1] ;
      H000K2_A7CiudadId = new long[1] ;
      H000K2_A6DepartamentoId = new long[1] ;
      H000K2_A244ClienteUser = new String[] {""} ;
      H000K2_A61DepartamentoNombre = new String[] {""} ;
      H000K2_A62CiudadNombre = new String[] {""} ;
      H000K2_A64LocalidadNombre = new String[] {""} ;
      H000K2_A66PersonaTelefono = new String[] {""} ;
      H000K2_A57PersonaDireccion = new String[] {""} ;
      H000K2_A4ClienteId = new long[1] ;
      H000K2_A56PersonaApellido = new String[] {""} ;
      H000K2_A55PersonaNombre = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.clienteww__default(),
         new Object[] {
             new Object[] {
            H000K2_A1PersonaId, H000K2_A3LocalidadId, H000K2_A7CiudadId, H000K2_A6DepartamentoId, H000K2_A244ClienteUser, H000K2_A61DepartamentoNombre, H000K2_A62CiudadNombre, H000K2_A64LocalidadNombre, H000K2_A66PersonaTelefono, H000K2_A57PersonaDireccion,
            H000K2_A4ClienteId, H000K2_A56PersonaApellido, H000K2_A55PersonaNombre
            }
            , new Object[] {
   ...
   private boolean AV38IsAuthorized_LocalidadNombre ;
   private boolean AV39IsAuthorized_CiudadNombre ;
   private boolean AV40IsAuthorized_DepartamentoNombre ;
   ...
   private String lV44Clientewwds_1_filterfulltext ;
   private String AV44Clientewwds_1_filterfulltext ;
   ...
   private long[] H000K2_A1PersonaId ;
   private long[] H000K2_A3LocalidadId ;
   private long[] H000K2_A7CiudadId ;
   private long[] H000K2_A6DepartamentoId ;
   private String[] H000K2_A244ClienteUser ;
   private String[] H000K2_A61DepartamentoNombre ;
   private String[] H000K2_A62CiudadNombre ;
   private String[] H000K2_A64LocalidadNombre ;
   private String[] H000K2_A66PersonaTelefono ;
   private String[] H000K2_A57PersonaDireccion ;
   private long[] H000K2_A4ClienteId ;
   private String[] H000K2_A56PersonaApellido ;
   private String[] H000K2_A55PersonaNombre ;
...
final  class clienteww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000K2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV44Clientewwds_1_filterfulltext ,
                                          long A4ClienteId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[PersonaId], T2.[LocalidadId], T3.[CiudadId], T4.[DepartamentoId], T1.[ClienteUser], T5.[DepartamentoNombre], T4.[CiudadNombre], T3.[LocalidadNombre], T2.[PersonaTelefono]," ;
      sSelectString += " T2.[PersonaDireccion], T1.[ClienteId], T2.[PersonaApellido], T2.[PersonaNombre]" ;
      sFromString = " FROM (((([Cliente] T1 INNER JOIN [Persona] T2 ON T2.[PersonaId] = T1.[PersonaId]) INNER JOIN [Localidad] T3 ON T3.[LocalidadId] = T2.[LocalidadId]) INNER JOIN [Ciudad]" ;
      sFromString += " T4 ON T4.[CiudadId] = T3.[CiudadId]) INNER JOIN [Departamento] T5 ON T5.[DepartamentoId] = T4.[DepartamentoId])" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV44Clientewwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY T2.[PersonaDireccion]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[PersonaDireccion] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T2.[PersonaTelefono]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[PersonaTelefono] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T3.[LocalidadNombre]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[LocalidadNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T4.[CiudadNombre]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T4.[CiudadNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T5.[DepartamentoNombre]" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T5.[DepartamentoNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 7 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClienteUser]" ;
      }
      else if ( ( AV13OrderedBy == 7 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClienteUser] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[ClienteId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (((([Cliente] T1 INNER JOIN [Persona] T2 ON T2.[PersonaId] = T1.[PersonaId]) INNER JOIN [Localidad] T3 ON T3.[LocalidadId] = T2.[LocalidadId])" ;
      scmdbuf += " INNER JOIN [Ciudad] T4 ON T4.[CiudadId] = T3.[CiudadId]) INNER JOIN [Departamento] T5 ON T5.[DepartamentoId] = T4.[DepartamentoId])" ;
      if ( ! (GXutil.strcmp("", AV44Clientewwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ClienteId] AS decimal(11,0))) like '%' + ?) or ( RTRIM(LTRIM(T2.[PersonaNombre])) + ' ' + RTRIM(LTRIM(T2.[PersonaApellido])) like '%' + ?) or ( T2.[PersonaDireccion] like '%' + ?) or ( T2.[PersonaTelefono] like '%' + ?) or ( T3.[LocalidadNombre] like '%' + ?) or ( T4.[CiudadNombre] like '%' + ?) or ( T5.[DepartamentoNombre] like '%' + ?) or ( T1.[ClienteUser] like '%' + ?))");
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000K2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000K3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
