...
public final  class timbradoprompt_impl extends GXDataArea
{
   public timbradoprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public timbradoprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( timbradoprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutTimbradoId") ;
         ...
         {
            AV8InOutTimbradoId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTimbradoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTimbradoId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.timbradoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTimbradoId,11,0))}, new String[] {"InOutTimbradoId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTIMBRADOID", GXutil.ltrim( localUtil.ntoc( AV8InOutTimbradoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.timbradoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTimbradoId,11,0))}, new String[] {"InOutTimbradoId"})  ;
   }

   public String getPgmname( )
   {
      return "TimbradoPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Timbrado", "") ;
   }
   ...
   public void wb5R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_5R2( true) ;
      }
      else
      {
         wb_table1_14_5R2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_5R2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5R2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Timbrado", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf5R2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H005R2 */
         pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A308TimbradoEstado = H005R2_A308TimbradoEstado[0] ;
            A307TimbradoNroFacturaSerie2 = H005R2_A307TimbradoNroFacturaSerie2[0] ;
            A306TimbradoNroFacturaSerie1 = H005R2_A306TimbradoNroFacturaSerie1[0] ;
            A305TimbradoNroFacturaFinal = H005R2_A305TimbradoNroFacturaFinal[0] ;
            A304TimbradoNroFacturaInicial = H005R2_A304TimbradoNroFacturaInicial[0] ;
            A128TimbradoNroFactura = H005R2_A128TimbradoNroFactura[0] ;
            A127TimbradoFinVigencia = H005R2_A127TimbradoFinVigencia[0] ;
            A126TimbradoInicioVigencia = H005R2_A126TimbradoInicioVigencia[0] ;
            A125TimbradoNumero = H005R2_A125TimbradoNumero[0] ;
            A29TimbradoId = H005R2_A29TimbradoId[0] ;
            e175R2 ();
   ...
   public void send_integrity_lvl_hashes5R2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIMBRADOID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A29TimbradoId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H005R3 */
      pr_default.execute(1, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText});
   ...
   public void e155R2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Timbrado", "") );
   ...
   public void e165R2( )
   {
      ...
      timbradoprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e185R2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutTimbradoId = A29TimbradoId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTimbradoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTimbradoId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutTimbradoId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutTimbradoId"});
   ...
   public void wb_table1_14_5R2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_TimbradoPrompt.htm");
   ...
   {
      AV8InOutTimbradoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTimbradoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTimbradoId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224796", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("timbradoprompt.js", "?202412111224797", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtTimbradoInicioVigencia_Internalname = "TIMBRADOINICIOVIGENCIA_"+sGXsfl_26_idx ;
      edtTimbradoFinVigencia_Internalname = "TIMBRADOFINVIGENCIA_"+sGXsfl_26_idx ;
      edtTimbradoNroFactura_Internalname = "TIMBRADONROFACTURA_"+sGXsfl_26_idx ;
      edtTimbradoNroFacturaInicial_Internalname = "TIMBRADONROFACTURAINICIAL_"+sGXsfl_26_idx ;
      edtTimbradoNroFacturaFinal_Internalname = "TIMBRADONROFACTURAFINAL_"+sGXsfl_26_idx ;
      edtTimbradoNroFacturaSerie1_Internalname = "TIMBRADONROFACTURASERIE1_"+sGXsfl_26_idx ;
      edtTimbradoNroFacturaSerie2_Internalname = "TIMBRADONROFACTURASERIE2_"+sGXsfl_26_idx ;
      edtTimbradoEstado_Internalname = "TIMBRADOESTADO_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtTimbradoInicioVigencia_Internalname = "TIMBRADOINICIOVIGENCIA_"+sGXsfl_26_fel_idx ;
      edtTimbradoFinVigencia_Internalname = "TIMBRADOFINVIGENCIA_"+sGXsfl_26_fel_idx ;
      edtTimbradoNroFactura_Internalname = "TIMBRADONROFACTURA_"+sGXsfl_26_fel_idx ;
      edtTimbradoNroFacturaInicial_Internalname = "TIMBRADONROFACTURAINICIAL_"+sGXsfl_26_fel_idx ;
      edtTimbradoNroFacturaFinal_Internalname = "TIMBRADONROFACTURAFINAL_"+sGXsfl_26_fel_idx ;
      edtTimbradoNroFacturaSerie1_Internalname = "TIMBRADONROFACTURASERIE1_"+sGXsfl_26_fel_idx ;
      edtTimbradoNroFacturaSerie2_Internalname = "TIMBRADONROFACTURASERIE2_"+sGXsfl_26_fel_idx ;
      edtTimbradoEstado_Internalname = "TIMBRADOESTADO_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:TimbradoId|2:TimbradoNumero|3:TimbradoInicioVigencia|4:TimbradoFinVigencia|5:TimbradoNroFactura|6:TimbradoNroFacturaInicial|7:TimbradoNroFacturaFinal|8:TimbradoNroFacturaSerie1|9:TimbradoNroFacturaSerie2|10:TimbradoEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e175R2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e185R2',iparms:[{av:'A29TimbradoId',fld:'TIMBRADOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTimbradoId',fld:'vINOUTTIMBRADOID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H005R2_A308TimbradoEstado = new String[] {""} ;
      H005R2_A307TimbradoNroFacturaSerie2 = new short[1] ;
      H005R2_A306TimbradoNroFacturaSerie1 = new short[1] ;
      H005R2_A305TimbradoNroFacturaFinal = new long[1] ;
      H005R2_A304TimbradoNroFacturaInicial = new long[1] ;
      H005R2_A128TimbradoNroFactura = new long[1] ;
      H005R2_A127TimbradoFinVigencia = new java.util.Date[] {GXutil.nullDate()} ;
      H005R2_A126TimbradoInicioVigencia = new java.util.Date[] {GXutil.nullDate()} ;
      H005R2_A125TimbradoNumero = new long[1] ;
      H005R2_A29TimbradoId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.timbradoprompt__default(),
         new Object[] {
             new Object[] {
            H005R2_A308TimbradoEstado, H005R2_A307TimbradoNroFacturaSerie2, H005R2_A306TimbradoNroFacturaSerie1, H005R2_A305TimbradoNroFacturaFinal, H005R2_A304TimbradoNroFacturaInicial, H005R2_A128TimbradoNroFactura, H005R2_A127TimbradoFinVigencia, H005R2_A126TimbradoInicioVigencia, H005R2_A125TimbradoNumero, H005R2_A29TimbradoId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutTimbradoId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutTimbradoId ;
   ...
   private String[] H005R2_A308TimbradoEstado ;
   private short[] H005R2_A307TimbradoNroFacturaSerie2 ;
   private short[] H005R2_A306TimbradoNroFacturaSerie1 ;
   private long[] H005R2_A305TimbradoNroFacturaFinal ;
   private long[] H005R2_A304TimbradoNroFacturaInicial ;
   private long[] H005R2_A128TimbradoNroFactura ;
   private java.util.Date[] H005R2_A127TimbradoFinVigencia ;
   private java.util.Date[] H005R2_A126TimbradoInicioVigencia ;
   private long[] H005R2_A125TimbradoNumero ;
   private long[] H005R2_A29TimbradoId ;
...
final  class timbradoprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005R2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H005R3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A29TimbradoId ,
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005R2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005R3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
