...
public final  class empresaww_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.empresaww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.empresaww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb190( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Empresa", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_EmpresaWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_192( true) ;
      }
      else
      {
         wb_table1_22_192( false) ;
      }
      return  ;
   }

   public void wb_table1_22_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_EMPRESAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A28EmpresaId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "EMPRESAID", GXutil.ltrim( localUtil.ntoc( A28EmpresaId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf192( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV39Empresawwds_1_filterfulltext ,
         ...
         lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
         lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
         lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
         lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
         lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
         lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
         /* Using cursor H00192 */
         pr_default.execute(0, new Object[] {lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A129EmpresaTelefono = H00192_A129EmpresaTelefono[0] ;
            A124EmpresaEmail = H00192_A124EmpresaEmail[0] ;
            A123EmpresaRuc = H00192_A123EmpresaRuc[0] ;
            A122EmpresaDireccion = H00192_A122EmpresaDireccion[0] ;
            A121EmpresaNombre = H00192_A121EmpresaNombre[0] ;
            A28EmpresaId = H00192_A28EmpresaId[0] ;
            e19192 ();
   ...
   public void send_integrity_lvl_hashes192( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV35IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_EMPRESAID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A28EmpresaId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV39Empresawwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV39Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Empresawwds_1_filterfulltext), "%", "") ;
      /* Using cursor H00193 */
      pr_default.execute(1, new Object[] {lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext, lV39Empresawwds_1_filterfulltext});
   ...
   public void e18192( )
   {
      ...
      empresaww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e19192( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.empresaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A28EmpresaId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"EmpresaId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.empresa", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A28EmpresaId,11,0))}, new String[] {"Mode","EmpresaId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.empresa", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A28EmpresaId,11,0))}, new String[] {"Mode","EmpresaId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e11192( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("EmpresaWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV38Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("EmpresaWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "EmpresaWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         empresaww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e16192( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.empresa", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","EmpresaId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "empresaview_Execute", GXv_boolean7) ;
      empresaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "empresa_Update", GXv_boolean7) ;
      empresaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "empresa_Delete", GXv_boolean7) ;
      empresaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "empresa_Insert", GXv_boolean7) ;
      empresaww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "EmpresaWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.empresawwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      empresaww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      empresaww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.empresawwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_192( true) ;
      }
      else
      {
         wb_table2_27_192( false) ;
      }
      return  ;
   }

   public void wb_table2_27_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_192e( true) ;
      }
      else
      {
         wb_table1_22_192e( false) ;
      }
   }

   public void wb_table2_27_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111131080", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresaww.js", "?202412111131080", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtEmpresaId_Internalname = "EMPRESAID_"+sGXsfl_40_idx ;
      edtEmpresaNombre_Internalname = "EMPRESANOMBRE_"+sGXsfl_40_idx ;
      edtEmpresaDireccion_Internalname = "EMPRESADIRECCION_"+sGXsfl_40_idx ;
      edtEmpresaRuc_Internalname = "EMPRESARUC_"+sGXsfl_40_idx ;
      edtEmpresaEmail_Internalname = "EMPRESAEMAIL_"+sGXsfl_40_idx ;
      edtEmpresaTelefono_Internalname = "EMPRESATELEFONO_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtEmpresaId_Internalname = "EMPRESAID_"+sGXsfl_40_fel_idx ;
      edtEmpresaNombre_Internalname = "EMPRESANOMBRE_"+sGXsfl_40_fel_idx ;
      edtEmpresaDireccion_Internalname = "EMPRESADIRECCION_"+sGXsfl_40_fel_idx ;
      edtEmpresaRuc_Internalname = "EMPRESARUC_"+sGXsfl_40_fel_idx ;
      edtEmpresaEmail_Internalname = "EMPRESAEMAIL_"+sGXsfl_40_fel_idx ;
      edtEmpresaTelefono_Internalname = "EMPRESATELEFONO_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmpresaNombre_Internalname,GXutil.rtrim( A121EmpresaNombre),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtEmpresaNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmpresaDireccion_Internalname,A122EmpresaDireccion,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtEmpresaDireccion_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(256),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Direccion","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmpresaRuc_Internalname,A123EmpresaRuc,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtEmpresaRuc_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Empresa","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmpresaEmail_Internalname,A124EmpresaEmail,"","","'"+""+"'"+",false,"+"'"+""+"'","mailto:"+A124EmpresaEmail,"","","",edtEmpresaEmail_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"email","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Email","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmpresaTelefono_Internalname,GXutil.rtrim( A129EmpresaTelefono),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtEmpresaTelefono_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(25),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Telefono","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ruc", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A121EmpresaNombre));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A122EmpresaDireccion);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A123EmpresaRuc);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A124EmpresaEmail);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A129EmpresaTelefono));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:EmpresaId|4:EmpresaNombre|5:EmpresaDireccion|6:EmpresaRuc|7:EmpresaEmail|8:EmpresaTelefono" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e19192',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A28EmpresaId',fld:'EMPRESAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e16192',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A28EmpresaId',fld:'EMPRESAID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e14192',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Empresatelefono',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A129EmpresaTelefono = "" ;
      scmdbuf = "" ;
      lV39Empresawwds_1_filterfulltext = "" ;
      AV39Empresawwds_1_filterfulltext = "" ;
      H00192_A129EmpresaTelefono = new String[] {""} ;
      H00192_A124EmpresaEmail = new String[] {""} ;
      H00192_A123EmpresaRuc = new String[] {""} ;
      H00192_A122EmpresaDireccion = new String[] {""} ;
      H00192_A121EmpresaNombre = new String[] {""} ;
      H00192_A28EmpresaId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.empresaww__default(),
         new Object[] {
             new Object[] {
            H00192_A129EmpresaTelefono, H00192_A124EmpresaEmail, H00192_A123EmpresaRuc, H00192_A122EmpresaDireccion, H00192_A121EmpresaNombre, H00192_A28EmpresaId
            }
            , new Object[] {
   ...
   private String edtEmpresaDireccion_Jsonclick ;
   ...
   private String lV39Empresawwds_1_filterfulltext ;
   private String AV39Empresawwds_1_filterfulltext ;
   ...
   private String[] H00192_A129EmpresaTelefono ;
   private String[] H00192_A124EmpresaEmail ;
   private String[] H00192_A123EmpresaRuc ;
   private String[] H00192_A122EmpresaDireccion ;
   private String[] H00192_A121EmpresaNombre ;
   private long[] H00192_A28EmpresaId ;
...
final  class empresaww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00192( ModelContext context ,
                                          ...
                                          String AV39Empresawwds_1_filterfulltext ,
                                          long A28EmpresaId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [EmpresaTelefono], [EmpresaEmail], [EmpresaRuc], [EmpresaDireccion], [EmpresaNombre], [EmpresaId]" ;
      sFromString = " FROM [Empresa]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV39Empresawwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY [EmpresaId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [EmpresaNombre]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [EmpresaNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [EmpresaDireccion]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [EmpresaDireccion] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [EmpresaRuc]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [EmpresaRuc] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [EmpresaEmail]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [EmpresaEmail] DESC" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [EmpresaTelefono]" ;
      }
      else if ( ( AV13OrderedBy == 6 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [EmpresaTelefono] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [EmpresaId]" ;
   ...
   protected Object[] conditional_H00193( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Empresawwds_1_filterfulltext ,
                                          long A28EmpresaId ,
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00192", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00193", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
