...
public final  class devicesww_impl extends GXDataArea
{
   public devicesww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devicesww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devicesww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.devicesww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.devicesww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb1H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Devices", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_DevicesWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_DevicesWW.htm");
         /* Div Control */
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVICETYPE", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A15DeviceType), "9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DEVICETYPE", GXutil.ltrim( localUtil.ntoc( A15DeviceType, (byte)(1), (byte)(0), ".", "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVICEID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A16DeviceId, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DEVICEID", GXutil.rtrim( A16DeviceId));
   }
   ...
   {
      AV39Deviceswwds_1_filterfulltext = AV15FilterFullText ;
      GRID_nRecordCount = 0 ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           Short.valueOf(AV13OrderedBy) ,
                                           Boolean.valueOf(AV14OrderedDsc) ,
                                           AV39Deviceswwds_1_filterfulltext ,
      ...
      {
         A270DeviceName = H001H2_A270DeviceName[0] ;
         A269DeviceToken = H001H2_A269DeviceToken[0] ;
         A16DeviceId = H001H2_A16DeviceId[0] ;
         A15DeviceType = H001H2_A15DeviceType[0] ;
         if ( (GXutil.strcmp("", AV39Deviceswwds_1_filterfulltext)==0) || ( ( GXutil.like( httpContext.getMessage( "ios", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 0 ) ) || ( GXutil.like( httpContext.getMessage( "android", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 1 ) ) || ( GXutil.like( httpContext.getMessage( "blackberry", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 2 ) ) || ( GXutil.like( httpContext.getMessage( "windows", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 3 ) ) || ( GXutil.like( A16DeviceId , GXutil.padr( "%" + AV39Deviceswwds_1_filterfulltext , 128 , "%"),  ' ' ) ) || ( GXutil.like( A269DeviceToken , GXutil.padr( "%" + AV39Deviceswwds_1_filterfulltext , 1000 , "%"),  ' ' ) ) || ( GXutil.like( A270DeviceName , GXutil.padr( "%" + AV39Deviceswwds_1_filterfulltext , 128 , "%"),  ' ' ) ) ) )
         {
   ...
   public void rf1H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A270DeviceName = H001H3_A270DeviceName[0] ;
            A269DeviceToken = H001H3_A269DeviceToken[0] ;
            A16DeviceId = H001H3_A16DeviceId[0] ;
            A15DeviceType = H001H3_A15DeviceType[0] ;
            if ( (GXutil.strcmp("", AV39Deviceswwds_1_filterfulltext)==0) || ( ( GXutil.like( httpContext.getMessage( "ios", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 0 ) ) || ( GXutil.like( httpContext.getMessage( "android", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 1 ) ) || ( GXutil.like( httpContext.getMessage( "blackberry", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 2 ) ) || ( GXutil.like( httpContext.getMessage( "windows", "") , GXutil.padr( "%" + GXutil.lower( AV39Deviceswwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A15DeviceType == 3 ) ) || ( GXutil.like( A16DeviceId , GXutil.padr( "%" + AV39Deviceswwds_1_filterfulltext , 128 , "%"),  ' ' ) ) || ( GXutil.like( A269DeviceToken , GXutil.padr( "%" + AV39Deviceswwds_1_filterfulltext , 1000 , "%"),  ' ' ) ) || ( GXutil.like( A270DeviceName , GXutil.padr( "%" + AV39Deviceswwds_1_filterfulltext , 128 , "%"),  ' ' ) ) ) )
            {
               e191H2 ();
            }
   ...
   public void send_integrity_lvl_hashes1H2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV35IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVICETYPE"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A15DeviceType), "9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_DEVICEID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, GXutil.rtrim( localUtil.format( A16DeviceId, ""))));
   }
   ...
   public void e181H2( )
   {
      ...
      devicesww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e191H2( )
   {
      if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subgrid_fnc_recordsperpage( ) ) ) )
      {
         ...
         {
            edtavDisplay_Link = formatLink("com.mujermorena.devicesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A15DeviceType,1,0)),GXutil.URLEncode(GXutil.rtrim(A16DeviceId)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"DeviceType","DeviceId","TabCode"})  ;
         }
         AV29Update = "<i class=\"fa fa-pen\"></i>" ;
         httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
         if ( AV30IsAuthorized_Update )
         {
            edtavUpdate_Link = formatLink("com.mujermorena.devices", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A15DeviceType,1,0)),GXutil.URLEncode(GXutil.rtrim(A16DeviceId))}, new String[] {"Mode","DeviceType","DeviceId"})  ;
         }
         AV31Delete = "<i class=\"fa fa-times\"></i>" ;
         httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
         if ( AV32IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("com.mujermorena.devices", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A15DeviceType,1,0)),GXutil.URLEncode(GXutil.rtrim(A16DeviceId))}, new String[] {"Mode","DeviceType","DeviceId"})  ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
   ...
   public void e111H2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("DevicesWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV38Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("DevicesWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "DevicesWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         devicesww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e161H2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.devices", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"Mode","DeviceType","DeviceId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "devicesview_Execute", GXv_boolean7) ;
      devicesww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "devices_Update", GXv_boolean7) ;
      devicesww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "devices_Delete", GXv_boolean7) ;
      devicesww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "devices_Insert", GXv_boolean7) ;
      devicesww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "DevicesWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Devices" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.deviceswwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      devicesww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      devicesww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.deviceswwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111133492", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("devicesww.js", "?202412111133492", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtDeviceToken_Internalname = "DEVICETOKEN_"+sGXsfl_40_idx ;
      edtDeviceName_Internalname = "DEVICENAME_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtDeviceToken_Internalname = "DEVICETOKEN_"+sGXsfl_40_fel_idx ;
      edtDeviceName_Internalname = "DEVICENAME_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDeviceToken_Internalname,GXutil.rtrim( A269DeviceToken),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDeviceToken_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1000),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDeviceName_Internalname,GXutil.rtrim( A270DeviceName),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDeviceName_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(128),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Device Token", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A269DeviceToken));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A270DeviceName));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:DeviceType|4:DeviceId|5:DeviceToken|6:DeviceName" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e191H2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'cmbDeviceType'},{av:'A15DeviceType',fld:'DEVICETYPE',pic:'9',hsh:true},{av:'A16DeviceId',fld:'DEVICEID',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e161H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'cmbDeviceType'},{av:'A15DeviceType',fld:'DEVICETYPE',pic:'9',hsh:true},{av:'A16DeviceId',fld:'DEVICEID',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e141H2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("VALID_DEVICETOKEN","{handler:'valid_Devicetoken',iparms:[]");
      setEventMetadata("VALID_DEVICETOKEN",",oparms:[]}");
      setEventMetadata("VALID_DEVICENAME","{handler:'valid_Devicename',iparms:[]");
      setEventMetadata("VALID_DEVICENAME",",oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV39Deviceswwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV39Deviceswwds_1_filterfulltext = "" ;
      H001H2_A270DeviceName = new String[] {""} ;
      H001H2_A269DeviceToken = new String[] {""} ;
      H001H2_A16DeviceId = new String[] {""} ;
      H001H2_A15DeviceType = new byte[1] ;
      H001H3_A270DeviceName = new String[] {""} ;
      H001H3_A269DeviceToken = new String[] {""} ;
      H001H3_A16DeviceId = new String[] {""} ;
      H001H3_A15DeviceType = new byte[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devicesww__default(),
         new Object[] {
             new Object[] {
            H001H2_A270DeviceName, H001H2_A269DeviceToken, H001H2_A16DeviceId, H001H2_A15DeviceType
            }
            , new Object[] {
            H001H3_A270DeviceName, H001H3_A269DeviceToken, H001H3_A16DeviceId, H001H3_A15DeviceType
            }
         }
      );
      AV38Pgmname = "DevicesWW" ;
   ...
   private String edtDeviceToken_Jsonclick ;
   ...
   private String AV39Deviceswwds_1_filterfulltext ;
   private String lV39Deviceswwds_1_filterfulltext ;
   ...
   private String[] H001H2_A270DeviceName ;
   private String[] H001H2_A269DeviceToken ;
   private String[] H001H2_A16DeviceId ;
   private byte[] H001H2_A15DeviceType ;
   private String[] H001H3_A270DeviceName ;
   private String[] H001H3_A269DeviceToken ;
   private String[] H001H3_A16DeviceId ;
   private byte[] H001H3_A15DeviceType ;
...
final  class devicesww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001H2( ModelContext context ,
                                          ...
                                          short AV13OrderedBy ,
                                          boolean AV14OrderedDsc ,
                                          String AV39Deviceswwds_1_filterfulltext ,
                                          byte A15DeviceType ,
                                          String A16DeviceId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001H2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).byteValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] );
            case 1 :
                  return conditional_H001H3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).byteValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H001H3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
      };
   }
