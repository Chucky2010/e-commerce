...
public final  class articuloww_impl extends GXDataArea
{
   public articuloww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public articuloww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( articuloww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV33IsAuthorized_TipoArticuloNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_TipoArticuloNombre")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV15FilterFullText, AV21ManageFiltersExecutionStep, AV39Pgmname, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_TipoArticuloNombre, AV36IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.articuloww", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_TIPOARTICULONOMBRE", getSecureSignedToken( "", AV33IsAuthorized_TipoArticuloNombre));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_TIPOARTICULONOMBRE", AV33IsAuthorized_TipoArticuloNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_TIPOARTICULONOMBRE", getSecureSignedToken( "", AV33IsAuthorized_TipoArticuloNombre));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   {
      return formatLink("com.mujermorena.articuloww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb100( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Articulo", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_ArticuloWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ArticuloWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_102( true) ;
      }
      else
      {
         wb_table1_22_102( false) ;
      }
      return  ;
   }

   public void wb_table1_22_102e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_40_Refreshing);
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV33IsAuthorized_TipoArticuloNombre ,
   ...
   public void rf102( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV40Articulowwds_1_filterfulltext ,
         ...
         lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
         lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
         lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
         lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
         lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
         ...
         lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
         /* Using cursor H00102 */
         pr_default.execute(0, new Object[] {lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A231ArticuloImagen = H00102_A231ArticuloImagen[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_40_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
            A40000ArticuloImagen_GXI = H00102_A40000ArticuloImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_40_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
            A83ImpuestoPorcentaje = H00102_A83ImpuestoPorcentaje[0] ;
            A18ImpuestoId = H00102_A18ImpuestoId[0] ;
            A103TipoArticuloNombre = H00102_A103TipoArticuloNombre[0] ;
            A17TipoArticuloId = H00102_A17TipoArticuloId[0] ;
            A79ArticuloStock = H00102_A79ArticuloStock[0] ;
            A222ArticuloPrecioPromedio = H00102_A222ArticuloPrecioPromedio[0] ;
            A78ArticuloPrecioVenta = H00102_A78ArticuloPrecioVenta[0] ;
            A77ArticuloPrecioCompra = H00102_A77ArticuloPrecioCompra[0] ;
            A215ArticuloDescripcionLarga = H00102_A215ArticuloDescripcionLarga[0] ;
            A214ArticuloDescripcionCorta = H00102_A214ArticuloDescripcionCorta[0] ;
            A76ArticuloNombre = H00102_A76ArticuloNombre[0] ;
            A13ArticuloId = H00102_A13ArticuloId[0] ;
            A83ImpuestoPorcentaje = H00102_A83ImpuestoPorcentaje[0] ;
            A103TipoArticuloNombre = H00102_A103TipoArticuloNombre[0] ;
            e19102 ();
   ...
   public void send_integrity_lvl_hashes102( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_ARTICULOID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A13ArticuloId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV40Articulowwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV40Articulowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV40Articulowwds_1_filterfulltext), "%", "") ;
      /* Using cursor H00103 */
      pr_default.execute(1, new Object[] {lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext, lV40Articulowwds_1_filterfulltext});
   ...
   public void e17102( )
   {
      ...
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV34AGExportData.add(AV35AGExportDataItem, 0);
      GXt_boolean1 = AV33IsAuthorized_TipoArticuloNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipoarticuloview_Execute", GXv_boolean2) ;
      articuloww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV33IsAuthorized_TipoArticuloNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV33IsAuthorized_TipoArticuloNombre", AV33IsAuthorized_TipoArticuloNombre);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_TIPOARTICULONOMBRE", getSecureSignedToken( "", AV33IsAuthorized_TipoArticuloNombre));
   ...
   public void e18102( )
   {
      ...
      articuloww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e19102( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.articuloview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A13ArticuloId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"ArticuloId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.articulo", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A13ArticuloId,11,0))}, new String[] {"Mode","ArticuloId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.articulo", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A13ArticuloId,11,0))}, new String[] {"Mode","ArticuloId"})  ;
      }
      if ( AV33IsAuthorized_TipoArticuloNombre )
      {
   ...
   public void e11102( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ArticuloWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV39Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ArticuloWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ArticuloWWFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         articuloww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e16102( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.articulo", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","ArticuloId"}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articuloview_Execute", GXv_boolean2) ;
      articuloww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articulo_Update", GXv_boolean2) ;
      articuloww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articulo_Delete", GXv_boolean2) ;
      articuloww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articulo_Insert", GXv_boolean2) ;
      articuloww_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ArticuloWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Articulo" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.articulowwexport(remoteHandle, context).execute( GXv_char7, GXv_char11) ;
      articuloww_impl.this.AV16ExcelFilename = GXv_char7[0] ;
      articuloww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.articulowwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_102( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_102( true) ;
      }
      else
      {
         wb_table2_27_102( false) ;
      }
      return  ;
   }

   public void wb_table2_27_102e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_102e( true) ;
      }
      else
      {
         wb_table1_22_102e( false) ;
      }
   }

   public void wb_table2_27_102( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211113042", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("articuloww.js", "?20241211113043", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtArticuloId_Internalname = "ARTICULOID_"+sGXsfl_40_idx ;
      edtArticuloNombre_Internalname = "ARTICULONOMBRE_"+sGXsfl_40_idx ;
      edtArticuloDescripcionCorta_Internalname = "ARTICULODESCRIPCIONCORTA_"+sGXsfl_40_idx ;
      edtArticuloDescripcionLarga_Internalname = "ARTICULODESCRIPCIONLARGA_"+sGXsfl_40_idx ;
      edtArticuloPrecioCompra_Internalname = "ARTICULOPRECIOCOMPRA_"+sGXsfl_40_idx ;
      edtArticuloPrecioVenta_Internalname = "ARTICULOPRECIOVENTA_"+sGXsfl_40_idx ;
      edtArticuloPrecioPromedio_Internalname = "ARTICULOPRECIOPROMEDIO_"+sGXsfl_40_idx ;
      edtArticuloStock_Internalname = "ARTICULOSTOCK_"+sGXsfl_40_idx ;
      edtTipoArticuloId_Internalname = "TIPOARTICULOID_"+sGXsfl_40_idx ;
      edtTipoArticuloNombre_Internalname = "TIPOARTICULONOMBRE_"+sGXsfl_40_idx ;
      edtImpuestoId_Internalname = "IMPUESTOID_"+sGXsfl_40_idx ;
      edtImpuestoPorcentaje_Internalname = "IMPUESTOPORCENTAJE_"+sGXsfl_40_idx ;
      edtArticuloImagen_Internalname = "ARTICULOIMAGEN_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtArticuloId_Internalname = "ARTICULOID_"+sGXsfl_40_fel_idx ;
      edtArticuloNombre_Internalname = "ARTICULONOMBRE_"+sGXsfl_40_fel_idx ;
      edtArticuloDescripcionCorta_Internalname = "ARTICULODESCRIPCIONCORTA_"+sGXsfl_40_fel_idx ;
      edtArticuloDescripcionLarga_Internalname = "ARTICULODESCRIPCIONLARGA_"+sGXsfl_40_fel_idx ;
      edtArticuloPrecioCompra_Internalname = "ARTICULOPRECIOCOMPRA_"+sGXsfl_40_fel_idx ;
      edtArticuloPrecioVenta_Internalname = "ARTICULOPRECIOVENTA_"+sGXsfl_40_fel_idx ;
      edtArticuloPrecioPromedio_Internalname = "ARTICULOPRECIOPROMEDIO_"+sGXsfl_40_fel_idx ;
      edtArticuloStock_Internalname = "ARTICULOSTOCK_"+sGXsfl_40_fel_idx ;
      edtTipoArticuloId_Internalname = "TIPOARTICULOID_"+sGXsfl_40_fel_idx ;
      edtTipoArticuloNombre_Internalname = "TIPOARTICULONOMBRE_"+sGXsfl_40_fel_idx ;
      edtImpuestoId_Internalname = "IMPUESTOID_"+sGXsfl_40_fel_idx ;
      edtImpuestoPorcentaje_Internalname = "IMPUESTOPORCENTAJE_"+sGXsfl_40_fel_idx ;
      edtArticuloImagen_Internalname = "ARTICULOIMAGEN_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTipoArticuloNombre_Internalname,GXutil.rtrim( A103TipoArticuloNombre),"","","'"+""+"'"+",false,"+"'"+""+"'",edtTipoArticuloNombre_Link,"","","",edtTipoArticuloNombre_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(80),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Nombre","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Articulo Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Articulo Nombre", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtTipoArticuloNombre_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:ArticuloId|4:ArticuloNombre|5:ArticuloDescripcionCorta|6:ArticuloDescripcionLarga|7:ArticuloPrecioCompra|8:ArticuloPrecioVenta|9:ArticuloPrecioPromedio|10:ArticuloStock|11:TipoArticuloId|12:TipoArticuloNombre|13:ImpuestoId|14:ImpuestoPorcentaje" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e12102',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e13102',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e15102',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e19102',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A13ArticuloId',fld:'ARTICULOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'A17TipoArticuloId',fld:'TIPOARTICULOID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTipoArticuloNombre_Link',ctrl:'TIPOARTICULONOMBRE',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e11102',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e16102',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A13ArticuloId',fld:'ARTICULOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e14102',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_TipoArticuloNombre',fld:'vISAUTHORIZED_TIPOARTICULONOMBRE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
   ...
   public void initialize( )
   {
      ...
      lV40Articulowwds_1_filterfulltext = "" ;
      AV40Articulowwds_1_filterfulltext = "" ;
      H00102_A231ArticuloImagen = new String[] {""} ;
      H00102_A40000ArticuloImagen_GXI = new String[] {""} ;
      H00102_A83ImpuestoPorcentaje = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00102_A18ImpuestoId = new long[1] ;
      H00102_A103TipoArticuloNombre = new String[] {""} ;
      H00102_A17TipoArticuloId = new long[1] ;
      H00102_A79ArticuloStock = new long[1] ;
      H00102_A222ArticuloPrecioPromedio = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00102_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00102_A77ArticuloPrecioCompra = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00102_A215ArticuloDescripcionLarga = new String[] {""} ;
      H00102_A214ArticuloDescripcionCorta = new String[] {""} ;
      H00102_A76ArticuloNombre = new String[] {""} ;
      H00102_A13ArticuloId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.articuloww__default(),
         new Object[] {
             new Object[] {
            H00102_A231ArticuloImagen, H00102_A40000ArticuloImagen_GXI, H00102_A83ImpuestoPorcentaje, H00102_A18ImpuestoId, H00102_A103TipoArticuloNombre, H00102_A17TipoArticuloId, H00102_A79ArticuloStock, H00102_A222ArticuloPrecioPromedio, H00102_A78ArticuloPrecioVenta, H00102_A77ArticuloPrecioCompra,
            H00102_A215ArticuloDescripcionLarga, H00102_A214ArticuloDescripcionCorta, H00102_A76ArticuloNombre, H00102_A13ArticuloId
            }
            , new Object[] {
   ...
   private boolean AV33IsAuthorized_TipoArticuloNombre ;
   ...
   private String lV40Articulowwds_1_filterfulltext ;
   private String AV40Articulowwds_1_filterfulltext ;
   ...
   private String[] H00102_A231ArticuloImagen ;
   private String[] H00102_A40000ArticuloImagen_GXI ;
   private java.math.BigDecimal[] H00102_A83ImpuestoPorcentaje ;
   private long[] H00102_A18ImpuestoId ;
   private String[] H00102_A103TipoArticuloNombre ;
   private long[] H00102_A17TipoArticuloId ;
   private long[] H00102_A79ArticuloStock ;
   private java.math.BigDecimal[] H00102_A222ArticuloPrecioPromedio ;
   private java.math.BigDecimal[] H00102_A78ArticuloPrecioVenta ;
   private java.math.BigDecimal[] H00102_A77ArticuloPrecioCompra ;
   private String[] H00102_A215ArticuloDescripcionLarga ;
   private String[] H00102_A214ArticuloDescripcionCorta ;
   private String[] H00102_A76ArticuloNombre ;
   private long[] H00102_A13ArticuloId ;
...
final  class articuloww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00102( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV40Articulowwds_1_filterfulltext ,
                                          long A13ArticuloId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV40Articulowwds_1_filterfulltext)==0) )
      {
