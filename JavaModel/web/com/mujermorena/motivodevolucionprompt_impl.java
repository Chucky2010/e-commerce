...
public final  class motivodevolucionprompt_impl extends GXDataArea
{
   public motivodevolucionprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public motivodevolucionprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( motivodevolucionprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutMotivoDevolucionID") ;
         ...
         {
            AV8InOutMotivoDevolucionID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutMotivoDevolucionID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutMotivoDevolucionID), 10, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutMotivoDevolucionDescripcion = httpContext.GetPar( "InOutMotivoDevolucionDescripcion") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutMotivoDevolucionDescripcion", AV9InOutMotivoDevolucionDescripcion);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.motivodevolucionprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutMotivoDevolucionID,10,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutMotivoDevolucionDescripcion))}, new String[] {"InOutMotivoDevolucionID","InOutMotivoDevolucionDescripcion"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTMOTIVODEVOLUCIONID", GXutil.ltrim( localUtil.ntoc( AV8InOutMotivoDevolucionID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTMOTIVODEVOLUCIONDESCRIPCION", AV9InOutMotivoDevolucionDescripcion);
   ...
   {
      return formatLink("com.mujermorena.motivodevolucionprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutMotivoDevolucionID,10,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutMotivoDevolucionDescripcion))}, new String[] {"InOutMotivoDevolucionID","InOutMotivoDevolucionDescripcion"})  ;
   }

   public String getPgmname( )
   {
      return "MotivoDevolucionPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Motivo Devolucion", "") ;
   }
   ...
   public void wb650( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_652( true) ;
      }
      else
      {
         wb_table1_14_652( false) ;
      }
      return  ;
   }

   public void wb_table1_14_652e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start652( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Motivo Devolucion", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_MOTIVODEVOLUCIONDESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A280MotivoDevolucionDescripcion, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "MOTIVODEVOLUCIONDESCRIPCION", A280MotivoDevolucionDescripcion);
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "MotivoDevolucionPrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf652( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H00652 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A280MotivoDevolucionDescripcion = H00652_A280MotivoDevolucionDescripcion[0] ;
            A273MotivoDevolucionID = H00652_A273MotivoDevolucionID[0] ;
            e17652 ();
   ...
   public void send_integrity_lvl_hashes652( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_MOTIVODEVOLUCIONID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A273MotivoDevolucionID), "ZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_MOTIVODEVOLUCIONDESCRIPCION"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A280MotivoDevolucionDescripcion, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      GRID_nRecordCount = H00653_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e15652( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Motivo Devolucion", "") );
   ...
   public void e16652( )
   {
      ...
      motivodevolucionprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e18652( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutMotivoDevolucionID = A273MotivoDevolucionID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutMotivoDevolucionID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutMotivoDevolucionID), 10, 0));
      AV9InOutMotivoDevolucionDescripcion = A280MotivoDevolucionDescripcion ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutMotivoDevolucionDescripcion", AV9InOutMotivoDevolucionDescripcion);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutMotivoDevolucionID),AV9InOutMotivoDevolucionDescripcion});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutMotivoDevolucionID","AV9InOutMotivoDevolucionDescripcion"});
   ...
   public void wb_table1_14_652( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_MotivoDevolucionPrompt.htm");
   ...
   {
      AV8InOutMotivoDevolucionID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutMotivoDevolucionID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutMotivoDevolucionID), 10, 0));
      AV9InOutMotivoDevolucionDescripcion = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutMotivoDevolucionDescripcion", AV9InOutMotivoDevolucionDescripcion);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224830", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("motivodevolucionprompt.js", "?202412111224830", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:MotivoDevolucionID|2:MotivoDevolucionDescripcion" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17652',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18652',iparms:[{av:'A273MotivoDevolucionID',fld:'MOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A280MotivoDevolucionDescripcion',fld:'MOTIVODEVOLUCIONDESCRIPCION',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutMotivoDevolucionID',fld:'vINOUTMOTIVODEVOLUCIONID',pic:'ZZZZZZZZZ9'},{av:'AV9InOutMotivoDevolucionDescripcion',fld:'vINOUTMOTIVODEVOLUCIONDESCRIPCION',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14652',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   {
      wcpOAV9InOutMotivoDevolucionDescripcion = "" ;
      Gridpaginationbar_Selectedpage = "" ;
      Ddo_grid_Activeeventkey = "" ;
      Ddo_grid_Selectedvalue_get = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV9InOutMotivoDevolucionDescripcion = "" ;
      AV13FilterFullText = "" ;
      AV22Pgmname = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00652_A280MotivoDevolucionDescripcion = new String[] {""} ;
      H00652_A273MotivoDevolucionID = new long[1] ;
      H00653_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.motivodevolucionprompt__default(),
         new Object[] {
             new Object[] {
            H00652_A280MotivoDevolucionDescripcion, H00652_A273MotivoDevolucionID
            }
            , new Object[] {
            H00653_AGRID_nRecordCount
            }
         }
      );
      AV22Pgmname = "MotivoDevolucionPrompt" ;
   ...
   private long wcpOAV8InOutMotivoDevolucionID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutMotivoDevolucionID ;
   ...
   private String wcpOAV9InOutMotivoDevolucionDescripcion ;
   private String AV9InOutMotivoDevolucionDescripcion ;
   ...
   private String[] H00652_A280MotivoDevolucionDescripcion ;
   private long[] H00652_A273MotivoDevolucionID ;
   private long[] H00653_AGRID_nRecordCount ;
...
final  class motivodevolucionprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00652( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00653( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A273MotivoDevolucionID ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00652(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H00653(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00652", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00653", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
