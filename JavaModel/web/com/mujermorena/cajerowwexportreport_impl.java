...
public final  class cajerowwexportreport_impl extends GXWebReport
{
   public cajerowwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "cajeroww_Execute", GXv_boolean2) ;
         cajerowwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Cajero", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 30, Gx_line+10, 154, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 158, Gx_line+10, 406, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Identificador", ""), 410, Gx_line+10, 534, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Usuario ID", ""), 538, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Cajerowwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Cajerowwds_1_filterfulltext ,
      ...
      lV35Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Cajerowwds_1_filterfulltext), "%", "") ;
      lV35Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Cajerowwds_1_filterfulltext), "%", "") ;
      lV35Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Cajerowwds_1_filterfulltext), "%", "") ;
      lV35Cajerowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Cajerowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P004R2 */
      pr_default.execute(0, new Object[] {lV35Cajerowwds_1_filterfulltext, lV35Cajerowwds_1_filterfulltext, lV35Cajerowwds_1_filterfulltext, lV35Cajerowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A113CajeroIdentificador = P004R2_A113CajeroIdentificador[0] ;
         A26CajeroId = P004R2_A26CajeroId[0] ;
         A254CajeroUsuarioID = P004R2_A254CajeroUsuarioID[0] ;
         A112CajeroNombre = P004R2_A112CajeroNombre[0] ;
         ...
         h4R0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A26CajeroId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 154, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A112CajeroNombre, "")), 158, Gx_line+10, 406, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A113CajeroIdentificador), "ZZZZZZZZZ9")), 410, Gx_line+10, 534, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A254CajeroUsuarioID, "")), 538, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("CajeroWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "CajeroWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("CajeroWWGridState"), null, null);
      }
   ...
   public void h4R0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Cajerowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Cajerowwds_1_filterfulltext = "" ;
      P004R2_A113CajeroIdentificador = new long[1] ;
      P004R2_A26CajeroId = new long[1] ;
      P004R2_A254CajeroUsuarioID = new String[] {""} ;
      P004R2_A112CajeroNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.cajerowwexportreport__default(),
         new Object[] {
             new Object[] {
            P004R2_A113CajeroIdentificador, P004R2_A26CajeroId, P004R2_A254CajeroUsuarioID, P004R2_A112CajeroNombre
            }
         }
      );
   ...
   private String AV35Cajerowwds_1_filterfulltext ;
   private String lV35Cajerowwds_1_filterfulltext ;
   ...
   private long[] P004R2_A113CajeroIdentificador ;
   private long[] P004R2_A26CajeroId ;
   private String[] P004R2_A254CajeroUsuarioID ;
   private String[] P004R2_A112CajeroNombre ;
...
final  class cajerowwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P004R2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Cajerowwds_1_filterfulltext ,
                                          long A26CajeroId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Cajerowwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P004R2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
