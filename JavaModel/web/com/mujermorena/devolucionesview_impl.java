...
public final  class devolucionesview_impl extends GXDataArea
{
   public devolucionesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public devolucionesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( devolucionesview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10DevolucionesID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10DevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10DevolucionesID), 10, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEVOLUCIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DevolucionesID), "ZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.devolucionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DevolucionesID,10,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DevolucionesID","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vDEVOLUCIONESID", GXutil.ltrim( localUtil.ntoc( AV10DevolucionesID, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEVOLUCIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DevolucionesID), "ZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.devolucionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DevolucionesID,10,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DevolucionesID","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Devoluciones View", "") ;
   }
   ...
   public void wb680( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Devoluciones :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_DevolucionesView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Devoluciones", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_DevolucionesView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DevolucionesView.htm");
         /* Div Control */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblDetalle_title_Internalname, httpContext.getMessage( "Detalle", ""), "", "", lblDetalle_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DevolucionesView.htm");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
   ...
   public void start682( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Devoluciones View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes682( )
   {
   }
   ...
   public void strup680( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10DevolucionesID = localUtil.ctol( httpContext.cgiGet( "vDEVOLUCIONESID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e11682( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.devolucionesww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H00682 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10DevolucionesID)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A272DevolucionesID = H00682_A272DevolucionesID[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "DevolucionesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.devolucionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "DevolucionesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10DevolucionesID)});
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "Detalle") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Detallewc_Component), GXutil.lower( "DevolucionesDetalleWC")) != 0 )
         {
            WebComp_Detallewc = WebUtils.getWebComponent(getClass(), "com.mujermorena.devolucionesdetallewc_impl", remoteHandle, context);
            WebComp_Detallewc_Component = "DevolucionesDetalleWC" ;
         }
         if ( GXutil.len( WebComp_Detallewc_Component) != 0 )
         {
            WebComp_Detallewc.setjustcreated();
            WebComp_Detallewc.componentprepare(new Object[] {"W0039","",Long.valueOf(AV10DevolucionesID)});
   ...
   {
      AV10DevolucionesID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10DevolucionesID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10DevolucionesID), 10, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEVOLUCIONESID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DevolucionesID), "ZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111225158", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("devolucionesview.js", "?202412111225158", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Devoluciones View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10DevolucionesID',fld:'vDEVOLUCIONESID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00682_A272DevolucionesID = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.devolucionesview__default(),
         new Object[] {
             new Object[] {
            H00682_A272DevolucionesID
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10DevolucionesID ;
   private long AV10DevolucionesID ;
   ...
   private long[] H00682_A272DevolucionesID ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class devolucionesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00682", "SELECT [DevolucionesID] FROM [Devoluciones] WHERE [DevolucionesID] = ? ORDER BY [DevolucionesID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
