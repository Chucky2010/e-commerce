...
public final  class ciudadwwexportreport_impl extends GXWebReport
{
   public ciudadwwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "ciudadww_Execute", GXv_boolean2) ;
         ciudadwwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Ciudad", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 30, Gx_line+10, 122, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 126, Gx_line+10, 310, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 314, Gx_line+10, 407, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 411, Gx_line+10, 597, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 601, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Ciudadwwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Ciudadwwds_1_filterfulltext ,
      ...
      lV35Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Ciudadwwds_1_filterfulltext), "%", "") ;
      lV35Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Ciudadwwds_1_filterfulltext), "%", "") ;
      lV35Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Ciudadwwds_1_filterfulltext), "%", "") ;
      lV35Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Ciudadwwds_1_filterfulltext), "%", "") ;
      lV35Ciudadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Ciudadwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003X2 */
      pr_default.execute(0, new Object[] {lV35Ciudadwwds_1_filterfulltext, lV35Ciudadwwds_1_filterfulltext, lV35Ciudadwwds_1_filterfulltext, lV35Ciudadwwds_1_filterfulltext, lV35Ciudadwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A5PaisId = P003X2_A5PaisId[0] ;
         A6DepartamentoId = P003X2_A6DepartamentoId[0] ;
         A7CiudadId = P003X2_A7CiudadId[0] ;
         A60PaisNombre = P003X2_A60PaisNombre[0] ;
         A61DepartamentoNombre = P003X2_A61DepartamentoNombre[0] ;
         A62CiudadNombre = P003X2_A62CiudadNombre[0] ;
         A5PaisId = P003X2_A5PaisId[0] ;
         A61DepartamentoNombre = P003X2_A61DepartamentoNombre[0] ;
         A60PaisNombre = P003X2_A60PaisNombre[0] ;
         ...
         h3X0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A7CiudadId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 122, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A62CiudadNombre, "")), 126, Gx_line+10, 310, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6DepartamentoId), "ZZZZZZZZZZ9")), 314, Gx_line+10, 407, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A61DepartamentoNombre, "")), 411, Gx_line+10, 597, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A60PaisNombre, "")), 601, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("CiudadWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "CiudadWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("CiudadWWGridState"), null, null);
      }
   ...
   public void h3X0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Ciudadwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Ciudadwwds_1_filterfulltext = "" ;
      P003X2_A5PaisId = new long[1] ;
      P003X2_A6DepartamentoId = new long[1] ;
      P003X2_A7CiudadId = new long[1] ;
      P003X2_A60PaisNombre = new String[] {""} ;
      P003X2_A61DepartamentoNombre = new String[] {""} ;
      P003X2_A62CiudadNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.ciudadwwexportreport__default(),
         new Object[] {
             new Object[] {
            P003X2_A5PaisId, P003X2_A6DepartamentoId, P003X2_A7CiudadId, P003X2_A60PaisNombre, P003X2_A61DepartamentoNombre, P003X2_A62CiudadNombre
            }
         }
      );
   ...
   private String AV35Ciudadwwds_1_filterfulltext ;
   private String lV35Ciudadwwds_1_filterfulltext ;
   ...
   private long[] P003X2_A5PaisId ;
   private long[] P003X2_A6DepartamentoId ;
   private long[] P003X2_A7CiudadId ;
   private String[] P003X2_A60PaisNombre ;
   private String[] P003X2_A61DepartamentoNombre ;
   private String[] P003X2_A62CiudadNombre ;
...
final  class ciudadwwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P003X2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Ciudadwwds_1_filterfulltext ,
                                          long A7CiudadId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Ciudadwwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003X2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003X2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
