...
public final  class tipoarticuloarticulowc_impl extends GXWebComponent
{
   public tipoarticuloarticulowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipoarticuloarticulowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipoarticuloarticulowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8TipoArticuloId = GXutil.lval( httpContext.GetPar( "TipoArticuloId")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoArticuloId), 11, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(AV8TipoArticuloId)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8TipoArticuloId, AV20ManageFiltersExecutionStep, AV36Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Tipo Articulo Articulo WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tipoarticuloarticulowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8TipoArticuloId,11,0))}, new String[] {"TipoArticuloId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8TipoArticuloId", GXutil.ltrim( localUtil.ntoc( wcpOAV8TipoArticuloId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( sPrefix, AV33IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTIPOARTICULOID", GXutil.ltrim( localUtil.ntoc( AV8TipoArticuloId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return "TipoArticuloArticuloWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Articulo Articulo WC", "") ;
   }
   ...
   public void wb4H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.tipoarticuloarticulowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_TipoArticuloArticuloWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_4H2( true) ;
      }
      else
      {
         wb_table1_21_4H2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_4H2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4H2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Articulo Articulo WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV36Pgmname = "TipoArticuloArticuloWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Long.valueOf(AV8TipoArticuloId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.DECIMAL, TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.LONG,
                                              TypeConstants.DECIMAL, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004H2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8TipoArticuloId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A17TipoArticuloId = H004H2_A17TipoArticuloId[0] ;
            ...
            A231ArticuloImagen = H004H2_A231ArticuloImagen[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_36_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
            A40000ArticuloImagen_GXI = H004H2_A40000ArticuloImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A231ArticuloImagen)==0) ? A40000ArticuloImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A231ArticuloImagen))), !bGXsfl_36_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtArticuloImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A231ArticuloImagen), true);
            A83ImpuestoPorcentaje = H004H2_A83ImpuestoPorcentaje[0] ;
            A18ImpuestoId = H004H2_A18ImpuestoId[0] ;
            A79ArticuloStock = H004H2_A79ArticuloStock[0] ;
            A222ArticuloPrecioPromedio = H004H2_A222ArticuloPrecioPromedio[0] ;
            A78ArticuloPrecioVenta = H004H2_A78ArticuloPrecioVenta[0] ;
            A77ArticuloPrecioCompra = H004H2_A77ArticuloPrecioCompra[0] ;
            A215ArticuloDescripcionLarga = H004H2_A215ArticuloDescripcionLarga[0] ;
            A214ArticuloDescripcionCorta = H004H2_A214ArticuloDescripcionCorta[0] ;
            A76ArticuloNombre = H004H2_A76ArticuloNombre[0] ;
            A13ArticuloId = H004H2_A13ArticuloId[0] ;
            A83ImpuestoPorcentaje = H004H2_A83ImpuestoPorcentaje[0] ;
            e184H2 ();
   ...
   public void send_integrity_lvl_hashes4H2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV36Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV36Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DISPLAY", AV28IsAuthorized_Display);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004H3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8TipoArticuloId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup4H0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8TipoArticuloId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8TipoArticuloId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e164H2( )
   {
      ...
      edtTipoArticuloId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTipoArticuloId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtTipoArticuloId_Visible), 5, 0), true);
   ...
   public void e174H2( )
   {
      ...
      tipoarticuloarticulowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e114H2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoArticuloArticuloWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV36Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoArticuloArticuloWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "TipoArticuloArticuloWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         tipoarticuloarticulowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articuloview_Execute", GXv_boolean7) ;
      tipoarticuloarticulowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articulo_Update", GXv_boolean7) ;
      tipoarticuloarticulowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articulo_Delete", GXv_boolean7) ;
      tipoarticuloarticulowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "articulo_Insert", GXv_boolean7) ;
      tipoarticuloarticulowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "TipoArticuloArticuloWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "TipoArticuloId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8TipoArticuloId, 11, 0) );
   ...
   public void wb_table1_21_4H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_4H2( true) ;
      }
      else
      {
         wb_table2_26_4H2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_4H2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_4H2e( true) ;
      }
      else
      {
         wb_table1_21_4H2e( false) ;
      }
   }

   public void wb_table2_26_4H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8TipoArticuloId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoArticuloId), 11, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8TipoArticuloId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "tipoarticuloarticulowc", GetJustCreated( ));
      ...
      {
         AV8TipoArticuloId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoArticuloId), 11, 0));
      }
      wcpOAV8TipoArticuloId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8TipoArticuloId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( AV8TipoArticuloId != wcpOAV8TipoArticuloId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8TipoArticuloId = AV8TipoArticuloId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8TipoArticuloId = httpContext.cgiGet( sPrefix+"AV8TipoArticuloId_CTRL") ;
      if ( GXutil.len( sCtrlAV8TipoArticuloId) > 0 )
      {
         AV8TipoArticuloId = localUtil.ctol( httpContext.cgiGet( sCtrlAV8TipoArticuloId), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8TipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8TipoArticuloId), 11, 0));
      }
      else
      {
         AV8TipoArticuloId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8TipoArticuloId_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8TipoArticuloId_PARM", GXutil.ltrim( localUtil.ntoc( AV8TipoArticuloId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8TipoArticuloId)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8TipoArticuloId_CTRL", GXutil.rtrim( sCtrlAV8TipoArticuloId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211192538", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("tipoarticuloarticulowc.js", "?20241211192538", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtImpuestoId_Internalname = sPrefix+"IMPUESTOID_"+sGXsfl_36_idx ;
      edtImpuestoPorcentaje_Internalname = sPrefix+"IMPUESTOPORCENTAJE_"+sGXsfl_36_idx ;
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtImpuestoId_Internalname = sPrefix+"IMPUESTOID_"+sGXsfl_36_fel_idx ;
      edtImpuestoPorcentaje_Internalname = sPrefix+"IMPUESTOPORCENTAJE_"+sGXsfl_36_fel_idx ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:ArticuloId|4:ArticuloNombre|5:ArticuloDescripcionCorta|6:ArticuloDescripcionLarga|7:ArticuloPrecioCompra|8:ArticuloPrecioVenta|9:ArticuloPrecioPromedio|10:ArticuloStock|11:ImpuestoId|12:ImpuestoPorcentaje" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184H2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A13ArticuloId',fld:'ARTICULOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TipoArticuloId',fld:'vTIPOARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV36Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A13ArticuloId',fld:'ARTICULOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004H2_A17TipoArticuloId = new long[1] ;
      H004H2_A231ArticuloImagen = new String[] {""} ;
      H004H2_A40000ArticuloImagen_GXI = new String[] {""} ;
      H004H2_A83ImpuestoPorcentaje = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004H2_A18ImpuestoId = new long[1] ;
      H004H2_A79ArticuloStock = new long[1] ;
      H004H2_A222ArticuloPrecioPromedio = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004H2_A78ArticuloPrecioVenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004H2_A77ArticuloPrecioCompra = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004H2_A215ArticuloDescripcionLarga = new String[] {""} ;
      H004H2_A214ArticuloDescripcionCorta = new String[] {""} ;
      H004H2_A76ArticuloNombre = new String[] {""} ;
      H004H2_A13ArticuloId = new long[1] ;
      ...
      sCtrlAV8TipoArticuloId = "" ;
      subGrid_Linesclass = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      GridColumn = new com.genexus.webpanels.GXWebColumn();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipoarticuloarticulowc__default(),
         new Object[] {
             new Object[] {
            H004H2_A17TipoArticuloId, H004H2_A231ArticuloImagen, H004H2_A40000ArticuloImagen_GXI, H004H2_A83ImpuestoPorcentaje, H004H2_A18ImpuestoId, H004H2_A79ArticuloStock, H004H2_A222ArticuloPrecioPromedio, H004H2_A78ArticuloPrecioVenta, H004H2_A77ArticuloPrecioCompra, H004H2_A215ArticuloDescripcionLarga,
            H004H2_A214ArticuloDescripcionCorta, H004H2_A76ArticuloNombre, H004H2_A13ArticuloId
            }
            , new Object[] {
   ...
   private int edtTipoArticuloId_Visible ;
   ...
   private long wcpOAV8TipoArticuloId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8TipoArticuloId ;
   ...
   private String sCtrlAV8TipoArticuloId ;
   ...
   private long[] H004H2_A17TipoArticuloId ;
   private String[] H004H2_A231ArticuloImagen ;
   private String[] H004H2_A40000ArticuloImagen_GXI ;
   private java.math.BigDecimal[] H004H2_A83ImpuestoPorcentaje ;
   private long[] H004H2_A18ImpuestoId ;
   private long[] H004H2_A79ArticuloStock ;
   private java.math.BigDecimal[] H004H2_A222ArticuloPrecioPromedio ;
   private java.math.BigDecimal[] H004H2_A78ArticuloPrecioVenta ;
   private java.math.BigDecimal[] H004H2_A77ArticuloPrecioCompra ;
   private String[] H004H2_A215ArticuloDescripcionLarga ;
   private String[] H004H2_A214ArticuloDescripcionCorta ;
   private String[] H004H2_A76ArticuloNombre ;
   private long[] H004H2_A13ArticuloId ;
...
final  class tipoarticuloarticulowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004H2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long AV8TipoArticuloId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[TipoArticuloId], T1.[ArticuloImagen], T1.[ArticuloImagen_GXI], T2.[ImpuestoPorcentaje], T1.[ImpuestoId], T1.[ArticuloStock], T1.[ArticuloPrecioPromedio], T1.[ArticuloPrecioVenta]," ;
      ...
      sFromString = " FROM ([Articulo] T1 INNER JOIN [Impuesto] T2 ON T2.[ImpuestoId] = T1.[ImpuestoId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[TipoArticuloId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T1.[ArticuloNombre] like '%' + ?) or ( T1.[ArticuloDescripcionCorta] like '%' + ?) or ( T1.[ArticuloDescripcionLarga] like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioCompra] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioVenta] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioPromedio] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[ArticuloStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ImpuestoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(9), CAST(T2.[ImpuestoPorcentaje] AS decimal(9,2))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloNombre]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloDescripcionCorta]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloDescripcionCorta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloDescripcionLarga]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloDescripcionLarga] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloPrecioCompra]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloPrecioCompra] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloPrecioVenta]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloPrecioVenta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloPrecioPromedio]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloPrecioPromedio] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ArticuloStock]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ArticuloStock] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T1.[ImpuestoId]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T1.[ImpuestoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId], T2.[ImpuestoPorcentaje]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[TipoArticuloId] DESC, T2.[ImpuestoPorcentaje] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H004H3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          long A13ArticuloId ,
                                          ...
                                          long AV8TipoArticuloId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Articulo] T1 INNER JOIN [Impuesto] T2 ON T2.[ImpuestoId] = T1.[ImpuestoId])" ;
      addWhere(sWhereString, "(T1.[TipoArticuloId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T1.[ArticuloNombre] like '%' + ?) or ( T1.[ArticuloDescripcionCorta] like '%' + ?) or ( T1.[ArticuloDescripcionLarga] like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioCompra] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioVenta] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ArticuloPrecioPromedio] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(10), CAST(T1.[ArticuloStock] AS decimal(10,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ImpuestoId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(9), CAST(T2.[ImpuestoPorcentaje] AS decimal(9,2))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004H2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , (java.math.BigDecimal)dynConstraints[6] , (java.math.BigDecimal)dynConstraints[7] , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).longValue() , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() , ((Number) dynConstraints[13]).longValue() );
            case 1 :
                  return conditional_H004H3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , (java.math.BigDecimal)dynConstraints[6] , (java.math.BigDecimal)dynConstraints[7] , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).longValue() , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() , ((Number) dynConstraints[13]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004H2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004H3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
