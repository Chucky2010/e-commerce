...
public final  class rwdrecentlinks_impl extends GXWebComponent
{
   ...
   public void gxnrlinks_newrow_invoke( )
   {
      ...
      gxnrlinks_newrow( ) ;
      /* End function gxnrLinks_newrow_invoke */
   }

   public void gxgrlinks_refresh_invoke( )
   {
      AV6FormCaption = httpContext.GetPar( "FormCaption") ;
      sPrefix = httpContext.GetPar( "sPrefix") ;
      ...
      /* End function gxgrLinks_refresh_invoke */
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Responsive Recent Links", "")) ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_8", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_8, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6FormCaption", GXutil.rtrim( wcpOAV6FormCaption));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7FormPgmName", wcpOAV7FormPgmName);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMCAPTION", GXutil.rtrim( AV6FormCaption));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMPGMNAME", AV7FormPgmName);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"MAINTABLE_Class", GXutil.rtrim( divMaintable_Class));
   }
   ...
   {
      return httpContext.getMessage( "Responsive Recent Links", "") ;
   }
   ...
   public void wb050( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.rwdrecentlinks");
         }
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", divMaintable_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2 col-md-1", "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblRecenttext_Internalname, httpContext.getMessage( "Recents", ""), "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e11051_client"+"'", "", "RecentsTitle", 7, "", 1, 1, 0, (short)(0), "HLP_RwdRecentLinks.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10 col-md-11", "left", "top", "", "", "div");
         /*  Grid Control  */
      ...
      if ( wbEnd == 8 )
      {
         ...
         else
         {
            ...
            httpContext.ajax_rsp_assign_grid(sPrefix+"_"+"Links", LinksContainer, subLinks_Internalname);
            if ( ! isAjaxCallMode( ) && ! httpContext.isSpaRequest( ) )
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LinksContainerData", LinksContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LinksContainerData"+"V", LinksContainer.GridValuesHidden());
            }
            else
            {
   ...
   public void start052( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Responsive Recent Links", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf052( )
   {
      ...
      if ( subLinks_Islastpage != 0 )
      {
         ...
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LINKS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( LINKS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
   ...
   public void strup050( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         nRC_GXsfl_8 = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"nRC_GXsfl_8"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   private void e12052( )
   {
      ...
      {
         AV12RecentLinksItem = (com.mujermorena.SdtLinkList_LinkItem)((com.mujermorena.SdtLinkList_LinkItem)AV11RecentLinksItems.elementAt(-1+AV9i));
      ...
      AV12RecentLinksItem = (com.mujermorena.SdtLinkList_LinkItem)new com.mujermorena.SdtLinkList_LinkItem(remoteHandle, context);
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6FormCaption_PARM", GXutil.rtrim( AV6FormCaption));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6FormCaption)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6FormCaption_CTRL", GXutil.rtrim( sCtrlAV6FormCaption));
      }
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7FormPgmName_PARM", AV7FormPgmName);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7FormPgmName)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7FormPgmName_CTRL", GXutil.rtrim( sCtrlAV7FormPgmName));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211164263", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("rwdrecentlinks.js", "?20241211164263", false, true);
   ...
   public void startgridcontrol8( )
   {
      if ( LinksContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subLinks_Internalname, subLinks_Internalname, "", "RecentLinksGrid", 0, "", "", 1, 2, sStyleString, "", "", 0);
         LinksContainer.AddObjectProperty("GridName", "Links");
      }
      else
      {
   ...
   public void initialize_properties( )
   {
      ...
      lblPlace_Caption = httpContext.getMessage( "Place.", "") ;
      lblPlace_Link = "" ;
      lblPlace_Caption = httpContext.getMessage( "Place.", "") ;
   ...
   public void initialize( )
   {
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      AV11RecentLinksItems = new GXBaseCollection<com.mujermorena.SdtLinkList_LinkItem>(com.mujermorena.SdtLinkList_LinkItem.class, "LinkItem", "GeneXus", remoteHandle);
      AV8Session = httpContext.getWebSession();
      AV12RecentLinksItem = new com.mujermorena.SdtLinkList_LinkItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.mujermorena.SdtLinkList_LinkItem> AV11RecentLinksItems ;
   private com.mujermorena.SdtLinkList_LinkItem AV12RecentLinksItem ;
}
