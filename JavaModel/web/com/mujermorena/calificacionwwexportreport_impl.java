...
public final  class calificacionwwexportreport_impl extends GXWebReport
{
   public calificacionwwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "calificacionww_Execute", GXv_boolean2) ;
         calificacionwwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Calificacion", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 30, Gx_line+10, 135, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nro", ""), 139, Gx_line+10, 245, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Desc", ""), 249, Gx_line+10, 461, Gx_line+27, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Usuario", ""), 465, Gx_line+10, 677, Gx_line+27, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Fecha Hora", ""), 681, Gx_line+10, 787, Gx_line+27, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Calificacionwwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Calificacionwwds_1_filterfulltext ,
      ...
      lV35Calificacionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Calificacionwwds_1_filterfulltext), "%", "") ;
      lV35Calificacionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Calificacionwwds_1_filterfulltext), "%", "") ;
      lV35Calificacionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Calificacionwwds_1_filterfulltext), "%", "") ;
      lV35Calificacionwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Calificacionwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P00722 */
      pr_default.execute(0, new Object[] {lV35Calificacionwwds_1_filterfulltext, lV35Calificacionwwds_1_filterfulltext, lV35Calificacionwwds_1_filterfulltext, lV35Calificacionwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A299CalificacionNro = P00722_A299CalificacionNro[0] ;
         A298CalificacionId = P00722_A298CalificacionId[0] ;
         A301CalificacionUsuario = P00722_A301CalificacionUsuario[0] ;
         A300CalificacionDesc = P00722_A300CalificacionDesc[0] ;
         A302CalificacionFechaHora = P00722_A302CalificacionFechaHora[0] ;
         ...
         h720( false, 66) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A298CalificacionId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 135, Gx_line+55, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A299CalificacionNro), "ZZZ9")), 139, Gx_line+10, 245, Gx_line+55, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A300CalificacionDesc, "")), 249, Gx_line+10, 461, Gx_line+55, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A301CalificacionUsuario, "")), 465, Gx_line+10, 677, Gx_line+55, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(localUtil.format( A302CalificacionFechaHora, "99/99/99 99:99"), 681, Gx_line+10, 787, Gx_line+55, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("CalificacionWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "CalificacionWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("CalificacionWWGridState"), null, null);
      }
   ...
   public void initialize( )
   {
      ...
      AV35Calificacionwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Calificacionwwds_1_filterfulltext = "" ;
      P00722_A299CalificacionNro = new short[1] ;
      P00722_A298CalificacionId = new long[1] ;
      P00722_A301CalificacionUsuario = new String[] {""} ;
      P00722_A300CalificacionDesc = new String[] {""} ;
      P00722_A302CalificacionFechaHora = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.calificacionwwexportreport__default(),
         new Object[] {
             new Object[] {
            P00722_A299CalificacionNro, P00722_A298CalificacionId, P00722_A301CalificacionUsuario, P00722_A300CalificacionDesc, P00722_A302CalificacionFechaHora
            }
         }
      );
   ...
   private String AV35Calificacionwwds_1_filterfulltext ;
   private String lV35Calificacionwwds_1_filterfulltext ;
   ...
   private short[] P00722_A299CalificacionNro ;
   private long[] P00722_A298CalificacionId ;
   private String[] P00722_A301CalificacionUsuario ;
   private String[] P00722_A300CalificacionDesc ;
   private java.util.Date[] P00722_A302CalificacionFechaHora ;
...
final  class calificacionwwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00722( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Calificacionwwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Calificacionwwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00722(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00722", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
