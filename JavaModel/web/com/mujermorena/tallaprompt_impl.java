...
public final  class tallaprompt_impl extends GXDataArea
{
   public tallaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tallaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tallaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutTallaID") ;
         ...
         {
            AV8InOutTallaID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTallaID), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutTallaNombre = httpContext.GetPar( "InOutTallaNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTallaNombre", AV9InOutTallaNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.tallaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTallaID,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutTallaNombre))}, new String[] {"InOutTallaID","InOutTallaNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTALLAID", GXutil.ltrim( localUtil.ntoc( AV8InOutTallaID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTALLANOMBRE", GXutil.rtrim( AV9InOutTallaNombre));
   ...
   {
      return formatLink("com.mujermorena.tallaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTallaID,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutTallaNombre))}, new String[] {"InOutTallaID","InOutTallaNombre"})  ;
   }
   ...
   public void wb6L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_6L2( true) ;
      }
      else
      {
         wb_table1_14_6L2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_6L2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TALLANOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A287TallaNombre, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "TALLANOMBRE", GXutil.rtrim( A287TallaNombre));
   }
   ...
   public void rf6L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A288TallaNumero = H006L2_A288TallaNumero[0] ;
            A287TallaNombre = H006L2_A287TallaNombre[0] ;
            A286TallaID = H006L2_A286TallaID[0] ;
            e176L2 ();
   ...
   public void send_integrity_lvl_hashes6L2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TALLAID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A286TallaID), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TALLANOMBRE"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A287TallaNombre, ""))));
   }
   ...
   public void e166L2( )
   {
      ...
      tallaprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e186L2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutTallaID = A286TallaID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTallaID), 11, 0));
      AV9InOutTallaNombre = A287TallaNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTallaNombre", AV9InOutTallaNombre);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutTallaID),AV9InOutTallaNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutTallaID","AV9InOutTallaNombre"});
   ...
   public void wb_table1_14_6L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_TallaPrompt.htm");
   ...
   {
      AV8InOutTallaID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTallaID), 11, 0));
      AV9InOutTallaNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTallaNombre", AV9InOutTallaNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024121112381", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tallaprompt.js", "?2024121112381", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:TallaID|2:TallaNombre|3:TallaNumero" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e176L2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e186L2',iparms:[{av:'A286TallaID',fld:'TALLAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A287TallaNombre',fld:'TALLANOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTallaID',fld:'vINOUTTALLAID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutTallaNombre',fld:'vINOUTTALLANOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H006L2_A288TallaNumero = new short[1] ;
      H006L2_A287TallaNombre = new String[] {""} ;
      H006L2_A286TallaID = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tallaprompt__default(),
         new Object[] {
             new Object[] {
            H006L2_A288TallaNumero, H006L2_A287TallaNombre, H006L2_A286TallaID
            }
            , new Object[] {
   ...
   private short[] H006L2_A288TallaNumero ;
   private String[] H006L2_A287TallaNombre ;
   private long[] H006L2_A286TallaID ;
...
final  class tallaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006L2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H006L3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A286TallaID ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006L2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H006L3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006L2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006L3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
