...
public final  class StructSdtGxMap_Point implements Cloneable, java.io.Serializable
{
   public StructSdtGxMap_Point( )
   {
      this( -1, new ModelContext( StructSdtGxMap_Point.class ));
   }

   public StructSdtGxMap_Point( int remoteHandle ,
   ...
   public boolean getPointdraggable( )
   {
      return gxTv_SdtGxMap_Point_Pointdraggable ;
   }

   public void setPointdraggable( boolean value )
   {
      gxTv_SdtGxMap_Point_N = (byte)(0) ;
      gxTv_SdtGxMap_Point_Pointdraggable = value ;
   }

   public boolean getPointflat( )
   {
      return gxTv_SdtGxMap_Point_Pointflat ;
   }

   public void setPointflat( boolean value )
   {
      gxTv_SdtGxMap_Point_N = (byte)(0) ;
      gxTv_SdtGxMap_Point_Pointflat = value ;
   }

   public boolean getPointclickeable( )
   {
      return gxTv_SdtGxMap_Point_Pointclickeable ;
   }

   public void setPointclickeable( boolean value )
   {
      gxTv_SdtGxMap_Point_N = (byte)(0) ;
      gxTv_SdtGxMap_Point_Pointclickeable = value ;
   }

   public boolean getPointdeletable( )
   {
      return gxTv_SdtGxMap_Point_Pointdeletable ;
   }

   public void setPointdeletable( boolean value )
   {
      gxTv_SdtGxMap_Point_N = (byte)(0) ;
   ...
   public void setPointvisible( boolean value )
   {
      gxTv_SdtGxMap_Point_N = (byte)(0) ;
      gxTv_SdtGxMap_Point_Pointvisible = value ;
   }

   public String getPointinfowinhtml( )
   {
      return gxTv_SdtGxMap_Point_Pointinfowinhtml ;
   }

   public void setPointinfowinhtml( String value )
   {
      gxTv_SdtGxMap_Point_N = (byte)(0) ;
