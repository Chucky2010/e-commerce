...
public final  class tipopagowwexportreport_impl extends GXWebReport
{
   public tipopagowwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopagoww_Execute", GXv_boolean2) ;
         tipopagowwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Tipo Pago", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Pago Id", ""), 30, Gx_line+10, 179, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Pago Nombre", ""), 183, Gx_line+10, 483, Gx_line+27, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Pago Dato", ""), 487, Gx_line+10, 787, Gx_line+27, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Tipopagowwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Tipopagowwds_1_filterfulltext ,
      ...
      lV35Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipopagowwds_1_filterfulltext), "%", "") ;
      lV35Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipopagowwds_1_filterfulltext), "%", "") ;
      lV35Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Tipopagowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P00542 */
      pr_default.execute(0, new Object[] {lV35Tipopagowwds_1_filterfulltext, lV35Tipopagowwds_1_filterfulltext, lV35Tipopagowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A9TipoPagoId = P00542_A9TipoPagoId[0] ;
         A297TipoPagoDato = P00542_A297TipoPagoDato[0] ;
         A71TipoPagoNombre = P00542_A71TipoPagoNombre[0] ;
         ...
         h540( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A9TipoPagoId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 179, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A71TipoPagoNombre, "")), 183, Gx_line+10, 483, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A297TipoPagoDato, "")), 487, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("TipoPagoWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "TipoPagoWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("TipoPagoWWGridState"), null, null);
      }
   ...
   public void initialize( )
   {
      ...
      AV35Tipopagowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Tipopagowwds_1_filterfulltext = "" ;
      P00542_A9TipoPagoId = new long[1] ;
      P00542_A297TipoPagoDato = new String[] {""} ;
      P00542_A71TipoPagoNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopagowwexportreport__default(),
         new Object[] {
             new Object[] {
            P00542_A9TipoPagoId, P00542_A297TipoPagoDato, P00542_A71TipoPagoNombre
            }
         }
      );
   ...
   private String AV35Tipopagowwds_1_filterfulltext ;
   private String lV35Tipopagowwds_1_filterfulltext ;
   ...
   private long[] P00542_A9TipoPagoId ;
   private String[] P00542_A297TipoPagoDato ;
   private String[] P00542_A71TipoPagoNombre ;
...
final  class tipopagowwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00542( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Tipopagowwds_1_filterfulltext ,
                                          long A9TipoPagoId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Tipopagowwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00542(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
