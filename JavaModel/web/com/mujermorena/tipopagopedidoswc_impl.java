...
public final  class tipopagopedidoswc_impl extends GXWebComponent
{
   public tipopagopedidoswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopagopedidoswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopagopedidoswc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV33IsAuthorized_OpcionEnvioDescripcion = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_OpcionEnvioDescripcion")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8TipoPagoId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV33IsAuthorized_OpcionEnvioDescripcion, AV34IsAuthorized_Insert, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Tipo Pago Pedidos WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tipopagopedidoswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8TipoPagoId,11,0))}, new String[] {"TipoPagoId"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_OPCIONENVIODESCRIPCION", getSecureSignedToken( sPrefix, AV33IsAuthorized_OpcionEnvioDescripcion));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV32IsAuthorized_Delete));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_OPCIONENVIODESCRIPCION", AV33IsAuthorized_OpcionEnvioDescripcion);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_OPCIONENVIODESCRIPCION", getSecureSignedToken( sPrefix, AV33IsAuthorized_OpcionEnvioDescripcion));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   public void renderHtmlCloseForm6V2( )
   {
   ...
   {
      return "TipoPagoPedidosWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Pago Pedidos WC", "") ;
   }
   ...
   public void wb6V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.tipopagopedidoswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_TipoPagoPedidosWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_21_6V2( true) ;
      }
      else
      {
         wb_table1_21_6V2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_6V2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6V2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Pago Pedidos WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "Bitmap", ((GXutil.strcmp("", A296PedidosImagenComprobante)==0) ? A40000PedidosImagenComprobante_GXI : httpContext.convertURL( httpContext.getResourceRelative(A296PedidosImagenComprobante))), !bGXsfl_36_Refreshing);
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A296PedidosImagenComprobante), true);
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV33IsAuthorized_OpcionEnvioDescripcion ,
   ...
   public int subgridclient_rec_count_fnc( )
   {
      ...
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           ...
                                           AV16FilterFullText ,
                                           Long.valueOf(A51PedidosID) ,
                                           Long.valueOf(A4ClienteId) ,
                                           A247PedidosEstado ,
                                           Long.valueOf(A283OpcionEnvioId) ,
                                           ...
                                           new int[]{
                                           TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DECIMAL,
                                           TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.LONG
                                           }
      });
      /* Using cursor H006V3 */
      ...
      {
         A9TipoPagoId = H006V3_A9TipoPagoId[0] ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A9TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A9TipoPagoId), 11, 0));
         A295PedidosComprobanteObs = H006V3_A295PedidosComprobanteObs[0] ;
         A296PedidosImagenComprobante = H006V3_A296PedidosImagenComprobante[0] ;
         httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "Bitmap", ((GXutil.strcmp("", A296PedidosImagenComprobante)==0) ? A40000PedidosImagenComprobante_GXI : httpContext.convertURL( httpContext.getResourceRelative(A296PedidosImagenComprobante))), !bGXsfl_36_Refreshing);
         httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A296PedidosImagenComprobante), true);
         A40000PedidosImagenComprobante_GXI = H006V3_A40000PedidosImagenComprobante_GXI[0] ;
         httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "Bitmap", ((GXutil.strcmp("", A296PedidosImagenComprobante)==0) ? A40000PedidosImagenComprobante_GXI : httpContext.convertURL( httpContext.getResourceRelative(A296PedidosImagenComprobante))), !bGXsfl_36_Refreshing);
         httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A296PedidosImagenComprobante), true);
         A284OpcionEnvioDescripcion = H006V3_A284OpcionEnvioDescripcion[0] ;
         A283OpcionEnvioId = H006V3_A283OpcionEnvioId[0] ;
         A247PedidosEstado = H006V3_A247PedidosEstado[0] ;
         A246PedidosFecha = H006V3_A246PedidosFecha[0] ;
         A4ClienteId = H006V3_A4ClienteId[0] ;
         A51PedidosID = H006V3_A51PedidosID[0] ;
         A248PedidosTotal = H006V3_A248PedidosTotal[0] ;
         A250PedidosSubTotal = H006V3_A250PedidosSubTotal[0] ;
         A284OpcionEnvioDescripcion = H006V3_A284OpcionEnvioDescripcion[0] ;
         A248PedidosTotal = H006V3_A248PedidosTotal[0] ;
         A250PedidosSubTotal = H006V3_A250PedidosSubTotal[0] ;
         if ( (GXutil.strcmp("", AV16FilterFullText)==0) || ( ( GXutil.like( GXutil.str( A51PedidosID, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A4ClienteId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( httpContext.getMessage( "pendiente", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "PEN") == 0 ) ) || ( GXutil.like( httpContext.getMessage( "confirmado", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "FIN") == 0 ) ) || ( GXutil.like( GXutil.str( A283OpcionEnvioId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( A284OpcionEnvioDescripcion , GXutil.padr( "%" + AV16FilterFullText , 101 , "%"),  ' ' ) ) || ( GXutil.like( A295PedidosComprobanteObs , GXutil.padr( "%" + AV16FilterFullText , 512 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A250PedidosSubTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A248PedidosTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) ) )
         {
   ...
   public void rf6V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H006V5 */
         pr_default.execute(1, new Object[] {Long.valueOf(AV8TipoPagoId)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         GRID_nEOF = (byte)(0) ;
         ...
         {
            A9TipoPagoId = H006V5_A9TipoPagoId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A9TipoPagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A9TipoPagoId), 11, 0));
            A295PedidosComprobanteObs = H006V5_A295PedidosComprobanteObs[0] ;
            A296PedidosImagenComprobante = H006V5_A296PedidosImagenComprobante[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "Bitmap", ((GXutil.strcmp("", A296PedidosImagenComprobante)==0) ? A40000PedidosImagenComprobante_GXI : httpContext.convertURL( httpContext.getResourceRelative(A296PedidosImagenComprobante))), !bGXsfl_36_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A296PedidosImagenComprobante), true);
            A40000PedidosImagenComprobante_GXI = H006V5_A40000PedidosImagenComprobante_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "Bitmap", ((GXutil.strcmp("", A296PedidosImagenComprobante)==0) ? A40000PedidosImagenComprobante_GXI : httpContext.convertURL( httpContext.getResourceRelative(A296PedidosImagenComprobante))), !bGXsfl_36_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPedidosImagenComprobante_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A296PedidosImagenComprobante), true);
            A284OpcionEnvioDescripcion = H006V5_A284OpcionEnvioDescripcion[0] ;
            A283OpcionEnvioId = H006V5_A283OpcionEnvioId[0] ;
            A247PedidosEstado = H006V5_A247PedidosEstado[0] ;
            A246PedidosFecha = H006V5_A246PedidosFecha[0] ;
            A4ClienteId = H006V5_A4ClienteId[0] ;
            A51PedidosID = H006V5_A51PedidosID[0] ;
            A248PedidosTotal = H006V5_A248PedidosTotal[0] ;
            A250PedidosSubTotal = H006V5_A250PedidosSubTotal[0] ;
            A284OpcionEnvioDescripcion = H006V5_A284OpcionEnvioDescripcion[0] ;
            A248PedidosTotal = H006V5_A248PedidosTotal[0] ;
            A250PedidosSubTotal = H006V5_A250PedidosSubTotal[0] ;
            if ( (GXutil.strcmp("", AV16FilterFullText)==0) || ( ( GXutil.like( GXutil.str( A51PedidosID, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A4ClienteId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( httpContext.getMessage( "pendiente", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "PEN") == 0 ) ) || ( GXutil.like( httpContext.getMessage( "confirmado", "") , GXutil.padr( "%" + GXutil.lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( GXutil.strcmp(A247PedidosEstado, "FIN") == 0 ) ) || ( GXutil.like( GXutil.str( A283OpcionEnvioId, 11, 0) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( A284OpcionEnvioDescripcion , GXutil.padr( "%" + AV16FilterFullText , 101 , "%"),  ' ' ) ) || ( GXutil.like( A295PedidosComprobanteObs , GXutil.padr( "%" + AV16FilterFullText , 512 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A250PedidosSubTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( GXutil.like( GXutil.str( A248PedidosTotal, 17, 2) , GXutil.padr( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) ) )
   ...
   public void send_integrity_lvl_hashes6V2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV37Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV37Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DISPLAY", AV28IsAuthorized_Display);
   ...
   public void e166V2( )
   {
      ...
      GXt_boolean1 = AV33IsAuthorized_OpcionEnvioDescripcion ;
      ...
      tipopagopedidoswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV33IsAuthorized_OpcionEnvioDescripcion = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV33IsAuthorized_OpcionEnvioDescripcion", AV33IsAuthorized_OpcionEnvioDescripcion);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_OPCIONENVIODESCRIPCION", getSecureSignedToken( sPrefix, AV33IsAuthorized_OpcionEnvioDescripcion));
   ...
   public void e176V2( )
   {
      ...
      tipopagopedidoswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   private void e186V2( )
   {
      if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subgrid_fnc_recordsperpage( ) ) ) )
      {
         ...
         {
            edtavUpdate_Link = formatLink("com.mujermorena.pedidos", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A51PedidosID,11,0))}, new String[] {})  ;
         }
         AV31Delete = "<i class=\"fa fa-times\"></i>" ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV31Delete);
         if ( AV32IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("com.mujermorena.pedidos", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A51PedidosID,11,0))}, new String[] {})  ;
         }
         if ( AV33IsAuthorized_OpcionEnvioDescripcion )
         {
   ...
   public void e116V2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPagoPedidosWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV37Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPagoPedidosWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         GXv_char7[0] = GXt_char6 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "TipoPagoPedidosWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         tipopagopedidoswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void e156V2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.pedidos", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {}) );
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidosview_Execute", GXv_boolean2) ;
      tipopagopedidoswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidos_Update", GXv_boolean2) ;
      tipopagopedidoswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidos_Delete", GXv_boolean2) ;
      tipopagopedidoswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "pedidos_Insert", GXv_boolean2) ;
      tipopagopedidoswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "TipoPagoPedidosWCFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Pedidos" );
   ...
   public void wb_table1_21_6V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_26_6V2( true) ;
      }
      else
      {
         wb_table2_26_6V2( false) ;
      }
      return  ;
   }

   public void wb_table2_26_6V2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_6V2e( true) ;
      }
      else
      {
         wb_table1_21_6V2e( false) ;
      }
   }

   public void wb_table2_26_6V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "tipopagopedidoswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111105652", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("tipopagopedidoswc.js", "?202412111105652", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtPedidosID_Internalname = sPrefix+"PEDIDOSID_"+sGXsfl_36_idx ;
      edtClienteId_Internalname = sPrefix+"CLIENTEID_"+sGXsfl_36_idx ;
      edtPedidosFecha_Internalname = sPrefix+"PEDIDOSFECHA_"+sGXsfl_36_idx ;
      cmbPedidosEstado.setInternalname( sPrefix+"PEDIDOSESTADO_"+sGXsfl_36_idx );
      edtOpcionEnvioId_Internalname = sPrefix+"OPCIONENVIOID_"+sGXsfl_36_idx ;
      edtOpcionEnvioDescripcion_Internalname = sPrefix+"OPCIONENVIODESCRIPCION_"+sGXsfl_36_idx ;
      edtPedidosImagenComprobante_Internalname = sPrefix+"PEDIDOSIMAGENCOMPROBANTE_"+sGXsfl_36_idx ;
      edtPedidosComprobanteObs_Internalname = sPrefix+"PEDIDOSCOMPROBANTEOBS_"+sGXsfl_36_idx ;
      edtPedidosSubTotal_Internalname = sPrefix+"PEDIDOSSUBTOTAL_"+sGXsfl_36_idx ;
      edtPedidosTotal_Internalname = sPrefix+"PEDIDOSTOTAL_"+sGXsfl_36_idx ;
   }
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtPedidosID_Internalname = sPrefix+"PEDIDOSID_"+sGXsfl_36_fel_idx ;
      edtClienteId_Internalname = sPrefix+"CLIENTEID_"+sGXsfl_36_fel_idx ;
      edtPedidosFecha_Internalname = sPrefix+"PEDIDOSFECHA_"+sGXsfl_36_fel_idx ;
      cmbPedidosEstado.setInternalname( sPrefix+"PEDIDOSESTADO_"+sGXsfl_36_fel_idx );
      edtOpcionEnvioId_Internalname = sPrefix+"OPCIONENVIOID_"+sGXsfl_36_fel_idx ;
      edtOpcionEnvioDescripcion_Internalname = sPrefix+"OPCIONENVIODESCRIPCION_"+sGXsfl_36_fel_idx ;
      edtPedidosImagenComprobante_Internalname = sPrefix+"PEDIDOSIMAGENCOMPROBANTE_"+sGXsfl_36_fel_idx ;
      edtPedidosComprobanteObs_Internalname = sPrefix+"PEDIDOSCOMPROBANTEOBS_"+sGXsfl_36_fel_idx ;
      edtPedidosSubTotal_Internalname = sPrefix+"PEDIDOSSUBTOTAL_"+sGXsfl_36_fel_idx ;
      edtPedidosTotal_Internalname = sPrefix+"PEDIDOSTOTAL_"+sGXsfl_36_fel_idx ;
   }
   ...
   public void sendrow_362( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_36_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavDisplay_Internalname,GXutil.rtrim( AV27Display),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","",httpContext.getMessage( "GXM_display", ""),"",edtavDisplay_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWIconActionColumn","",Integer.valueOf(edtavDisplay_Visible),Integer.valueOf(edtavDisplay_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(1),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         {
            GXCCtl = "PEDIDOSESTADO_" + sGXsfl_36_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPedidosEstado.getInternalname(), "Values", cmbPedidosEstado.ToJavascriptSource(), !bGXsfl_36_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtOpcionEnvioDescripcion_Internalname,A284OpcionEnvioDescripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtOpcionEnvioDescripcion_Link,"","","",edtOpcionEnvioDescripcion_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPedidosComprobanteObs_Internalname,A295PedidosComprobanteObs,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPedidosComprobanteObs_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(512),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPedidosSubTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A250PedidosSubTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A250PedidosSubTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPedidosSubTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPedidosTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A248PedidosTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A248PedidosTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPedidosTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void init_default_properties( )
   {
      ...
      edtPedidosID_Internalname = sPrefix+"PEDIDOSID" ;
      edtClienteId_Internalname = sPrefix+"CLIENTEID" ;
      edtPedidosFecha_Internalname = sPrefix+"PEDIDOSFECHA" ;
      cmbPedidosEstado.setInternalname( sPrefix+"PEDIDOSESTADO" );
      edtOpcionEnvioId_Internalname = sPrefix+"OPCIONENVIOID" ;
      edtOpcionEnvioDescripcion_Internalname = sPrefix+"OPCIONENVIODESCRIPCION" ;
      edtPedidosImagenComprobante_Internalname = sPrefix+"PEDIDOSIMAGENCOMPROBANTE" ;
      edtPedidosComprobanteObs_Internalname = sPrefix+"PEDIDOSCOMPROBANTEOBS" ;
      edtPedidosSubTotal_Internalname = sPrefix+"PEDIDOSSUBTOTAL" ;
      edtPedidosTotal_Internalname = sPrefix+"PEDIDOSTOTAL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:PedidosID|4:ClienteId|5:PedidosFecha|6:PedidosEstado|7:OpcionEnvioId|8:OpcionEnvioDescripcion|10:PedidosComprobanteObs" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e186V2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A51PedidosID',fld:'PEDIDOSID',pic:'ZZZZZZZZZZ9'},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_OpcionEnvioDescripcion',fld:'vISAUTHORIZED_OPCIONENVIODESCRIPCION',pic:'',hsh:true},{av:'A283OpcionEnvioId',fld:'OPCIONENVIOID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Display',fld:'vDISPLAY',pic:''},{av:'AV29Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtOpcionEnvioDescripcion_Link',ctrl:'OPCIONENVIODESCRIPCION',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e116V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TipoPagoId',fld:'vTIPOPAGOID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_OpcionEnvioDescripcion',fld:'vISAUTHORIZED_OPCIONENVIODESCRIPCION',pic:'',hsh:true},{av:'AV34IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e156V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TipoPagoId',fld:'vTIPOPAGOID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_OpcionEnvioDescripcion',fld:'vISAUTHORIZED_OPCIONENVIODESCRIPCION',pic:'',hsh:true},{av:'AV34IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A51PedidosID',fld:'PEDIDOSID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("'DOINSERT'",",oparms:[{av:'A51PedidosID',fld:'PEDIDOSID',pic:'ZZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV34IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'lblBtninsert_Visible',ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
      ...
      setEventMetadata("VALID_PEDIDOSESTADO","{handler:'valid_Pedidosestado',iparms:[]");
      setEventMetadata("VALID_PEDIDOSESTADO",",oparms:[]}");
      setEventMetadata("VALID_OPCIONENVIOID","{handler:'valid_Opcionenvioid',iparms:[]");
      setEventMetadata("VALID_OPCIONENVIOID",",oparms:[]}");
      setEventMetadata("VALID_OPCIONENVIODESCRIPCION","{handler:'valid_Opcionenviodescripcion',iparms:[]");
      setEventMetadata("VALID_OPCIONENVIODESCRIPCION",",oparms:[]}");
      setEventMetadata("VALID_PEDIDOSCOMPROBANTEOBS","{handler:'valid_Pedidoscomprobanteobs',iparms:[]");
      setEventMetadata("VALID_PEDIDOSCOMPROBANTEOBS",",oparms:[]}");
      setEventMetadata("VALID_PEDIDOSSUBTOTAL","{handler:'valid_Pedidossubtotal',iparms:[]");
      setEventMetadata("VALID_PEDIDOSSUBTOTAL",",oparms:[]}");
      setEventMetadata("VALID_PEDIDOSTOTAL","{handler:'valid_Pedidostotal',iparms:[]");
      setEventMetadata("VALID_PEDIDOSTOTAL",",oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H006V3_A9TipoPagoId = new long[1] ;
      H006V3_A295PedidosComprobanteObs = new String[] {""} ;
      H006V3_A296PedidosImagenComprobante = new String[] {""} ;
      H006V3_A40000PedidosImagenComprobante_GXI = new String[] {""} ;
      H006V3_A284OpcionEnvioDescripcion = new String[] {""} ;
      H006V3_A283OpcionEnvioId = new long[1] ;
      H006V3_A247PedidosEstado = new String[] {""} ;
      H006V3_A246PedidosFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006V3_A4ClienteId = new long[1] ;
      H006V3_A51PedidosID = new long[1] ;
      H006V3_A248PedidosTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006V3_A250PedidosSubTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006V5_A9TipoPagoId = new long[1] ;
      H006V5_A295PedidosComprobanteObs = new String[] {""} ;
      H006V5_A296PedidosImagenComprobante = new String[] {""} ;
      H006V5_A40000PedidosImagenComprobante_GXI = new String[] {""} ;
      H006V5_A284OpcionEnvioDescripcion = new String[] {""} ;
      H006V5_A283OpcionEnvioId = new long[1] ;
      H006V5_A247PedidosEstado = new String[] {""} ;
      H006V5_A246PedidosFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H006V5_A4ClienteId = new long[1] ;
      H006V5_A51PedidosID = new long[1] ;
      H006V5_A248PedidosTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006V5_A250PedidosSubTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopagopedidoswc__default(),
         new Object[] {
             new Object[] {
            H006V3_A9TipoPagoId, H006V3_A295PedidosComprobanteObs, H006V3_A296PedidosImagenComprobante, H006V3_A40000PedidosImagenComprobante_GXI, H006V3_A284OpcionEnvioDescripcion, H006V3_A283OpcionEnvioId, H006V3_A247PedidosEstado, H006V3_A246PedidosFecha, H006V3_A4ClienteId, H006V3_A51PedidosID,
            H006V3_A248PedidosTotal, H006V3_A250PedidosSubTotal
            }
            , new Object[] {
            H006V5_A9TipoPagoId, H006V5_A295PedidosComprobanteObs, H006V5_A296PedidosImagenComprobante, H006V5_A40000PedidosImagenComprobante_GXI, H006V5_A284OpcionEnvioDescripcion, H006V5_A283OpcionEnvioId, H006V5_A247PedidosEstado, H006V5_A246PedidosFecha, H006V5_A4ClienteId, H006V5_A51PedidosID,
            H006V5_A248PedidosTotal, H006V5_A250PedidosSubTotal
            }
         }
      );
      AV37Pgmname = "TipoPagoPedidosWC" ;
   ...
   private boolean AV33IsAuthorized_OpcionEnvioDescripcion ;
   ...
   private long[] H006V3_A9TipoPagoId ;
   private String[] H006V3_A295PedidosComprobanteObs ;
   private String[] H006V3_A296PedidosImagenComprobante ;
   private String[] H006V3_A40000PedidosImagenComprobante_GXI ;
   private String[] H006V3_A284OpcionEnvioDescripcion ;
   private long[] H006V3_A283OpcionEnvioId ;
   private String[] H006V3_A247PedidosEstado ;
   private java.util.Date[] H006V3_A246PedidosFecha ;
   private long[] H006V3_A4ClienteId ;
   private long[] H006V3_A51PedidosID ;
   private java.math.BigDecimal[] H006V3_A248PedidosTotal ;
   private java.math.BigDecimal[] H006V3_A250PedidosSubTotal ;
   private long[] H006V5_A9TipoPagoId ;
   private String[] H006V5_A295PedidosComprobanteObs ;
   private String[] H006V5_A296PedidosImagenComprobante ;
   private String[] H006V5_A40000PedidosImagenComprobante_GXI ;
   private String[] H006V5_A284OpcionEnvioDescripcion ;
   private long[] H006V5_A283OpcionEnvioId ;
   private String[] H006V5_A247PedidosEstado ;
   private java.util.Date[] H006V5_A246PedidosFecha ;
   private long[] H006V5_A4ClienteId ;
   private long[] H006V5_A51PedidosID ;
   private java.math.BigDecimal[] H006V5_A248PedidosTotal ;
   private java.math.BigDecimal[] H006V5_A250PedidosSubTotal ;
...
final  class tipopagopedidoswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H006V3( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long A51PedidosID ,
                                          long A4ClienteId ,
                                          String A247PedidosEstado ,
                                          long A283OpcionEnvioId ,
                                          String A284OpcionEnvioDescripcion ,
                                          String A295PedidosComprobanteObs ,
                                          java.math.BigDecimal A250PedidosSubTotal ,
                                          java.math.BigDecimal A248PedidosTotal ,
                                          long AV8TipoPagoId ,
                                          long A9TipoPagoId )
   {
      ...
      scmdbuf = "SELECT T1.[TipoPagoId], T1.[PedidosComprobanteObs], T1.[PedidosImagenComprobante], T1.[PedidosImagenComprobante_GXI], T2.[OpcionEnvioDescripcion], T1.[OpcionEnvioId]," ;
      scmdbuf += " T1.[PedidosEstado], T1.[PedidosFecha], T1.[ClienteId], T1.[PedidosID], COALESCE( T3.[PedidosTotal], 0) AS PedidosTotal, COALESCE( T3.[PedidosTotal], 0) AS PedidosSubTotal" ;
      scmdbuf += " FROM (([Pedidos] T1 INNER JOIN [OpcionEnvio] T2 ON T2.[OpcionEnvioId] = T1.[OpcionEnvioId]) LEFT JOIN (SELECT T4.[PedidosID], SUM(T5.[ArticuloPrecioVenta] * CAST(T4.[PedidosDetalleCantidad]" ;
      scmdbuf += " AS decimal( 27, 10))) AS PedidosTotal FROM ([PedidosDetalle] T4 INNER JOIN [Articulo] T5 ON T5.[ArticuloId] = T4.[ArticuloId]) GROUP BY T4.[PedidosID] ) T3 ON T3.[PedidosID]" ;
      scmdbuf += " = T1.[PedidosID])" ;
      addWhere(sWhereString, "(T1.[TipoPagoId] = ?)");
      scmdbuf += sWhereString ;
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T1.[PedidosID]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T1.[PedidosID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T1.[ClienteId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T1.[ClienteId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T1.[PedidosFecha]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T1.[PedidosFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T1.[PedidosEstado]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T1.[PedidosEstado] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T1.[OpcionEnvioId]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T1.[OpcionEnvioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T2.[OpcionEnvioDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T2.[OpcionEnvioDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId], T1.[PedidosComprobanteObs]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[TipoPagoId] DESC, T1.[PedidosComprobanteObs] DESC" ;
      }
   ...
   protected Object[] conditional_H006V5( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006V3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , (String)dynConstraints[7] , (String)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).longValue() , ((Number) dynConstraints[12]).longValue() );
            case 1 :
                  return conditional_H006V5(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , (String)dynConstraints[7] , (String)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).longValue() , ((Number) dynConstraints[12]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006V3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H006V5", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
      };
   }
