...
public final  class tipoarticuloprompt_impl extends GXDataArea
{
   public tipoarticuloprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipoarticuloprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipoarticuloprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutTipoArticuloId") ;
         ...
         {
            AV8InOutTipoArticuloId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoArticuloId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutTipoArticuloNombre = httpContext.GetPar( "InOutTipoArticuloNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTipoArticuloNombre", AV9InOutTipoArticuloNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.tipoarticuloprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTipoArticuloId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutTipoArticuloNombre))}, new String[] {"InOutTipoArticuloId","InOutTipoArticuloNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTIPOARTICULOID", GXutil.ltrim( localUtil.ntoc( AV8InOutTipoArticuloId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTTIPOARTICULONOMBRE", GXutil.rtrim( AV9InOutTipoArticuloNombre));
   ...
   {
      return formatLink("com.mujermorena.tipoarticuloprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTipoArticuloId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutTipoArticuloNombre))}, new String[] {"InOutTipoArticuloId","InOutTipoArticuloNombre"})  ;
   }

   public String getPgmname( )
   {
      return "TipoArticuloPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Tipo Articulo", "") ;
   }
   ...
   public void wb0Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_0Y2( true) ;
      }
      else
      {
         wb_table1_14_0Y2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_0Y2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Tipo Articulo", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOARTICULOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A17TipoArticuloId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "TIPOARTICULOID", GXutil.ltrim( localUtil.ntoc( A17TipoArticuloId, (byte)(11), (byte)(0), ".", "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOARTICULONOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A103TipoArticuloNombre, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "TIPOARTICULONOMBRE", GXutil.rtrim( A103TipoArticuloNombre));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "TipoArticuloPrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf0Y2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A103TipoArticuloNombre = H000Y2_A103TipoArticuloNombre[0] ;
            A17TipoArticuloId = H000Y2_A17TipoArticuloId[0] ;
            e170Y2 ();
   ...
   public void send_integrity_lvl_hashes0Y2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOARTICULOID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A17TipoArticuloId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOARTICULONOMBRE"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A103TipoArticuloNombre, ""))));
   }
   ...
   public void e150Y2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Tipo Articulo", "") );
   ...
   public void e160Y2( )
   {
      ...
      tipoarticuloprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e180Y2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutTipoArticuloId = A17TipoArticuloId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoArticuloId), 11, 0));
      AV9InOutTipoArticuloNombre = A103TipoArticuloNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTipoArticuloNombre", AV9InOutTipoArticuloNombre);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutTipoArticuloId),AV9InOutTipoArticuloNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutTipoArticuloId","AV9InOutTipoArticuloNombre"});
   ...
   public void wb_table1_14_0Y2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_TipoArticuloPrompt.htm");
   ...
   {
      AV8InOutTipoArticuloId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTipoArticuloId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTipoArticuloId), 11, 0));
      AV9InOutTipoArticuloNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTipoArticuloNombre", AV9InOutTipoArticuloNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111123439", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipoarticuloprompt.js", "?202412111123439", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:TipoArticuloId|2:TipoArticuloNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e170Y2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e180Y2',iparms:[{av:'A17TipoArticuloId',fld:'TIPOARTICULOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A103TipoArticuloNombre',fld:'TIPOARTICULONOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTipoArticuloId',fld:'vINOUTTIPOARTICULOID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutTipoArticuloNombre',fld:'vINOUTTIPOARTICULONOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e140Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      setEventMetadata("'DOCLEANFILTERS'",",oparms:[{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]}");
      setEventMetadata("NULL","{handler:'valid_Tipoarticulonombre',iparms:[]");
   ...
   {
      return "tipoarticuloprompt_Execute";
   }
   ...
   {
      wcpOAV9InOutTipoArticuloNombre = "" ;
      Gridpaginationbar_Selectedpage = "" ;
      Ddo_grid_Activeeventkey = "" ;
      Ddo_grid_Selectedvalue_get = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV9InOutTipoArticuloNombre = "" ;
      AV13FilterFullText = "" ;
      AV22Pgmname = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H000Y2_A103TipoArticuloNombre = new String[] {""} ;
      H000Y2_A17TipoArticuloId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipoarticuloprompt__default(),
         new Object[] {
             new Object[] {
            H000Y2_A103TipoArticuloNombre, H000Y2_A17TipoArticuloId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutTipoArticuloId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutTipoArticuloId ;
   private long AV16GridCurrentPage ;
   private long AV17GridPageCount ;
   private long A17TipoArticuloId ;
   private long GRID_nCurrentRecord ;
   private long GRID_nRecordCount ;
   private String wcpOAV9InOutTipoArticuloNombre ;
   private String Gridpaginationbar_Selectedpage ;
   private String Ddo_grid_Activeeventkey ;
   private String Ddo_grid_Selectedvalue_get ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV9InOutTipoArticuloNombre ;
   ...
   private String[] H000Y2_A103TipoArticuloNombre ;
   private long[] H000Y2_A17TipoArticuloId ;
...
final  class tipoarticuloprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [TipoArticuloNombre], [TipoArticuloId]" ;
      sFromString = " FROM [TipoArticulo]" ;
      sOrderString = "" ;
      ...
      {
         sOrderString += " ORDER BY [TipoArticuloNombre]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoArticuloNombre] DESC" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY [TipoArticuloId]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoArticuloId] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [TipoArticuloId]" ;
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [TipoArticulo]" ;
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([TipoArticuloId] AS decimal(11,0))) like '%' + ?) or ( [TipoArticuloNombre] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000Y2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H000Y3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
