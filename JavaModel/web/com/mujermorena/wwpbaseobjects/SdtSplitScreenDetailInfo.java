...
public final  class SdtSplitScreenDetailInfo extends GxUserType
{
   ...
   {
      gxTv_SdtSplitScreenDetailInfo_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtSplitScreenDetailInfo_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtSplitScreenDetailInfo_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtSplitScreenDetailInfo Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtSplitScreenDetailInfo)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtSplitScreenDetailInfo struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtSplitScreenDetailInfo getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtSplitScreenDetailInfo struct = new com.mujermorena.wwpbaseobjects.StructSdtSplitScreenDetailInfo ();
   ...
   protected byte gxTv_SdtSplitScreenDetailInfo_N ;
