...
public final  class wizardstepsprogresswc_impl extends GXWebComponent
{
   public wizardstepsprogresswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wizardstepsprogresswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wizardstepsprogresswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV9WizardSteps);
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.wwpbaseobjects.wizardstepsprogresswc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV6CurrentStep))}, new String[] {"WizardSteps","CurrentStep"}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV8StepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV7SelectedStepNumber), "ZZZ9")));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV8StepNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV8StepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV7SelectedStepNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV7SelectedStepNumber), "ZZZ9")));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   public void wb2M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.wwpbaseobjects.wizardstepsprogresswc");
         }
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTablemain_Internalname, 1, 0, "px", 0, "px", "TableWizardStepsLine", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWizardsteptitle_Internalname, lblWizardsteptitle_Caption, "", "", lblWizardsteptitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardStepTitleLine", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WizardStepsProgressWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divWizardstepdescriptioncell_Internalname, divWizardstepdescriptioncell_Visible, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardStepDescriptionLine", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WizardStepsProgressWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 FreeStyleStepsProgressCell", "left", "top", "", "", "div");
         /*  Grid Control  */
   ...
   public void rf2M2( )
   {
      ...
      GridwizardstepsContainer.AddObjectProperty("Class", GXutil.rtrim( "FreeStyleStepsProgress"));
   ...
   public void e112M2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV7SelectedStepNumber), "ZZZ9")));
      AV14GXV1 = 1 ;
      while ( AV14GXV1 <= AV9WizardSteps.size() )
      {
         AV5WizardStep = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.elementAt(-1+AV14GXV1));
   ...
   private void e122M2( )
   {
      ...
      returnInSub = false ;
      AV15GXV2 = 1 ;
      while ( AV15GXV2 <= AV9WizardSteps.size() )
      {
         AV9WizardSteps.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.elementAt(-1+AV15GXV2)) );
   ...
   {
      AV9WizardSteps = (GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "wwpbaseobjects\\wizardstepsprogresswc", GetJustCreated( ));
      ...
      {
         AV9WizardSteps = (GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV9WizardSteps = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>() ;
      }
      else
      {
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"AV9WizardSteps_PARM"), AV9WizardSteps);
      }
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9WizardSteps_CTRL", GXutil.rtrim( sCtrlAV9WizardSteps));
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211162661", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepsprogresswc.js", "?20241211162661", false, true);
      }
   ...
   public void sendrow_152( )
   {
      ...
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtablefsgridwizardsteps_Internalname+"_"+sGXsfl_15_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px",divUnnamedtablefsgridwizardsteps_Class,"left","top"," "+"data-gx-flex"+" ","","div"});
   ...
   public void startgridcontrol15( )
   {
      if ( GridwizardstepsContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subGridwizardsteps_Internalname, subGridwizardsteps_Internalname, "", "FreeStyleStepsProgress", 0, "", "", 1, 2, sStyleString, "", "", 0);
         GridwizardstepsContainer.AddObjectProperty("GridName", "Gridwizardsteps");
      }
      else
      {
   ...
   public void initialize_properties( )
   {
      ...
      lblWizardsteptitle_Caption = httpContext.getMessage( "Step Title", "") ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'e122M2',iparms:[{av:'AV8StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV7SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV9WizardSteps = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "Mujer_Morena", remoteHandle);
      AV6CurrentStep = "" ;
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV9WizardSteps ;
