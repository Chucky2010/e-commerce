...
public final  class wwp_searchwc_impl extends GXWebComponent
{
   ...
   public void gxgrfsresults_refresh_invoke( )
   {
      edtavUrl_Visible = (int)(GXutil.lval( httpContext.GetNextPar( ))) ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavUrl_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavUrl_Visible), 5, 0), !bGXsfl_29_Refreshing);
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV26WWP_SearchResults);
      sPrefix = httpContext.GetPar( "sPrefix") ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "WWP_Search WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.wwpbaseobjects.wwp_searchwc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV22SearchText))}, new String[] {"SearchText"}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWWP_SEARCHRESULTS", getSecureSignedToken( sPrefix, AV26WWP_SearchResults));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_Wwp_searchresults", getSecureSignedToken( sPrefix, AV26WWP_SearchResults));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_21", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_21, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV22SearchText", wcpOAV22SearchText);
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWWP_SEARCHRESULTS", getSecureSignedToken( sPrefix, AV26WWP_SearchResults));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSEARCHTEXT", AV22SearchText);
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TABLEADVANCEDSEARCHCELL_Class", GXutil.rtrim( divTableadvancedsearchcell_Class));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TABLESIMPLESEARCHCELL_Class", GXutil.rtrim( divTablesimplesearchcell_Class));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"COMBO_ADVFILTERENTITIES_Selectedvalue_get", GXutil.rtrim( Combo_advfilterentities_Selectedvalue_get));
   }

   public void renderHtmlCloseForm2O2( )
   {
   ...
   {
      return httpContext.getMessage( "WWP_Search WC", "") ;
   }
   ...
   public void wb2O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.wwpbaseobjects.wwp_searchwc");
            httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 CloseSearchIconCell", "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblClosesearch_Internalname, httpContext.getMessage( "<i class=\"fa fa-times\"></i>", ""), "", "", lblClosesearch_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOCLOSESEARCH\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, (short)(1), "HLP_WWPBaseObjects\\WWP_SearchWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divShowall_cell_Internalname, 1, 0, "px", 0, "px", divShowall_cell_Class, "left", "top", "", "", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTxtnoresultscell_Internalname, 1, 0, "px", 0, "px", divTxtnoresultscell_Class, "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTxtnoresults_Internalname, lblTxtnoresults_Caption, "", "", lblTxtnoresults_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlockShowingOnly", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WWP_SearchWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTablesimplesearchcell_Internalname, 1, 0, "px", 0, "px", divTablesimplesearchcell_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTablesimplesearch_Internalname, 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divFsresultcategories_cell_Internalname, 1, 0, "px", 0, "px", divFsresultcategories_cell_Class, "left", "top", "", "", "div");
         /*  Grid Control  */
      ...
      if ( wbEnd == 21 )
      {
         ...
         else
         {
            ...
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FsresultcategoriesContainerData", FsresultcategoriesContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FsresultcategoriesContainerData"+"V", FsresultcategoriesContainer.GridValuesHidden());
            }
            else
            {
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTableadvancedsearchcell_Internalname, 1, 0, "px", 0, "px", divTableadvancedsearchcell_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTableadvancedsearch_Internalname, 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavAdvfiltertext_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavAdvfiltertext_Internalname, httpContext.getMessage( "WWP_Search", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavAdvfiltertext_Internalname, AV8AdvFilterText, GXutil.rtrim( localUtil.format( AV8AdvFilterText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,94);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAdvfiltertext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavAdvfiltertext_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWPBaseObjects\\WWP_SearchWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell ExtendedComboCell", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTablesplittedadvfilterentities_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblockcombo_advfilterentities_Internalname, httpContext.getMessage( "WWP_Search_SearchInDescription", ""), "", "", lblTextblockcombo_advfilterentities_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WWP_SearchWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 BtnAdvancedSearchCell", "left", "top", "", "", "div");
         /* User Defined Control */
      ...
      if ( wbEnd == 29 )
      {
         ...
         if ( isFullAjaxMode( ) )
         {
            ...
            else
            {
               ...
               if ( ! isAjaxCallMode( ) )
               {
                  com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FsresultsContainerData", FsresultsContainer.ToJavascriptSource());
               }
               if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
               {
                  com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FsresultsContainerData"+"V", FsresultsContainer.GridValuesHidden());
               }
               else
               {
   ...
   public void start2O2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "WWP_Search WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 23), "FSRESULTCATEGORIES.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 29), "UNNAMEDTABLEFSFSRESULTS.CLICK") == 0 ) )
                        {
                           ...
                           AV32GXV1 = nGXsfl_21_idx ;
                           if ( ( AV26WWP_SearchResults.size() >= AV32GXV1 ) && ( AV32GXV1 > 0 ) )
                           {
                              AV26WWP_SearchResults.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)) );
                           }
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                           ...
                           else
                           {
                              ...
                              if ( ( GXutil.strcmp(GXutil.left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 29), "UNNAMEDTABLEFSFSRESULTS.CLICK") == 0 ) )
                              {
                                 ...
                                 httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplaytype4_image_Internalname, "Bitmap", ((GXutil.strcmp("", AV14DisplayType4_Image)==0) ? AV35Displaytype4_image_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV14DisplayType4_Image))), !bGXsfl_29_Refreshing);
   ...
   public void gxgrfsresults_refresh( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV26WWP_SearchResults ,
                                      String sPrefix )
   {
      initialize_formulas( ) ;
      com.mujermorena.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void gxgrfsresultcategories_refresh( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV26WWP_SearchResults ,
                                               String sPrefix )
   {
      initialize_formulas( ) ;
      com.mujermorena.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void rf2O3( )
   {
      ...
      if ( subFsresults_Islastpage != 0 )
      {
         ...
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+GXCCtl, GXutil.ltrim( localUtil.ntoc( FSRESULTS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
   ...
   public void strup2O0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"Wwp_searchresults"), AV26WWP_SearchResults);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"vDDO_TITLESETTINGSICONS"), AV9DDO_TitleSettingsIcons);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"vADVFILTERENTITIES_DATA"), AV6AdvFilterEntities_Data);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"vADVFILTERENTITIES"), AV5AdvFilterEntities);
         /* Read saved values. */
   ...
   public void e152O2( )
   {
      ...
      else
      {
         ...
         new com.mujermorena.wwpbaseobjects.wwp_getsearchwcdata(remoteHandle, context).execute( AV22SearchText, (short)(4), (short)(3), GXv_objcol_svchar4, GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem5) ;
      ...
      if ( AV26WWP_SearchResults.size() == 0 )
      {
         ...
         if ( GXutil.len( GXutil.trim( AV22SearchText)) < AV20MinimumCharsToSearch )
         {
            lblTxtnoresults_Caption = httpContext.getMessage( "WWP_Search_TypeToSearch", "") ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, lblTxtnoresults_Internalname, "Caption", lblTxtnoresults_Caption, true);
         }
         else
         {
            lblTxtnoresults_Caption = GXutil.format( httpContext.getMessage( "WWP_Search_NoResults", ""), AV22SearchText, "", "", "", "", "", "", "", "") ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, lblTxtnoresults_Internalname, "Caption", lblTxtnoresults_Caption, true);
         }
      }
      else
      {
         if ( AV23ShowingRecents )
         {
            divShowall_cell_Class = "Invisible" ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divShowall_cell_Internalname, "Class", divShowall_cell_Class, true);
            lblTxtnoresults_Caption = httpContext.getMessage( "WWP_Search_ShowingRecentSearchResults", "") ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, lblTxtnoresults_Internalname, "Caption", lblTxtnoresults_Caption, true);
         }
         else
         {
      ...
      Btnshowall_Caption = GXutil.format( httpContext.getMessage( "WWP_Search_ShowAll", ""), AV22SearchText, "", "", "", "", "", "", "", "") ;
      ...
      new com.mujermorena.wwpbaseobjects.getwwptitlesettingsicons(remoteHandle, context).execute( GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons7) ;
   ...
   private void e162O2( )
   {
      ...
      returnInSub = false ;
      AV32GXV1 = 1 ;
      while ( AV32GXV1 <= AV26WWP_SearchResults.size() )
      {
         AV26WWP_SearchResults.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)) );
         divShowingonlycell_Visible = ((!((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Showingallresults()) ? 1 : 0) ;
         ...
         lblTxtshowingonly_Caption = GXutil.format( httpContext.getMessage( "WWP_Search_ShowingTopResults", ""), GXutil.ltrimstr( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().size(), 9, 0), "", "", "", "", "", "", "", "") ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = (short)(21) ;
   ...
   public void e122O2( )
   {
      ...
      returnInSub = false ;
      this.executeExternalObjectMethod(sPrefix, false, "WWPActions", "Popover_Close", new Object[] {divTablemain_Internalname,Boolean.valueOf(false)}, false);
      callWebObject(formatLink("com.mujermorena.wwpbaseobjects.wwp_search", new String[] {GXutil.URLEncode(GXutil.rtrim(AV22SearchText)),GXutil.URLEncode(GXutil.booltostr(false)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"DeafultSearchText","DefaultIsAdvancedSearch","DefaultAdvFilterEntitiesJson"}) );
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getsearchwcdata(remoteHandle, context).execute( "", (short)(999), (short)(0), GXv_objcol_svchar4, GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem5) ;
      ...
      AV6AdvFilterEntities_Data = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item>(com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle) ;
      AV36GXV4 = 1 ;
      while ( AV36GXV4 <= AV19EntityDescriptions.size() )
      {
         AV18EntityDescription = (String)AV19EntityDescriptions.elementAt(-1+AV36GXV4) ;
         AV7AdvFilterEntities_DataItem = (com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item)new com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item(remoteHandle, context);
   ...
   {
      AV32GXV1 = nGXsfl_21_idx ;
      if ( ( AV32GXV1 > 0 ) && ( AV26WWP_SearchResults.size() >= AV32GXV1 ) )
      {
         AV26WWP_SearchResults.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)) );
      }
      ...
      returnInSub = false ;
      this.executeExternalObjectMethod(sPrefix, false, "WWPActions", "Popover_Close", new Object[] {divTablemain_Internalname,Boolean.valueOf(false)}, false);
      new com.mujermorena.wwpbaseobjects.wwp_addrecentsearch(remoteHandle, context).execute( AV26WWP_SearchResults, AV24Url, (short)(4), (short)(3)) ;
   ...
   {
      AV32GXV1 = nGXsfl_21_idx ;
      if ( AV26WWP_SearchResults.size() < AV32GXV1 )
      {
         return  ;
      }
      ...
      returnInSub = false ;
      AV34GXV3 = 1 ;
      while ( AV34GXV3 <= ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().size() )
      {
         ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().elementAt(-1+AV34GXV3)) );
         ...
         if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title") == 0 )
         {
            divDisplaytype1_cell_Visible = 1 ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divDisplaytype1_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype1_cell_Visible), 5, 0), !bGXsfl_29_Refreshing);
            AV10DisplayType1_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype1_title_Internalname, AV10DisplayType1_Title);
         }
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title and icon image") == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divDisplaytype2_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype2_cell_Visible), 5, 0), !bGXsfl_29_Refreshing);
            AV11DisplayType2_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype2_title_Internalname, AV11DisplayType2_Title);
            lblDisplaytype2_icon_Caption = GXutil.format( "<i class='SearchResultIcon %1'></i>", ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2(), "", "", "", "", "", "", "", "") ;
         }
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title and subtitle") == 0 )
         {
            divDisplaytype3_cell_Visible = 1 ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divDisplaytype3_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype3_cell_Visible), 5, 0), !bGXsfl_29_Refreshing);
            AV13DisplayType3_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype3_title_Internalname, AV13DisplayType3_Title);
            AV12DisplayType3_Subtitle = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype3_subtitle_Internalname, AV12DisplayType3_Subtitle);
         }
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title and image") == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divDisplaytype4_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype4_cell_Visible), 5, 0), !bGXsfl_29_Refreshing);
            AV15DisplayType4_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype4_title_Internalname, AV15DisplayType4_Title);
            if ( (GXutil.strcmp("", ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2())==0) )
            {
            ...
            {
               AV14DisplayType4_Image = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2() ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype4_image_Internalname, AV14DisplayType4_Image);
               AV35Displaytype4_image_GXI = GXDbFile.pathToUrl( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2(), context.getHttpContext()) ;
            }
         ...
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title, subtitle and icon image") == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divDisplaytype5_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype5_cell_Visible), 5, 0), !bGXsfl_29_Refreshing);
            AV17DisplayType5_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype5_title_Internalname, AV17DisplayType5_Title);
            AV16DisplayType5_Subtitle = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplaytype5_subtitle_Internalname, AV16DisplayType5_Subtitle);
            lblDisplaytype5_icon_Caption = GXutil.format( "<i class='SearchResultIconWS %1'></i>", ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description3(), "", "", "", "", "", "", "", "") ;
         }
         AV24Url = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Url() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavUrl_Internalname, AV24Url);
         /* Load Method */
         if ( wbStart != -1 )
         {
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV22SearchText_PARM", AV22SearchText);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV22SearchText)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV22SearchText_CTRL", GXutil.rtrim( sCtrlAV22SearchText));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211163028", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("wwpbaseobjects/wwp_searchwc.js", "?20241211163028", false, true);
      httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
   ...
   public void sendrow_293( )
   {
      ...
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtablefsfsresults_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Flex","left","top"," "+"data-gx-flex"+" ","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Invisible","left","top","","flex-grow:1;","div"});
      /* Table start */
      ...
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavUrl_Internalname,httpContext.getMessage( "Url", ""),"gx-form-item AttributeLabel",Integer.valueOf(0),Boolean.valueOf(true),"width: 25%;"});
      /* Single line edit */
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      if ( FsresultsContainer.GetWrapped() == 1 )
      {
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype1_cell_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(divDisplaytype1_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable1_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype1_title_Internalname,httpContext.getMessage( "Display Type1_Title", ""),"col-sm-3 AttributeSearchResultTitleLabel",Integer.valueOf(0),Boolean.valueOf(true),""});
      /* Single line edit */
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype2_cell_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(divDisplaytype2_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;","div"});
      /* Table start */
      FsresultsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblUnnamedtable2_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),"","","","","","","",Integer.valueOf(1),Integer.valueOf(2),"","","","px","px",""});
      FsresultsRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {"","",""});
      FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Text block */
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype2_title_Internalname,httpContext.getMessage( "Display Type2_Title", ""),"gx-form-item AttributeSearchResultTitleLabel",Integer.valueOf(0),Boolean.valueOf(true),"width: 25%;"});
      /* Single line edit */
      ROClassString = "AttributeSearchResultTitle" ;
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype3_cell_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(divDisplaytype3_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable3_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype3_title_Internalname,httpContext.getMessage( "Display Type3_Title", ""),"col-sm-3 AttributeSearchResultTitleLabel",Integer.valueOf(0),Boolean.valueOf(true),""});
      /* Single line edit */
      ROClassString = "AttributeSearchResultTitle" ;
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype3_subtitle_Internalname,httpContext.getMessage( "Display Type3_Subtitle", ""),"col-sm-3 AttributeSearchResultSubtitleLabel",Integer.valueOf(0),Boolean.valueOf(true),""});
      /* Single line edit */
   ...
   {
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype4_cell_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(divDisplaytype4_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable4_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Flex","left","top"," "+"data-gx-flex"+" ","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","AttributeSearchResultImageCell","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {"",httpContext.getMessage( "Display Type4_Image", ""),"gx-form-item AttributeSearchResultImageLabel",Integer.valueOf(0),Boolean.valueOf(true),"width: 25%;"});
      ...
      StyleString = "" ;
      AV14DisplayType4_Image_IsBlob = (boolean)(((GXutil.strcmp("", AV14DisplayType4_Image)==0)&&(GXutil.strcmp("", AV35Displaytype4_image_GXI)==0))||!(GXutil.strcmp("", AV14DisplayType4_Image)==0)) ;
      sImgUrl = ((GXutil.strcmp("", AV14DisplayType4_Image)==0) ? AV35Displaytype4_image_GXI : httpContext.getResourceRelative(AV14DisplayType4_Image)) ;
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;align-self:center;","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype4_title_Internalname,httpContext.getMessage( "Display Type4_Title", ""),"gx-form-item AttributeSearchResultTitleLabel",Integer.valueOf(0),Boolean.valueOf(true),"width: 25%;"});
      /* Single line edit */
      ROClassString = "AttributeSearchResultTitle" ;
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype5_cell_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(divDisplaytype5_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;","div"});
      /* Table start */
      FsresultsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblUnnamedtable5_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),"","","","","","","",Integer.valueOf(1),Integer.valueOf(2),"","","","px","px",""});
      FsresultsRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {"","",""});
      FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Text block */
      ...
      FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable6_Internalname+"_"+sGXsfl_29_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype5_title_Internalname,httpContext.getMessage( "Display Type5_Title", ""),"col-sm-3 AttributeSearchResultTitleLabel",Integer.valueOf(0),Boolean.valueOf(true),""});
      /* Single line edit */
      ROClassString = "AttributeSearchResultTitle" ;
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavDisplaytype5_subtitle_Internalname,httpContext.getMessage( "Display Type5_Subtitle", ""),"col-sm-3 AttributeSearchResultSubtitleLabel",Integer.valueOf(0),Boolean.valueOf(true),""});
      /* Single line edit */
      ROClassString = "AttributeSearchResultSubtitle" ;
   ...
   public void sendrow_212( )
   {
      ...
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtablefsfsresultcategories_Internalname+"_"+sGXsfl_21_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Table","left","top","","","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12 SearchResultMPCategoryCell","left","top","","","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px"," gx-attribute","left","top","","","div"});
      /* Attribute/Variable Label */
      FsresultcategoriesRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavWwp_searchresults__categoryname_Internalname,httpContext.getMessage( "Category Name", ""),"col-sm-3 AttributeLabel",Integer.valueOf(0),Boolean.valueOf(true),""});
      /* Single line edit */
      ROClassString = "Attribute" ;
      FsresultcategoriesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavWwp_searchresults__categoryname_Internalname,((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.elementAt(-1+AV32GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Categoryname(),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtavWwp_searchresults__categoryname_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"","",Integer.valueOf(1),Integer.valueOf(edtavWwp_searchresults__categoryname_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(40),"chr",Integer.valueOf(1),"row",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
      FsresultcategoriesRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      FsresultcategoriesRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      FsresultcategoriesRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /*  Child Grid Control  */
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+GXCCtl, GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_29, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( FsresultsContainer.GetWrapped() == 1 )
      {
         httpContext.writeText( "</table>") ;
      }
      else
      {
         if ( ! isAjaxCallMode( ) )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FsresultsContainerData"+"_"+sGXsfl_21_idx, FsresultsContainer.ToJavascriptSource());
         }
         if ( isAjaxCallMode( ) )
         {
         ...
         if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FsresultsContainerData"+"V_"+sGXsfl_21_idx, FsresultsContainer.GridValuesHidden());
         }
         else
         {
      ...
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divShowingonlycell_Internalname+"_"+sGXsfl_21_idx,Integer.valueOf(divShowingonlycell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Text block */
   ...
   public void startgridcontrol21( )
   {
      if ( FsresultcategoriesContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subFsresultcategories_Internalname, subFsresultcategories_Internalname, "", "FreeStyleGridMPSearch", 0, "", "", 1, 2, sStyleString, "", "", 0);
         FsresultcategoriesContainer.AddObjectProperty("GridName", "Fsresultcategories");
      }
      else
      {
   ...
   public void startgridcontrol29( )
   {
      if ( FsresultsContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subFsresults_Internalname, subFsresults_Internalname, "", "FreeStyleGrid", 0, "", "", 1, 2, sStyleString, "", "", 0);
         FsresultsContainer.AddObjectProperty("GridName", "Fsresults");
      }
      else
      {
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV24Url);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV10DisplayType1_Title);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV11DisplayType2_Title);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV13DisplayType3_Title);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV12DisplayType3_Subtitle);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV15DisplayType4_Title);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV17DisplayType5_Title);
         ...
         FsresultsContainer.AddColumnProperties(FsresultsColumn);
         FsresultsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         FsresultsColumn.AddObjectProperty("Value", AV16DisplayType5_Subtitle);
   ...
   public void initialize_properties( )
   {
      ...
      lblDisplaytype2_icon_Caption = httpContext.getMessage( "<i class='fa fa-home'></i>", "") ;
      subFsresultcategories_Allowcollapsing = (byte)(0) ;
      lblTxtshowingonly_Caption = httpContext.getMessage( "WWP_Search_ShowingTopResults", "") ;
      lblTxtshowingonly_Caption = httpContext.getMessage( "WWP_Search_ShowingTopResults", "") ;
      ...
      edtavDisplaytype5_title_Enabled = 0 ;
      lblDisplaytype5_icon_Caption = httpContext.getMessage( "<i class='fa fa-home'></i>", "") ;
      divDisplaytype5_cell_Visible = 1 ;
      ...
      Btnadvancedsearch_Caption = httpContext.getMessage( "WWP_Search_AdvancedSearch", "") ;
      ...
      Combo_advfilterentities_Cls = "ExtendedCombo AttributeRealWidth" ;
      ...
      lblTxtnoresults_Caption = httpContext.getMessage( "WWP_Search_NoResults", "") ;
      divTxtnoresultscell_Class = "col-xs-12" ;
      Btnshowall_Class = "IconButtonLink IconButtonSearchAll" ;
      Btnshowall_Caption = httpContext.getMessage( "WWP_Search_ShowAll", "") ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("FSRESULTCATEGORIES.LOAD","{handler:'e162O2',iparms:[{av:'AV26WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:21,pic:'',hsh:true},{av:'nGXsfl_21_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:21},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_21',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:21}]");
      ...
      setEventMetadata("FSRESULTS.LOAD","{handler:'e172O3',iparms:[{av:'AV26WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:21,pic:'',hsh:true},{av:'nGXsfl_21_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:21},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_21',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:21}]");
      ...
      setEventMetadata("'DOCLOSESEARCH'","{handler:'e112O2',iparms:[]");
      setEventMetadata("'DOCLOSESEARCH'",",oparms:[]}");
      setEventMetadata("'DOSHOWALL'","{handler:'e122O2',iparms:[{av:'AV22SearchText',fld:'vSEARCHTEXT',pic:''}]");
      setEventMetadata("'DOSHOWALL'",",oparms:[]}");
      setEventMetadata("'DOBTNADVSEARCH'","{handler:'e132O2',iparms:[{av:'AV8AdvFilterText',fld:'vADVFILTERTEXT',pic:''},{av:'AV5AdvFilterEntities',fld:'vADVFILTERENTITIES',pic:''}]");
      setEventMetadata("'DOBTNADVSEARCH'",",oparms:[]}");
      setEventMetadata("UNNAMEDTABLEFSFSRESULTS.CLICK","{handler:'e142O2',iparms:[{av:'AV26WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:21,pic:'',hsh:true},{av:'nGXsfl_21_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:21},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_21',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:21},{av:'AV24Url',fld:'vURL',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sPrefix = "" ;
      AV22SearchText = "" ;
      AV26WWP_SearchResults = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>(com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem.class, "WWP_SearchResultsItem", "Mujer_Morena", remoteHandle);
      Form = new com.genexus.webpanels.GXWebForm();
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      GXKey = "" ;
      AV9DDO_TitleSettingsIcons = new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      AV6AdvFilterEntities_Data = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item>(com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
      ...
      GXt_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem3 = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>(com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem.class, "WWP_SearchResultsItem", "Mujer_Morena", remoteHandle);
      GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons6 = new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons7 = new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons[1] ;
      ...
      AV25WWP_SearchResultAux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>(com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem.class, "WWP_SearchResultsItem", "Mujer_Morena", remoteHandle);
      GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem5 = new GXBaseCollection[1] ;
      AV18EntityDescription = "" ;
      AV7AdvFilterEntities_DataItem = new com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item(remoteHandle, context);
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV6AdvFilterEntities_Data ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV26WWP_SearchResults ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> GXt_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem3 ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV25WWP_SearchResultAux ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem5[] ;
   private com.mujermorena.wwpbaseobjects.SdtDVB_SDTComboData_Item AV7AdvFilterEntities_DataItem ;
   private com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV9DDO_TitleSettingsIcons ;
   private com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons6 ;
   private com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons7[] ;
}
