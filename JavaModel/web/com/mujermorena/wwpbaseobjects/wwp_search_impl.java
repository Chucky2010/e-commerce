...
public final  class wwp_search_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEAFULTSEARCHTEXT", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10DeafultSearchText, ""))));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTISADVANCEDSEARCH", getSecureSignedToken( "", AV12DefaultIsAdvancedSearch));
               ...
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTADVFILTERENTITIESJSON", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11DefaultAdvFilterEntitiesJson, ""))));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrfsresults_refresh_invoke( )
   {
      edtavUrl_Visible = (int)(GXutil.lval( httpContext.GetNextPar( ))) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUrl_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavUrl_Visible), 5, 0), !bGXsfl_56_Refreshing);
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV28WWP_SearchResults);
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_48", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_48, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISADVANCEDSEARCH", AV23IsAdvancedSearch);
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vDEAFULTSEARCHTEXT", AV10DeafultSearchText);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEAFULTSEARCHTEXT", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10DeafultSearchText, ""))));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vDEFAULTISADVANCEDSEARCH", AV12DefaultIsAdvancedSearch);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTISADVANCEDSEARCH", getSecureSignedToken( "", AV12DefaultIsAdvancedSearch));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vDEFAULTADVFILTERENTITIESJSON", AV11DefaultAdvFilterEntitiesJson);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTADVFILTERENTITIESJSON", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11DefaultAdvFilterEntitiesJson, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "COMBO_ADVFILTERENTITIES_Selectedvalue_get", GXutil.rtrim( Combo_advfilterentities_Selectedvalue_get));
   }
   ...
   {
      return formatLink("com.mujermorena.wwpbaseobjects.wwp_search", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10DeafultSearchText)),GXutil.URLEncode(GXutil.booltostr(AV12DefaultIsAdvancedSearch)),GXutil.URLEncode(GXutil.rtrim(AV11DefaultAdvFilterEntitiesJson))}, new String[] {"DeafultSearchText","DefaultIsAdvancedSearch","DefaultAdvFilterEntitiesJson"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Search results", "") ;
   }
   ...
   public void wb2P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 WWFiltersCell WWFiltersCell SearchFiltersCell", "left", "top", "", "", "div");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTablesimplesearchcell_Internalname, divTablesimplesearchcell_Visible, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9 col-md-8 col-lg-6 DataContentCell", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavSearchtext_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavSearchtext_Internalname, httpContext.getMessage( "WWP_Search_SearchDescription", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavSearchtext_Internalname, AV25SearchText, GXutil.rtrim( localUtil.format( AV25SearchText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSearchtext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavSearchtext_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWPBaseObjects\\WWP_Search.htm");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtnenter_Internalname, "gx.evt.setGridEvt("+GXutil.str( 48, 2, 0)+","+"null"+");", httpContext.getMessage( "GX_BtnSearch", ""), bttBtnenter_Jsonclick, 5, httpContext.getMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\WWP_Search.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-3", "Right", "top", "", "", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTableadvancedsearchcell_Internalname, divTableadvancedsearchcell_Visible, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
         /* Div Control */
         ...
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavAdvfiltertext_Internalname, httpContext.getMessage( "WWP_Search_SearchDescription", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 33,'',false,'" + sGXsfl_48_idx + "',0)\"" ;
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavAdvfiltertext_Internalname, AV8AdvFilterText, GXutil.rtrim( localUtil.format( AV8AdvFilterText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,33);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAdvfiltertext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavAdvfiltertext_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWPBaseObjects\\WWP_Search.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9 col-md-8 col-lg-6 DataContentCell ExtendedComboCell", "left", "top", "", "", "div");
         /* Div Control */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblockcombo_advfilterentities_Internalname, httpContext.getMessage( "WWP_Search_SearchInDescription", ""), "", "", lblTextblockcombo_advfilterentities_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WWP_Search.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divFsresultcategoriescell_Internalname, divFsresultcategoriescell_Visible, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /*  Grid Control  */
      ...
      if ( wbEnd == 48 )
      {
         ...
         else
         {
            ...
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "FsresultcategoriesContainerData", FsresultcategoriesContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "FsresultcategoriesContainerData"+"V", FsresultcategoriesContainer.GridValuesHidden());
            }
            else
            {
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTxtnoresultscell_Internalname, divTxtnoresultscell_Visible, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTxtnoresults_Internalname, lblTxtnoresults_Caption, "", "", lblTxtnoresults_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockShowingOnly", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WWP_Search.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 56 )
      {
         ...
         if ( isFullAjaxMode( ) )
         {
            ...
            else
            {
               ...
               if ( ! isAjaxCallMode( ) )
               {
                  com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "FsresultsContainerData", FsresultsContainer.ToJavascriptSource());
               }
               if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
               {
                  com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "FsresultsContainerData"+"V", FsresultsContainer.GridValuesHidden());
               }
               else
               {
   ...
   public void start2P2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Search results", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 23), "FSRESULTCATEGORIES.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 17), "TABLEFSCARD.CLICK") == 0 ) )
                        {
                           ...
                           AV34GXV1 = nGXsfl_48_idx ;
                           if ( ( AV28WWP_SearchResults.size() >= AV34GXV1 ) && ( AV34GXV1 > 0 ) )
                           {
                              AV28WWP_SearchResults.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)) );
                           }
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                           ...
                           else
                           {
                              ...
                              if ( ( GXutil.strcmp(GXutil.left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 17), "TABLEFSCARD.CLICK") == 0 ) )
                              {
                                 ...
                                 httpContext.ajax_rsp_assign_prop("", false, edtavDisplaytype4_image_Internalname, "Bitmap", ((GXutil.strcmp("", AV17DisplayType4_Image)==0) ? AV37Displaytype4_image_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV17DisplayType4_Image))), !bGXsfl_56_Refreshing);
   ...
   public void gxgrfsresults_refresh( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV28WWP_SearchResults ,
   ...
   public void gxgrfsresultcategories_refresh( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV28WWP_SearchResults ,
                                               String AV10DeafultSearchText ,
                                               boolean AV12DefaultIsAdvancedSearch ,
                                               String AV11DefaultAdvFilterEntitiesJson )
   {
   ...
   public void rf2P3( )
   {
      ...
      if ( subFsresults_Islastpage != 0 )
      {
         ...
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, GXCCtl, GXutil.ltrim( localUtil.ntoc( FSRESULTS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
   ...
   public void send_integrity_lvl_hashes2P3( )
   {
   }
   ...
   public void strup2P0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "Wwp_searchresults"), AV28WWP_SearchResults);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vDDO_TITLESETTINGSICONS"), AV9DDO_TitleSettingsIcons);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vADVFILTERENTITIES_DATA"), AV6AdvFilterEntities_Data);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vADVFILTERENTITIES"), AV5AdvFilterEntities);
         /* Read saved values. */
   ...
   private void e152P2( )
   {
      ...
      returnInSub = false ;
      AV34GXV1 = 1 ;
      while ( AV34GXV1 <= AV28WWP_SearchResults.size() )
      {
         AV28WWP_SearchResults.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)) );
         if ( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Showingallresults() )
         {
            lblTxtshowingonly_Caption = "" ;
         }
         else
         {
            lblTxtshowingonly_Caption = GXutil.format( httpContext.getMessage( "WWP_Search_ShowingTopResults", ""), GXutil.ltrimstr( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().size(), 9, 0), "", "", "", "", "", "", "", "") ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
   ...
   {
      AV34GXV1 = nGXsfl_48_idx ;
      if ( ( AV34GXV1 > 0 ) && ( AV28WWP_SearchResults.size() >= AV34GXV1 ) )
      {
         AV28WWP_SearchResults.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)) );
      }
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getsearchwcdata(remoteHandle, context).execute( "", (short)(999), (short)(0), GXv_objcol_svchar3, GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem4) ;
      ...
      AV38GXV4 = 1 ;
      while ( AV38GXV4 <= AV22EntityDescriptions.size() )
      {
         AV21EntityDescription = (String)AV22EntityDescriptions.elementAt(-1+AV38GXV4) ;
   ...
   public void e132P2( )
   {
      ...
      returnInSub = false ;
      new com.mujermorena.wwpbaseobjects.wwp_addrecentsearch(remoteHandle, context).execute( AV28WWP_SearchResults, AV26Url, (short)(4), (short)(3)) ;
   ...
   public void S122( )
   {
      ...
      if ( GXutil.len( GXutil.trim( AV25SearchText)) >= AV24MinimumCharsToSearch )
      {
         ...
         new com.mujermorena.wwpbaseobjects.wwp_getsearchwcdata(remoteHandle, context).execute( AV25SearchText, (short)(10), (short)(12), GXv_objcol_svchar3, GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem4) ;
      ...
      {
         AV28WWP_SearchResults = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>(com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem.class, "WWP_SearchResultsItem", "Mujer_Morena", remoteHandle) ;
         gx_BV48 = true ;
      }
      if ( AV28WWP_SearchResults.size() == 0 )
      {
         ...
         {
            lblTxtnoresults_Caption = GXutil.format( httpContext.getMessage( "WWP_Search_NoResults", ""), AV25SearchText, "", "", "", "", "", "", "", "") ;
            httpContext.ajax_rsp_assign_prop("", false, lblTxtnoresults_Internalname, "Caption", lblTxtnoresults_Caption, true);
         }
      }
   ...
   {
      AV34GXV1 = nGXsfl_48_idx ;
      if ( AV28WWP_SearchResults.size() < AV34GXV1 )
      {
         return  ;
      }
      ...
      returnInSub = false ;
      AV36GXV3 = 1 ;
      while ( AV36GXV3 <= ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().size() )
      {
         ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().elementAt(-1+AV36GXV3)) );
         ...
         if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title") == 0 )
         {
            divDisplaytype1_cell_Visible = 1 ;
            httpContext.ajax_rsp_assign_prop("", false, divDisplaytype1_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype1_cell_Visible), 5, 0), !bGXsfl_56_Refreshing);
            AV13DisplayType1_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri("", false, edtavDisplaytype1_title_Internalname, AV13DisplayType1_Title);
         }
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title and icon image") == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_prop("", false, divDisplaytype2_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype2_cell_Visible), 5, 0), !bGXsfl_56_Refreshing);
            AV14DisplayType2_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri("", false, edtavDisplaytype2_title_Internalname, AV14DisplayType2_Title);
            lblDisplaytype2_icon_Caption = GXutil.format( "<i class='SearchResultIcon %1'></i>", ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2(), "", "", "", "", "", "", "", "") ;
         }
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title and subtitle") == 0 )
         {
            divDisplaytype3_cell_Visible = 1 ;
            httpContext.ajax_rsp_assign_prop("", false, divDisplaytype3_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype3_cell_Visible), 5, 0), !bGXsfl_56_Refreshing);
            AV16DisplayType3_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri("", false, edtavDisplaytype3_title_Internalname, AV16DisplayType3_Title);
         ...
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title and image") == 0 )
         {
            ...
            if ( (GXutil.strcmp("", ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2())==0) )
            {
               ...
               AV37Displaytype4_image_GXI = "" ;
            }
            else
            {
               AV17DisplayType4_Image = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2() ;
               httpContext.ajax_rsp_assign_attri("", false, edtavDisplaytype4_image_Internalname, AV17DisplayType4_Image);
               AV37Displaytype4_image_GXI = GXDbFile.pathToUrl( ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description2(), context.getHttpContext()) ;
            }
         ...
         else if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Displaytype(), "Title, subtitle and icon image") == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_prop("", false, divDisplaytype5_cell_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divDisplaytype5_cell_Visible), 5, 0), !bGXsfl_56_Refreshing);
            AV20DisplayType5_Title = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Description() ;
            httpContext.ajax_rsp_assign_attri("", false, edtavDisplaytype5_title_Internalname, AV20DisplayType5_Title);
         ...
         AV26Url = ((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Result().currentItem())).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem_Url() ;
         httpContext.ajax_rsp_assign_attri("", false, edtavUrl_Internalname, AV26Url);
         /* Load Method */
         if ( wbStart != -1 )
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111174610", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/wwp_search.js", "?202412111174611", false, true);
      httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
   ...
   public void sendrow_563( )
   {
      ...
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtablefsfsresults_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Flex","left","top"," "+"data-gx-flex"+" ","","div"});
      /* Div Control */
      ...
      FsresultsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","CellMarginTop SearchResultCardCell","left","top","","flex-grow:1;","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divTablefscard_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","SimpleCardTable","left","top","","","div"});
      /* Div Control */
      ...
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype1_cell_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(divDisplaytype1_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable1_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype2_cell_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(divDisplaytype2_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Table start */
      FsresultsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblUnnamedtable2_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),"","","","","","","",Integer.valueOf(1),Integer.valueOf(2),"","","","px","px",""});
      FsresultsRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {"","",""});
      FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Text block */
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype3_cell_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(divDisplaytype3_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable3_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
   ...
   public void sendrow_56330( )
   {
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype4_cell_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(divDisplaytype4_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable4_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Flex","left","top"," "+"data-gx-flex"+" ","","div"});
      /* Div Control */
      ...
      StyleString = "" ;
      AV17DisplayType4_Image_IsBlob = (boolean)(((GXutil.strcmp("", AV17DisplayType4_Image)==0)&&(GXutil.strcmp("", AV37Displaytype4_image_GXI)==0))||!(GXutil.strcmp("", AV17DisplayType4_Image)==0)) ;
      sImgUrl = ((GXutil.strcmp("", AV17DisplayType4_Image)==0) ? AV37Displaytype4_image_GXI : httpContext.getResourceRelative(AV17DisplayType4_Image)) ;
      ...
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divDisplaytype5_cell_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(divDisplaytype5_cell_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
      /* Table start */
      FsresultsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblUnnamedtable5_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),"","","","","","","",Integer.valueOf(1),Integer.valueOf(2),"","","","px","px",""});
      FsresultsRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {"","",""});
      FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Text block */
      ...
      FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtable6_Internalname+"_"+sGXsfl_56_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","left","top","","","div"});
   ...
   public void sendrow_482( )
   {
      ...
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divUnnamedtablefsfsresultcategories_Internalname+"_"+sGXsfl_48_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Table","left","top","","","div"});
      /* Div Control */
      ...
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12 SearchResultCategoryCell","left","top","","","div"});
      /* Div Control */
      ...
      /* Single line edit */
      ROClassString = "Attribute" ;
      FsresultcategoriesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavWwp_searchresults__categoryname_Internalname,((com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.elementAt(-1+AV34GXV1)).getgxTv_SdtWWP_SearchResults_WWP_SearchResultsItem_Categoryname(),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavWwp_searchresults__categoryname_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"","",Integer.valueOf(1),Integer.valueOf(edtavWwp_searchresults__categoryname_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(40),"chr",Integer.valueOf(1),"row",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(48),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, GXCCtl, GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_56, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( FsresultsContainer.GetWrapped() == 1 )
      {
         httpContext.writeText( "</table>") ;
      }
      else
      {
         if ( ! isAjaxCallMode( ) )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "FsresultsContainerData"+"_"+sGXsfl_48_idx, FsresultsContainer.ToJavascriptSource());
         }
         if ( isAjaxCallMode( ) )
         {
         ...
         if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "FsresultsContainerData"+"V_"+sGXsfl_48_idx, FsresultsContainer.GridValuesHidden());
         }
         else
         {
      ...
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      /* Div Control */
      FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","Right","top","","","div"});
      /* Text block */
      ...
      FsresultcategoriesRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"Right","top","div"});
      FsresultcategoriesRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
      FsresultcategoriesRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"left","top","div"});
   ...
   public void startgridcontrol48( )
   {
      if ( FsresultcategoriesContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subFsresultcategories_Internalname, subFsresultcategories_Internalname, "", "FreeStyleGrid", 0, "", "", 1, 2, sStyleString, "", "", 0);
         FsresultcategoriesContainer.AddObjectProperty("GridName", "Fsresultcategories");
      }
      else
      {
   ...
   public void initialize_properties( )
   {
      ...
      lblTxtshowingonly_Caption = httpContext.getMessage( "Showing only the first 3 results...", "") ;
      lblTxtshowingonly_Caption = httpContext.getMessage( "Showing only the first 3 results...", "") ;
      ...
      lblTxtnoresults_Caption = httpContext.getMessage( "No results found for '%1'.", "") ;
      divTxtnoresultscell_Visible = 1 ;
      divFsresultcategoriescell_Visible = 1 ;
      Btnbasicsearch_Class = "IconButtonLink" ;
      Btnbasicsearch_Caption = httpContext.getMessage( "WWP_Search_BasicSearch", "") ;
      ...
      Form.setCaption( httpContext.getMessage( "Search results", "") );
      edtavUrl_Visible = 1 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("FSRESULTCATEGORIES.LOAD","{handler:'e152P2',iparms:[{av:'AV28WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:48,pic:''},{av:'nGXsfl_48_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:48},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_48',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:48}]");
      setEventMetadata("FSRESULTCATEGORIES.LOAD",",oparms:[{av:'lblTxtshowingonly_Caption',ctrl:'TXTSHOWINGONLY',prop:'Caption'}]}");
      setEventMetadata("FSRESULTS.LOAD","{handler:'e162P3',iparms:[{av:'AV28WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:48,pic:''},{av:'nGXsfl_48_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:48},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_48',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:48}]");
      ...
      setEventMetadata("ENTER","{handler:'e122P2',iparms:[{av:'AV23IsAdvancedSearch',fld:'vISADVANCEDSEARCH',pic:''},{av:'AV8AdvFilterText',fld:'vADVFILTERTEXT',pic:''},{av:'AV25SearchText',fld:'vSEARCHTEXT',pic:''},{av:'AV5AdvFilterEntities',fld:'vADVFILTERENTITIES',pic:''},{av:'AV28WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:48,pic:''},{av:'nGXsfl_48_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:48},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_48',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:48},{av:'FSRESULTCATEGORIES_nEOF'},{av:'FSRESULTS_nFirstRecordOnPage'},{av:'FSRESULTS_nEOF'},{av:'edtavUrl_Visible',ctrl:'vURL',prop:'Visible'},{av:'AV10DeafultSearchText',fld:'vDEAFULTSEARCHTEXT',pic:'',hsh:true},{av:'AV12DefaultIsAdvancedSearch',fld:'vDEFAULTISADVANCEDSEARCH',pic:'',hsh:true},{av:'AV11DefaultAdvFilterEntitiesJson',fld:'vDEFAULTADVFILTERENTITIESJSON',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'divTableadvancedsearchcell_Visible',ctrl:'TABLEADVANCEDSEARCHCELL',prop:'Visible'},{av:'divTablesimplesearchcell_Visible',ctrl:'TABLESIMPLESEARCHCELL',prop:'Visible'},{av:'AV25SearchText',fld:'vSEARCHTEXT',pic:''},{av:'AV5AdvFilterEntities',fld:'vADVFILTERENTITIES',pic:''},{av:'Combo_advfilterentities_Selectedvalue_set',ctrl:'COMBO_ADVFILTERENTITIES',prop:'SelectedValue_set'},{av:'AV28WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:48,pic:''},{av:'nGXsfl_48_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:48},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_48',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:48},{av:'lblTxtnoresults_Caption',ctrl:'TXTNORESULTS',prop:'Caption'},{av:'divFsresultcategoriescell_Visible',ctrl:'FSRESULTCATEGORIESCELL',prop:'Visible'},{av:'divTxtnoresultscell_Visible',ctrl:'TXTNORESULTSCELL',prop:'Visible'}]}");
      setEventMetadata("TABLEFSCARD.CLICK","{handler:'e132P2',iparms:[{av:'AV28WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:48,pic:''},{av:'nGXsfl_48_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:48},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_48',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:48},{av:'AV26Url',fld:'vURL',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      AV27WWP_SearchResultAux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>(com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem.class, "WWP_SearchResultsItem", "Mujer_Morena", remoteHandle);
      ...
      GXt_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem5 = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>(com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem.class, "WWP_SearchResultsItem", "Mujer_Morena", remoteHandle);
   ...
   private String AV37Displaytype4_image_GXI ;
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV28WWP_SearchResults ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> AV27WWP_SearchResultAux ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> GXt_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem5 ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem> GXv_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem4[] ;
