...
public final  class SdtWWPColumnsSelector_Column extends GxUserType
{
   ...
   {
      gxTv_SdtWWPColumnsSelector_Column_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtWWPColumnsSelector_Column_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtWWPColumnsSelector_Column_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtWWPColumnsSelector_Column Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtWWPColumnsSelector_Column)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtWWPColumnsSelector_Column struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtWWPColumnsSelector_Column getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtWWPColumnsSelector_Column struct = new com.mujermorena.wwpbaseobjects.StructSdtWWPColumnsSelector_Column ();
   ...
   protected byte gxTv_SdtWWPColumnsSelector_Column_N ;
