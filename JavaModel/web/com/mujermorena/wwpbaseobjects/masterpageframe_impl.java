...
public final  class masterpageframe_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm2A2( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202412111172093", false, true);
   ...
   {
      return httpContext.getMessage( "Master Page Frame", "") ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202412111172159", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202412111172159", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void initialize( )
   {
      ...
      AV5WWP_DesignSystemSettings = new com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings(remoteHandle, context);
   ...
   private com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings AV5WWP_DesignSystemSettings ;
