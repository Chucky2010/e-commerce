...
public final  class exportoptions_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEXCELFILENAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV7ExcelFileName, ""))));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTTITLE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV6DefaultTitle, ""))));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vGOOGLEDOCRESULTXML", getSecureSignedToken( "", AV9GoogleDocResultXML));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEXCELFILENAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV7ExcelFileName, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTTITLE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV6DefaultTitle, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vGOOGLEDOCRESULTXML", AV9GoogleDocResultXML);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vGOOGLEDOCRESULTXML", getSecureSignedToken( "", AV9GoogleDocResultXML));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vEXCELFILENAME", AV7ExcelFileName);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEXCELFILENAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV7ExcelFileName, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vDEFAULTTITLE", AV6DefaultTitle);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEFAULTTITLE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV6DefaultTitle, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Width", GXutil.rtrim( Dvpanel_tableexport_Width));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Autowidth", GXutil.booltostr( Dvpanel_tableexport_Autowidth));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Autoheight", GXutil.booltostr( Dvpanel_tableexport_Autoheight));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Cls", GXutil.rtrim( Dvpanel_tableexport_Cls));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Title", GXutil.rtrim( Dvpanel_tableexport_Title));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Collapsible", GXutil.booltostr( Dvpanel_tableexport_Collapsible));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Collapsed", GXutil.booltostr( Dvpanel_tableexport_Collapsed));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Showcollapseicon", GXutil.booltostr( Dvpanel_tableexport_Showcollapseicon));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Iconposition", GXutil.rtrim( Dvpanel_tableexport_Iconposition));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "DVPANEL_TABLEEXPORT_Autoscroll", GXutil.booltostr( Dvpanel_tableexport_Autoscroll));
   ...
   {
      return formatLink("com.mujermorena.wwpbaseobjects.exportoptions", new String[] {GXutil.URLEncode(GXutil.rtrim(AV7ExcelFileName)),GXutil.URLEncode(GXutil.rtrim(AV6DefaultTitle))}, new String[] {"ExcelFileName","DefaultTitle"})  ;
   }
   ...
   {
      return httpContext.getMessage( "WWP_ExportOptionsDescription", "") ;
   }
   ...
   public void wb0D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_6_0D2( true) ;
      }
      else
      {
         wb_table1_6_0D2( false) ;
      }
      return  ;
   }

   public void wb_table1_6_0D2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0D2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "WWP_ExportOptionsDescription", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e110D2( )
   {
      ...
      bttBtndownloadtofile_Jsonclick = httpContext.getMessage( "exportActionDownloadFile('", "")+AV13URL+"')" ;
   ...
   public void e130D2( )
   {
      ...
      {
         Innewwindow1_Target = ((com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc)AV10GoogleDocsResult.getgxTv_SdtGoogleDocsResult_Docs().elementAt(-1+1)).getgxTv_SdtGoogleDocsResult_Doc_Url() ;
         ...
         httpContext.GX_msglist.addItem(httpContext.getMessage( "The document was succesully uploaded to Google Drive", ""));
         bttBtncancel_Caption = httpContext.getMessage( "WWP_CloseButtonCaption", "") ;
      ...
      {
         httpContext.GX_msglist.addItem(httpContext.getMessage( "Error uploading Spreadsheet:  ", "")+AV10GoogleDocsResult.getgxTv_SdtGoogleDocsResult_Error());
      }
   ...
   public void wb_table1_6_0D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblTablemain_Internalname, tblTablemain_Internalname, "", "TableMainTransaction", 0, "", "", 1, 2, sStyleString, "", "", 0);
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblJs_Internalname, lblJs_Caption, "", "", lblJs_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(2), "HLP_WWPBaseObjects\\ExportOptions.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         wb_table2_15_0D2( true) ;
      }
      else
      {
         wb_table2_15_0D2( false) ;
      }
      return  ;
   }

   public void wb_table2_15_0D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divHtml_usertable_ut_Internalname, 1, 0, "px", 0, "px", "Section", "left", "top", "", "", "div");
         wb_table3_52_0D2( true) ;
      }
      else
      {
         wb_table3_52_0D2( false) ;
      }
      return  ;
   }

   public void wb_table3_52_0D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "Button" ;
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtndownloadtofile_Internalname, "", httpContext.getMessage( "WWP_SaveButtonCaption", ""), bttBtndownloadtofile_Jsonclick, 5, httpContext.getMessage( "WWP_SaveButtonCaption", ""), "", StyleString, ClassString, bttBtndownloadtofile_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DODOWNLOADTOFILE\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\ExportOptions.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "Button" ;
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtnsavegoogledrive_Internalname, "", httpContext.getMessage( "WWP_SaveButtonCaption", ""), bttBtnsavegoogledrive_Jsonclick, 5, httpContext.getMessage( "WWP_SaveButtonCaption", ""), "", StyleString, ClassString, bttBtnsavegoogledrive_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOSAVEGOOGLEDRIVE\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\ExportOptions.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtncancel_Internalname, "", bttBtncancel_Caption, bttBtncancel_Jsonclick, 1, httpContext.getMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\ExportOptions.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         wb_table1_6_0D2e( true) ;
      }
      else
      {
         wb_table1_6_0D2e( false) ;
      }
   }

   public void wb_table3_52_0D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblUt_Internalname, tblUt_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_52_0D2e( true) ;
      }
      else
      {
         wb_table3_52_0D2e( false) ;
      }
   }

   public void wb_table2_15_0D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblTablecontent_Internalname, tblTablecontent_Internalname, "", "Table", 0, "", "", 0, 0, sStyleString, "", "", 0);
         httpContext.writeText( "<tr>") ;
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTableexport_Internalname, 1, 0, "px", 0, "px", "TableData", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellFL", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+cmbavExporttype.getInternalname()+"\"", "", "div");
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, cmbavExporttype.getInternalname(), httpContext.getMessage( "WWP_ExportTypeDescription", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'',false,'',0)\"" ;
         /* ComboBox */
         com.mujermorena.GxWebStd.gx_combobox_ctrl1( httpContext, cmbavExporttype, cmbavExporttype.getInternalname(), GXutil.trim( GXutil.str( AV8ExportType, 1, 0)), 1, cmbavExporttype.getJsonclick(), 7, "'"+""+"'"+",false,"+"'"+"e150d1_client"+"'", "int", "", 1, cmbavExporttype.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "AttributeRealWidth", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "", true, (byte)(0), "HLP_WWPBaseObjects\\ExportOptions.htm");
         cmbavExporttype.setValue( GXutil.trim( GXutil.str( AV8ExportType, 1, 0)) );
         httpContext.ajax_rsp_assign_prop("", false, cmbavExporttype.getInternalname(), "Values", cmbavExporttype.ToJavascriptSource(), true);
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class='CellPaddingTop10 CellMarginLeft15'>") ;
         wb_table4_28_0D2( true) ;
      }
      else
      {
         wb_table4_28_0D2( false) ;
      }
      return  ;
   }

   public void wb_table4_28_0D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_15_0D2e( true) ;
      }
      else
      {
         wb_table2_15_0D2e( false) ;
      }
   }

   public void wb_table4_28_0D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblTablegoogledriveinfo_Internalname, tblTablegoogledriveinfo_Internalname, "", "Table100x100", 0, "", "", 0, 0, sStyleString, "", "", 0);
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         /* User Defined Control */
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellFL", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavUser_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavUser_Internalname, httpContext.getMessage( "WWP_GoogleDriveEmail", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 38,'',false,'',0)\"" ;
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavUser_Internalname, AV14User, GXutil.rtrim( localUtil.format( AV14User, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,38);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUser_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavUser_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "WWPBaseObjects\\WWP_Description", "left", true, "", "HLP_WWPBaseObjects\\ExportOptions.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellFL", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavDoctitle_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavDoctitle_Internalname, httpContext.getMessage( "WWP_GoogleDriveDocumentTitle", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 43,'',false,'',0)\"" ;
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavDoctitle_Internalname, AV5DocTitle, GXutil.rtrim( localUtil.format( AV5DocTitle, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDoctitle_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavDoctitle_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "WWPBaseObjects\\WWP_Description", "left", true, "", "HLP_WWPBaseObjects\\ExportOptions.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Attribute/Variable Label */
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtavPassword_Internalname, httpContext.getMessage( "WWP_GoogleDrivePassword", ""), "col-sm-3 AttributeRealWidthLabel", 1, true, "");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 48,'',false,'',0)\"" ;
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavPassword_Internalname, AV12Password, GXutil.rtrim( localUtil.format( AV12Password, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPassword_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavPassword_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, edtavPassword_Ispassword, (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "WWPBaseObjects\\WWP_Description", "left", true, "", "HLP_WWPBaseObjects\\ExportOptions.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_28_0D2e( true) ;
      }
      else
      {
         wb_table4_28_0D2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111112932", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/exportoptions.js", "?202412111112933", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      bttBtncancel_Caption = httpContext.getMessage( "GX_BtnCancel", "") ;
      ...
      Dvpanel_tableattributes_Title = httpContext.getMessage( "WWP_ExcelOptions_GoogleDriveInfo", "") ;
      ...
      Dvpanel_tableexport_Title = httpContext.getMessage( "WWP_ExportOptions_Where", "") ;
      ...
      Form.setCaption( httpContext.getMessage( "WWP_ExportOptionsDescription", "") );
   ...
   public void init_web_controls( )
   {
      ...
      cmbavExporttype.addItem("1", httpContext.getMessage( "Download to disk", ""), (short)(0));
      cmbavExporttype.addItem("2", httpContext.getMessage( "Upload to Google Drive", ""), (short)(0));
      if ( cmbavExporttype.getItemCount() > 0 )
      {
         AV8ExportType = (byte)(GXutil.lval( cmbavExporttype.getValidValue(GXutil.trim( GXutil.str( AV8ExportType, 1, 0))))) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV8ExportType", GXutil.str( AV8ExportType, 1, 0));
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DODOWNLOADTOFILE'","{handler:'e120D2',iparms:[]");
      setEventMetadata("'DODOWNLOADTOFILE'",",oparms:[]}");
      setEventMetadata("'DOSAVEGOOGLEDRIVE'","{handler:'e130D2',iparms:[{av:'AV9GoogleDocResultXML',fld:'vGOOGLEDOCRESULTXML',pic:'',hsh:true}]");
      ...
      setEventMetadata("VEXPORTTYPE.CLICK","{handler:'e150D1',iparms:[{av:'cmbavExporttype'},{av:'AV8ExportType',fld:'vEXPORTTYPE',pic:'9'}]");
   ...
   public void initialize( )
   {
      ...
      AV10GoogleDocsResult = new com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult(remoteHandle, context);
   ...
   private com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult AV10GoogleDocsResult ;
}
