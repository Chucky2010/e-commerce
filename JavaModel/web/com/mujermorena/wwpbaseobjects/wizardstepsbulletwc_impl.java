...
public final  class wizardstepsbulletwc_impl extends GXWebComponent
{
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV17WizardSteps);
   ...
   public void gxgrgridwizardsteps_refresh_invoke( )
   {
      ...
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV18WizardStepsAux);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Wizard Steps Bullet WC.", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.mujermorena.wwpbaseobjects.wizardstepsbulletwc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV6CurrentStep))}, new String[] {"WizardSteps","CurrentStep"}) +"\">") ;
      ...
      else
      {
         ...
         com.mujermorena.GxWebStd.classAttribute( httpContext, "gxwebcomponent-body"+" "+((GXutil.strcmp("", Form.getThemeClass())==0) ? "Form" : Form.getThemeClass())+"-fx");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepRealNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV12SelectedStepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV18WizardStepsAux));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV14StepNumber), "ZZZ9")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV10PenultimateIsDummy));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_Wizardstepsaux", getSecureSignedToken( sPrefix, AV18WizardStepsAux));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_5", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_5, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6CurrentStep", wcpOAV6CurrentStep);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPREALNUMBER", GXutil.ltrim( localUtil.ntoc( AV15StepRealNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepRealNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV12SelectedStepNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV12SelectedStepNumber), "ZZZ9")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV18WizardStepsAux));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV14StepNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV14StepNumber), "ZZZ9")));
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPENULTIMATEISDUMMY", AV10PenultimateIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV10PenultimateIsDummy));
   ...
   {
      return httpContext.getMessage( "Wizard Steps Bullet WC.", "") ;
   }
   ...
   public void wb0F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.wwpbaseobjects.wizardstepsbulletwc");
         }
   ...
   public void start0F2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Wizard Steps Bullet WC.", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV26GXV1 = nGXsfl_5_idx ;
                           if ( ( AV18WizardStepsAux.size() >= AV26GXV1 ) && ( AV26GXV1 > 0 ) )
                           {
                              AV18WizardStepsAux.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+AV26GXV1)) );
                           }
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
   ...
   public void gxgrgridwizardsteps_refresh( short AV15StepRealNumber ,
                                            ...
                                            GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardStepsAux ,
                                            short AV14StepNumber ,
                                            short AV20WizardStepsCount ,
                                            boolean AV7FirstIsDummy ,
                                            boolean AV8LastIsDummy ,
                                            GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV17WizardSteps ,
   ...
   public void strup0F0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"Wizardstepsaux"), AV18WizardStepsAux);
         /* Read saved values. */
   ...
   public void e110F2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV12SelectedStepNumber), "ZZZ9")));
      AV28GXV3 = 1 ;
      while ( AV28GXV3 <= AV17WizardSteps.size() )
      {
         AV5WizardStep = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV17WizardSteps.elementAt(-1+AV28GXV3));
      ...
      if ( AV18WizardStepsAux.size() > AV9MaxStepsToShow )
      {
         ...
         if ( ( AV12SelectedStepNumber + 3 - AV9MaxStepsToShow / (double) ( 2 ) > 0 ) )
         {
            AV13StartIndex = (short)(AV12SelectedStepNumber+3-AV9MaxStepsToShow/ (double) (2)) ;
         ...
         if ( AV13StartIndex > 3 )
         {
            ...
            ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+2)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "..." );
         ...
         if ( AV18WizardStepsAux.size() > AV9MaxStepsToShow )
         {
            ...
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10PenultimateIsDummy", AV10PenultimateIsDummy);
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV10PenultimateIsDummy));
            ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+AV18WizardStepsAux.size()-1)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "" );
      ...
      {
         AV19WizardStepsItem = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)new com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private void e120F2( )
   {
      ...
      returnInSub = false ;
      AV26GXV1 = 1 ;
      while ( AV26GXV1 <= AV18WizardStepsAux.size() )
      {
         AV18WizardStepsAux.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+AV26GXV1)) );
         ...
         if ( ! GXutil.contains( ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(AV18WizardStepsAux.currentItem())).getgxTv_SdtWizardSteps_WizardStepsItem_Code(), "DummyXS") )
         {
         ...
         else
         {
            ...
            if ( ( AV12SelectedStepNumber > 3 ) && ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(AV18WizardStepsAux.currentItem())).getgxTv_SdtWizardSteps_WizardStepsItem_Code(), "FirstDummyXS") == 0 ) )
            {
   ...
   public void wb_table1_2_0F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblTablemain_Internalname, tblTablemain_Internalname, "", "TableWizardSteps TableAlignedCentered", 0, "", "", 1, 2, sStyleString, "", "", 0);
   ...
   {
      AV17WizardSteps = (GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV17WizardSteps = (GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV17WizardSteps = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>() ;
      }
      else
      {
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"AV17WizardSteps_PARM"), AV17WizardSteps);
      }
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV17WizardSteps_CTRL", GXutil.rtrim( sCtrlAV17WizardSteps));
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211164611", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepsbulletwc.js", "?20241211164611", false, true);
      }
   ...
   public void startgridcontrol5( )
   {
      if ( GridwizardstepsContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subGridwizardsteps_Internalname, subGridwizardsteps_Internalname, "", "FreeStyleSteps", 0, "", "", 1, 2, sStyleString, "", "", 0);
         GridwizardstepsContainer.AddObjectProperty("GridName", "Gridwizardsteps");
      }
      else
      {
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'e120F2',iparms:[{av:'AV15StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV18WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:'',hsh:true},{av:'nGXsfl_5_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:5},{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC',grid:5},{av:'AV14StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV20WizardStepsCount',fld:'vWIZARDSTEPSCOUNT',pic:'ZZZ9',hsh:true},{av:'AV7FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV8LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV17WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'AV10PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV17WizardSteps = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "Mujer_Morena", remoteHandle);
      AV6CurrentStep = "" ;
      AV18WizardStepsAux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "Mujer_Morena", remoteHandle);
      ...
      AV19WizardStepsItem = new com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV17WizardSteps ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardStepsAux ;
   private com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV5WizardStep ;
   private com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV19WizardStepsItem ;
}
