...
public final  class SdtGridStateCollection_Item extends GxUserType
{
   ...
   {
      gxTv_SdtGridStateCollection_Item_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtGridStateCollection_Item_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtGridStateCollection_Item_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtGridStateCollection_Item struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtGridStateCollection_Item getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtGridStateCollection_Item struct = new com.mujermorena.wwpbaseobjects.StructSdtGridStateCollection_Item ();
   ...
   protected byte gxTv_SdtGridStateCollection_Item_N ;
