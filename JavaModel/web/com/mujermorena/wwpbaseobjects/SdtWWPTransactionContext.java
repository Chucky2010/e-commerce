...
public final  class SdtWWPTransactionContext extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Attributes") )
            {
               ...
               {
                  gxTv_SdtWWPTransactionContext_Attributes = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute>(com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute.class, "WWPTransactionContext.Attribute", "Mujer_Morena", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute> getgxTv_SdtWWPTransactionContext_Attributes( )
   {
      if ( gxTv_SdtWWPTransactionContext_Attributes == null )
      {
         gxTv_SdtWWPTransactionContext_Attributes = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute>(com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute.class, "WWPTransactionContext.Attribute", "Mujer_Morena", remoteHandle);
   ...
   public void setgxTv_SdtWWPTransactionContext_Attributes( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute> value )
   {
      gxTv_SdtWWPTransactionContext_Attributes_N = (byte)(0) ;
      gxTv_SdtWWPTransactionContext_N = (byte)(0) ;
   ...
   public com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext struct )
   {
      ...
      GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes_aux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute>(com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute.class, "WWPTransactionContext.Attribute", "Mujer_Morena", remoteHandle);
      Vector<com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes_aux1 = struct.getAttributes();
      if (gxTv_SdtWWPTransactionContext_Attributes_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPTransactionContext_Attributes_aux1.size(); i++)
         {
            gxTv_SdtWWPTransactionContext_Attributes_aux.add(new com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute(gxTv_SdtWWPTransactionContext_Attributes_aux1.elementAt(i)));
         }
      }
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext struct = new com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext ();
   ...
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes_aux ;
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes=null ;
}
