...
public final  class SdtProgramNames_ProgramName extends GxUserType
{
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtProgramNames_ProgramName_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtProgramNames_ProgramName_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtProgramNames_ProgramName Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtProgramNames_ProgramName)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtProgramNames_ProgramName struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtProgramNames_ProgramName getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtProgramNames_ProgramName struct = new com.mujermorena.wwpbaseobjects.StructSdtProgramNames_ProgramName ();
