...
public final  class SdtWWPGridState extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "FilterValues") )
            {
               ...
               {
                  gxTv_SdtWWPGridState_Filtervalues = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue>(com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "Mujer_Morena", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "DynamicFilters") )
            {
               ...
               {
                  gxTv_SdtWWPGridState_Dynamicfilters = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "Mujer_Morena", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue> getgxTv_SdtWWPGridState_Filtervalues( )
   {
      if ( gxTv_SdtWWPGridState_Filtervalues == null )
      {
         gxTv_SdtWWPGridState_Filtervalues = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue>(com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "Mujer_Morena", remoteHandle);
   ...
   public void setgxTv_SdtWWPGridState_Filtervalues( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue> value )
   {
      gxTv_SdtWWPGridState_Filtervalues_N = (byte)(0) ;
      gxTv_SdtWWPGridState_N = (byte)(0) ;
   ...
   public GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter> getgxTv_SdtWWPGridState_Dynamicfilters( )
   {
      if ( gxTv_SdtWWPGridState_Dynamicfilters == null )
      {
         gxTv_SdtWWPGridState_Dynamicfilters = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "Mujer_Morena", remoteHandle);
   ...
   public void setgxTv_SdtWWPGridState_Dynamicfilters( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter> value )
   {
      gxTv_SdtWWPGridState_Dynamicfilters_N = (byte)(0) ;
      gxTv_SdtWWPGridState_N = (byte)(0) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtWWPGridState_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtWWPGridState Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtWWPGridState)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtWWPGridState struct )
   {
      ...
      GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue>(com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "Mujer_Morena", remoteHandle);
      Vector<com.mujermorena.wwpbaseobjects.StructSdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux1 = struct.getFiltervalues();
      if (gxTv_SdtWWPGridState_Filtervalues_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPGridState_Filtervalues_aux1.size(); i++)
         {
            gxTv_SdtWWPGridState_Filtervalues_aux.add(new com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue(gxTv_SdtWWPGridState_Filtervalues_aux1.elementAt(i)));
         }
      }
      setgxTv_SdtWWPGridState_Filtervalues(gxTv_SdtWWPGridState_Filtervalues_aux);
      GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "Mujer_Morena", remoteHandle);
      Vector<com.mujermorena.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux1 = struct.getDynamicfilters();
      if (gxTv_SdtWWPGridState_Dynamicfilters_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPGridState_Dynamicfilters_aux1.size(); i++)
         {
            gxTv_SdtWWPGridState_Dynamicfilters_aux.add(new com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter(gxTv_SdtWWPGridState_Dynamicfilters_aux1.elementAt(i)));
         }
      }
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtWWPGridState getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtWWPGridState struct = new com.mujermorena.wwpbaseobjects.StructSdtWWPGridState ();
   ...
   protected byte gxTv_SdtWWPGridState_N ;
   ...
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux ;
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux ;
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues=null ;
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters=null ;
}
