...
public final  class SdtBlobData extends GxUserType
{
   ...
   public byte isNull( )
   {
      return gxTv_SdtBlobData_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtBlobData Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtBlobData)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtBlobData struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtBlobData getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtBlobData struct = new com.mujermorena.wwpbaseobjects.StructSdtBlobData ();
   ...
   protected byte gxTv_SdtBlobData_N ;
