...
public final  class SdtGoogleDocsResult extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Docs") )
            {
               ...
               {
                  gxTv_SdtGoogleDocsResult_Docs = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc>(com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc.class, "GoogleDocsResult.Doc", "DVelop.Extensions.GoogleDocs", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc> getgxTv_SdtGoogleDocsResult_Docs( )
   {
      if ( gxTv_SdtGoogleDocsResult_Docs == null )
      {
         gxTv_SdtGoogleDocsResult_Docs = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc>(com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc.class, "GoogleDocsResult.Doc", "DVelop.Extensions.GoogleDocs", remoteHandle);
   ...
   public void setgxTv_SdtGoogleDocsResult_Docs( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc> value )
   {
      gxTv_SdtGoogleDocsResult_Docs_N = (byte)(0) ;
      gxTv_SdtGoogleDocsResult_N = (byte)(0) ;
   ...
   {
      gxTv_SdtGoogleDocsResult_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtGoogleDocsResult_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult struct )
   {
      setgxTv_SdtGoogleDocsResult_Success(struct.getSuccess());
      setgxTv_SdtGoogleDocsResult_Error(struct.getError());
      GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs_aux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc>(com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc.class, "GoogleDocsResult.Doc", "DVelop.Extensions.GoogleDocs", remoteHandle);
      Vector<com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs_aux1 = struct.getDocs();
      if (gxTv_SdtGoogleDocsResult_Docs_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtGoogleDocsResult_Docs_aux1.size(); i++)
         {
            gxTv_SdtGoogleDocsResult_Docs_aux.add(new com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc(gxTv_SdtGoogleDocsResult_Docs_aux1.elementAt(i)));
         }
      }
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult struct = new com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult ();
   ...
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs_aux ;
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs=null ;
}
