...
public final  class SdtDVelop_Menu_Item extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "subItems") )
            {
               ...
               {
                  gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item>(com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "Mujer_Morena", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item> getgxTv_SdtDVelop_Menu_Item_Subitems( )
   {
      if ( gxTv_SdtDVelop_Menu_Item_Subitems == null )
      {
         gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item>(com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "Mujer_Morena", remoteHandle);
   ...
   public void setgxTv_SdtDVelop_Menu_Item_Subitems( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item> value )
   {
      gxTv_SdtDVelop_Menu_Item_Subitems_N = (byte)(0) ;
      gxTv_SdtDVelop_Menu_Item_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtDVelop_Menu_Item_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtDVelop_Menu_Item_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtDVelop_Menu_Item struct )
   {
      ...
      GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item>(com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "Mujer_Morena", remoteHandle);
      Vector<com.mujermorena.wwpbaseobjects.StructSdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux1 = struct.getSubitems();
      if (gxTv_SdtDVelop_Menu_Item_Subitems_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtDVelop_Menu_Item_Subitems_aux1.size(); i++)
         {
            gxTv_SdtDVelop_Menu_Item_Subitems_aux.add(new com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item(gxTv_SdtDVelop_Menu_Item_Subitems_aux1.elementAt(i)));
         }
      }
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtDVelop_Menu_Item getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtDVelop_Menu_Item struct = new com.mujermorena.wwpbaseobjects.StructSdtDVelop_Menu_Item ();
   ...
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux ;
   protected GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems=null ;
}
