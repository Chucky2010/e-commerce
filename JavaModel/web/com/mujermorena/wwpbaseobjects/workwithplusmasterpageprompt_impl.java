...
public final  class workwithplusmasterpageprompt_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm0C2( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?202412111112240", false, true);
   ...
   public void wb0C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 CellContentHolder", "left", "top", "", "", "div");
         if ( httpContext.isSpaRequest( ) )
         {
            httpContext.enableOutput();
         }
         ...
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtavPickerdummyvariable_Internalname, localUtil.format(AV7PickerDummyVariable, "99/99/99"), localUtil.format( AV7PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), false, "", "right", false, "", "HLP_WWPBaseObjects\\WorkWithPlusMasterPagePrompt.htm");
   ...
   public void e110C2( )
   {
      ...
      if ( GXutil.strcmp(AV5HttpRequest.getMethod(), "GET") == 0 )
      {
         ...
         new com.mujermorena.wwpbaseobjects.wwp_getdesignsystemsettings(remoteHandle, context).execute( GXv_SdtWWP_DesignSystemSettings2) ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20241211111236", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?20241211111236", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void initialize( )
   {
      ...
      TempTags = "" ;
      AV7PickerDummyVariable = GXutil.nullDate() ;
      sEvt = "" ;
      EvtGridId = "" ;
      EvtRowId = "" ;
      sEvtType = "" ;
      GX_FocusControl = "" ;
      AV5HttpRequest = httpContext.getHttpRequest();
      AV6WWP_DesignSystemSettings = new com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings(remoteHandle, context);
      GXt_SdtWWP_DesignSystemSettings1 = new com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings(remoteHandle, context);
      GXv_SdtWWP_DesignSystemSettings2 = new com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings[1] ;
   ...
   private java.util.Date AV7PickerDummyVariable ;
   ...
   private com.genexus.internet.HttpRequest AV5HttpRequest ;
   ...
   private com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings AV6WWP_DesignSystemSettings ;
   private com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings GXt_SdtWWP_DesignSystemSettings1 ;
   private com.mujermorena.wwpbaseobjects.SdtWWP_DesignSystemSettings GXv_SdtWWP_DesignSystemSettings2[] ;
}
