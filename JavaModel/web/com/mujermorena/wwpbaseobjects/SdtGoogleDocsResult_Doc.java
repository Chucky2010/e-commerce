...
public final  class SdtGoogleDocsResult_Doc extends GxUserType
{
   ...
   {
      gxTv_SdtGoogleDocsResult_Doc_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtGoogleDocsResult_Doc_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtGoogleDocsResult_Doc_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtGoogleDocsResult_Doc)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult_Doc struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult_Doc getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult_Doc struct = new com.mujermorena.wwpbaseobjects.StructSdtGoogleDocsResult_Doc ();
   ...
   protected byte gxTv_SdtGoogleDocsResult_Doc_N ;
