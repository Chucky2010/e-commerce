...
public final  class SdtDVB_SDTDropDownOptionsTitleSettingsIcons extends GxUserType
{
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons struct = new com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons ();
