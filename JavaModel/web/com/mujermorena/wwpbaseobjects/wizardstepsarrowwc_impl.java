...
public final  class wizardstepsarrowwc_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Wizard Steps Arrow WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.mujermorena.wwpbaseobjects.wizardstepsarrowwc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV11SelectedStep))}, new String[] {"WizardSteps","SelectedStep"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPREVIOUSSELECTED", getSecureSignedToken( sPrefix, AV9PreviousSelected));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV5FirstIsDummy));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV6LastIsDummy));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSECONDISDUMMY", getSecureSignedToken( sPrefix, AV10SecondIsDummy));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV8PenultimateIsDummy));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_Wizardstepsaux", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV11SelectedStep", wcpOAV11SelectedStep);
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEP", AV11SelectedStep);
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPREVIOUSSELECTED", AV9PreviousSelected);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPREVIOUSSELECTED", getSecureSignedToken( sPrefix, AV9PreviousSelected));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV14StepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vFIRSTISDUMMY", AV5FirstIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV5FirstIsDummy));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vLASTISDUMMY", AV6LastIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV6LastIsDummy));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vSECONDISDUMMY", AV10SecondIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSECONDISDUMMY", getSecureSignedToken( sPrefix, AV10SecondIsDummy));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPENULTIMATEISDUMMY", AV8PenultimateIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV8PenultimateIsDummy));
   }

   public void renderHtmlCloseForm2B2( )
   {
   ...
   {
      return httpContext.getMessage( "Wizard Steps Arrow WC", "") ;
   }
   ...
   public void wb2B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.wwpbaseobjects.wizardstepsarrowwc");
         }
   ...
   public void start2B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Wizard Steps Arrow WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV24GXV1 = nGXsfl_5_idx ;
                           if ( ( AV19WizardStepsAux.size() >= AV24GXV1 ) && ( AV24GXV1 > 0 ) )
                           {
                              AV19WizardStepsAux.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV24GXV1)) );
                           }
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
   ...
   public void gxgrgridwizardsteps_refresh( short AV15StepRealNumber ,
                                            GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV19WizardStepsAux ,
   ...
   public void send_integrity_lvl_hashes2B2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPREALNUMBER", GXutil.ltrim( localUtil.ntoc( AV15StepRealNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepRealNumber), "ZZZ9")));
      if ( httpContext.isAjaxRequest( ) )
   ...
   public void strup2B0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( sPrefix+"Wizardstepsaux"), AV19WizardStepsAux);
         /* Read saved values. */
   ...
   public void e112B2( )
   {
      ...
      if ( AV19WizardStepsAux.size() > AV7MaxStepsToShow )
      {
         ...
         AV26GXV3 = 1 ;
         while ( AV26GXV3 <= AV19WizardStepsAux.size() )
         {
            AV17WizardStep = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV26GXV3));
         ...
         if ( ( AV12SelectedStepIndex + 1 > ( AV7MaxStepsToShow ) / (double) ( 2 ) ) )
         {
            AV13StartIndex = (short)(AV12SelectedStepIndex+1-(AV7MaxStepsToShow)/ (double) (2)) ;
   ...
   private void e122B2( )
   {
      ...
      returnInSub = false ;
      AV24GXV1 = 1 ;
      while ( AV24GXV1 <= AV19WizardStepsAux.size() )
      {
         AV19WizardStepsAux.currentItem( ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV24GXV1)) );
         ...
         if ( GXutil.strcmp(((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.currentItem())).getgxTv_SdtWizardSteps_WizardStepsItem_Code(), AV11SelectedStep) == 0 )
         {
   ...
   public void wb_table1_2_2B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblTablemain_Internalname, tblTablemain_Internalname, "", "TableWizardStepsArrow", 0, "", "", 1, 2, sStyleString, "", "", 0);
   ...
   public void wcparametersset( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11SelectedStep_PARM", AV11SelectedStep);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV11SelectedStep)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11SelectedStep_CTRL", GXutil.rtrim( sCtrlAV11SelectedStep));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211164191", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?20241211164192", false, true);
      }
   ...
   public void sendrow_52( )
   {
      ...
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divLayout_tblstep_Internalname+"_"+sGXsfl_5_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","Section","left","top","","","div"});
      /* Div Control */
      ...
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divTblstep_Internalname+"_"+sGXsfl_5_idx,Integer.valueOf(divTblstep_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px",divTblstep_Class,"left","top","","","div"});
      /* Div Control */
      ...
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12 StepNumberCell","left","top","","","div"});
      /* Text block */
   ...
   public void initialize( )
   {
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      AV17WizardStep = new com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV17WizardStep ;
}
