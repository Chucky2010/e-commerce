...
public final  class managefilters_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14UserKey, ""))));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim(AV14UserKey))}, new String[] {"UserKey"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_15", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_15, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vUSERKEY", AV14UserKey);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14UserKey, ""))));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage, (byte)(15), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nEOF", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nEOF, (byte)(1), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_Rows", GXutil.ltrim( localUtil.ntoc( subGridgridstatecollections_Rows, (byte)(6), (byte)(0), ".", "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_EMPOWERER_Gridinternalname", GXutil.rtrim( Gridgridstatecollections_empowerer_Gridinternalname));
   }
   ...
   {
      return formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim(AV14UserKey))}, new String[] {"UserKey"})  ;
   }
   ...
   {
      return httpContext.getMessage( "WWP_ManageFiltersDescription", "") ;
   }
   ...
   public void wb2D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 PopupContentCell", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divTablecontent_Internalname, 1, 0, "px", 0, "px", "TableContent", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 EditableGridCell_LinedAtts HasGridEmpowerer", "left", "top", "", "", "div");
         /*  Grid Control  */
      ...
      if ( wbEnd == 15 )
      {
         ...
         else
         {
            ...
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GridgridstatecollectionsContainerData", GridgridstatecollectionsContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GridgridstatecollectionsContainerData"+"V", GridgridstatecollectionsContainer.GridValuesHidden());
            }
            else
            {
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-action-group ActionGroupRight", "left", "top", " "+"data-gx-actiongroup-type=\"toolbar\""+" ", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'',false,'',0)\"" ;
         ClassString = "ButtonMaterial" ;
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtnenter_Internalname, "gx.evt.setGridEvt("+GXutil.str( 15, 2, 0)+","+"null"+");", httpContext.getMessage( "WWP_SaveButtonCaption", ""), bttBtnenter_Jsonclick, 5, httpContext.getMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\ManageFilters.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, divHtml_usertable_utpaneldummy_Internalname, 1, 0, "px", 0, "px", "Section", "left", "top", "", "", "div");
         wb_table1_31_2D2( true) ;
      }
      else
      {
         wb_table1_31_2D2( false) ;
      }
      return  ;
   }

   public void wb_table1_31_2D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_checkbox_ctrl( httpContext, chkavCollectionisempty.getInternalname(), GXutil.booltostr( AV5CollectionIsEmpty), "", "", chkavCollectionisempty.getVisible(), 1, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(39, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,39);\"");
   ...
   public void start2D2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "WWP_ManageFiltersDescription", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 29), "GRIDGRIDSTATECOLLECTIONS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "VUDELETE.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "VUDELETE.CLICK") == 0 ) )
                        {
                           ...
                           if ( ( AV6GridStateCollection.size() >= AV19GXV1 ) && ( AV19GXV1 > 0 ) )
                           {
                              AV6GridStateCollection.currentItem( ((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)) );
   ...
   public int subgridgridstatecollections_fnc_pagecount( )
   {
      ...
      {
         return (int)(GXutil.Int( GRIDGRIDSTATECOLLECTIONS_nRecordCount/ (double) (subgridgridstatecollections_fnc_recordsperpage( )))) ;
      }
      return (int)(GXutil.Int( GRIDGRIDSTATECOLLECTIONS_nRecordCount/ (double) (subgridgridstatecollections_fnc_recordsperpage( )))+1) ;
   }
   ...
   {
      return (int)(GXutil.Int( GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage/ (double) (subgridgridstatecollections_fnc_recordsperpage( )))+1) ;
   }

   public short subgridgridstatecollections_firstpage( )
   {
      GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage = 0 ;
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
      if ( isFullAjaxMode( ) )
      {
         gxgrgridgridstatecollections_refresh( subGridgridstatecollections_Rows, AV14UserKey, AV5CollectionIsEmpty) ;
      }
   ...
   public void strup2D0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "Gridstatecollection"), AV6GridStateCollection);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vGRIDSTATECOLLECTION"), AV6GridStateCollection);
         /* Read saved values. */
         ...
         GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage = localUtil.ctol( httpContext.cgiGet( "GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         GRIDGRIDSTATECOLLECTIONS_nEOF = (byte)(localUtil.ctol( httpContext.cgiGet( "GRIDGRIDSTATECOLLECTIONS_nEOF"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         subGridgridstatecollections_Rows = (int)(localUtil.ctol( httpContext.cgiGet( "GRIDGRIDSTATECOLLECTIONS_Rows"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_Rows", GXutil.ltrim( localUtil.ntoc( subGridgridstatecollections_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e122D2( )
   {
      ...
      {
         AV6GridStateCollection.fromxml(new com.mujermorena.wwpbaseobjects.loadmanagefiltersstate(remoteHandle, context).executeUdp( AV14UserKey), null, null);
         gx_BV15 = true ;
      }
   }
   ...
   private void e132D2( )
   {
      ...
      returnInSub = false ;
      AV19GXV1 = 1 ;
      while ( AV19GXV1 <= AV6GridStateCollection.size() )
      {
         AV6GridStateCollection.currentItem( ((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)) );
         ...
         {
            sendrow_152( ) ;
            GRIDGRIDSTATECOLLECTIONS_nEOF = (byte)(0) ;
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nEOF", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nEOF, (byte)(1), (byte)(0), ".", "")));
            if ( GRIDGRIDSTATECOLLECTIONS_nCurrentRecord + 1 >= subgridgridstatecollections_fnc_recordcount( ) )
            {
               GRIDGRIDSTATECOLLECTIONS_nEOF = (byte)(1) ;
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nEOF", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nEOF, (byte)(1), (byte)(0), ".", "")));
            }
         }
   ...
   public void e142D2( )
   {
      ...
      {
         edtavGridstatecollection__title_Title = httpContext.getMessage( "Bookmark", "") ;
         ...
         Form.setCaption( httpContext.getMessage( "Bookmark Manager", "") );
   ...
   {
      AV19GXV1 = (int)(nGXsfl_15_idx+GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage) ;
      if ( ( AV19GXV1 > 0 ) && ( AV6GridStateCollection.size() >= AV19GXV1 ) )
      {
         AV6GridStateCollection.currentItem( ((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)) );
      }
      /* Enter Routine */
      ...
      AV10IsOK = true ;
      AV22GXV4 = 1 ;
      while ( AV22GXV4 <= AV6GridStateCollection.size() )
      {
         AV7GridStateCollectionItem = (com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV22GXV4));
         if ( (GXutil.strcmp("", AV7GridStateCollectionItem.getgxTv_SdtGridStateCollection_Item_Title())==0) )
         {
            httpContext.GX_msglist.addItem(httpContext.getMessage( "Empty", ""));
            AV10IsOK = false ;
            if (true) break;
         }
      ...
      if ( AV10IsOK )
      {
         ...
         {
            AV6GridStateCollection = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item>(com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item.class, "Item", "", remoteHandle) ;
            gx_BV15 = true ;
         }
         new com.mujermorena.wwpbaseobjects.savemanagefiltersstate(remoteHandle, context).execute( AV14UserKey, AV6GridStateCollection.toxml(false, true, "Items", "")) ;
         if ( GXutil.strcmp(GXutil.lower( AV14UserKey), "appbookmarks") == 0 )
         {
         }
   ...
   public void e152D2( )
   {
      ...
      returnInSub = false ;
      AV9i = (short)(AV6GridStateCollection.indexof(((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.currentItem()))) ;
      if ( AV9i > 1 )
      {
         AV7GridStateCollectionItem = (com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV9i));
   ...
   public void wb_table1_31_2D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, tblUtpaneldummy_Internalname, tblUtpaneldummy_Internalname, "", "Invisible", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_31_2D2e( true) ;
      }
      else
      {
         wb_table1_31_2D2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111172331", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?202412111172331", false, true);
      httpContext.AddJavascriptSource("Shared/jquery/jquery1.9.1.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGridgridstatecollections_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgridgridstatecollections_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridgridstatecollectionsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavGridstatecollection__title_Internalname,((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)).getgxTv_SdtGridStateCollection_Item_Title(),"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavGridstatecollection__title_Enabled!=0)&&(edtavGridstatecollection__title_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,18);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavGridstatecollection__title_Jsonclick,Integer.valueOf(0),edtavGridstatecollection__title_Class,"",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(1),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridgridstatecollectionsContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtavGridstatecollection__gridstatexml_Visible==0) ? "display:none;" : "")+"\">") ;
         }
         /* Single line edit */
         ...
         GridgridstatecollectionsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavGridstatecollection__gridstatexml_Internalname,((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)).getgxTv_SdtGridStateCollection_Item_Gridstatexml(),((com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)).getgxTv_SdtGridStateCollection_Item_Gridstatexml(),TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavGridstatecollection__gridstatexml_Enabled!=0)&&(edtavGridstatecollection__gridstatexml_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,19);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavGridstatecollection__gridstatexml_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(edtavGridstatecollection__gridstatexml_Visible),Integer.valueOf(1),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridgridstatecollectionsContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void startgridcontrol15( )
   {
      if ( GridgridstatecollectionsContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subGridgridstatecollections_Internalname, subGridgridstatecollections_Internalname, "", "WorkWith", 0, "", "", 1, 2, sStyleString, "", "", 0);
         /* Subfile titles */
         httpContext.writeText( "<tr") ;
         ...
         httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrimstr( DecimalUtil.doubleToDec(30), 4, 0)+"px"+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrimstr( DecimalUtil.doubleToDec(30), 4, 0)+"px"+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+edtavGridstatecollection__title_Class+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( edtavGridstatecollection__title_Title) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+((edtavGridstatecollection__gridstatexml_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "URL", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrimstr( DecimalUtil.doubleToDec(30), 4, 0)+"px"+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridgridstatecollectionsColumn.AddObjectProperty("Value", GXutil.rtrim( AV12MoveUp));
         ...
         GridgridstatecollectionsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridgridstatecollectionsColumn.AddObjectProperty("Value", GXutil.rtrim( AV11MoveDown));
         ...
         GridgridstatecollectionsContainer.AddColumnProperties(GridgridstatecollectionsColumn);
         GridgridstatecollectionsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridgridstatecollectionsColumn.AddObjectProperty("Value", GXutil.rtrim( AV13UDelete));
   ...
   public void initialize_properties( )
   {
      ...
      edtavGridstatecollection__title_Title = httpContext.getMessage( "WWP_FiltersColumnName", "") ;
      ...
      Form.setCaption( httpContext.getMessage( "WWP_ManageFiltersDescription", "") );
      subGridgridstatecollections_Rows = 0 ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD","{handler:'e132D2',iparms:[]");
      ...
      setEventMetadata("ENTER","{handler:'e112D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'}]");
      ...
      setEventMetadata("VMOVEUP.CLICK","{handler:'e152D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
      ...
      setEventMetadata("VMOVEDOWN.CLICK","{handler:'e162D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
      ...
      setEventMetadata("VUDELETE.CLICK","{handler:'e172D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDGRIDSTATECOLLECTIONS_FIRSTPAGE","{handler:'subgridgridstatecollections_firstpage',iparms:[{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15}]");
   ...
   public void initialize( )
   {
      ...
      AV7GridStateCollectionItem = new com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item(remoteHandle, context);
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item> AV6GridStateCollection ;
   private com.mujermorena.wwpbaseobjects.SdtGridStateCollection_Item AV7GridStateCollectionItem ;
}
