...
public final  class SdtWWPTransactionContext_Attribute extends GxUserType
{
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtWWPTransactionContext_Attribute_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtWWPTransactionContext_Attribute_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtWWPTransactionContext_Attribute)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute struct = new com.mujermorena.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute ();
