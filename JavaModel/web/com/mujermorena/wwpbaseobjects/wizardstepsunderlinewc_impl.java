...
public final  class wizardstepsunderlinewc_impl extends GXWebComponent
{
   ...
   {
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV19WizardStepsAux);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Wizard Steps Underline WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.wwpbaseobjects.wizardstepsunderlinewc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV6CurrentStep))}, new String[] {"WizardSteps","CurrentStep"}) +"\">") ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV16StepRealNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV13SelectedStepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSCOUNT", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV20WizardStepsCount), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV7FirstIsDummy));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV8LastIsDummy));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV11PenultimateIsDummy));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6CurrentStep", wcpOAV6CurrentStep);
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPREALNUMBER", GXutil.ltrim( localUtil.ntoc( AV16StepRealNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV16StepRealNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV15StepNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV13SelectedStepNumber, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV13SelectedStepNumber), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vWIZARDSTEPSCOUNT", GXutil.ltrim( localUtil.ntoc( AV20WizardStepsCount, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSCOUNT", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV20WizardStepsCount), "ZZZ9")));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vFIRSTISDUMMY", AV7FirstIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV7FirstIsDummy));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vLASTISDUMMY", AV8LastIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV8LastIsDummy));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPENULTIMATEISDUMMY", AV11PenultimateIsDummy);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV11PenultimateIsDummy));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCURRENTSTEP", AV6CurrentStep);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRIDWIZARDSTEPS_Class", GXutil.rtrim( subGridwizardsteps_Class));
   }
   ...
   {
      return httpContext.getMessage( "Wizard Steps Underline WC", "") ;
   }
   ...
   public void wb2K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.wwpbaseobjects.wizardstepsunderlinewc");
         }
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 WizardStepsUnderlineContainerCell", "left", "top", "", "", "div");
         /*  Grid Control  */
      ...
      if ( wbEnd == 9 )
      {
         ...
         else
         {
            ...
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GridwizardstepsContainerData", GridwizardstepsContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GridwizardstepsContainerData"+"V", GridwizardstepsContainer.GridValuesHidden());
            }
            else
            {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardStepDescriptionUnderline", 0, "", lblWizardstepdescription_Visible, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WizardStepsUnderlineWC.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start2K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Wizard Steps Underline WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgridwizardsteps_refresh( GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV19WizardStepsAux ,
                                            ...
                                            GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardSteps ,
   ...
   public void rf2K2( )
   {
      ...
      if ( subGridwizardsteps_Islastpage != 0 )
      {
         ...
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRIDWIZARDSTEPS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( GRIDWIZARDSTEPS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
   ...
   public void e112K2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV13SelectedStepNumber), "ZZZ9")));
      AV27GXV1 = 1 ;
      while ( AV27GXV1 <= AV18WizardSteps.size() )
      {
         AV5WizardStep = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.elementAt(-1+AV27GXV1));
      ...
      if ( AV19WizardStepsAux.size() > AV9MaxStepsToShow )
      {
         ...
         if ( ( AV13SelectedStepNumber + 3 - AV9MaxStepsToShow / (double) ( 2 ) > 0 ) )
         {
            AV14StartIndex = (short)(AV13SelectedStepNumber+3-AV9MaxStepsToShow/ (double) (2)) ;
         ...
         if ( AV14StartIndex > 3 )
         {
            ...
            ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+2)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "..." );
         ...
         if ( AV19WizardStepsAux.size() > AV9MaxStepsToShow )
         {
            ...
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11PenultimateIsDummy", AV11PenultimateIsDummy);
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV11PenultimateIsDummy));
            ((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV19WizardStepsAux.size()-1)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "" );
      ...
      {
         AV21WizardStepsItem = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)new com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private void e122K2( )
   {
      ...
      returnInSub = false ;
      AV28GXV2 = 1 ;
      while ( AV28GXV2 <= AV19WizardStepsAux.size() )
      {
         AV5WizardStep = (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV28GXV2));
         ...
         if ( ! GXutil.contains( AV5WizardStep.getgxTv_SdtWizardSteps_WizardStepsItem_Code(), "DummyXS") )
         {
            ...
            else if ( ( AV15StepNumber == 2 ) && AV7FirstIsDummy )
            {
               ...
               httpContext.ajax_rsp_assign_prop(sPrefix, false, divTablestepitem_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(divTablestepitem_Visible), 5, 0), !bGXsfl_9_Refreshing);
               divTblcontainerstep_Class = divTblcontainerstep_Class+httpContext.getMessage( " TableContainerUnderlineExtraBullet", "") ;
               httpContext.ajax_rsp_assign_prop(sPrefix, false, divTblcontainerstep_Internalname, "Class", divTblcontainerstep_Class, !bGXsfl_9_Refreshing);
            }
            else
            {
         ...
         {
            lblStepnumber_Caption = "..." ;
            divTblcontainerstep_Class = divTblcontainerstep_Class+httpContext.getMessage( " TableContainerUnderlineExtraBullet hidden-sm hidden-lg hidden-md", "") ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, divTblcontainerstep_Internalname, "Class", divTblcontainerstep_Class, !bGXsfl_9_Refreshing);
   ...
   {
      AV18WizardSteps = (GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV18WizardSteps = (GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV18WizardSteps = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>() ;
      }
      else
      {
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV18WizardSteps_CTRL", GXutil.rtrim( sCtrlAV18WizardSteps));
      }
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CurrentStep_PARM", AV6CurrentStep);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6CurrentStep)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CurrentStep_CTRL", GXutil.rtrim( sCtrlAV6CurrentStep));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211164056", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepsunderlinewc.js", "?20241211164057", false, true);
      }
   ...
   public void sendrow_92( )
   {
      ...
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divTblcontainerstep_Internalname+"_"+sGXsfl_9_idx,Integer.valueOf(divTblcontainerstep_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px",divTblcontainerstep_Class,"left","top"," "+"data-gx-flex"+" ","","div"});
      GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","left","top","","flex-grow:1;","div"});
      GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divTablestepitem_Internalname+"_"+sGXsfl_9_idx,Integer.valueOf(divTablestepitem_Visible),Integer.valueOf(0),"px",Integer.valueOf(0),"px",divTablestepitem_Class,"left","top","","","div"});
      GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","left","top","","","div"});
      ...
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12 StepNumberUnderlineCell","left","top","","","div"});
      GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Text block */
      ...
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","AttributeStepBulletCell hidden-xs","left","top","","flex-grow:1;","div"});
      GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Div Control */
      ...
      GridwizardstepsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {edtavWizardsteptitle_Internalname,httpContext.getMessage( "Wizard Step Title", ""),"gx-form-item AttributeStepUnderlineLabel",Integer.valueOf(0),Boolean.valueOf(true),"width: 25%;"});
      GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
      /* Multiple line edit */
   ...
   public void startgridcontrol9( )
   {
      if ( GridwizardstepsContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         com.mujermorena.GxWebStd.gx_table_start( httpContext, subGridwizardsteps_Internalname, subGridwizardsteps_Internalname, "", "FreeStyleStepsUnderline", 0, "", "", 1, 2, sStyleString, "", "", 0);
         GridwizardstepsContainer.AddObjectProperty("GridName", "Gridwizardsteps");
      }
      else
      {
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV18WizardSteps = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "Mujer_Morena", remoteHandle);
      AV6CurrentStep = "" ;
      AV19WizardStepsAux = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "Mujer_Morena", remoteHandle);
      ...
      sEvtType = "" ;
      AV22WizardStepTitle = "" ;
      AV5WizardStep = new com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
      AV21WizardStepsItem = new com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardSteps ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV19WizardStepsAux ;
   private com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV5WizardStep ;
   private com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV21WizardStepsItem ;
}
