...
public final  class SdtWizardSteps_WizardStepsItem extends GxUserType
{
   ...
   {
      gxTv_SdtWizardSteps_WizardStepsItem_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtWizardSteps_WizardStepsItem_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtWizardSteps_WizardStepsItem_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem struct = new com.mujermorena.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem ();
   ...
   protected byte gxTv_SdtWizardSteps_WizardStepsItem_N ;
