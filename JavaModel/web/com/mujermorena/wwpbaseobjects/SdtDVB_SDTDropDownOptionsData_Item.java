...
public final  class SdtDVB_SDTDropDownOptionsData_Item extends GxUserType
{
   ...
   {
      gxTv_SdtDVB_SDTDropDownOptionsData_Item_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtDVB_SDTDropDownOptionsData_Item_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtDVB_SDTDropDownOptionsData_Item_N ;
   }

   public com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item Clone( )
   {
      return (com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)(clone()) ;
   }

   public void setStruct( com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item struct )
   {
   ...
   public com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item getStruct( )
   {
      com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item struct = new com.mujermorena.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item ();
   ...
   protected byte gxTv_SdtDVB_SDTDropDownOptionsData_Item_N ;
