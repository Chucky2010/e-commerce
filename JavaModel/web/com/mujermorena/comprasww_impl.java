...
public final  class comprasww_impl extends GXDataArea
{
   public comprasww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public comprasww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( comprasww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV36IsAuthorized_Insert = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_Insert")) ;
      httpContext.setAjaxCallMode();
      if ( ! httpContext.IsValidAjaxCall( true) )
      {
         GxWebError = (byte)(1) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV21ManageFiltersExecutionStep, AV40Pgmname, AV15FilterFullText, AV13OrderedBy, AV14OrderedDsc, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV36IsAuthorized_Insert) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.comprasww", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vAGEXPORTDATA", AV34AGExportData);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vAGEXPORTDATA", AV34AGExportData);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
   ...
   {
      return formatLink("com.mujermorena.comprasww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Compras", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_ComprasWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_ComprasWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0V2( true) ;
      }
      else
      {
         wb_table1_22_0V2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0V2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A74ComprasFecha = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtComprasFecha_Internalname), 0)) ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV36IsAuthorized_Insert )
   {
      initialize_formulas( ) ;
      com.mujermorena.GxWebStd.set_html_headers( httpContext, 0, "", "");
      /* Execute user event: Refresh */
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_COMPRASID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A11ComprasId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "COMPRASID", GXutil.ltrim( localUtil.ntoc( A11ComprasId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf0V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              AV41Compraswwds_1_filterfulltext ,
         ...
         lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
         lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
         lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
         lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
         lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
         ...
         lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000V7 */
         pr_default.execute(0, new Object[] {AV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A88ComprasTotal10 = H000V7_A88ComprasTotal10[0] ;
            A86ComprasTotal5 = H000V7_A86ComprasTotal5[0] ;
            A227ComprasNumeroFactura = H000V7_A227ComprasNumeroFactura[0] ;
            A226ComprasTimbrado = H000V7_A226ComprasTimbrado[0] ;
            A10ProveedorId = H000V7_A10ProveedorId[0] ;
            A74ComprasFecha = H000V7_A74ComprasFecha[0] ;
            A11ComprasId = H000V7_A11ComprasId[0] ;
            A225ComprasTotalIva = H000V7_A225ComprasTotalIva[0] ;
            n225ComprasTotalIva = H000V7_n225ComprasTotalIva[0] ;
            A89ComprasTotalIva10 = H000V7_A89ComprasTotalIva10[0] ;
            A87ComprasTotalIva5 = H000V7_A87ComprasTotalIva5[0] ;
            A229ComprasTotal = H000V7_A229ComprasTotal[0] ;
            n229ComprasTotal = H000V7_n229ComprasTotal[0] ;
            A90ComprasTotalExento = H000V7_A90ComprasTotalExento[0] ;
            A88ComprasTotal10 = H000V7_A88ComprasTotal10[0] ;
            A86ComprasTotal5 = H000V7_A86ComprasTotal5[0] ;
            A225ComprasTotalIva = H000V7_A225ComprasTotalIva[0] ;
            n225ComprasTotalIva = H000V7_n225ComprasTotalIva[0] ;
   ...
   public void send_integrity_lvl_hashes0V2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_COMPRASID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A11ComprasId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV41Compraswwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
      lV41Compraswwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV41Compraswwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000V13 */
      pr_default.execute(1, new Object[] {AV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext, lV41Compraswwds_1_filterfulltext});
      GRID_nRecordCount = H000V13_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup0V0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vAGEXPORTDATA"), AV34AGExportData);
   ...
   public void e170V2( )
   {
      ...
      AV34AGExportData = new GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle) ;
      AV35AGExportDataItem = (com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(remoteHandle, context);
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Title( httpContext.getMessage( "WWP_ExportCaption", "") );
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Fonticon( "fas fa-file-excel" );
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Eventkey( "Export" );
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV34AGExportData.add(AV35AGExportDataItem, 0);
      AV35AGExportDataItem = (com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(remoteHandle, context);
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Title( httpContext.getMessage( "WWP_ExportReportCaption", "") );
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Fonticon( "fas fa-file-pdf" );
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Eventkey( "ExportReport" );
      AV35AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV34AGExportData.add(AV35AGExportDataItem, 0);
   ...
   public void e180V2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV40Pgmname, GXv_char5) ;
      comprasww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e190V2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.comprasview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A11ComprasId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"ComprasId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.compras", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A11ComprasId,11,0))}, new String[] {"Mode","ComprasId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.compras", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A11ComprasId,11,0))}, new String[] {"Mode","ComprasId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e110V2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ComprasWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV40Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ComprasWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ComprasWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         comprasww_impl.this.GXt_char4 = GXv_char5[0] ;
         ...
         else
         {
            ...
            S172 ();
            if (returnInSub) return;
            new com.mujermorena.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV40Pgmname+"GridState", AV20ManageFiltersXml) ;
   ...
   public void e160V2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.compras", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","ComprasId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "comprasview_Execute", GXv_boolean7) ;
      comprasww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "compras_Update", GXv_boolean7) ;
      comprasww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "compras_Delete", GXv_boolean7) ;
      comprasww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXt_boolean6 = AV36IsAuthorized_Insert ;
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "compras_Insert", GXv_boolean7) ;
      comprasww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      AV36IsAuthorized_Insert = GXt_boolean6 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV36IsAuthorized_Insert", AV36IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV36IsAuthorized_Insert));
      if ( ! ( AV36IsAuthorized_Insert ) )
      {
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ComprasWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S132( )
   {
      ...
      {
         AV11GridState.fromxml(AV18Session.getValue(AV40Pgmname+"GridState"), null, null);
      }
      AV13OrderedBy = AV11GridState.getgxTv_SdtWWPGridState_Orderedby() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13OrderedBy", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13OrderedBy), 4, 0));
      AV14OrderedDsc = AV11GridState.getgxTv_SdtWWPGridState_Ordereddsc() ;
   ...
   public void S182( )
   {
      ...
      returnInSub = false ;
      AV42GXV1 = 1 ;
      while ( AV42GXV1 <= AV11GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV12GridStateFilterValue = (com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV42GXV1));
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Compras" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.compraswwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      comprasww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      comprasww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.compraswwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0V2( true) ;
      }
      else
      {
         wb_table2_27_0V2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0V2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0V2e( true) ;
      }
      else
      {
         wb_table1_22_0V2e( false) ;
      }
   }

   public void wb_table2_27_0V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111144298", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("comprasww.js", "?202412111144298", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtComprasId_Internalname = "COMPRASID_"+sGXsfl_40_idx ;
      edtComprasFecha_Internalname = "COMPRASFECHA_"+sGXsfl_40_idx ;
      edtProveedorId_Internalname = "PROVEEDORID_"+sGXsfl_40_idx ;
      edtComprasTimbrado_Internalname = "COMPRASTIMBRADO_"+sGXsfl_40_idx ;
      edtComprasNumeroFactura_Internalname = "COMPRASNUMEROFACTURA_"+sGXsfl_40_idx ;
      edtComprasTotalExento_Internalname = "COMPRASTOTALEXENTO_"+sGXsfl_40_idx ;
      edtComprasTotalIva5_Internalname = "COMPRASTOTALIVA5_"+sGXsfl_40_idx ;
      edtComprasTotalIva10_Internalname = "COMPRASTOTALIVA10_"+sGXsfl_40_idx ;
      edtComprasTotal_Internalname = "COMPRASTOTAL_"+sGXsfl_40_idx ;
      edtComprasTotal5_Internalname = "COMPRASTOTAL5_"+sGXsfl_40_idx ;
      edtComprasTotal10_Internalname = "COMPRASTOTAL10_"+sGXsfl_40_idx ;
      edtComprasTotalIva_Internalname = "COMPRASTOTALIVA_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtComprasId_Internalname = "COMPRASID_"+sGXsfl_40_fel_idx ;
      edtComprasFecha_Internalname = "COMPRASFECHA_"+sGXsfl_40_fel_idx ;
      edtProveedorId_Internalname = "PROVEEDORID_"+sGXsfl_40_fel_idx ;
      edtComprasTimbrado_Internalname = "COMPRASTIMBRADO_"+sGXsfl_40_fel_idx ;
      edtComprasNumeroFactura_Internalname = "COMPRASNUMEROFACTURA_"+sGXsfl_40_fel_idx ;
      edtComprasTotalExento_Internalname = "COMPRASTOTALEXENTO_"+sGXsfl_40_fel_idx ;
      edtComprasTotalIva5_Internalname = "COMPRASTOTALIVA5_"+sGXsfl_40_fel_idx ;
      edtComprasTotalIva10_Internalname = "COMPRASTOTALIVA10_"+sGXsfl_40_fel_idx ;
      edtComprasTotal_Internalname = "COMPRASTOTAL_"+sGXsfl_40_fel_idx ;
      edtComprasTotal5_Internalname = "COMPRASTOTAL5_"+sGXsfl_40_fel_idx ;
      edtComprasTotal10_Internalname = "COMPRASTOTAL10_"+sGXsfl_40_fel_idx ;
      edtComprasTotalIva_Internalname = "COMPRASTOTALIVA_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasId_Internalname,GXutil.ltrim( localUtil.ntoc( A11ComprasId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A11ComprasId), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasId_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasFecha_Internalname,localUtil.format(A74ComprasFecha, "99/99/99"),localUtil.format( A74ComprasFecha, "99/99/99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasFecha_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Fecha","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtProveedorId_Internalname,GXutil.ltrim( localUtil.ntoc( A10ProveedorId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A10ProveedorId), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtProveedorId_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTimbrado_Internalname,GXutil.ltrim( localUtil.ntoc( A226ComprasTimbrado, (byte)(15), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A226ComprasTimbrado), "ZZZZZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTimbrado_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Timbrado","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasNumeroFactura_Internalname,GXutil.ltrim( localUtil.ntoc( A227ComprasNumeroFactura, (byte)(15), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A227ComprasNumeroFactura), "ZZZZZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasNumeroFactura_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Factura","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotalExento_Internalname,GXutil.ltrim( localUtil.ntoc( A90ComprasTotalExento, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A90ComprasTotalExento, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotalExento_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotalIva5_Internalname,GXutil.ltrim( localUtil.ntoc( A87ComprasTotalIva5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A87ComprasTotalIva5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotalIva5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotalIva10_Internalname,GXutil.ltrim( localUtil.ntoc( A89ComprasTotalIva10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A89ComprasTotalIva10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotalIva10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A229ComprasTotal, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A229ComprasTotal, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotal5_Internalname,GXutil.ltrim( localUtil.ntoc( A86ComprasTotal5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A86ComprasTotal5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotal5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotal10_Internalname,GXutil.ltrim( localUtil.ntoc( A88ComprasTotal10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A88ComprasTotal10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotal10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasTotalIva_Internalname,GXutil.ltrim( localUtil.ntoc( A225ComprasTotalIva, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A225ComprasTotalIva, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasTotalIva_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Compras Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Fecha", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Proveedor Id", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Timbrado", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A11ComprasId, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A74ComprasFecha, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A10ProveedorId, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A226ComprasTimbrado, (byte)(15), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A227ComprasNumeroFactura, (byte)(15), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A90ComprasTotalExento, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A87ComprasTotalIva5, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A89ComprasTotalIva10, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A229ComprasTotal, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A86ComprasTotal5, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A88ComprasTotal10, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A225ComprasTotalIva, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:ComprasId|4:ComprasFecha|5:ProveedorId|6:ComprasTimbrado|7:ComprasNumeroFactura" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'lblBtninsert_Visible',ctrl:'BTNINSERT',prop:'Visible'},{av:'AV19ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e120V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e130V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e150V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e190V2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A11ComprasId',fld:'COMPRASID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e110V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A11ComprasId',fld:'COMPRASID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140V2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'Innewwindow1_Height',ctrl:'INNEWWINDOW1',prop:'Height'},{av:'Innewwindow1_Width',ctrl:'INNEWWINDOW1',prop:'Width'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV36IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("VALID_COMPRASID","{handler:'valid_Comprasid',iparms:[]");
      setEventMetadata("VALID_COMPRASID",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Comprastotaliva',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV41Compraswwds_1_filterfulltext = "" ;
      AV41Compraswwds_1_filterfulltext = "" ;
      H000V7_A88ComprasTotal10 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V7_A86ComprasTotal5 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V7_A227ComprasNumeroFactura = new long[1] ;
      H000V7_A226ComprasTimbrado = new long[1] ;
      H000V7_A10ProveedorId = new long[1] ;
      H000V7_A74ComprasFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H000V7_A11ComprasId = new long[1] ;
      H000V7_A225ComprasTotalIva = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V7_n225ComprasTotalIva = new boolean[] {false} ;
      H000V7_A89ComprasTotalIva10 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V7_A87ComprasTotalIva5 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V7_A229ComprasTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V7_n229ComprasTotal = new boolean[] {false} ;
      H000V7_A90ComprasTotalExento = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000V13_AGRID_nRecordCount = new long[1] ;
      AV8HTTPRequest = httpContext.getHttpRequest();
      AV35AGExportDataItem = new com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(remoteHandle, context);
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.comprasww__default(),
         new Object[] {
             new Object[] {
            H000V7_A88ComprasTotal10, H000V7_A86ComprasTotal5, H000V7_A227ComprasNumeroFactura, H000V7_A226ComprasTimbrado, H000V7_A10ProveedorId, H000V7_A74ComprasFecha, H000V7_A11ComprasId, H000V7_A225ComprasTotalIva, H000V7_n225ComprasTotalIva, H000V7_A89ComprasTotalIva10,
            H000V7_A87ComprasTotalIva5, H000V7_A229ComprasTotal, H000V7_n229ComprasTotal, H000V7_A90ComprasTotalExento
            }
            , new Object[] {
            H000V13_AGRID_nRecordCount
            }
         }
      );
      AV40Pgmname = "ComprasWW" ;
   ...
   private boolean AV36IsAuthorized_Insert ;
   ...
   private String lV41Compraswwds_1_filterfulltext ;
   private String AV41Compraswwds_1_filterfulltext ;
   ...
   private java.math.BigDecimal[] H000V7_A88ComprasTotal10 ;
   private java.math.BigDecimal[] H000V7_A86ComprasTotal5 ;
   private long[] H000V7_A227ComprasNumeroFactura ;
   private long[] H000V7_A226ComprasTimbrado ;
   private long[] H000V7_A10ProveedorId ;
   private java.util.Date[] H000V7_A74ComprasFecha ;
   private long[] H000V7_A11ComprasId ;
   private java.math.BigDecimal[] H000V7_A225ComprasTotalIva ;
   private boolean[] H000V7_n225ComprasTotalIva ;
   private java.math.BigDecimal[] H000V7_A89ComprasTotalIva10 ;
   private java.math.BigDecimal[] H000V7_A87ComprasTotalIva5 ;
   private java.math.BigDecimal[] H000V7_A229ComprasTotal ;
   private boolean[] H000V7_n229ComprasTotal ;
   private java.math.BigDecimal[] H000V7_A90ComprasTotalExento ;
   private long[] H000V13_AGRID_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV19ManageFiltersData ;
   private GXBaseCollection<com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV34AGExportData ;
   ...
   private com.mujermorena.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item AV35AGExportDataItem ;
...
final  class comprasww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000V7( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV13OrderedBy ,
                                          boolean AV14OrderedDsc ,
                                          String AV41Compraswwds_1_filterfulltext ,
                                          long A11ComprasId ,
                                          long A10ProveedorId ,
                                          ...
                                          java.math.BigDecimal A225ComprasTotalIva )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " ROUND(CAST(COALESCE( T2.[ComprasTotalIva10], 0) AS decimal( 27, 10)) / 11, 0) AS ComprasTotal10, ROUND(CAST(COALESCE( T2.[ComprasTotalIva5], 0) AS decimal( 27," ;
      sSelectString += " 10)) / 21, 0) AS ComprasTotal5, T1.[ComprasNumeroFactura], T1.[ComprasTimbrado], T1.[ProveedorId], T1.[ComprasFecha], T1.[ComprasId], COALESCE( T3.[ComprasTotalIva]," ;
      sSelectString += " 0) AS ComprasTotalIva, COALESCE( T4.[ComprasTotalIva10], 0) AS ComprasTotalIva10, COALESCE( T4.[ComprasTotalIva5], 0) AS ComprasTotalIva5, COALESCE( T3.[ComprasTotal]," ;
      sSelectString += " 0) AS ComprasTotal, COALESCE( T4.[ComprasTotalExento], 0) AS ComprasTotalExento" ;
      sFromString = " FROM ((([Compras] T1 LEFT JOIN (SELECT SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 5 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27," ;
      sFromString += " 10)) END) AS ComprasTotalIva5, T5.[ComprasId], SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal(" ;
      sFromString += " 27, 10)) END) AS ComprasTotalIva10 FROM (([ComprasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) INNER JOIN [Impuesto] T7 ON T7.[ImpuestoId]" ;
      sFromString += " = T6.[ImpuestoId]) GROUP BY T5.[ComprasId] ) T2 ON T2.[ComprasId] = T1.[ComprasId]) INNER JOIN (SELECT COALESCE( T6.[ComprasTotalExento], 0) + COALESCE( COALESCE(" ;
      sFromString += " T6.[ComprasTotalIva5], 0), 0) + COALESCE( COALESCE( T6.[ComprasTotalIva10], 0), 0) AS ComprasTotal, T5.[ComprasId], COALESCE( T7.[ComprasTotalIva5], 0) + COALESCE(" ;
      sFromString += " T7.[ComprasTotalIva10], 0) AS ComprasTotalIva FROM (([Compras] T5 LEFT JOIN (SELECT T8.[ComprasId], SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 10 THEN T8.[ComprasCantidad]" ;
      sFromString += " * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva10, SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 5 THEN T8.[ComprasCantidad] * CAST(T8.[ComprasDetallePrecioCompra]" ;
      sFromString += " AS decimal( 27, 10)) END) AS ComprasTotalIva5, SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 0 THEN T8.[ComprasCantidad] * CAST(T8.[ComprasDetallePrecioCompra] AS decimal(" ;
      sFromString += " 27, 10)) END) AS ComprasTotalExento FROM (([ComprasDetalle] T8 INNER JOIN [Articulo] T9 ON T9.[ArticuloId] = T8.[ArticuloId]) INNER JOIN [Impuesto] T10 ON T10.[ImpuestoId]" ;
      sFromString += " = T9.[ImpuestoId]) GROUP BY T8.[ComprasId] ) T6 ON T6.[ComprasId] = T5.[ComprasId]) LEFT JOIN (SELECT SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 5 THEN T8.[ComprasCantidad]" ;
      sFromString += " * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva5, T8.[ComprasId], SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 10 THEN T8.[ComprasCantidad]" ;
      sFromString += " * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva10 FROM (([ComprasDetalle] T8 INNER JOIN [Articulo] T9 ON T9.[ArticuloId] = T8.[ArticuloId])" ;
      sFromString += " INNER JOIN [Impuesto] T10 ON T10.[ImpuestoId] = T9.[ImpuestoId]) GROUP BY T8.[ComprasId] ) T7 ON T7.[ComprasId] = T5.[ComprasId]) ) T3 ON T3.[ComprasId] = T1.[ComprasId])" ;
      sFromString += " LEFT JOIN (SELECT T5.[ComprasId], SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27, 10))" ;
      sFromString += " END) AS ComprasTotalIva10, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 5 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END)" ;
      sFromString += " AS ComprasTotalIva5, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 0 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalExento" ;
      sFromString += " FROM (([ComprasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) INNER JOIN [Impuesto] T7 ON T7.[ImpuestoId] = T6.[ImpuestoId]) GROUP BY" ;
      sFromString += " T5.[ComprasId] ) T4 ON T4.[ComprasId] = T1.[ComprasId])" ;
      sOrderString = "" ;
      ...
      {
         sOrderString += " ORDER BY T1.[ComprasId]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasFecha]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasFecha] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ProveedorId]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ProveedorId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasTimbrado]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasTimbrado] DESC" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasNumeroFactura]" ;
      }
      else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasNumeroFactura] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[ComprasId]" ;
   ...
   protected Object[] conditional_H000V13( ModelContext context ,
                                           int remoteHandle ,
                                           com.genexus.IHttpContext httpContext ,
                                           short AV13OrderedBy ,
                                           boolean AV14OrderedDsc ,
                                           ...
                                           java.math.BigDecimal A225ComprasTotalIva )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ((([Compras] T1 LEFT JOIN (SELECT SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 5 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra]" ;
      scmdbuf += " AS decimal( 27, 10)) END) AS ComprasTotalIva5, T5.[ComprasId], SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10 THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra]" ;
      scmdbuf += " AS decimal( 27, 10)) END) AS ComprasTotalIva10 FROM (([ComprasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] = T5.[ArticuloId]) INNER JOIN [Impuesto] T7" ;
      scmdbuf += " ON T7.[ImpuestoId] = T6.[ImpuestoId]) GROUP BY T5.[ComprasId] ) T2 ON T2.[ComprasId] = T1.[ComprasId]) INNER JOIN (SELECT COALESCE( T6.[ComprasTotalExento], 0)" ;
      scmdbuf += " + COALESCE( COALESCE( T6.[ComprasTotalIva5], 0), 0) + COALESCE( COALESCE( T6.[ComprasTotalIva10], 0), 0) AS ComprasTotal, T5.[ComprasId], COALESCE( T7.[ComprasTotalIva5]," ;
      scmdbuf += " 0) + COALESCE( T7.[ComprasTotalIva10], 0) AS ComprasTotalIva FROM (([Compras] T5 LEFT JOIN (SELECT T8.[ComprasId], SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 10" ;
      scmdbuf += " THEN T8.[ComprasCantidad] * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva10, SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 5 THEN" ;
      scmdbuf += " T8.[ComprasCantidad] * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva5, SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 0 THEN T8.[ComprasCantidad]" ;
      scmdbuf += " * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalExento FROM (([ComprasDetalle] T8 INNER JOIN [Articulo] T9 ON T9.[ArticuloId] =" ;
      scmdbuf += " T8.[ArticuloId]) INNER JOIN [Impuesto] T10 ON T10.[ImpuestoId] = T9.[ImpuestoId]) GROUP BY T8.[ComprasId] ) T6 ON T6.[ComprasId] = T5.[ComprasId]) LEFT JOIN (SELECT" ;
      scmdbuf += " SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 5 THEN T8.[ComprasCantidad] * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva5, T8.[ComprasId]," ;
      scmdbuf += " SUM(CASE  WHEN T10.[ImpuestoPorcentaje] = 10 THEN T8.[ComprasCantidad] * CAST(T8.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva10 FROM" ;
      scmdbuf += " (([ComprasDetalle] T8 INNER JOIN [Articulo] T9 ON T9.[ArticuloId] = T8.[ArticuloId]) INNER JOIN [Impuesto] T10 ON T10.[ImpuestoId] = T9.[ImpuestoId]) GROUP BY T8.[ComprasId]" ;
      scmdbuf += " ) T7 ON T7.[ComprasId] = T5.[ComprasId]) ) T3 ON T3.[ComprasId] = T1.[ComprasId]) LEFT JOIN (SELECT T5.[ComprasId], SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 10" ;
      scmdbuf += " THEN T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva10, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 5 THEN" ;
      scmdbuf += " T5.[ComprasCantidad] * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalIva5, SUM(CASE  WHEN T7.[ImpuestoPorcentaje] = 0 THEN T5.[ComprasCantidad]" ;
      scmdbuf += " * CAST(T5.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS ComprasTotalExento FROM (([ComprasDetalle] T5 INNER JOIN [Articulo] T6 ON T6.[ArticuloId] =" ;
      scmdbuf += " T5.[ArticuloId]) INNER JOIN [Impuesto] T7 ON T7.[ImpuestoId] = T6.[ImpuestoId]) GROUP BY T5.[ComprasId] ) T4 ON T4.[ComprasId] = T1.[ComprasId])" ;
      addWhere(sWhereString, "((? = '') or ( ( CONVERT( char(11), CAST(T1.[ComprasId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ProveedorId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(15), CAST(T1.[ComprasTimbrado] AS decimal(15,0))) like '%' + ?) or ( CONVERT( char(15), CAST(T1.[ComprasNumeroFactura] AS decimal(15,0))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[ComprasTotalExento], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[ComprasTotalIva5], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T4.[ComprasTotalIva10], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[ComprasTotal], 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(ROUND(CAST(COALESCE( T2.[ComprasTotalIva5], 0) AS decimal( 27, 10)) / 21, 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(ROUND(CAST(COALESCE( T2.[ComprasTotalIva10], 0) AS decimal( 27, 10)) / 11, 0) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(COALESCE( T3.[ComprasTotalIva], 0) AS decimal(17,2))) like '%' + ?)))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000V7(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , (java.math.BigDecimal)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , (java.math.BigDecimal)dynConstraints[11] , (java.math.BigDecimal)dynConstraints[12] , (java.math.BigDecimal)dynConstraints[13] );
            case 1 :
                  return conditional_H000V13(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , (java.math.BigDecimal)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , (java.math.BigDecimal)dynConstraints[11] , (java.math.BigDecimal)dynConstraints[12] , (java.math.BigDecimal)dynConstraints[13] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000V7", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000V13", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
