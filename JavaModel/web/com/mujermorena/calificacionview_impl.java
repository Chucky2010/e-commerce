...
public final  class calificacionview_impl extends GXDataArea
{
   public calificacionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public calificacionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( calificacionview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "CalificacionId") ;
         ...
         {
            AV10CalificacionId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10CalificacionId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CalificacionId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCALIFICACIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CalificacionId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.calificacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CalificacionId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CalificacionId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"CalificacionView");
      forbiddenHiddens.add("CalificacionNro", localUtil.format( DecimalUtil.doubleToDec(A299CalificacionNro), "ZZZ9"));
      ...
      GXutil.writeLogInfo("calificacionview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vCALIFICACIONID", GXutil.ltrim( localUtil.ntoc( AV10CalificacionId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCALIFICACIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CalificacionId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.calificacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CalificacionId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CalificacionId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Calificacion View", "") ;
   }
   ...
   public void wb6W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Calificacion :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_CalificacionView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtCalificacionNro_Internalname, httpContext.getMessage( "Calificacion Nro", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtCalificacionNro_Internalname, GXutil.ltrim( localUtil.ntoc( A299CalificacionNro, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtCalificacionNro_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(A299CalificacionNro), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(A299CalificacionNro), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCalificacionNro_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtCalificacionNro_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_CalificacionView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Calificacion", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_CalificacionView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_CalificacionView.htm");
         /* Div Control */
   ...
   public void start6W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Calificacion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf6W2( )
   {
      ...
      {
         /* Using cursor H006W2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10CalificacionId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A298CalificacionId = H006W2_A298CalificacionId[0] ;
            A299CalificacionNro = H006W2_A299CalificacionNro[0] ;
   ...
   public void strup6W0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10CalificacionId = localUtil.ctol( httpContext.cgiGet( "vCALIFICACIONID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("calificacionview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e116W2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.calificacionww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H006W3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10CalificacionId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A298CalificacionId = H006W3_A298CalificacionId[0] ;
         A299CalificacionNro = H006W3_A299CalificacionNro[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A299CalificacionNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(A299CalificacionNro), 4, 0));
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( GXutil.str( A299CalificacionNro, 4, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "CalificacionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.calificaciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "CalificacionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10CalificacionId)});
   ...
   {
      AV10CalificacionId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10CalificacionId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CalificacionId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCALIFICACIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CalificacionId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111231011", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("calificacionview.js", "?202412111231011", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Calificacion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CalificacionId',fld:'vCALIFICACIONID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A299CalificacionNro',fld:'CALIFICACIONNRO',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H006W2_A298CalificacionId = new long[1] ;
      H006W2_A299CalificacionNro = new short[1] ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H006W3_A298CalificacionId = new long[1] ;
      H006W3_A299CalificacionNro = new short[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.calificacionview__default(),
         new Object[] {
             new Object[] {
            H006W2_A298CalificacionId, H006W2_A299CalificacionNro
            }
            , new Object[] {
            H006W3_A298CalificacionId, H006W3_A299CalificacionNro
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10CalificacionId ;
   private long AV10CalificacionId ;
   ...
   private long[] H006W2_A298CalificacionId ;
   private short[] H006W2_A299CalificacionNro ;
   private long[] H006W3_A298CalificacionId ;
   private short[] H006W3_A299CalificacionNro ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class calificacionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H006W2", "SELECT [CalificacionId], [CalificacionNro] FROM [Calificacion] WHERE [CalificacionId] = ? ORDER BY [CalificacionId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H006W3", "SELECT [CalificacionId], [CalificacionNro] FROM [Calificacion] WHERE [CalificacionId] = ? ORDER BY [CalificacionId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
