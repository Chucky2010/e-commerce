...
public final  class prcinsertarcalificacionsd extends GXProcedure
{
   public prcinsertarcalificacionsd( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( prcinsertarcalificacionsd.class ), "" );
   }
   ...
   {
      prcinsertarcalificacionsd.this.aP1 = new String[] {""};
      execute_int(aP0, aP1);
      return aP1[0];
   }
   ...
   private void execute_int( short[] aP0 ,
                             String[] aP1 )
   {
      prcinsertarcalificacionsd.this.AV9Calificacion = aP0[0];
      this.aP0 = aP0;
      prcinsertarcalificacionsd.this.AV10Comentario = aP1[0];
      this.aP1 = aP1;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      prcinsertarcalificacionsd.this.GXt_int1 = GXv_int2[0] ;
   ...
   {
      this.aP0[0] = prcinsertarcalificacionsd.this.AV9Calificacion;
      this.aP1[0] = prcinsertarcalificacionsd.this.AV10Comentario;
      Application.commitDataStores(context, remoteHandle, pr_default, "prcinsertarcalificacionsd");
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.prcinsertarcalificacionsd__default(),
         new Object[] {
             new Object[] {
            }
         }
...
final  class prcinsertarcalificacionsd__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new UpdateCursor("P007O2", "INSERT INTO [Calificacion]([CalificacionId], [CalificacionNro], [CalificacionDesc], [CalificacionUsuario], [CalificacionFechaHora]) VALUES(?, ?, ?, ?, ?)", GX_NOMASK + GX_MASKLOOPLOCK)
      };
   }
