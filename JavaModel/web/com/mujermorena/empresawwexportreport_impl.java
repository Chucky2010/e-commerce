...
public final  class empresawwexportreport_impl extends GXWebReport
{
   public empresawwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "empresaww_Execute", GXv_boolean2) ;
         empresawwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Empresa", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Direccion", ""), 257, Gx_line+10, 405, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Ruc", ""), 409, Gx_line+10, 483, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Email", ""), 487, Gx_line+10, 635, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Telefono", ""), 639, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Empresawwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Empresawwds_1_filterfulltext ,
      ...
      lV35Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Empresawwds_1_filterfulltext), "%", "") ;
      lV35Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Empresawwds_1_filterfulltext), "%", "") ;
      lV35Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Empresawwds_1_filterfulltext), "%", "") ;
      lV35Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Empresawwds_1_filterfulltext), "%", "") ;
      lV35Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Empresawwds_1_filterfulltext), "%", "") ;
      lV35Empresawwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Empresawwds_1_filterfulltext), "%", "") ;
      /* Using cursor P004V2 */
      pr_default.execute(0, new Object[] {lV35Empresawwds_1_filterfulltext, lV35Empresawwds_1_filterfulltext, lV35Empresawwds_1_filterfulltext, lV35Empresawwds_1_filterfulltext, lV35Empresawwds_1_filterfulltext, lV35Empresawwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A28EmpresaId = P004V2_A28EmpresaId[0] ;
         A129EmpresaTelefono = P004V2_A129EmpresaTelefono[0] ;
         A124EmpresaEmail = P004V2_A124EmpresaEmail[0] ;
         A123EmpresaRuc = P004V2_A123EmpresaRuc[0] ;
         A122EmpresaDireccion = P004V2_A122EmpresaDireccion[0] ;
         A121EmpresaNombre = P004V2_A121EmpresaNombre[0] ;
         ...
         h4V0( false, 66) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A28EmpresaId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 103, Gx_line+55, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A121EmpresaNombre, "")), 107, Gx_line+10, 253, Gx_line+55, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A122EmpresaDireccion, "")), 257, Gx_line+10, 405, Gx_line+55, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A123EmpresaRuc, "")), 409, Gx_line+10, 483, Gx_line+55, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A124EmpresaEmail, "")), 487, Gx_line+10, 635, Gx_line+55, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A129EmpresaTelefono, "")), 639, Gx_line+10, 787, Gx_line+55, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("EmpresaWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "EmpresaWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("EmpresaWWGridState"), null, null);
      }
   ...
   public void h4V0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Empresawwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Empresawwds_1_filterfulltext = "" ;
      P004V2_A28EmpresaId = new long[1] ;
      P004V2_A129EmpresaTelefono = new String[] {""} ;
      P004V2_A124EmpresaEmail = new String[] {""} ;
      P004V2_A123EmpresaRuc = new String[] {""} ;
      P004V2_A122EmpresaDireccion = new String[] {""} ;
      P004V2_A121EmpresaNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.empresawwexportreport__default(),
         new Object[] {
             new Object[] {
            P004V2_A28EmpresaId, P004V2_A129EmpresaTelefono, P004V2_A124EmpresaEmail, P004V2_A123EmpresaRuc, P004V2_A122EmpresaDireccion, P004V2_A121EmpresaNombre
            }
         }
      );
   ...
   private String AV35Empresawwds_1_filterfulltext ;
   private String lV35Empresawwds_1_filterfulltext ;
   ...
   private long[] P004V2_A28EmpresaId ;
   private String[] P004V2_A129EmpresaTelefono ;
   private String[] P004V2_A124EmpresaEmail ;
   private String[] P004V2_A123EmpresaRuc ;
   private String[] P004V2_A122EmpresaDireccion ;
   private String[] P004V2_A121EmpresaNombre ;
...
final  class empresawwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P004V2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Empresawwds_1_filterfulltext ,
                                          long A28EmpresaId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Empresawwds_1_filterfulltext)==0) )
      {
