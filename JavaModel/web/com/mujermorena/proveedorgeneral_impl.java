...
public final  class proveedorgeneral_impl extends GXWebComponent
{
   public proveedorgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public proveedorgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( proveedorgeneral_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(A10ProveedorId)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Proveedor General", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.proveedorgeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A10ProveedorId,11,0))}, new String[] {"ProveedorId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA10ProveedorId", GXutil.ltrim( localUtil.ntoc( wcpOA10ProveedorId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return httpContext.getMessage( "Proveedor General", "") ;
   }
   ...
   public void wb4E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.proveedorgeneral");
         }
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtPersonaNombreCompleto_Internalname, GXutil.rtrim( A59PersonaNombreCompleto), GXutil.rtrim( localUtil.format( A59PersonaNombreCompleto, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPersonaNombreCompleto_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPersonaNombreCompleto_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Nombre", "left", true, "", "HLP_ProveedorGeneral.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_html_textarea( httpContext, edtPersonaDireccion_Internalname, A57PersonaDireccion, "", "", (short)(0), 1, edtPersonaDireccion_Enabled, 0, 80, "chr", 4, "row", (byte)(0), StyleString, ClassString, "", "", "256", -1, 0, "", "", (byte)(-1), true, "Direccion", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_ProveedorGeneral.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtPersonaTelefono_Internalname, GXutil.rtrim( A66PersonaTelefono), GXutil.rtrim( localUtil.format( A66PersonaTelefono, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPersonaTelefono_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPersonaTelefono_Enabled, 0, "text", "", 25, "chr", 1, "row", 25, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Telefono", "left", true, "", "HLP_ProveedorGeneral.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e114e1_client"+"'", TempTags, "", 2, "HLP_ProveedorGeneral.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.mujermorena.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e124e1_client"+"'", TempTags, "", 2, "HLP_ProveedorGeneral.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4E2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Proveedor General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes4E2( )
   {
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( sPrefix, AV12IsAuthorized_Update));
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
   ...
   public void strup4E0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         wcpOA10ProveedorId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA10ProveedorId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   protected void e144E2( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "proveedor_Update", GXv_boolean3) ;
      proveedorgeneral_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
      ...
      GXv_boolean3[0] = GXt_boolean2 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "proveedor_Delete", GXv_boolean3) ;
      proveedorgeneral_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Proveedor" );
   ...
   {
      A10ProveedorId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A10ProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A10ProveedorId), 11, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA10ProveedorId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "proveedorgeneral", GetJustCreated( ));
      ...
      {
         A10ProveedorId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A10ProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A10ProveedorId), 11, 0));
      }
      wcpOA10ProveedorId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA10ProveedorId"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( A10ProveedorId != wcpOA10ProveedorId ) ) )
      {
         setjustcreated();
      }
      wcpOA10ProveedorId = A10ProveedorId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlA10ProveedorId = httpContext.cgiGet( sPrefix+"A10ProveedorId_CTRL") ;
      if ( GXutil.len( sCtrlA10ProveedorId) > 0 )
      {
         A10ProveedorId = localUtil.ctol( httpContext.cgiGet( sCtrlA10ProveedorId), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A10ProveedorId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A10ProveedorId), 11, 0));
      }
      else
      {
         A10ProveedorId = localUtil.ctol( httpContext.cgiGet( sPrefix+"A10ProveedorId_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A10ProveedorId_PARM", GXutil.ltrim( localUtil.ntoc( A10ProveedorId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlA10ProveedorId)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A10ProveedorId_CTRL", GXutil.rtrim( sCtrlA10ProveedorId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211191013", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("proveedorgeneral.js", "?20241211191013", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A10ProveedorId',fld:'PROVEEDORID',pic:'ZZZZZZZZZZ9'},{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e114E1',iparms:[{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A10ProveedorId',fld:'PROVEEDORID',pic:'ZZZZZZZZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[{ctrl:'BTNUPDATE',prop:'Visible'}]}");
      setEventMetadata("'DODELETE'","{handler:'e124E1',iparms:[{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A10ProveedorId',fld:'PROVEEDORID',pic:'ZZZZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H004E2_A10ProveedorId = new long[1] ;
      H004E2_A66PersonaTelefono = new String[] {""} ;
      H004E2_A57PersonaDireccion = new String[] {""} ;
      H004E2_A1PersonaId = new long[1] ;
      H004E2_A56PersonaApellido = new String[] {""} ;
      H004E2_A55PersonaNombre = new String[] {""} ;
      ...
      sCtrlA10ProveedorId = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.proveedorgeneral__default(),
         new Object[] {
             new Object[] {
            H004E2_A10ProveedorId, H004E2_A66PersonaTelefono, H004E2_A57PersonaDireccion, H004E2_A1PersonaId, H004E2_A56PersonaApellido, H004E2_A55PersonaNombre
            }
         }
      );
      AV17Pgmname = "ProveedorGeneral" ;
   ...
   private int idxLst ;
   private long wcpOA10ProveedorId ;
   ...
   private String sCtrlA10ProveedorId ;
   ...
   private long[] H004E2_A10ProveedorId ;
   private String[] H004E2_A66PersonaTelefono ;
   private String[] H004E2_A57PersonaDireccion ;
   private long[] H004E2_A1PersonaId ;
   private String[] H004E2_A56PersonaApellido ;
   private String[] H004E2_A55PersonaNombre ;
...
final  class proveedorgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004E2", "SELECT T1.[ProveedorId], T2.[PersonaTelefono], T2.[PersonaDireccion], T1.[PersonaId], T2.[PersonaApellido], T2.[PersonaNombre] FROM ([Proveedor] T1 INNER JOIN [Persona] T2 ON T2.[PersonaId] = T1.[PersonaId]) WHERE T1.[ProveedorId] = ? ORDER BY T1.[ProveedorId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
