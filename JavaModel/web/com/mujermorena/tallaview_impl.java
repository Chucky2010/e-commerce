...
public final  class tallaview_impl extends GXDataArea
{
   public tallaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tallaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tallaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10TallaID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TallaID), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTALLAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TallaID), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tallaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TallaID,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TallaID","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"TallaView");
      forbiddenHiddens.add("TallaNombre", GXutil.rtrim( localUtil.format( A287TallaNombre, "")));
      ...
      GXutil.writeLogInfo("tallaview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vTALLAID", GXutil.ltrim( localUtil.ntoc( AV10TallaID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTALLAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TallaID), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.tallaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TallaID,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TallaID","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Talla View", "") ;
   }
   ...
   public void wb6J0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Talla :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_TallaView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtTallaNombre_Internalname, httpContext.getMessage( "Talla Nombre", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtTallaNombre_Internalname, GXutil.rtrim( A287TallaNombre), GXutil.rtrim( localUtil.format( A287TallaNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTallaNombre_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtTallaNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Nombre", "left", true, "", "HLP_TallaView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Talla", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_TallaView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TallaView.htm");
         /* Div Control */
   ...
   public void start6J2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Talla View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf6J2( )
   {
      ...
      {
         /* Using cursor H006J2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10TallaID)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A286TallaID = H006J2_A286TallaID[0] ;
            A287TallaNombre = H006J2_A287TallaNombre[0] ;
   ...
   public void strup6J0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10TallaID = localUtil.ctol( httpContext.cgiGet( "vTALLAID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("tallaview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e116J2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.tallaww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H006J3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10TallaID)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A286TallaID = H006J3_A286TallaID[0] ;
         A287TallaNombre = H006J3_A287TallaNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A287TallaNombre", A287TallaNombre);
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A287TallaNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TallaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.tallageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TallaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10TallaID)});
   ...
   {
      AV10TallaID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TallaID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TallaID), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTALLAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TallaID), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111225888", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tallaview.js", "?202412111225888", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Talla View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TallaID',fld:'vTALLAID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A287TallaNombre',fld:'TALLANOMBRE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H006J2_A286TallaID = new long[1] ;
      H006J2_A287TallaNombre = new String[] {""} ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H006J3_A286TallaID = new long[1] ;
      H006J3_A287TallaNombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tallaview__default(),
         new Object[] {
             new Object[] {
            H006J2_A286TallaID, H006J2_A287TallaNombre
            }
            , new Object[] {
            H006J3_A286TallaID, H006J3_A287TallaNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10TallaID ;
   private long AV10TallaID ;
   ...
   private long[] H006J2_A286TallaID ;
   private String[] H006J2_A287TallaNombre ;
   private long[] H006J3_A286TallaID ;
   private String[] H006J3_A287TallaNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tallaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H006J2", "SELECT [TallaID], [TallaNombre] FROM [Talla] WHERE [TallaID] = ? ORDER BY [TallaID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H006J3", "SELECT [TallaID], [TallaNombre] FROM [Talla] WHERE [TallaID] = ? ORDER BY [TallaID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
