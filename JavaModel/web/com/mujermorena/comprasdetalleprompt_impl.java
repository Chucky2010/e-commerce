...
public final  class comprasdetalleprompt_impl extends GXDataArea
{
   public comprasdetalleprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public comprasdetalleprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( comprasdetalleprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InComprasId") ;
         ...
         {
            AV8InComprasId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InComprasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InComprasId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutComprasDetalleId = GXutil.lval( httpContext.GetPar( "InOutComprasDetalleId")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutComprasDetalleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutComprasDetalleId), 11, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV8InComprasId = GXutil.lval( httpContext.GetPar( "InComprasId")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InComprasId, AV22Pgmname) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.comprasdetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InComprasId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutComprasDetalleId,11,0))}, new String[] {"InComprasId","InOutComprasDetalleId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINCOMPRASID", GXutil.ltrim( localUtil.ntoc( AV8InComprasId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTCOMPRASDETALLEID", GXutil.ltrim( localUtil.ntoc( AV9InOutComprasDetalleId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.comprasdetalleprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InComprasId,11,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutComprasDetalleId,11,0))}, new String[] {"InComprasId","InOutComprasDetalleId"})  ;
   }

   public String getPgmname( )
   {
      return "ComprasDetallePrompt" ;
   }
   ...
   public void wb4X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_4X2( true) ;
      }
      else
      {
         wb_table1_14_4X2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_4X2e( boolean wbgen )
   {
      if ( wbgen )
      {
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A291ComprasDetalleTallaID = localUtil.ctol( httpContext.cgiGet( edtComprasDetalleTallaID_Internalname), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_COMPRASDETALLEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A12ComprasDetalleId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "COMPRASDETALLEID", GXutil.ltrim( localUtil.ntoc( A12ComprasDetalleId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "ComprasDetallePrompt" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4X2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV13FilterFullText ,
                                              Long.valueOf(A12ComprasDetalleId) ,
                                              Integer.valueOf(A75ComprasDetalleCantidad) ,
                                              Long.valueOf(A13ArticuloId) ,
                                              A76ArticuloNombre ,
                                              A83ImpuestoPorcentaje ,
                                              Integer.valueOf(A82ComprasCantidad) ,
                                              A80ComprasDetallePrecioCompra ,
                                              Long.valueOf(A291ComprasDetalleTallaID) ,
                                              Short.valueOf(AV11OrderedBy) ,
                                              Boolean.valueOf(AV12OrderedDsc) ,
                                              Long.valueOf(AV8InComprasId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.INT, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.INT, TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.SHORT,
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H004X2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InComprasId), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A18ImpuestoId = H004X2_A18ImpuestoId[0] ;
            A11ComprasId = H004X2_A11ComprasId[0] ;
            A291ComprasDetalleTallaID = H004X2_A291ComprasDetalleTallaID[0] ;
            A76ArticuloNombre = H004X2_A76ArticuloNombre[0] ;
            A13ArticuloId = H004X2_A13ArticuloId[0] ;
            A75ComprasDetalleCantidad = H004X2_A75ComprasDetalleCantidad[0] ;
            A12ComprasDetalleId = H004X2_A12ComprasDetalleId[0] ;
            A83ImpuestoPorcentaje = H004X2_A83ImpuestoPorcentaje[0] ;
            A80ComprasDetallePrecioCompra = H004X2_A80ComprasDetallePrecioCompra[0] ;
            A82ComprasCantidad = H004X2_A82ComprasCantidad[0] ;
            A18ImpuestoId = H004X2_A18ImpuestoId[0] ;
            A76ArticuloNombre = H004X2_A76ArticuloNombre[0] ;
            A83ImpuestoPorcentaje = H004X2_A83ImpuestoPorcentaje[0] ;
   ...
   public void send_integrity_lvl_hashes4X2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_COMPRASDETALLEID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A12ComprasDetalleId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H004X3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InComprasId), lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e164X2( )
   {
      ...
      comprasdetalleprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e184X2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutComprasDetalleId = A12ComprasDetalleId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutComprasDetalleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutComprasDetalleId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV9InOutComprasDetalleId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutComprasDetalleId"});
   ...
   public void wb_table1_14_4X2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ComprasDetallePrompt.htm");
   ...
   {
      AV8InComprasId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InComprasId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InComprasId), 11, 0));
      AV9InOutComprasDetalleId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutComprasDetalleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutComprasDetalleId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111223834", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("comprasdetalleprompt.js", "?202412111223834", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtComprasDetalleId_Internalname = "COMPRASDETALLEID_"+sGXsfl_26_idx ;
      edtComprasDetalleCantidad_Internalname = "COMPRASDETALLECANTIDAD_"+sGXsfl_26_idx ;
      ...
      edtComprasCantidad_Internalname = "COMPRASCANTIDAD_"+sGXsfl_26_idx ;
      edtComprasDetallePrecioCompra_Internalname = "COMPRASDETALLEPRECIOCOMPRA_"+sGXsfl_26_idx ;
      edtComprasDetalleTallaID_Internalname = "COMPRASDETALLETALLAID_"+sGXsfl_26_idx ;
      edtComprasDetalleExento_Internalname = "COMPRASDETALLEEXENTO_"+sGXsfl_26_idx ;
      edtComprasDetalleIva5_Internalname = "COMPRASDETALLEIVA5_"+sGXsfl_26_idx ;
      edtComprasDetalleIva10_Internalname = "COMPRASDETALLEIVA10_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtComprasDetalleId_Internalname = "COMPRASDETALLEID_"+sGXsfl_26_fel_idx ;
      edtComprasDetalleCantidad_Internalname = "COMPRASDETALLECANTIDAD_"+sGXsfl_26_fel_idx ;
      ...
      edtComprasCantidad_Internalname = "COMPRASCANTIDAD_"+sGXsfl_26_fel_idx ;
      edtComprasDetallePrecioCompra_Internalname = "COMPRASDETALLEPRECIOCOMPRA_"+sGXsfl_26_fel_idx ;
      edtComprasDetalleTallaID_Internalname = "COMPRASDETALLETALLAID_"+sGXsfl_26_fel_idx ;
      edtComprasDetalleExento_Internalname = "COMPRASDETALLEEXENTO_"+sGXsfl_26_fel_idx ;
      edtComprasDetalleIva5_Internalname = "COMPRASDETALLEIVA5_"+sGXsfl_26_fel_idx ;
      edtComprasDetalleIva10_Internalname = "COMPRASDETALLEIVA10_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetalleId_Internalname,GXutil.ltrim( localUtil.ntoc( A12ComprasDetalleId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A12ComprasDetalleId), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetalleId_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetalleCantidad_Internalname,GXutil.ltrim( localUtil.ntoc( A75ComprasDetalleCantidad, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A75ComprasDetalleCantidad), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetalleCantidad_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasCantidad_Internalname,GXutil.ltrim( localUtil.ntoc( A82ComprasCantidad, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A82ComprasCantidad), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasCantidad_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetallePrecioCompra_Internalname,GXutil.ltrim( localUtil.ntoc( A80ComprasDetallePrecioCompra, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A80ComprasDetallePrecioCompra, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetallePrecioCompra_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetalleTallaID_Internalname,GXutil.ltrim( localUtil.ntoc( A291ComprasDetalleTallaID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A291ComprasDetalleTallaID), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetalleTallaID_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"IDN11","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetalleExento_Internalname,GXutil.ltrim( localUtil.ntoc( A81ComprasDetalleExento, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A81ComprasDetalleExento, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetalleExento_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetalleIva5_Internalname,GXutil.ltrim( localUtil.ntoc( A85ComprasDetalleIva5, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A85ComprasDetalleIva5, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetalleIva5_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComprasDetalleIva10_Internalname,GXutil.ltrim( localUtil.ntoc( A84ComprasDetalleIva10, (byte)(21), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A84ComprasDetalleIva10, "ZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtComprasDetalleIva10_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(21),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Monto","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Cantidad", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Exento", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Iva5", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Detalle Iva10", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A12ComprasDetalleId, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A75ComprasDetalleCantidad, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A82ComprasCantidad, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A80ComprasDetallePrecioCompra, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A291ComprasDetalleTallaID, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A81ComprasDetalleExento, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A85ComprasDetalleIva5, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A84ComprasDetalleIva10, (byte)(21), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void init_default_properties( )
   {
      ...
      edtComprasDetalleTallaID_Internalname = "COMPRASDETALLETALLAID" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtComprasDetalleTallaID_Jsonclick = "" ;
      ...
      Ddo_grid_Columnids = "1:ComprasDetalleId|2:ComprasDetalleCantidad|3:ArticuloId|4:ArticuloNombre|5:ImpuestoPorcentaje|6:ComprasCantidad|7:ComprasDetallePrecioCompra|8:ComprasDetalleTallaID" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InComprasId',fld:'vINCOMPRASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e114X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InComprasId',fld:'vINCOMPRASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e124X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InComprasId',fld:'vINCOMPRASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e134X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InComprasId',fld:'vINCOMPRASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e174X2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e184X2',iparms:[{av:'A12ComprasDetalleId',fld:'COMPRASDETALLEID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutComprasDetalleId',fld:'vINOUTCOMPRASDETALLEID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e144X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InComprasId',fld:'vINCOMPRASID',pic:'ZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Comprasdetalleiva10',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H004X2_A18ImpuestoId = new long[1] ;
      H004X2_A11ComprasId = new long[1] ;
      H004X2_A291ComprasDetalleTallaID = new long[1] ;
      H004X2_A76ArticuloNombre = new String[] {""} ;
      H004X2_A13ArticuloId = new long[1] ;
      H004X2_A75ComprasDetalleCantidad = new int[1] ;
      H004X2_A12ComprasDetalleId = new long[1] ;
      H004X2_A83ImpuestoPorcentaje = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004X2_A80ComprasDetallePrecioCompra = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004X2_A82ComprasCantidad = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.comprasdetalleprompt__default(),
         new Object[] {
             new Object[] {
            H004X2_A18ImpuestoId, H004X2_A11ComprasId, H004X2_A291ComprasDetalleTallaID, H004X2_A76ArticuloNombre, H004X2_A13ArticuloId, H004X2_A75ComprasDetalleCantidad, H004X2_A12ComprasDetalleId, H004X2_A83ImpuestoPorcentaje, H004X2_A80ComprasDetallePrecioCompra, H004X2_A82ComprasCantidad
            }
            , new Object[] {
   ...
   private long wcpOAV8InComprasId ;
   private long wcpOAV9InOutComprasDetalleId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InComprasId ;
   private long AV9InOutComprasDetalleId ;
   ...
   private String edtComprasDetalleTallaID_Internalname ;
   ...
   private String edtComprasDetalleTallaID_Jsonclick ;
   ...
   private long[] H004X2_A18ImpuestoId ;
   private long[] H004X2_A11ComprasId ;
   private long[] H004X2_A291ComprasDetalleTallaID ;
   private String[] H004X2_A76ArticuloNombre ;
   private long[] H004X2_A13ArticuloId ;
   private int[] H004X2_A75ComprasDetalleCantidad ;
   private long[] H004X2_A12ComprasDetalleId ;
   private java.math.BigDecimal[] H004X2_A83ImpuestoPorcentaje ;
   private java.math.BigDecimal[] H004X2_A80ComprasDetallePrecioCompra ;
   private int[] H004X2_A82ComprasCantidad ;
...
final  class comprasdetalleprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004X2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A12ComprasDetalleId ,
                                          int A75ComprasDetalleCantidad ,
                                          long A13ArticuloId ,
                                          String A76ArticuloNombre ,
                                          java.math.BigDecimal A83ImpuestoPorcentaje ,
                                          int A82ComprasCantidad ,
                                          java.math.BigDecimal A80ComprasDetallePrecioCompra ,
                                          long A291ComprasDetalleTallaID ,
                                          short AV11OrderedBy ,
                                          ...
                                          long AV8InComprasId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T2.[ImpuestoId], T1.[ComprasId], T1.[ComprasDetalleTallaID], T2.[ArticuloNombre], T1.[ArticuloId], T1.[ComprasDetalleCantidad], T1.[ComprasDetalleId], T3.[ImpuestoPorcentaje]," ;
      sSelectString += " T1.[ComprasDetallePrecioCompra], T1.[ComprasCantidad]" ;
      sFromString = " FROM (([ComprasDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId]) INNER JOIN [Impuesto] T3 ON T3.[ImpuestoId] = T2.[ImpuestoId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[ComprasId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ComprasDetalleId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[ComprasDetalleCantidad] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(9), CAST(T3.[ImpuestoPorcentaje] AS decimal(9,2))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[ComprasCantidad] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ComprasDetallePrecioCompra] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ComprasDetalleTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 0 THEN T1.[ComprasCantidad] * CAST(T1.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 5 THEN T1.[ComprasCantidad] * CAST(T1.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 10 THEN T1.[ComprasCantidad] * CAST(T1.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?))");
      }
      else
      {
         GXv_int6[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[ComprasDetalleId]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasDetalleId] DESC" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasDetalleCantidad]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasDetalleCantidad] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T2.[ArticuloNombre]" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T2.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T3.[ImpuestoPorcentaje]" ;
      }
      else if ( ( AV11OrderedBy == 5 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[ImpuestoPorcentaje] DESC" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasCantidad]" ;
      }
      else if ( ( AV11OrderedBy == 6 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasCantidad] DESC" ;
      }
      else if ( ( AV11OrderedBy == 7 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasDetallePrecioCompra]" ;
      }
      else if ( ( AV11OrderedBy == 7 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasDetallePrecioCompra] DESC" ;
      }
      else if ( ( AV11OrderedBy == 8 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ComprasDetalleTallaID]" ;
      }
      else if ( ( AV11OrderedBy == 8 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ComprasDetalleTallaID] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[ComprasId], T1.[ComprasDetalleId]" ;
      }
   ...
   protected Object[] conditional_H004X3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A12ComprasDetalleId ,
                                          ...
                                          long AV8InComprasId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (([ComprasDetalle] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId]) INNER JOIN [Impuesto] T3 ON T3.[ImpuestoId] = T2.[ImpuestoId])" ;
      addWhere(sWhereString, "(T1.[ComprasId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[ComprasDetalleId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[ComprasDetalleCantidad] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(9), CAST(T3.[ImpuestoPorcentaje] AS decimal(9,2))) like '%' + ?) or ( CONVERT( char(5), CAST(T1.[ComprasCantidad] AS decimal(5,0))) like '%' + ?) or ( CONVERT( char(17), CAST(T1.[ComprasDetallePrecioCompra] AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ComprasDetalleTallaID] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 0 THEN T1.[ComprasCantidad] * CAST(T1.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 5 THEN T1.[ComprasCantidad] * CAST(T1.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?) or ( CONVERT( char(17), CAST(( CASE  WHEN T3.[ImpuestoPorcentaje] = 10 THEN T1.[ComprasCantidad] * CAST(T1.[ComprasDetallePrecioCompra] AS decimal( 27, 10)) END) AS decimal(17,2))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004X2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , (java.math.BigDecimal)dynConstraints[7] , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() , ((Number) dynConstraints[11]).longValue() );
            case 1 :
                  return conditional_H004X3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (java.math.BigDecimal)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , (java.math.BigDecimal)dynConstraints[7] , ((Number) dynConstraints[8]).longValue() , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() , ((Number) dynConstraints[11]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004X2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004X3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
