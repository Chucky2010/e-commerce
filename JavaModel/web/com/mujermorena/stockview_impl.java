...
public final  class stockview_impl extends GXDataArea
{
   public stockview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public stockview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( stockview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10StockId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10StockId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10StockId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSTOCKID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10StockId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.stockview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10StockId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"StockId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vSTOCKID", GXutil.ltrim( localUtil.ntoc( AV10StockId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSTOCKID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10StockId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.stockview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10StockId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"StockId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Stock View", "") ;
   }
   ...
   public void wb4P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Stock :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_StockView.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Stock", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_StockView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_StockView.htm");
         /* Div Control */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblDetalle_title_Internalname, httpContext.getMessage( "Detalle", ""), "", "", lblDetalle_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_StockView.htm");
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
   ...
   public void start4P2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Stock View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup4P0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10StockId = localUtil.ctol( httpContext.cgiGet( "vSTOCKID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e114P2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.stockww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H004P2 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV10StockId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A46StockId = H004P2_A46StockId[0] ;
         AV16GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "StockGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.stockgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "StockGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0031","",Long.valueOf(AV10StockId)});
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "Detalle") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Detallewc_Component), GXutil.lower( "StockDetalleWC")) != 0 )
         {
            WebComp_Detallewc = WebUtils.getWebComponent(getClass(), "com.mujermorena.stockdetallewc_impl", remoteHandle, context);
            WebComp_Detallewc_Component = "StockDetalleWC" ;
         }
         if ( GXutil.len( WebComp_Detallewc_Component) != 0 )
         {
            WebComp_Detallewc.setjustcreated();
            WebComp_Detallewc.componentprepare(new Object[] {"W0039","",Long.valueOf(AV10StockId)});
   ...
   {
      AV10StockId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10StockId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10StockId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSTOCKID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10StockId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111221641", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("stockview.js", "?202412111221641", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Stock View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10StockId',fld:'vSTOCKID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H004P2_A46StockId = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.stockview__default(),
         new Object[] {
             new Object[] {
            H004P2_A46StockId
            }
   ...
   private int idxLst ;
   private long wcpOAV10StockId ;
   private long AV10StockId ;
   ...
   private long[] H004P2_A46StockId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class stockview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004P2", "SELECT [StockId] FROM [Stock] WHERE [StockId] = ? ORDER BY [StockId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
