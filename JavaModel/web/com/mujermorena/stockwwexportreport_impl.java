...
public final  class stockwwexportreport_impl extends GXWebReport
{
   public stockwwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "stockww_Execute", GXv_boolean2) ;
         stockwwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Stock", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 30, Gx_line+10, 179, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 183, Gx_line+10, 332, Gx_line+27, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 336, Gx_line+10, 634, Gx_line+27, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Total", ""), 638, Gx_line+10, 787, Gx_line+27, 2, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Stockwwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Stockwwds_1_filterfulltext ,
      ...
      lV35Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Stockwwds_1_filterfulltext), "%", "") ;
      lV35Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Stockwwds_1_filterfulltext), "%", "") ;
      lV35Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Stockwwds_1_filterfulltext), "%", "") ;
      lV35Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Stockwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P004B2 */
      pr_default.execute(0, new Object[] {lV35Stockwwds_1_filterfulltext, lV35Stockwwds_1_filterfulltext, lV35Stockwwds_1_filterfulltext, lV35Stockwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A233StockTotal = P004B2_A233StockTotal[0] ;
         A13ArticuloId = P004B2_A13ArticuloId[0] ;
         A46StockId = P004B2_A46StockId[0] ;
         A76ArticuloNombre = P004B2_A76ArticuloNombre[0] ;
         A76ArticuloNombre = P004B2_A76ArticuloNombre[0] ;
         ...
         h4B0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A46StockId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 179, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A13ArticuloId), "ZZZZZZZZZZ9")), 183, Gx_line+10, 332, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A76ArticuloNombre, "")), 336, Gx_line+10, 634, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A233StockTotal), "ZZZZ9")), 638, Gx_line+10, 787, Gx_line+25, 2, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("StockWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "StockWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("StockWWGridState"), null, null);
      }
   ...
   public void h4B0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Stockwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Stockwwds_1_filterfulltext = "" ;
      P004B2_A233StockTotal = new int[1] ;
      P004B2_A13ArticuloId = new long[1] ;
      P004B2_A46StockId = new long[1] ;
      P004B2_A76ArticuloNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.stockwwexportreport__default(),
         new Object[] {
             new Object[] {
            P004B2_A233StockTotal, P004B2_A13ArticuloId, P004B2_A46StockId, P004B2_A76ArticuloNombre
            }
         }
      );
   ...
   private String AV35Stockwwds_1_filterfulltext ;
   private String lV35Stockwwds_1_filterfulltext ;
   ...
   private int[] P004B2_A233StockTotal ;
   private long[] P004B2_A13ArticuloId ;
   private long[] P004B2_A46StockId ;
   private String[] P004B2_A76ArticuloNombre ;
...
final  class stockwwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P004B2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Stockwwds_1_filterfulltext ,
                                          long A46StockId ,
                                          long A13ArticuloId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT T1.[StockTotal], T1.[ArticuloId], T1.[StockId], T2.[ArticuloNombre] FROM ([Stock] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      if ( ! (GXutil.strcmp("", AV35Stockwwds_1_filterfulltext)==0) )
      {
      ...
      {
         scmdbuf += " ORDER BY T1.[StockId]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[StockId] DESC" ;
      }
      ...
      {
         scmdbuf += " ORDER BY T2.[ArticuloNombre]" ;
      }
      else if ( ( AV11OrderedBy == 3 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T2.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ! AV12OrderedDsc )
      {
         scmdbuf += " ORDER BY T1.[StockTotal]" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY T1.[StockTotal] DESC" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P004B2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
