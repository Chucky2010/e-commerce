...
public final  class paisprompt_impl extends GXDataArea
{
   public paisprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public paisprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( paisprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutPaisId") ;
         ...
         {
            AV8InOutPaisId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPaisId), 11, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutPaisNombre = httpContext.GetPar( "InOutPaisNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPaisNombre", AV9InOutPaisNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.paisprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPaisId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPaisNombre))}, new String[] {"InOutPaisId","InOutPaisNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTPAISID", GXutil.ltrim( localUtil.ntoc( AV8InOutPaisId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTPAISNOMBRE", GXutil.rtrim( AV9InOutPaisNombre));
   ...
   {
      return formatLink("com.mujermorena.paisprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPaisId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPaisNombre))}, new String[] {"InOutPaisId","InOutPaisNombre"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Selecciona Pais", "") ;
   }
   ...
   public void wb420( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_422( true) ;
      }
      else
      {
         wb_table1_14_422( false) ;
      }
      return  ;
   }

   public void wb_table1_14_422e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start422( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Pais", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAISNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A60PaisNombre, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "PAISNOMBRE", GXutil.rtrim( A60PaisNombre));
   }
   ...
   public void rf422( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A60PaisNombre = H00422_A60PaisNombre[0] ;
            A5PaisId = H00422_A5PaisId[0] ;
            e17422 ();
   ...
   public void send_integrity_lvl_hashes422( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAISID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A5PaisId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAISNOMBRE"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, GXutil.rtrim( localUtil.format( A60PaisNombre, ""))));
   }
   ...
   public void e15422( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Pais", "") );
   ...
   public void e16422( )
   {
      ...
      paisprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e18422( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutPaisId = A5PaisId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPaisId), 11, 0));
      AV9InOutPaisNombre = A60PaisNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPaisNombre", AV9InOutPaisNombre);
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutPaisId),AV9InOutPaisNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutPaisId","AV9InOutPaisNombre"});
   ...
   public void wb_table1_14_422( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_PaisPrompt.htm");
   ...
   {
      AV8InOutPaisId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPaisId), 11, 0));
      AV9InOutPaisNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPaisNombre", AV9InOutPaisNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122843", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paisprompt.js", "?20241211122844", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:PaisId|2:PaisNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17422',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18422',iparms:[{av:'A5PaisId',fld:'PAISID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'A60PaisNombre',fld:'PAISNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPaisId',fld:'vINOUTPAISID',pic:'ZZZZZZZZZZ9'},{av:'AV9InOutPaisNombre',fld:'vINOUTPAISNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14422',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00422_A60PaisNombre = new String[] {""} ;
      H00422_A5PaisId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.paisprompt__default(),
         new Object[] {
             new Object[] {
            H00422_A60PaisNombre, H00422_A5PaisId
            }
            , new Object[] {
   ...
   private String[] H00422_A60PaisNombre ;
   private long[] H00422_A5PaisId ;
...
final  class paisprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00422( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00423( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          long A5PaisId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00422(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H00423(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00422", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00423", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
