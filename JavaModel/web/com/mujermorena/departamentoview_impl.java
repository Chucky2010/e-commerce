...
public final  class departamentoview_impl extends GXDataArea
{
   public departamentoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public departamentoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( departamentoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "DepartamentoId") ;
         ...
         {
            AV10DepartamentoId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10DepartamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10DepartamentoId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEPARTAMENTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DepartamentoId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.departamentoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DepartamentoId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DepartamentoId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"DepartamentoView");
      forbiddenHiddens.add("DepartamentoNombre", GXutil.rtrim( localUtil.format( A61DepartamentoNombre, "")));
      ...
      GXutil.writeLogInfo("departamentoview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vDEPARTAMENTOID", GXutil.ltrim( localUtil.ntoc( AV10DepartamentoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEPARTAMENTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DepartamentoId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.departamentoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DepartamentoId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DepartamentoId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Departamento View", "") ;
   }
   ...
   public void wb3Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Departamento :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_DepartamentoView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtDepartamentoNombre_Internalname, httpContext.getMessage( "Departamento Nombre", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtDepartamentoNombre_Internalname, GXutil.rtrim( A61DepartamentoNombre), GXutil.rtrim( localUtil.format( A61DepartamentoNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDepartamentoNombre_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtDepartamentoNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Nombre", "left", true, "", "HLP_DepartamentoView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Departamento", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_DepartamentoView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DepartamentoView.htm");
         /* Div Control */
   ...
   public void start3Z2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Departamento View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf3Z2( )
   {
      ...
      {
         /* Using cursor H003Z2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10DepartamentoId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A6DepartamentoId = H003Z2_A6DepartamentoId[0] ;
            A61DepartamentoNombre = H003Z2_A61DepartamentoNombre[0] ;
   ...
   public void strup3Z0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10DepartamentoId = localUtil.ctol( httpContext.cgiGet( "vDEPARTAMENTOID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("departamentoview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e113Z2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.departamentoww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H003Z3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10DepartamentoId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A6DepartamentoId = H003Z3_A6DepartamentoId[0] ;
         A61DepartamentoNombre = H003Z3_A61DepartamentoNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A61DepartamentoNombre", A61DepartamentoNombre);
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A61DepartamentoNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "DepartamentoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.departamentogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "DepartamentoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10DepartamentoId)});
   ...
   {
      AV10DepartamentoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10DepartamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10DepartamentoId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEPARTAMENTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DepartamentoId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122529", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("departamentoview.js", "?20241211122529", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Departamento View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A61DepartamentoNombre',fld:'DEPARTAMENTONOMBRE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H003Z2_A6DepartamentoId = new long[1] ;
      H003Z2_A61DepartamentoNombre = new String[] {""} ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H003Z3_A6DepartamentoId = new long[1] ;
      H003Z3_A61DepartamentoNombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.departamentoview__default(),
         new Object[] {
             new Object[] {
            H003Z2_A6DepartamentoId, H003Z2_A61DepartamentoNombre
            }
            , new Object[] {
            H003Z3_A6DepartamentoId, H003Z3_A61DepartamentoNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10DepartamentoId ;
   private long AV10DepartamentoId ;
   ...
   private long[] H003Z2_A6DepartamentoId ;
   private String[] H003Z2_A61DepartamentoNombre ;
   private long[] H003Z3_A6DepartamentoId ;
   private String[] H003Z3_A61DepartamentoNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class departamentoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003Z2", "SELECT [DepartamentoId], [DepartamentoNombre] FROM [Departamento] WHERE [DepartamentoId] = ? ORDER BY [DepartamentoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H003Z3", "SELECT [DepartamentoId], [DepartamentoNombre] FROM [Departamento] WHERE [DepartamentoId] = ? ORDER BY [DepartamentoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
