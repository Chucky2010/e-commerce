...
public final  class ciudadview_impl extends GXDataArea
{
   public ciudadview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ciudadview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ciudadview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10CiudadId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10CiudadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CiudadId), 11, 0));
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCIUDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CiudadId), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.ciudadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CiudadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CiudadId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"CiudadView");
      forbiddenHiddens.add("CiudadNombre", GXutil.rtrim( localUtil.format( A62CiudadNombre, "")));
      ...
      GXutil.writeLogInfo("ciudadview:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vCIUDADID", GXutil.ltrim( localUtil.ntoc( AV10CiudadId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCIUDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CiudadId), "ZZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.mujermorena.ciudadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CiudadId,11,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CiudadId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Ciudad View", "") ;
   }
   ...
   public void wb3Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, httpContext.getMessage( "Ciudad :: ", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_CiudadView.htm");
         ...
         com.mujermorena.GxWebStd.gx_label_element( httpContext, edtCiudadNombre_Internalname, httpContext.getMessage( "Ciudad Nombre", ""), "gx-form-item AttributeTitleWWPLabel", 0, true, "width: 25%;");
         /* Single line edit */
         com.mujermorena.GxWebStd.gx_single_line_edit( httpContext, edtCiudadNombre_Internalname, GXutil.rtrim( A62CiudadNombre), GXutil.rtrim( localUtil.format( A62CiudadNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCiudadNombre_Jsonclick, 0, "AttributeTitleWWP", "", "", "", "", 1, edtCiudadNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Nombre", "left", true, "", "HLP_CiudadView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, httpContext.getMessage( "Ir a Ciudad", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_CiudadView.htm");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_CiudadView.htm");
         /* Div Control */
   ...
   public void start3Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Ciudad View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf3Y2( )
   {
      ...
      {
         /* Using cursor H003Y2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV10CiudadId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A7CiudadId = H003Y2_A7CiudadId[0] ;
            A62CiudadNombre = H003Y2_A62CiudadNombre[0] ;
   ...
   public void strup3Y0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10CiudadId = localUtil.ctol( httpContext.cgiGet( "vCIUDADID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         ...
         {
            GXutil.writeLogError("ciudadview:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e113Y2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.mujermorena.ciudadww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H003Y3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV10CiudadId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A7CiudadId = H003Y3_A7CiudadId[0] ;
         A62CiudadNombre = H003Y3_A62CiudadNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A62CiudadNombre", A62CiudadNombre);
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A62CiudadNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "CiudadGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.mujermorena.ciudadgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "CiudadGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0034","",Long.valueOf(AV10CiudadId)});
   ...
   {
      AV10CiudadId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10CiudadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CiudadId), 11, 0));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCIUDADID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CiudadId), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241211122460", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("ciudadview.js", "?20241211122460", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Ciudad View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CiudadId',fld:'vCIUDADID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A62CiudadNombre',fld:'CIUDADNOMBRE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H003Y2_A7CiudadId = new long[1] ;
      H003Y2_A62CiudadNombre = new String[] {""} ;
      hsh = "" ;
      AV6WWPContext = new com.mujermorena.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext1 = new com.mujermorena.wwpbaseobjects.SdtWWPContext[1] ;
      H003Y3_A7CiudadId = new long[1] ;
      H003Y3_A62CiudadNombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.ciudadview__default(),
         new Object[] {
             new Object[] {
            H003Y2_A7CiudadId, H003Y2_A62CiudadNombre
            }
            , new Object[] {
            H003Y3_A7CiudadId, H003Y3_A62CiudadNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private long wcpOAV10CiudadId ;
   private long AV10CiudadId ;
   ...
   private long[] H003Y2_A7CiudadId ;
   private String[] H003Y2_A62CiudadNombre ;
   private long[] H003Y3_A7CiudadId ;
   private String[] H003Y3_A62CiudadNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.mujermorena.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class ciudadview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003Y2", "SELECT [CiudadId], [CiudadNombre] FROM [Ciudad] WHERE [CiudadId] = ? ORDER BY [CiudadId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H003Y3", "SELECT [CiudadId], [CiudadNombre] FROM [Ciudad] WHERE [CiudadId] = ? ORDER BY [CiudadId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
