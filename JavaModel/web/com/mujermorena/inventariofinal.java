...
public final  class inventariofinal extends GXProcedure
{
   public inventariofinal( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( inventariofinal.class ), "" );
   }
   ...
   public String executeUdp( long aP0 ,
                             String[] aP1 )
   {
      inventariofinal.this.aP2 = new String[] {""};
   ...
   private void execute_int( long aP0 ,
                             ...
                             String[] aP2 )
   {
      inventariofinal.this.AV24InventarioID = aP0;
      inventariofinal.this.aP1 = aP1;
      inventariofinal.this.aP2 = aP2;
      initialize();
      /* GeneXus formulas */
   ...
   public void S111( )
   {
      ...
      AV12Filename = "InventarioFinal-" + GXutil.trim( GXutil.str( AV16Random, 8, 0)) + ".xlsx" ;
   ...
   public void S151( )
   {
      ...
      returnInSub = false ;
      /* Using cursor P00522 */
      pr_default.execute(0, new Object[] {Long.valueOf(AV24InventarioID)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A53InventarioID = P00522_A53InventarioID[0] ;
         A257InventarioFecha = P00522_A257InventarioFecha[0] ;
         A258InventarioDetalle = P00522_A258InventarioDetalle[0] ;
         A265InventarioNumeroProceso = P00522_A265InventarioNumeroProceso[0] ;
         ...
         {
            A54InventarioDetalleID = P00523_A54InventarioDetalleID[0] ;
            AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).setNumber( A53InventarioID );
            GXt_dtime6 = GXutil.resetTime( A257InventarioFecha );
            AV11ExcelDocument.setDateFormat(localUtil, 8, 5, ((GXutil.strcmp(httpContext.getLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0), localUtil.mapDateTimeFormat( httpContext.getLanguageProperty( "date_fmt")), "/", ":", " ");
            AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).setDate( GXt_dtime6 );
   ...
   public void S191( )
   {
      ...
      AV29GXV1 = 1 ;
      while ( AV29GXV1 <= AV22GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV23GridStateFilterValue = (com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.mujermorena.wwpbaseobjects.SdtWWPGridState_FilterValue)AV22GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV29GXV1));
   ...
   {
      this.aP1[0] = inventariofinal.this.AV12Filename;
      this.aP2[0] = inventariofinal.this.AV13ErrorMessage;
      CloseOpenCursors();
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      P00522_A53InventarioID = new long[1] ;
      P00522_A257InventarioFecha = new java.util.Date[] {GXutil.nullDate()} ;
      P00522_A258InventarioDetalle = new String[] {""} ;
      P00522_A265InventarioNumeroProceso = new short[1] ;
      A257InventarioFecha = GXutil.nullDate() ;
      A258InventarioDetalle = "" ;
      P00523_A53InventarioID = new long[1] ;
      P00523_A54InventarioDetalleID = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.inventariofinal__default(),
         new Object[] {
             new Object[] {
            P00522_A53InventarioID, P00522_A257InventarioFecha, P00522_A258InventarioDetalle, P00522_A265InventarioNumeroProceso
            }
            , new Object[] {
            P00523_A53InventarioID, P00523_A54InventarioDetalleID
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private long[] P00522_A53InventarioID ;
   private java.util.Date[] P00522_A257InventarioFecha ;
   private String[] P00522_A258InventarioDetalle ;
   private short[] P00522_A265InventarioNumeroProceso ;
   private long[] P00523_A53InventarioID ;
   private long[] P00523_A54InventarioDetalleID ;
...
final  class inventariofinal__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("P00522", "SELECT [InventarioID], [InventarioFecha], [InventarioDetalle], [InventarioNumeroProceso] FROM [Inventario] WHERE [InventarioID] = ? ORDER BY [InventarioID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("P00523", "SELECT [InventarioID], [InventarioDetalleID] FROM [InventarioDetalle] WHERE [InventarioID] = ? ORDER BY [InventarioID], [InventarioDetalleID] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
