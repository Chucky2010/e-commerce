...
public final  class wwpgetradialgaugelight_impl extends GXWebProcedure
{
   public wwpgetradialgaugelight_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpgetradialgaugelight_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpgetradialgaugelight_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLight");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLight.Execute");
            ...
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLight.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLight.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetRadialGaugeLight.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLight.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetRadialGaugeLight.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLightSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetRadialGaugeLight.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetRadialGaugeLight.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLightSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPGetRadialGaugeLightSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPGETRADIALGAUGELIGHT.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeLightSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPGetRadialGaugeLightSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpgetradialgaugelight");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPGetRadialGaugeLight.ExecuteResponse");
   ...
   public void execute_int( short aP0 ,
                            ...
                            String[] aP2 )
   {
      wwpgetradialgaugelight_impl.this.AV10Value = aP0;
      wwpgetradialgaugelight_impl.this.AV9ProgressColor = aP1;
      wwpgetradialgaugelight_impl.this.aP2 = aP2;
      initialize();
      privateExecute();
   }
   ...
   private void privateExecute( )
   {
      ...
      new com.mujermorena.workwithplus.nativemobile.wwpgetradialgauge(remoteHandle, context).execute( AV10Value, "", AV9ProgressColor, "", "", true, GXv_char2) ;
      wwpgetradialgaugelight_impl.this.GXt_char1 = GXv_char2[0] ;
      AV8HTML = GXt_char1 ;
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP2[0] = wwpgetradialgaugelight_impl.this.AV8HTML;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
