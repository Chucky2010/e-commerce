...
public final  class wwpgetcalendardatefromnr_impl extends GXWebProcedure
{
   public wwpgetcalendardatefromnr_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpgetcalendardatefromnr_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpgetcalendardatefromnr_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNr");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNr.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            GXSoapXMLWriter.writeAttribute("maxOccurs", "1");
            GXSoapXMLWriter.writeAttribute("name", "Day");
            GXSoapXMLWriter.writeAttribute("type", "xsd:byte");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNr.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNr.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetCalendarDateFromNr.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNr.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetCalendarDateFromNr.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNrSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetCalendarDateFromNr.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetCalendarDateFromNr.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNrSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPGetCalendarDateFromNrSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPGETCALENDARDATEFROMNR.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetCalendarDateFromNrSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPGetCalendarDateFromNrSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpgetcalendardatefromnr");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
         ...
         else
         {
            ...
            currSoapErrmsg = "No SOAP request found. Call " + "http://" + httpContext.getServerName( ) + ((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "") + httpContext.getScriptPath( ) + "com.mujermorena.workwithplus.nativemobile.wwpgetcalendardatefromnr" + "?wsdl to get the WSDL." ;
         }
      }
      if ( currSoapErr == 0 )
      {
                  ...
                  if ( currSoapErr == 0 )
                  {
                     ...
                     if ( GXSoapXMLReader.getIsSimple() == 0 )
                     {
                        ...
                        while ( ( ( GXutil.strcmp(GXSoapXMLReader.getName(), sTagName) != 0 ) || ( GXSoapXMLReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
                        {
                           readOk = (short)(0) ;
                           readElement = false ;
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Year") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              if ( GXutil.notNumeric( GXSoapXMLReader.getValue()) )
                              {
                                 formatError = true ;
                              }
                              AV12Year = (short)(GXutil.lval( GXSoapXMLReader.getValue())) ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
                           ...
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Month") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              if ( GXutil.notNumeric( GXSoapXMLReader.getValue()) )
                              {
                                 formatError = true ;
                              }
                              AV11Month = (byte)(GXutil.lval( GXSoapXMLReader.getValue())) ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
                           ...
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Day") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              if ( GXutil.notNumeric( GXSoapXMLReader.getValue()) )
                              {
                                 formatError = true ;
                              }
                              AV10Day = (byte)(GXutil.lval( GXSoapXMLReader.getValue())) ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPGetCalendarDateFromNr.ExecuteResponse");
         GXSoapXMLWriter.writeAttribute("xmlns", "Mujer_Morena");
         if ( currSoapErr == 0 )
         {
            GXSoapXMLWriter.writeElement("Datejson", AV9DateJson);
            GXSoapXMLWriter.writeAttribute("xmlns", "Mujer_Morena");
         }
         else
         {
   ...
   public void execute_int( short aP0 ,
                            ...
                            String[] aP3 )
   {
      wwpgetcalendardatefromnr_impl.this.AV12Year = aP0;
      wwpgetcalendardatefromnr_impl.this.AV11Month = aP1;
      wwpgetcalendardatefromnr_impl.this.AV10Day = aP2;
      wwpgetcalendardatefromnr_impl.this.aP3 = aP3;
      initialize();
      privateExecute();
   }
   ...
   private void privateExecute( )
   {
      ...
      AV8CurrentDate.setgxTv_SdtWWPCalendarEntry_Year( AV12Year );
      AV8CurrentDate.setgxTv_SdtWWPCalendarEntry_Month( AV11Month );
      AV8CurrentDate.setgxTv_SdtWWPCalendarEntry_Day( AV10Day );
      AV9DateJson = AV8CurrentDate.toJSonString(false, true) ;
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP3[0] = wwpgetcalendardatefromnr_impl.this.AV9DateJson;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
   ...
   private byte AV11Month ;
   private byte AV10Day ;
   private short GXSoapError ;
   private short currSoapErr ;
   private short readOk ;
   private short nOutParmCount ;
   private short AV12Year ;
