...
public final  class wwpgetrangedradialgauge_impl extends GXWebProcedure
{
   public wwpgetrangedradialgauge_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpgetrangedradialgauge_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpgetrangedradialgauge_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGauge");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGauge.Execute");
            ...
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGauge.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGauge.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetRangedRadialGauge.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGauge.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetRangedRadialGauge.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGaugeSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetRangedRadialGauge.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetRangedRadialGauge.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGaugeSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPGetRangedRadialGaugeSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPGETRANGEDRADIALGAUGE.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRangedRadialGaugeSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPGetRangedRadialGaugeSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpgetrangedradialgauge");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
         ...
         else
         {
            ...
            currSoapErrmsg = "No SOAP request found. Call " + "http://" + httpContext.getServerName( ) + ((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "") + httpContext.getScriptPath( ) + "com.mujermorena.workwithplus.nativemobile.wwpgetrangedradialgauge" + "?wsdl to get the WSDL." ;
         }
      }
      if ( currSoapErr == 0 )
      {
                     ...
                     if ( GXSoapXMLReader.getIsSimple() == 0 )
                     {
                        ...
                        while ( ( ( GXutil.strcmp(GXSoapXMLReader.getName(), sTagName) != 0 ) || ( GXSoapXMLReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Value") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              ...
                              AV11Value = (short)(GXutil.lval( GXSoapXMLReader.getValue())) ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
                           ...
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Text") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              AV10Text = GXSoapXMLReader.getValue() ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPGetRangedRadialGauge.ExecuteResponse");
   ...
   public void execute_int( short aP0 ,
                            ...
                            String[] aP2 )
   {
      wwpgetrangedradialgauge_impl.this.AV11Value = aP0;
      wwpgetrangedradialgauge_impl.this.AV10Text = aP1;
      wwpgetrangedradialgauge_impl.this.aP2 = aP2;
      initialize();
      privateExecute();
   }
   ...
   {
      AV9GaugeConfig = (com.mujermorena.workwithplus.nativemobile.SdtRangedRadialGaugeConfig)new com.mujermorena.workwithplus.nativemobile.SdtRangedRadialGaugeConfig(remoteHandle, context);
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Value( AV11Value );
      if ( GXutil.len( AV10Text) > 0 )
      {
         AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Text( AV10Text );
      }
      else
      {
         AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Text( GXutil.trim( GXutil.str( AV11Value, 4, 0))+"%" );
      }
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Width( (short)(200) );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Height( (short)(200) );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range1colorstart( "#007700" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range1colorend( "#009900" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range2colorstart( "#009900" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range2colorend( "#00ff00" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range3colorstart( "#00ff00" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range3colorend( "#ffff00" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range4colorstart( "#ffff00" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range4colorend( "#ff0000" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range5colorstart( "#ff0000" );
      AV9GaugeConfig.setgxTv_SdtRangedRadialGaugeConfig_Range5colorend( "#aa0000" );
      GXt_char1 = AV8GaugeRegions ;
      GXv_char2[0] = GXt_char1 ;
      new com.mujermorena.workwithplus.nativemobile.wwpgetrangedradialgaugefromconfig(remoteHandle, context).execute( AV9GaugeConfig, GXv_char2) ;
      wwpgetrangedradialgauge_impl.this.GXt_char1 = GXv_char2[0] ;
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP2[0] = wwpgetrangedradialgauge_impl.this.AV8GaugeRegions;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
