...
public final  class wwpwebserversessionget_impl extends GXWebProcedure
{
   public wwpwebserversessionget_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpwebserversessionget_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpwebserversessionget_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGet");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGet.Execute");
            ...
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGet.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGet.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPWebServerSessionGet.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGet.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPWebServerSessionGet.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGetSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPWebServerSessionGet.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPWebServerSessionGet.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGetSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPWebServerSessionGetSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPWEBSERVERSESSIONGET.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPWebServerSessionGetSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPWebServerSessionGetSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpwebserversessionget");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPWebServerSessionGet.ExecuteResponse");
   ...
   public void execute_int( String aP0 ,
                            String[] aP1 )
   {
      wwpwebserversessionget_impl.this.AV8ParameterKey = aP0;
      wwpwebserversessionget_impl.this.aP1 = aP1;
      initialize();
      privateExecute();
   }
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP1[0] = wwpwebserversessionget_impl.this.AV9ParameterValue;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
