...
public final  class wwpgetradialgaugewhite_impl extends GXWebProcedure
{
   public wwpgetradialgaugewhite_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpgetradialgaugewhite_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpgetradialgaugewhite_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhite");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhite.Execute");
            ...
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhite.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhite.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetRadialGaugeWhite.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhite.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetRadialGaugeWhite.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhiteSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetRadialGaugeWhite.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetRadialGaugeWhite.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhiteSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPGetRadialGaugeWhiteSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPGETRADIALGAUGEWHITE.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetRadialGaugeWhiteSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPGetRadialGaugeWhiteSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpgetradialgaugewhite");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
         ...
         else
         {
            ...
            currSoapErrmsg = "No SOAP request found. Call " + "http://" + httpContext.getServerName( ) + ((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "") + httpContext.getScriptPath( ) + "com.mujermorena.workwithplus.nativemobile.wwpgetradialgaugewhite" + "?wsdl to get the WSDL." ;
         }
      }
      if ( currSoapErr == 0 )
      {
                     ...
                     if ( GXSoapXMLReader.getIsSimple() == 0 )
                     {
                        ...
                        while ( ( ( GXutil.strcmp(GXSoapXMLReader.getName(), sTagName) != 0 ) || ( GXSoapXMLReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Value") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              ...
                              AV9Value = (short)(GXutil.lval( GXSoapXMLReader.getValue())) ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPGetRadialGaugeWhite.ExecuteResponse");
   ...
   public void execute_int( short aP0 ,
                            String[] aP1 )
   {
      wwpgetradialgaugewhite_impl.this.AV9Value = aP0;
      wwpgetradialgaugewhite_impl.this.aP1 = aP1;
      initialize();
      privateExecute();
   }
   ...
   private void privateExecute( )
   {
      ...
      new com.mujermorena.workwithplus.nativemobile.wwpgetradialgauge(remoteHandle, context).execute( AV9Value, "", "#fff", "#fff", "#eee6", true, GXv_char2) ;
      wwpgetradialgaugewhite_impl.this.GXt_char1 = GXv_char2[0] ;
      AV8HTML = GXt_char1 ;
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP1[0] = wwpgetradialgaugewhite_impl.this.AV8HTML;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
