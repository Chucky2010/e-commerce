...
public final  class wwpgetunicodefromhex_impl extends GXWebProcedure
{
   public wwpgetunicodefromhex_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpgetunicodefromhex_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpgetunicodefromhex_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHex");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHex.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "Hexaunicode");
            GXSoapXMLWriter.writeAttribute("type", "xsd:string");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHex.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            GXSoapXMLWriter.writeAttribute("maxOccurs", "1");
            GXSoapXMLWriter.writeAttribute("name", "Unicodecharacter");
            GXSoapXMLWriter.writeAttribute("type", "xsd:string");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHex.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetUnicodeFromHex.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHex.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetUnicodeFromHex.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHexSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetUnicodeFromHex.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetUnicodeFromHex.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHexSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPGetUnicodeFromHexSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPGETUNICODEFROMHEX.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetUnicodeFromHexSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPGetUnicodeFromHexSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpgetunicodefromhex");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
                  ...
                  if ( currSoapErr == 0 )
                  {
                     ...
                     if ( GXSoapXMLReader.getIsSimple() == 0 )
                     {
                        ...
                        while ( ( ( GXutil.strcmp(GXSoapXMLReader.getName(), sTagName) != 0 ) || ( GXSoapXMLReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
                        {
                           readOk = (short)(0) ;
                           readElement = false ;
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Hexaunicode") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              AV8HexaUnicode = GXSoapXMLReader.getValue() ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPGetUnicodeFromHex.ExecuteResponse");
         GXSoapXMLWriter.writeAttribute("xmlns", "Mujer_Morena");
         if ( currSoapErr == 0 )
         {
            GXSoapXMLWriter.writeElement("Unicodecharacter", AV9UnicodeCharacter);
            GXSoapXMLWriter.writeAttribute("xmlns", "Mujer_Morena");
         }
         else
         {
   ...
   public void execute_int( String aP0 ,
                            String[] aP1 )
   {
      wwpgetunicodefromhex_impl.this.AV8HexaUnicode = aP0;
      wwpgetunicodefromhex_impl.this.aP1 = aP1;
      initialize();
      privateExecute();
   }
   ...
   {
      GXt_int1 = AV10DecimalValue ;
      GXv_int2[0] = GXt_int1 ;
      new com.mujermorena.workwithplus.nativemobile.wwpgetdecimalfromhex(remoteHandle, context).execute( AV8HexaUnicode, GXv_int2) ;
      wwpgetunicodefromhex_impl.this.GXt_int1 = GXv_int2[0] ;
      AV10DecimalValue = GXt_int1 ;
      AV9UnicodeCharacter = GXutil.chr( (short)(AV10DecimalValue)) ;
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP1[0] = wwpgetunicodefromhex_impl.this.AV9UnicodeCharacter;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
   ...
   private int AV10DecimalValue ;
   private int GXt_int1 ;
   private int GXv_int2[] ;
   private String currSoapErrmsg ;
   private String currMethod ;
   private String sTagName ;
   private String AV9UnicodeCharacter ;
   private String AV8HexaUnicode ;
