...
public final  class wwpgetlineargaugeconfigfrompercentage_impl extends GXWebProcedure
{
   public wwpgetlineargaugeconfigfrompercentage_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwpgetlineargaugeconfigfrompercentage_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwpgetlineargaugeconfigfrompercentage_impl.class ));
   }
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentage");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentage.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "Percentage");
            GXSoapXMLWriter.writeAttribute("type", "xsd:short");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("element");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentage.ExecuteResponse");
            GXSoapXMLWriter.writeStartElement("complexType");
            GXSoapXMLWriter.writeStartElement("sequence");
            GXSoapXMLWriter.writeElement("element", "");
            GXSoapXMLWriter.writeAttribute("minOccurs", "1");
            GXSoapXMLWriter.writeAttribute("maxOccurs", "1");
            GXSoapXMLWriter.writeAttribute("name", "Gaugedata");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentage.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetLinearGaugeConfigFromPercentage.Execute");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("message");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentage.ExecuteSoapOut");
            GXSoapXMLWriter.writeElement("part", "");
            GXSoapXMLWriter.writeAttribute("name", "parameters");
            GXSoapXMLWriter.writeAttribute("element", "tns:WWPGetLinearGaugeConfigFromPercentage.ExecuteResponse");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("portType");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentageSoapPort");
            GXSoapXMLWriter.writeStartElement("operation");
            GXSoapXMLWriter.writeAttribute("name", "Execute");
            GXSoapXMLWriter.writeElement("input", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetLinearGaugeConfigFromPercentage.ExecuteSoapIn");
            GXSoapXMLWriter.writeElement("output", "");
            GXSoapXMLWriter.writeAttribute("message", "wsdlns:"+"WWPGetLinearGaugeConfigFromPercentage.ExecuteSoapOut");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeStartElement("binding");
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentageSoapBinding");
            GXSoapXMLWriter.writeAttribute("type", "wsdlns:"+"WWPGetLinearGaugeConfigFromPercentageSoapPort");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "Mujer_Morenaaction/"+"workwithplus.nativemobile.AWWPGETLINEARGAUGECONFIGFROMPERCENTAGE.Execute");
            ...
            GXSoapXMLWriter.writeAttribute("name", "WWPGetLinearGaugeConfigFromPercentageSoapPort");
            GXSoapXMLWriter.writeAttribute("binding", "wsdlns:"+"WWPGetLinearGaugeConfigFromPercentageSoapBinding");
            GXSoapXMLWriter.writeElement("soap:address", "");
            GXSoapXMLWriter.writeAttribute("location", "http://"+httpContext.getServerName( )+((httpContext.getServerPort( )>0)&&(httpContext.getServerPort( )!=80)&&(httpContext.getServerPort( )!=443) ? ":"+GXutil.ltrim( GXutil.str( httpContext.getServerPort( ), 6, 0)) : "")+httpContext.getScriptPath( )+"com.mujermorena.workwithplus.nativemobile.wwpgetlineargaugeconfigfrompercentage");
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
            GXSoapXMLWriter.writeEndElement();
                  ...
                  if ( currSoapErr == 0 )
                  {
                     ...
                     if ( GXSoapXMLReader.getIsSimple() == 0 )
                     {
                        ...
                        while ( ( ( GXutil.strcmp(GXSoapXMLReader.getName(), sTagName) != 0 ) || ( GXSoapXMLReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
                        {
                           readOk = (short)(0) ;
                           readElement = false ;
                           if ( GXutil.strcmp2( GXSoapXMLReader.getLocalName(), "Percentage") && ( GXSoapXMLReader.getNodeType() != 2 ) && ( GXutil.strcmp(GXSoapXMLReader.getNamespaceURI(), "Mujer_Morena") == 0 ) )
                           {
                              if ( GXutil.notNumeric( GXSoapXMLReader.getValue()) )
                              {
                                 formatError = true ;
                              }
                              AV9Percentage = (short)(GXutil.lval( GXSoapXMLReader.getValue())) ;
                              readElement = true ;
                              if ( GXSoapError > 0 )
                              {
                                 readOk = (short)(1) ;
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeStartElement("WWPGetLinearGaugeConfigFromPercentage.ExecuteResponse");
         GXSoapXMLWriter.writeAttribute("xmlns", "Mujer_Morena");
         if ( currSoapErr == 0 )
         {
            GXSoapXMLWriter.writeElement("Gaugedata", AV8GaugeData);
            GXSoapXMLWriter.writeAttribute("xmlns", "Mujer_Morena");
         }
         else
         {
   ...
   public void execute_int( short aP0 ,
                            String[] aP1 )
   {
      wwpgetlineargaugeconfigfrompercentage_impl.this.AV9Percentage = aP0;
      wwpgetlineargaugeconfigfrompercentage_impl.this.aP1 = aP1;
      initialize();
      privateExecute();
   }
   ...
   {
      AV8GaugeData = GXutil.format( "{\"Type\":\"\",\"Title\":\"\",\"Height\":12,\"Width\":0,\"MaxValue\":100,\"MinValue\":0,\"Value\":%1,\"Thickness\":0,\"ShowMinMax\":false,\"ShowValue\":false,\"Ranges\":[{\"Color\":\"#9a9a9a\",\"Name\":\"\",\"Length\":%1},{\"Color\":\"#e4e4e4\",\"Name\":\"\",\"Length\":%2}]}", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9Percentage), 3, 0), GXutil.ltrimstr( DecimalUtil.doubleToDec((double)(100-AV9Percentage)), 9, 0), "", "", "", "", "", "", "") ;
   ...
   protected void cleanup( )
   {
      if ( initialized != 1 )
      {
         this.aP1[0] = wwpgetlineargaugeconfigfrompercentage_impl.this.AV8GaugeData;
      }
      CloseOpenCursors();
      if ( initialized == 1 )
      {
