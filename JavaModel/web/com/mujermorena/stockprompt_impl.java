...
public final  class stockprompt_impl extends GXDataArea
{
   public stockprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public stockprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( stockprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutStockId") ;
         ...
         {
            AV8InOutStockId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutStockId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutStockId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.stockprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutStockId,11,0))}, new String[] {"InOutStockId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTSTOCKID", GXutil.ltrim( localUtil.ntoc( AV8InOutStockId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.stockprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutStockId,11,0))}, new String[] {"InOutStockId"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Selecciona Stock", "") ;
   }
   ...
   public void wb4S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_4S2( true) ;
      }
      else
      {
         wb_table1_14_4S2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_4S2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start4S2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Stock", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf4S2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
         /* Using cursor H004S2 */
         pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A233StockTotal = H004S2_A233StockTotal[0] ;
            A76ArticuloNombre = H004S2_A76ArticuloNombre[0] ;
            A13ArticuloId = H004S2_A13ArticuloId[0] ;
            A46StockId = H004S2_A46StockId[0] ;
            A76ArticuloNombre = H004S2_A76ArticuloNombre[0] ;
            e174S2 ();
   ...
   public void send_integrity_lvl_hashes4S2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV21Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV21Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_STOCKID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A46StockId), "ZZZZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV12FilterFullText = GXutil.concat( GXutil.rtrim( AV12FilterFullText), "%", "") ;
      /* Using cursor H004S3 */
      pr_default.execute(1, new Object[] {lV12FilterFullText, lV12FilterFullText, lV12FilterFullText, lV12FilterFullText});
   ...
   public void e154S2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Stock", "") );
   ...
   public void e164S2( )
   {
      ...
      stockprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e184S2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutStockId = A46StockId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutStockId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutStockId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutStockId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutStockId"});
   ...
   public void wb_table1_14_4S2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_StockPrompt.htm");
   ...
   {
      AV8InOutStockId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutStockId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutStockId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111221956", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("stockprompt.js", "?202412111221956", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:StockId|2:ArticuloId|3:ArticuloNombre|4:StockTotal" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e174S2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e184S2',iparms:[{av:'A46StockId',fld:'STOCKID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutStockId',fld:'vINOUTSTOCKID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e144S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H004S2_A233StockTotal = new int[1] ;
      H004S2_A76ArticuloNombre = new String[] {""} ;
      H004S2_A13ArticuloId = new long[1] ;
      H004S2_A46StockId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.stockprompt__default(),
         new Object[] {
             new Object[] {
            H004S2_A233StockTotal, H004S2_A76ArticuloNombre, H004S2_A13ArticuloId, H004S2_A46StockId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutStockId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutStockId ;
   ...
   private int[] H004S2_A233StockTotal ;
   private String[] H004S2_A76ArticuloNombre ;
   private long[] H004S2_A13ArticuloId ;
   private long[] H004S2_A46StockId ;
...
final  class stockprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004S2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H004S3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12FilterFullText ,
                                          long A46StockId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004S2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H004S3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004S2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004S3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
