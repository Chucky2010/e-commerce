...
public final  class agenerarfacturasd extends GXReport
{
   public static void main( String args[] )
   {
      Application.init(com.mujermorena.GXcfg.class);
      agenerarfacturasd pgm = new agenerarfacturasd (-1);
   ...
   public agenerarfacturasd( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( agenerarfacturasd.class ), "" );
   }
   ...
   {
      agenerarfacturasd.this.AV12VentasPedido = aP0;
      initialize();
      /* GeneXus formulas */
   ...
   {
      GXutil.refClasses(generarfacturasd.class);
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.agenerarfacturasd__default(),
         new Object[] {
             new Object[] {
...
final  class agenerarfacturasd__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
