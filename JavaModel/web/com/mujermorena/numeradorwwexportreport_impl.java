...
public final  class numeradorwwexportreport_impl extends GXWebReport
{
   public numeradorwwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "numeradorww_Execute", GXv_boolean2) ;
         numeradorwwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Numerador", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "ID", ""), 30, Gx_line+10, 532, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Ultimo NRO", ""), 536, Gx_line+10, 787, Gx_line+25, 2, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Numeradorwwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Numeradorwwds_1_filterfulltext ,
                                           A49NumeradorID ,
      ...
      lV35Numeradorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Numeradorwwds_1_filterfulltext), "%", "") ;
      lV35Numeradorwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Numeradorwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P004N2 */
      pr_default.execute(0, new Object[] {lV35Numeradorwwds_1_filterfulltext, lV35Numeradorwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A232NumeradorUltimoNRO = P004N2_A232NumeradorUltimoNRO[0] ;
         A49NumeradorID = P004N2_A49NumeradorID[0] ;
         ...
         h4N0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A49NumeradorID, "")), 30, Gx_line+10, 532, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A232NumeradorUltimoNRO), "ZZZZZZZZZ9")), 536, Gx_line+10, 787, Gx_line+25, 2, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("NumeradorWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "NumeradorWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("NumeradorWWGridState"), null, null);
      }
   ...
   public void h4N0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Numeradorwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Numeradorwwds_1_filterfulltext = "" ;
      P004N2_A232NumeradorUltimoNRO = new long[1] ;
      P004N2_A49NumeradorID = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.numeradorwwexportreport__default(),
         new Object[] {
             new Object[] {
            P004N2_A232NumeradorUltimoNRO, P004N2_A49NumeradorID
            }
         }
      );
   ...
   private String AV35Numeradorwwds_1_filterfulltext ;
   private String lV35Numeradorwwds_1_filterfulltext ;
   ...
   private long[] P004N2_A232NumeradorUltimoNRO ;
   private String[] P004N2_A49NumeradorID ;
...
final  class numeradorwwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P004N2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Numeradorwwds_1_filterfulltext ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT [NumeradorUltimoNRO], [NumeradorID] FROM [Numerador]" ;
      if ( ! (GXutil.strcmp("", AV35Numeradorwwds_1_filterfulltext)==0) )
      {
      ...
      {
         scmdbuf += " ORDER BY [NumeradorID]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY [NumeradorID] DESC" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
      {
         scmdbuf += " ORDER BY [NumeradorUltimoNRO]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         scmdbuf += " ORDER BY [NumeradorUltimoNRO] DESC" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P004N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
