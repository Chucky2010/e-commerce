...
public final  class departamentowwexport extends GXProcedure
{
   public departamentowwexport( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( departamentowwexport.class ), "" );
   }
   ...
   {
      departamentowwexport.this.aP1 = new String[] {""};
      execute_int(aP0, aP1);
      return aP1[0];
   }
   ...
   private void execute_int( String[] aP0 ,
                             String[] aP1 )
   {
      departamentowwexport.this.aP0 = aP0;
      departamentowwexport.this.aP1 = aP1;
      initialize();
      /* GeneXus formulas */
   ...
   public void S111( )
   {
      ...
      AV12Filename = "DepartamentoWWExport-" + GXutil.trim( GXutil.str( AV16Random, 8, 0)) + ".xlsx" ;
   ...
   public void S151( )
   {
      /* 'WRITEDATA' Routine */
      returnInSub = false ;
      AV27Departamentowwds_1_filterfulltext = AV19FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV27Departamentowwds_1_filterfulltext ,
      ...
      lV27Departamentowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Departamentowwds_1_filterfulltext), "%", "") ;
      lV27Departamentowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Departamentowwds_1_filterfulltext), "%", "") ;
      lV27Departamentowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV27Departamentowwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003U2 */
      pr_default.execute(0, new Object[] {lV27Departamentowwds_1_filterfulltext, lV27Departamentowwds_1_filterfulltext, lV27Departamentowwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A5PaisId = P003U2_A5PaisId[0] ;
         A6DepartamentoId = P003U2_A6DepartamentoId[0] ;
         A61DepartamentoNombre = P003U2_A61DepartamentoNombre[0] ;
         ...
         AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).setNumber( A6DepartamentoId );
         GXt_char4 = "" ;
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.wwp_export_securetext(remoteHandle, context).execute( A61DepartamentoNombre, GXv_char5) ;
         departamentowwexport.this.GXt_char4 = GXv_char5[0] ;
         AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).setText( GXt_char4 );
         AV11ExcelDocument.Cells(AV14CellRow, AV15FirstColumn+2, 1, 1).setNumber( A5PaisId );
   ...
   public void S191( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV20Session.getValue("DepartamentoWWGridState"), "") == 0 )
      {
         AV22GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "DepartamentoWWGridState"), null, null);
      }
      else
      {
         AV22GridState.fromxml(AV20Session.getValue("DepartamentoWWGridState"), null, null);
      }
   ...
   {
      this.aP0[0] = departamentowwexport.this.AV12Filename;
      this.aP1[0] = departamentowwexport.this.AV13ErrorMessage;
      CloseOpenCursors();
   ...
   public void initialize( )
   {
      ...
      AV27Departamentowwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV27Departamentowwds_1_filterfulltext = "" ;
      P003U2_A5PaisId = new long[1] ;
      P003U2_A6DepartamentoId = new long[1] ;
      P003U2_A61DepartamentoNombre = new String[] {""} ;
      GXt_char4 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.departamentowwexport__default(),
         new Object[] {
             new Object[] {
            P003U2_A5PaisId, P003U2_A6DepartamentoId, P003U2_A61DepartamentoNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String AV27Departamentowwds_1_filterfulltext ;
   private String lV27Departamentowwds_1_filterfulltext ;
   private com.genexus.webpanels.WebSession AV20Session ;
   private String[] aP1 ;
   private String[] aP0 ;
   private IDataStoreProvider pr_default ;
   private long[] P003U2_A5PaisId ;
   private long[] P003U2_A6DepartamentoId ;
   private String[] P003U2_A61DepartamentoNombre ;
...
final  class departamentowwexport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P003U2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV27Departamentowwds_1_filterfulltext ,
                                          ...
                                          boolean AV18OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV27Departamentowwds_1_filterfulltext)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003U2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
