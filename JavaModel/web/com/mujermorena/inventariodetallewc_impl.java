...
public final  class inventariodetallewc_impl extends GXWebComponent
{
   public inventariodetallewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public inventariodetallewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( inventariodetallewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8InventarioID = GXutil.lval( httpContext.GetPar( "InventarioID")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8InventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InventarioID), 11, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Long.valueOf(AV8InventarioID)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8InventarioID, AV25Pgmname, AV14OrderedBy, AV15OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Inventario Detalle WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.inventariodetallewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InventarioID,11,0))}, new String[] {"InventarioID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8InventarioID", GXutil.ltrim( localUtil.ntoc( wcpOAV8InventarioID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vINVENTARIOID", GXutil.ltrim( localUtil.ntoc( AV8InventarioID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return "InventarioDetalleWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Inventario Detalle WC", "") ;
   }
   ...
   public void wb5V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.mujermorena.inventariodetallewc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void start5V2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Inventario Detalle WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV25Pgmname = "InventarioDetalleWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf5V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H005V2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV8InventarioID), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A53InventarioID = H005V2_A53InventarioID[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A53InventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(A53InventarioID), 11, 0));
            A264InventarioDetalleStock4 = H005V2_A264InventarioDetalleStock4[0] ;
            A263InventarioDetalleStock3 = H005V2_A263InventarioDetalleStock3[0] ;
            A262InventarioDetalleStock2 = H005V2_A262InventarioDetalleStock2[0] ;
            A259InventarioDetalleStock = H005V2_A259InventarioDetalleStock[0] ;
            A76ArticuloNombre = H005V2_A76ArticuloNombre[0] ;
            A13ArticuloId = H005V2_A13ArticuloId[0] ;
            A54InventarioDetalleID = H005V2_A54InventarioDetalleID[0] ;
            A79ArticuloStock = H005V2_A79ArticuloStock[0] ;
            A261InventarioDetalleStockOk = H005V2_A261InventarioDetalleStockOk[0] ;
            A76ArticuloNombre = H005V2_A76ArticuloNombre[0] ;
            A79ArticuloStock = H005V2_A79ArticuloStock[0] ;
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H005V3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV8InventarioID)});
   ...
   public void strup5V0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8InventarioID = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8InventarioID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
   ...
   public void e145V2( )
   {
      ...
      edtInventarioID_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtInventarioID_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtInventarioID_Visible), 5, 0), true);
   ...
   public void e155V2( )
   {
      ...
      inventariodetallewc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "InventarioID" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8InventarioID, 11, 0) );
   ...
   {
      AV8InventarioID = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8InventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InventarioID), 11, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8InventarioID = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "inventariodetallewc", GetJustCreated( ));
      ...
      {
         AV8InventarioID = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8InventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InventarioID), 11, 0));
      }
      wcpOAV8InventarioID = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8InventarioID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      if ( ! GetJustCreated( ) && ( ( AV8InventarioID != wcpOAV8InventarioID ) ) )
      {
         setjustcreated();
      }
      wcpOAV8InventarioID = AV8InventarioID ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8InventarioID = httpContext.cgiGet( sPrefix+"AV8InventarioID_CTRL") ;
      if ( GXutil.len( sCtrlAV8InventarioID) > 0 )
      {
         AV8InventarioID = localUtil.ctol( httpContext.cgiGet( sCtrlAV8InventarioID), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8InventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InventarioID), 11, 0));
      }
      else
      {
         AV8InventarioID = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8InventarioID_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) ;
      }
   }
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8InventarioID_PARM", GXutil.ltrim( localUtil.ntoc( AV8InventarioID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8InventarioID)) > 0 )
      {
         com.mujermorena.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8InventarioID_CTRL", GXutil.rtrim( sCtrlAV8InventarioID));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111105185", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("inventariodetallewc.js", "?202412111105185", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtInventarioDetalleID_Internalname = sPrefix+"INVENTARIODETALLEID_"+sGXsfl_15_idx ;
      ...
      edtArticuloStock_Internalname = sPrefix+"ARTICULOSTOCK_"+sGXsfl_15_idx ;
      edtInventarioDetalleStock_Internalname = sPrefix+"INVENTARIODETALLESTOCK_"+sGXsfl_15_idx ;
      edtInventarioDetalleStock2_Internalname = sPrefix+"INVENTARIODETALLESTOCK2_"+sGXsfl_15_idx ;
      edtInventarioDetalleStock3_Internalname = sPrefix+"INVENTARIODETALLESTOCK3_"+sGXsfl_15_idx ;
      edtInventarioDetalleStock4_Internalname = sPrefix+"INVENTARIODETALLESTOCK4_"+sGXsfl_15_idx ;
      edtInventarioDetalleStockOk_Internalname = sPrefix+"INVENTARIODETALLESTOCKOK_"+sGXsfl_15_idx ;
      edtInventarioDetalleDiferencia_Internalname = sPrefix+"INVENTARIODETALLEDIFERENCIA_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtInventarioDetalleID_Internalname = sPrefix+"INVENTARIODETALLEID_"+sGXsfl_15_fel_idx ;
      ...
      edtArticuloStock_Internalname = sPrefix+"ARTICULOSTOCK_"+sGXsfl_15_fel_idx ;
      edtInventarioDetalleStock_Internalname = sPrefix+"INVENTARIODETALLESTOCK_"+sGXsfl_15_fel_idx ;
      edtInventarioDetalleStock2_Internalname = sPrefix+"INVENTARIODETALLESTOCK2_"+sGXsfl_15_fel_idx ;
      edtInventarioDetalleStock3_Internalname = sPrefix+"INVENTARIODETALLESTOCK3_"+sGXsfl_15_fel_idx ;
      edtInventarioDetalleStock4_Internalname = sPrefix+"INVENTARIODETALLESTOCK4_"+sGXsfl_15_fel_idx ;
      edtInventarioDetalleStockOk_Internalname = sPrefix+"INVENTARIODETALLESTOCKOK_"+sGXsfl_15_fel_idx ;
      edtInventarioDetalleDiferencia_Internalname = sPrefix+"INVENTARIODETALLEDIFERENCIA_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStock_Internalname,GXutil.ltrim( localUtil.ntoc( A259InventarioDetalleStock, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A259InventarioDetalleStock), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStock_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStock2_Internalname,GXutil.ltrim( localUtil.ntoc( A262InventarioDetalleStock2, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A262InventarioDetalleStock2), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStock2_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtInventarioDetalleStockOk_Internalname,GXutil.ltrim( localUtil.ntoc( A261InventarioDetalleStockOk, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A261InventarioDetalleStockOk), "ZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtInventarioDetalleStockOk_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Stock","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
   ...
   {
      edtInventarioDetalleID_Internalname = sPrefix+"INVENTARIODETALLEID" ;
      ...
      edtInventarioDetalleStock_Internalname = sPrefix+"INVENTARIODETALLESTOCK" ;
      edtInventarioDetalleStock2_Internalname = sPrefix+"INVENTARIODETALLESTOCK2" ;
      edtInventarioDetalleStock3_Internalname = sPrefix+"INVENTARIODETALLESTOCK3" ;
      edtInventarioDetalleStock4_Internalname = sPrefix+"INVENTARIODETALLESTOCK4" ;
      edtInventarioDetalleStockOk_Internalname = sPrefix+"INVENTARIODETALLESTOCKOK" ;
      edtInventarioDetalleDiferencia_Internalname = sPrefix+"INVENTARIODETALLEDIFERENCIA" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtInventarioID_Visible = 1 ;
      Grid_empowerer_Hastitlesettings = GXutil.toBoolean( -1) ;
      Ddo_grid_Includesortasc = "T" ;
      Ddo_grid_Columnssortvalues = "1|2|3|4|5|6|7|8|9" ;
      Ddo_grid_Columnids = "0:InventarioDetalleID|1:ArticuloId|2:ArticuloNombre|3:ArticuloStock|4:InventarioDetalleStock|5:InventarioDetalleStock2|6:InventarioDetalleStock3|7:InventarioDetalleStock4|8:InventarioDetalleStockOk" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8InventarioID',fld:'vINVENTARIOID',pic:'ZZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e165V2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A76ArticuloNombre = "" ;
      scmdbuf = "" ;
      H005V2_A53InventarioID = new long[1] ;
      H005V2_A264InventarioDetalleStock4 = new long[1] ;
      H005V2_A263InventarioDetalleStock3 = new long[1] ;
      H005V2_A262InventarioDetalleStock2 = new long[1] ;
      H005V2_A259InventarioDetalleStock = new long[1] ;
      H005V2_A76ArticuloNombre = new String[] {""} ;
      H005V2_A13ArticuloId = new long[1] ;
      H005V2_A54InventarioDetalleID = new long[1] ;
      H005V2_A79ArticuloStock = new long[1] ;
      H005V2_A261InventarioDetalleStockOk = new long[1] ;
      ...
      sCtrlAV8InventarioID = "" ;
      subGrid_Linesclass = "" ;
      ROClassString = "" ;
      GridColumn = new com.genexus.webpanels.GXWebColumn();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.inventariodetallewc__default(),
         new Object[] {
             new Object[] {
            H005V2_A53InventarioID, H005V2_A264InventarioDetalleStock4, H005V2_A263InventarioDetalleStock3, H005V2_A262InventarioDetalleStock2, H005V2_A259InventarioDetalleStock, H005V2_A76ArticuloNombre, H005V2_A13ArticuloId, H005V2_A54InventarioDetalleID, H005V2_A79ArticuloStock, H005V2_A261InventarioDetalleStockOk
            }
            , new Object[] {
   ...
   private int edtInventarioID_Visible ;
   ...
   private long wcpOAV8InventarioID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InventarioID ;
   ...
   private String sCtrlAV8InventarioID ;
   ...
   private long[] H005V2_A53InventarioID ;
   private long[] H005V2_A264InventarioDetalleStock4 ;
   private long[] H005V2_A263InventarioDetalleStock3 ;
   private long[] H005V2_A262InventarioDetalleStock2 ;
   private long[] H005V2_A259InventarioDetalleStock ;
   private String[] H005V2_A76ArticuloNombre ;
   private long[] H005V2_A13ArticuloId ;
   private long[] H005V2_A54InventarioDetalleID ;
   private long[] H005V2_A79ArticuloStock ;
   private long[] H005V2_A261InventarioDetalleStockOk ;
...
final  class inventariodetallewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          long A53InventarioID )
   {
      ...
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[InventarioDetalleID] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[ArticuloId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[ArticuloId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T2.[ArticuloNombre]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T2.[ArticuloNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T2.[ArticuloStock]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T2.[ArticuloStock] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleStock]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[InventarioDetalleStock] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleStock2]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[InventarioDetalleStock2] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleStock3]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[InventarioDetalleStock3] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleStock4]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[InventarioDetalleStock4] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleStockOk]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[InventarioID] DESC, T1.[InventarioDetalleStockOk] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[InventarioID], T1.[InventarioDetalleID]" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005V2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
            case 1 :
                  return conditional_H005V3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
      }
