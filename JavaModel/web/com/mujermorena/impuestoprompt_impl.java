...
public final  class impuestoprompt_impl extends GXDataArea
{
   public impuestoprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public impuestoprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( impuestoprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutImpuestoId") ;
         ...
         {
            AV8InOutImpuestoId = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutImpuestoId), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.impuestoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutImpuestoId,11,0))}, new String[] {"InOutImpuestoId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTIMPUESTOID", GXutil.ltrim( localUtil.ntoc( AV8InOutImpuestoId, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.impuestoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutImpuestoId,11,0))}, new String[] {"InOutImpuestoId"})  ;
   }

   public String getPgmname( )
   {
      return "ImpuestoPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Impuesto", "") ;
   }
   ...
   public void wb0Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_0Z2( true) ;
      }
      else
      {
         wb_table1_14_0Z2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_0Z2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0Z2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Impuesto", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf0Z2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A224ImpuestoDivisor = H000Z2_A224ImpuestoDivisor[0] ;
            A83ImpuestoPorcentaje = H000Z2_A83ImpuestoPorcentaje[0] ;
            A223ImpuestoDescripcion = H000Z2_A223ImpuestoDescripcion[0] ;
            A18ImpuestoId = H000Z2_A18ImpuestoId[0] ;
            e170Z2 ();
   ...
   public void send_integrity_lvl_hashes0Z2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_IMPUESTOID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A18ImpuestoId), "ZZZZZZZZZZ9")));
   }
   ...
   public void e150Z2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Impuesto", "") );
   ...
   public void e160Z2( )
   {
      ...
      impuestoprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e180Z2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutImpuestoId = A18ImpuestoId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutImpuestoId), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutImpuestoId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutImpuestoId"});
   ...
   public void wb_table1_14_0Z2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_ImpuestoPrompt.htm");
   ...
   {
      AV8InOutImpuestoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutImpuestoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutImpuestoId), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111123684", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("impuestoprompt.js", "?202412111123684", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtImpuestoDescripcion_Internalname = "IMPUESTODESCRIPCION_"+sGXsfl_26_idx ;
      edtImpuestoPorcentaje_Internalname = "IMPUESTOPORCENTAJE_"+sGXsfl_26_idx ;
      edtImpuestoDivisor_Internalname = "IMPUESTODIVISOR_"+sGXsfl_26_idx ;
   }
   ...
   public void subsflControlProps_fel_262( )
   {
      ...
      edtImpuestoDescripcion_Internalname = "IMPUESTODESCRIPCION_"+sGXsfl_26_fel_idx ;
      edtImpuestoPorcentaje_Internalname = "IMPUESTOPORCENTAJE_"+sGXsfl_26_fel_idx ;
      edtImpuestoDivisor_Internalname = "IMPUESTODIVISOR_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ImpuestoId|2:ImpuestoDescripcion|3:ImpuestoPorcentaje|4:ImpuestoDivisor" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("ENTER","{handler:'e180Z2',iparms:[{av:'A18ImpuestoId',fld:'IMPUESTOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutImpuestoId',fld:'vINOUTIMPUESTOID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e140Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H000Z2_A224ImpuestoDivisor = new short[1] ;
      H000Z2_A83ImpuestoPorcentaje = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000Z2_A223ImpuestoDescripcion = new String[] {""} ;
      H000Z2_A18ImpuestoId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.impuestoprompt__default(),
         new Object[] {
             new Object[] {
            H000Z2_A224ImpuestoDivisor, H000Z2_A83ImpuestoPorcentaje, H000Z2_A223ImpuestoDescripcion, H000Z2_A18ImpuestoId
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutImpuestoId ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutImpuestoId ;
   ...
   private short[] H000Z2_A224ImpuestoDivisor ;
   private java.math.BigDecimal[] H000Z2_A83ImpuestoPorcentaje ;
   private String[] H000Z2_A223ImpuestoDescripcion ;
   private long[] H000Z2_A18ImpuestoId ;
...
final  class impuestoprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000Z2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (java.math.BigDecimal)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H000Z3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (java.math.BigDecimal)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
