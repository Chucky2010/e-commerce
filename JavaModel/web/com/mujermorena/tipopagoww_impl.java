...
public final  class tipopagoww_impl extends GXDataArea
{
   public tipopagoww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipopagoww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipopagoww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.tipopagoww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.tipopagoww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Tipo Pago", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_TipoPagoWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_TipoPagoWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_0R2( true) ;
      }
      else
      {
         wb_table1_22_0R2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_0R2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOPAGOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A9TipoPagoId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "TIPOPAGOID", GXutil.ltrim( localUtil.ntoc( A9TipoPagoId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf0R2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV39Tipopagowwds_1_filterfulltext ,
         ...
         lV39Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopagowwds_1_filterfulltext), "%", "") ;
         lV39Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopagowwds_1_filterfulltext), "%", "") ;
         lV39Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopagowwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000R2 */
         pr_default.execute(0, new Object[] {lV39Tipopagowwds_1_filterfulltext, lV39Tipopagowwds_1_filterfulltext, lV39Tipopagowwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A297TipoPagoDato = H000R2_A297TipoPagoDato[0] ;
            A71TipoPagoNombre = H000R2_A71TipoPagoNombre[0] ;
            A9TipoPagoId = H000R2_A9TipoPagoId[0] ;
            e190R2 ();
   ...
   public void send_integrity_lvl_hashes0R2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV35IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_TIPOPAGOID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A9TipoPagoId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV39Tipopagowwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV39Tipopagowwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Tipopagowwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000R3 */
      pr_default.execute(1, new Object[] {lV39Tipopagowwds_1_filterfulltext, lV39Tipopagowwds_1_filterfulltext, lV39Tipopagowwds_1_filterfulltext});
   ...
   public void e180R2( )
   {
      ...
      tipopagoww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e190R2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.tipopagoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A9TipoPagoId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"TipoPagoId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.tipopago", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A9TipoPagoId,11,0))}, new String[] {"Mode","TipoPagoId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.tipopago", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A9TipoPagoId,11,0))}, new String[] {"Mode","TipoPagoId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e110R2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPagoWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV38Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("TipoPagoWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "TipoPagoWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         tipopagoww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e160R2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.tipopago", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","TipoPagoId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopagoview_Execute", GXv_boolean7) ;
      tipopagoww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopago_Update", GXv_boolean7) ;
      tipopagoww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopago_Delete", GXv_boolean7) ;
      tipopagoww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "tipopago_Insert", GXv_boolean7) ;
      tipopagoww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "TipoPagoWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "TipoPago" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.tipopagowwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      tipopagoww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      tipopagoww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.tipopagowwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_0R2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_0R2( true) ;
      }
      else
      {
         wb_table2_27_0R2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_0R2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_0R2e( true) ;
      }
      else
      {
         wb_table1_22_0R2e( false) ;
      }
   }

   public void wb_table2_27_0R2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111121015", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipopagoww.js", "?202412111121015", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_402( )
   {
      ...
      edtTipoPagoDato_Internalname = "TIPOPAGODATO_"+sGXsfl_40_idx ;
   }
   ...
   public void subsflControlProps_fel_402( )
   {
      ...
      edtTipoPagoDato_Internalname = "TIPOPAGODATO_"+sGXsfl_40_fel_idx ;
   }
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTipoPagoDato_Internalname,GXutil.rtrim( A297TipoPagoDato),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTipoPagoDato_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol40( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Pago Nombre", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Pago Dato", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A297TipoPagoDato));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:TipoPagoId|4:TipoPagoNombre|5:TipoPagoDato" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOINSERT'","{handler:'e160R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A9TipoPagoId',fld:'TIPOPAGOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e140R2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Tipopagodato',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A297TipoPagoDato = "" ;
      scmdbuf = "" ;
      lV39Tipopagowwds_1_filterfulltext = "" ;
      AV39Tipopagowwds_1_filterfulltext = "" ;
      H000R2_A297TipoPagoDato = new String[] {""} ;
      H000R2_A71TipoPagoNombre = new String[] {""} ;
      H000R2_A9TipoPagoId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.tipopagoww__default(),
         new Object[] {
             new Object[] {
            H000R2_A297TipoPagoDato, H000R2_A71TipoPagoNombre, H000R2_A9TipoPagoId
            }
            , new Object[] {
   ...
   private String lV39Tipopagowwds_1_filterfulltext ;
   private String AV39Tipopagowwds_1_filterfulltext ;
   ...
   private String[] H000R2_A297TipoPagoDato ;
   private String[] H000R2_A71TipoPagoNombre ;
   private long[] H000R2_A9TipoPagoId ;
...
final  class tipopagoww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000R2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Tipopagowwds_1_filterfulltext ,
                                          long A9TipoPagoId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [TipoPagoDato], [TipoPagoNombre], [TipoPagoId]" ;
      sFromString = " FROM [TipoPago]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV39Tipopagowwds_1_filterfulltext)==0) )
      {
      ...
      {
         sOrderString += " ORDER BY [TipoPagoId]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoPagoId] DESC" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [TipoPagoNombre]" ;
      }
      else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoPagoNombre] DESC" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
      {
         sOrderString += " ORDER BY [TipoPagoDato]" ;
      }
      else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TipoPagoDato] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [TipoPagoId]" ;
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [TipoPago]" ;
      if ( ! (GXutil.strcmp("", AV39Tipopagowwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST([TipoPagoId] AS decimal(11,0))) like '%' + ?) or ( [TipoPagoNombre] like '%' + ?) or ( [TipoPagoDato] like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000R2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H000R3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
