...
public final  class localidadwwexportreport_impl extends GXWebReport
{
   public localidadwwexportreport_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      try
      {
         ...
         new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "localidadww_Execute", GXv_boolean2) ;
         localidadwwexportreport_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
         ...
         if ( AV8IsAuthorized )
         {
            ...
            AV28Title = httpContext.getMessage( "Lista de Localidad", "") ;
   ...
   public void S121( ) throws ProcessInterruptedException
   {
      ...
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 107, Gx_line+10, 253, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Id", ""), 257, Gx_line+10, 331, Gx_line+25, 2, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 335, Gx_line+10, 483, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 487, Gx_line+10, 635, Gx_line+25, 0, 0, 0, 0) ;
      getPrinter().GxDrawText(httpContext.getMessage( "Nombre", ""), 639, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      Gx_OldLine = Gx_line ;
   ...
   public void S131( ) throws ProcessInterruptedException
   {
      /* 'PRINTDATA' Routine */
      returnInSub = false ;
      AV35Localidadwwds_1_filterfulltext = AV13FilterFullText ;
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           AV35Localidadwwds_1_filterfulltext ,
      ...
      lV35Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Localidadwwds_1_filterfulltext), "%", "") ;
      lV35Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Localidadwwds_1_filterfulltext), "%", "") ;
      lV35Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Localidadwwds_1_filterfulltext), "%", "") ;
      lV35Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Localidadwwds_1_filterfulltext), "%", "") ;
      lV35Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Localidadwwds_1_filterfulltext), "%", "") ;
      lV35Localidadwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV35Localidadwwds_1_filterfulltext), "%", "") ;
      /* Using cursor P003R2 */
      pr_default.execute(0, new Object[] {lV35Localidadwwds_1_filterfulltext, lV35Localidadwwds_1_filterfulltext, lV35Localidadwwds_1_filterfulltext, lV35Localidadwwds_1_filterfulltext, lV35Localidadwwds_1_filterfulltext, lV35Localidadwwds_1_filterfulltext});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A6DepartamentoId = P003R2_A6DepartamentoId[0] ;
         A5PaisId = P003R2_A5PaisId[0] ;
         A7CiudadId = P003R2_A7CiudadId[0] ;
         A3LocalidadId = P003R2_A3LocalidadId[0] ;
         A60PaisNombre = P003R2_A60PaisNombre[0] ;
         A61DepartamentoNombre = P003R2_A61DepartamentoNombre[0] ;
         A62CiudadNombre = P003R2_A62CiudadNombre[0] ;
         A64LocalidadNombre = P003R2_A64LocalidadNombre[0] ;
         A6DepartamentoId = P003R2_A6DepartamentoId[0] ;
         A62CiudadNombre = P003R2_A62CiudadNombre[0] ;
         A5PaisId = P003R2_A5PaisId[0] ;
         A61DepartamentoNombre = P003R2_A61DepartamentoNombre[0] ;
         ...
         h3R0( false, 36) ;
         getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3LocalidadId), "ZZZZZZZZZZ9")), 30, Gx_line+10, 103, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A64LocalidadNombre, "")), 107, Gx_line+10, 253, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A7CiudadId), "ZZZZZZZZZZ9")), 257, Gx_line+10, 331, Gx_line+25, 2, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A62CiudadNombre, "")), 335, Gx_line+10, 483, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A61DepartamentoNombre, "")), 487, Gx_line+10, 635, Gx_line+25, 0, 0, 0, 0) ;
         getPrinter().GxDrawText(GXutil.rtrim( localUtil.format( A60PaisNombre, "")), 639, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
   ...
   public void S151( ) throws ProcessInterruptedException
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV14Session.getValue("LocalidadWWGridState"), "") == 0 )
      {
         AV16GridState.fromxml(new com.mujermorena.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "LocalidadWWGridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV14Session.getValue("LocalidadWWGridState"), null, null);
      }
   ...
   public void h3R0( boolean bFoot ,
                     int Inc )
   {
   ...
   public void initialize( )
   {
      ...
      AV35Localidadwwds_1_filterfulltext = "" ;
      scmdbuf = "" ;
      lV35Localidadwwds_1_filterfulltext = "" ;
      P003R2_A6DepartamentoId = new long[1] ;
      P003R2_A5PaisId = new long[1] ;
      P003R2_A7CiudadId = new long[1] ;
      P003R2_A3LocalidadId = new long[1] ;
      P003R2_A60PaisNombre = new String[] {""} ;
      P003R2_A61DepartamentoNombre = new String[] {""} ;
      P003R2_A62CiudadNombre = new String[] {""} ;
      P003R2_A64LocalidadNombre = new String[] {""} ;
      ...
      AV19AddressLine2 = "" ;
      AV20AddressLine3 = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.localidadwwexportreport__default(),
         new Object[] {
             new Object[] {
            P003R2_A6DepartamentoId, P003R2_A5PaisId, P003R2_A7CiudadId, P003R2_A3LocalidadId, P003R2_A60PaisNombre, P003R2_A61DepartamentoNombre, P003R2_A62CiudadNombre, P003R2_A64LocalidadNombre
            }
         }
      );
   ...
   private String AV35Localidadwwds_1_filterfulltext ;
   private String lV35Localidadwwds_1_filterfulltext ;
   ...
   private long[] P003R2_A6DepartamentoId ;
   private long[] P003R2_A5PaisId ;
   private long[] P003R2_A7CiudadId ;
   private long[] P003R2_A3LocalidadId ;
   private String[] P003R2_A60PaisNombre ;
   private String[] P003R2_A61DepartamentoNombre ;
   private String[] P003R2_A62CiudadNombre ;
   private String[] P003R2_A64LocalidadNombre ;
...
final  class localidadwwexportreport__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P003R2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV35Localidadwwds_1_filterfulltext ,
                                          long A3LocalidadId ,
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      if ( ! (GXutil.strcmp("", AV35Localidadwwds_1_filterfulltext)==0) )
      {
