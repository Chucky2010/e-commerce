...
public final  class stockww_impl extends GXDataArea
{
   public stockww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public stockww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( stockww_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.mujermorena.stockww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.mujermorena.stockww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb1B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Stock", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_StockWW.htm");
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, lblBtninsert_Caption, "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "MenuOption", 5, "", lblBtninsert_Visible, 1, 0, (short)(1), "HLP_StockWW.htm");
         /* Div Control */
         ...
         /* Div Control */
         com.mujermorena.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_1B2( true) ;
      }
      else
      {
         wb_table1_22_1B2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.mujermorena.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_STOCKID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A46StockId), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "STOCKID", GXutil.ltrim( localUtil.ntoc( A46StockId, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf1B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV39Stockwwds_1_filterfulltext ,
                                              Long.valueOf(A46StockId) ,
                                              Long.valueOf(A13ArticuloId) ,
                                              A76ArticuloNombre ,
                                              Integer.valueOf(A233StockTotal) ,
                                              Short.valueOf(AV13OrderedBy) ,
                                              Boolean.valueOf(AV14OrderedDsc) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         lV39Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Stockwwds_1_filterfulltext), "%", "") ;
         lV39Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Stockwwds_1_filterfulltext), "%", "") ;
         lV39Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Stockwwds_1_filterfulltext), "%", "") ;
         lV39Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Stockwwds_1_filterfulltext), "%", "") ;
         /* Using cursor H001B2 */
         pr_default.execute(0, new Object[] {lV39Stockwwds_1_filterfulltext, lV39Stockwwds_1_filterfulltext, lV39Stockwwds_1_filterfulltext, lV39Stockwwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_40_idx = 1 ;
         sGXsfl_40_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_40_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_402( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A233StockTotal = H001B2_A233StockTotal[0] ;
            A76ArticuloNombre = H001B2_A76ArticuloNombre[0] ;
            A13ArticuloId = H001B2_A13ArticuloId[0] ;
            A46StockId = H001B2_A46StockId[0] ;
            A76ArticuloNombre = H001B2_A76ArticuloNombre[0] ;
            e191B2 ();
   ...
   public void send_integrity_lvl_hashes1B2( )
   {
      ...
      com.mujermorena.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_INSERT", getSecureSignedToken( "", AV35IsAuthorized_Insert));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_STOCKID"+"_"+sGXsfl_40_idx, getSecureSignedToken( sGXsfl_40_idx, localUtil.format( DecimalUtil.doubleToDec(A46StockId), "ZZZZZZZZZZ9")));
   }
   ...
   {
      AV39Stockwwds_1_filterfulltext = AV15FilterFullText ;
      ...
      lV39Stockwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV39Stockwwds_1_filterfulltext), "%", "") ;
      /* Using cursor H001B3 */
      pr_default.execute(1, new Object[] {lV39Stockwwds_1_filterfulltext, lV39Stockwwds_1_filterfulltext, lV39Stockwwds_1_filterfulltext, lV39Stockwwds_1_filterfulltext});
   ...
   public void e181B2( )
   {
      ...
      stockww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   private void e191B2( )
   {
      ...
      {
         edtavDisplay_Link = formatLink("com.mujermorena.stockview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A46StockId,11,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"StockId","TabCode"})  ;
      }
      AV29Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV29Update);
      if ( AV30IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("com.mujermorena.stock", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A46StockId,11,0))}, new String[] {"Mode","StockId"})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV31Delete);
      if ( AV32IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.mujermorena.stock", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A46StockId,11,0))}, new String[] {"Mode","StockId"})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e111B2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("StockWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV38Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
      ...
      {
         httpContext.popup(formatLink("com.mujermorena.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("StockWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV21ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV21ManageFiltersExecutionStep", GXutil.str( AV21ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char4 ;
         new com.mujermorena.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "StockWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         stockww_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e161B2( )
   {
      ...
      {
         callWebObject(formatLink("com.mujermorena.stock", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","StockId"}) );
   ...
   public void S152( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "stockview_Execute", GXv_boolean7) ;
      stockww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "stock_Update", GXv_boolean7) ;
      stockww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "stock_Delete", GXv_boolean7) ;
      stockww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.mujermorena.wwpbaseobjects.secgamisauthbyfunctionalitykey(remoteHandle, context).execute( "stock_Insert", GXv_boolean7) ;
      stockww_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.mujermorena.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "StockWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV9TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Stock" );
   ...
   public void S192( )
   {
      ...
      new com.mujermorena.stockwwexport(remoteHandle, context).execute( GXv_char5, GXv_char11) ;
      stockww_impl.this.AV16ExcelFilename = GXv_char5[0] ;
      stockww_impl.this.AV17ErrorMessage = GXv_char11[0] ;
   ...
   public void S202( )
   {
      ...
      S132 ();
      if (returnInSub) return;
      Innewwindow1_Target = formatLink("com.mujermorena.stockwwexportreport", new String[] {}, new String[] {})  ;
   ...
   public void wb_table1_22_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_1B2( true) ;
      }
      else
      {
         wb_table2_27_1B2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_1B2e( true) ;
      }
      else
      {
         wb_table1_22_1B2e( false) ;
      }
   }

   public void wb_table2_27_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111131860", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("stockww.js", "?202412111131860", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void sendrow_402( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "AttributeRealWidth" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtStockTotal_Internalname,GXutil.ltrim( localUtil.ntoc( A233StockTotal, (byte)(5), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A233StockTotal), "ZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtStockTotal_Jsonclick,Integer.valueOf(0),"AttributeRealWidth","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(5),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Cantidad","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol40( )
   {
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A46StockId, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A233StockTotal, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "3:StockId|4:ArticuloId|5:ArticuloNombre|6:StockTotal" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e191B2',iparms:[{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'A46StockId',fld:'STOCKID',pic:'ZZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e161B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV21ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV32IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A46StockId',fld:'STOCKID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      ...
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e141B2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Stocktotal',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A76ArticuloNombre = "" ;
      scmdbuf = "" ;
      lV39Stockwwds_1_filterfulltext = "" ;
      AV39Stockwwds_1_filterfulltext = "" ;
      H001B2_A233StockTotal = new int[1] ;
      H001B2_A76ArticuloNombre = new String[] {""} ;
      H001B2_A13ArticuloId = new long[1] ;
      H001B2_A46StockId = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.stockww__default(),
         new Object[] {
             new Object[] {
            H001B2_A233StockTotal, H001B2_A76ArticuloNombre, H001B2_A13ArticuloId, H001B2_A46StockId
            }
            , new Object[] {
   ...
   private String lV39Stockwwds_1_filterfulltext ;
   private String AV39Stockwwds_1_filterfulltext ;
   ...
   private int[] H001B2_A233StockTotal ;
   private String[] H001B2_A76ArticuloNombre ;
   private long[] H001B2_A13ArticuloId ;
   private long[] H001B2_A46StockId ;
...
final  class stockww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001B2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Stockwwds_1_filterfulltext ,
                                          long A46StockId ,
                                          long A13ArticuloId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[StockTotal], T2.[ArticuloNombre], T1.[ArticuloId], T1.[StockId]" ;
      sFromString = " FROM ([Stock] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV39Stockwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[StockId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(5), CAST(T1.[StockTotal] AS decimal(5,0))) like '%' + ?))");
      }
      else
      {
         GXv_int12[0] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[StockId]" ;
      }
      else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[StockId] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T1.[StockTotal]" ;
      }
      else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[StockTotal] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[StockId]" ;
   ...
   protected Object[] conditional_H001B3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV39Stockwwds_1_filterfulltext ,
                                          long A46StockId ,
                                          ...
                                          boolean AV14OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Stock] T1 INNER JOIN [Articulo] T2 ON T2.[ArticuloId] = T1.[ArticuloId])" ;
      if ( ! (GXutil.strcmp("", AV39Stockwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(11), CAST(T1.[StockId] AS decimal(11,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T1.[ArticuloId] AS decimal(11,0))) like '%' + ?) or ( T2.[ArticuloNombre] like '%' + ?) or ( CONVERT( char(5), CAST(T1.[StockTotal] AS decimal(5,0))) like '%' + ?))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001B2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H001B3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001B2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001B3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
