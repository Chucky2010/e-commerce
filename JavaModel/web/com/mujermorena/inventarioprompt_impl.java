...
public final  class inventarioprompt_impl extends GXDataArea
{
   public inventarioprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public inventarioprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( inventarioprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutInventarioID") ;
         ...
         {
            AV8InOutInventarioID = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutInventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutInventarioID), 11, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.mujermorena.inventarioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutInventarioID,11,0))}, new String[] {"InOutInventarioID"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vINOUTINVENTARIOID", GXutil.ltrim( localUtil.ntoc( AV8InOutInventarioID, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("com.mujermorena.inventarioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutInventarioID,11,0))}, new String[] {"InOutInventarioID"})  ;
   }

   public String getPgmname( )
   {
      return "InventarioPrompt" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Selecciona Inventario", "") ;
   }
   ...
   public void wb5W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_14_5W2( true) ;
      }
      else
      {
         wb_table1_14_5W2( false) ;
      }
      return  ;
   }

   public void wb_table1_14_5W2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Selecciona Inventario", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_INVENTARIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A53InventarioID), "ZZZZZZZZZZ9")));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "INVENTARIOID", GXutil.ltrim( localUtil.ntoc( A53InventarioID, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   public void rf5W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A265InventarioNumeroProceso = H005W2_A265InventarioNumeroProceso[0] ;
            A258InventarioDetalle = H005W2_A258InventarioDetalle[0] ;
            A257InventarioFecha = H005W2_A257InventarioFecha[0] ;
            A53InventarioID = H005W2_A53InventarioID[0] ;
            e175W2 ();
   ...
   public void send_integrity_lvl_hashes5W2( )
   {
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV22Pgmname));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22Pgmname, ""))));
      com.mujermorena.GxWebStd.gx_hidden_field( httpContext, "gxhash_INVENTARIOID"+"_"+sGXsfl_26_idx, getSecureSignedToken( sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A53InventarioID), "ZZZZZZZZZZ9")));
   }
   ...
   public void e155W2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Selecciona Inventario", "") );
   ...
   public void e165W2( )
   {
      ...
      inventarioprompt_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e185W2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutInventarioID = A53InventarioID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutInventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutInventarioID), 11, 0));
      httpContext.setWebReturnParms(new Object[] {Long.valueOf(AV8InOutInventarioID)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutInventarioID"});
   ...
   public void wb_table1_14_5W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.mujermorena.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, httpContext.getMessage( "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", ""), "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, httpContext.getMessage( "WWP_CleanFiltersTooltip", ""), 1, 1, 0, (short)(1), "HLP_InventarioPrompt.htm");
   ...
   {
      AV8InOutInventarioID = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutInventarioID", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutInventarioID), 11, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412111224532", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("inventarioprompt.js", "?202412111224534", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_262( )
   {
      ...
      edtInventarioID_Internalname = "INVENTARIOID_"+sGXsfl_26_idx ;
      edtInventarioFecha_Internalname = "INVENTARIOFECHA_"+sGXsfl_26_idx ;
      edtInventarioDetalle_Internalname = "INVENTARIODETALLE_"+sGXsfl_26_idx ;
      edtInventarioNumeroProceso_Internalname = "INVENTARIONUMEROPROCESO_"+sGXsfl_26_idx ;
   }

   public void subsflControlProps_fel_262( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx ;
      edtInventarioID_Internalname = "INVENTARIOID_"+sGXsfl_26_fel_idx ;
      edtInventarioFecha_Internalname = "INVENTARIOFECHA_"+sGXsfl_26_fel_idx ;
      edtInventarioDetalle_Internalname = "INVENTARIODETALLE_"+sGXsfl_26_fel_idx ;
      edtInventarioNumeroProceso_Internalname = "INVENTARIONUMEROPROCESO_"+sGXsfl_26_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:InventarioID|2:InventarioFecha|3:InventarioDetalle|4:InventarioNumeroProceso" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("ENTER","{handler:'e185W2',iparms:[{av:'A53InventarioID',fld:'INVENTARIOID',pic:'ZZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutInventarioID',fld:'vINOUTINVENTARIOID',pic:'ZZZZZZZZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H005W2_A265InventarioNumeroProceso = new short[1] ;
      H005W2_A258InventarioDetalle = new String[] {""} ;
      H005W2_A257InventarioFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H005W2_A53InventarioID = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.mujermorena.inventarioprompt__default(),
         new Object[] {
             new Object[] {
            H005W2_A265InventarioNumeroProceso, H005W2_A258InventarioDetalle, H005W2_A257InventarioFecha, H005W2_A53InventarioID
            }
            , new Object[] {
   ...
   private long wcpOAV8InOutInventarioID ;
   private long GRID_nFirstRecordOnPage ;
   private long AV8InOutInventarioID ;
   ...
   private short[] H005W2_A265InventarioNumeroProceso ;
   private String[] H005W2_A258InventarioDetalle ;
   private java.util.Date[] H005W2_A257InventarioFecha ;
   private long[] H005W2_A53InventarioID ;
...
final  class inventarioprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005W2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H005W3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
